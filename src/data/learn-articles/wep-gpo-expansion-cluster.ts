...
export const wepGpoExpansionArticles: LearnArticleRegistry = {
  ...
  'wep-reform-2026-update': {
    ...
    answerFirst: 'The Social Security Fairness Act aims to eliminate both WEP and GPO, and it has strong bipartisan support. But cost concerns ($196 billion over 10 years) have blocked passage for decades. Continue planning your retirement as if WEP will remain in effect — hope for reform but do not depend on it.',
    answerFirstFacts: [
      'Social Security Fairness Act would repeal both WEP and GPO if passed',
      'CBO estimates the cost at $196 billion over 10 years',
      'If repealed, affected retirees would see approximately $400-500/month increase',
      'Over 2.8 million Americans are affected by WEP including teachers, police, and federal workers',
    ],
  ...
  'wep-exemptions-guide': {
    ...
    answerFirst: 'The most common way to avoid WEP is earning 30 or more years of substantial Social Security-covered wages. Each year from 21 to 29 gradually reduces the penalty, and at 30 years WEP disappears completely. Other exemptions include survivor benefits (never subject to WEP), certain pre-1984 federal employees, and pensions from SS-covered work only.',
    answerFirstFacts: [
      '30+ years of substantial earnings eliminates WEP entirely — the 90% first bend point is restored',
      '2024 substantial earnings threshold is $31,275 in Social Security-covered wages',
      'Part-time SS-covered work counts if you meet the threshold — even summer jobs for teachers',
  ...
  'gpo-social-security': {
    ...
    answerFirst: 'The Government Pension Offset reduces Social Security spousal and survivor benefits by two-thirds of your government pension. For most government retirees, this wipes out spousal and survivor benefits entirely. GPO is different from WEP — GPO affects benefits from your spouse\'s Social Security record, while WEP reduces your own Social Security benefit.',
    answerFirstFacts: [
  ...
  'wep-calculation-guide': {
    ...
    answerFirst: 'WEP reduces your Social Security by modifying the first bend point percentage from 90% down to as low as 40%. The SSA provides a free calculator at ssa.gov to estimate your exact reduction. The maximum WEP reduction in 2024 is $558 per month, and it can never exceed half your non-covered pension amount.',
    answerFirstFacts: [
      'Normal SS formula uses 90% for the first bend point — WEP can reduce this to as low as 40%',
