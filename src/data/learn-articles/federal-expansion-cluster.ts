...
export const federalExpansionArticles: LearnArticleRegistry = {
  ...
  'tsp-vs-gold-ira': {
    ...
    answerFirst: 'TSP offers rock-bottom fees and government matching but limits you to 5 funds. A Gold IRA holds physical precious metals that protect against inflation and market crashes. Most federal employees benefit from keeping TSP for the match and adding a Gold IRA for diversification.',
    answerFirstFacts: [
      'TSP expense ratio is just 0.048% — one of the lowest in any retirement plan',
      'TSP only offers 5 core funds plus Lifecycle funds — no precious metals option',
      'You can roll TSP to a Gold IRA after separating from service or at age 59½',
      'Financial experts typically recommend 5-20% of retirement assets in precious metals',
    ],
  ...
  'fehb-retirement-guide': {
    ...
    answerFirst: 'Yes, federal retirees can keep their FEHB health insurance in retirement as long as they were enrolled for 5 continuous years before retiring. The government keeps paying about 72% of the premium, and you can coordinate FEHB with Medicare at age 65.',
    answerFirstFacts: [
  ...
  'fers-supplement-explained': {
    ...
    answerFirst: 'The FERS Supplement is a monthly payment that bridges the gap between early federal retirement and Social Security at age 62. It approximates what Social Security would pay based on your federal service years, and it ends automatically when you turn 62.',
    answerFirstFacts: [
      'Only immediate retirees with MRA+30 years or age 60+20 years qualify for the supplement',
      'Formula: estimated Social Security benefit at 62 × (FERS years ÷ 40)',
      'The supplement does NOT receive cost-of-living adjustments',
      'An earnings test reduces the supplement $1 for every $2 earned above the annual limit ($22,320 in 2024)',
    ],
