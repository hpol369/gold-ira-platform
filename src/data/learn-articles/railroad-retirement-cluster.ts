...
export const railroadRetirementArticles: LearnArticleRegistry = {
  ...
  'railroad-retirement-calculator': {
    ...
    answerFirst: 'Railroad Retirement pays in two tiers. Tier 1 equals what Social Security would pay based on your earnings. Tier 2 adds an extra pension of about 0.7% per year of railroad service times your average monthly earnings. With 30 years of service, you can retire at age 60 with full, unreduced benefits.',
    answerFirstFacts: [
      'Tier 1 is calculated using the same formula as Social Security benefits',
      'Tier 2 adds approximately 0.7% of average earnings per year of railroad service',
      'The 60/30 rule lets you retire at age 60 with 30 years for full unreduced benefits',
      'Railroad retirement benefits are generally 30-40% higher than Social Security alone',
    ],
  ...
  'tier-1-vs-tier-2-railroad': {
    ...
    answerFirst: 'Tier 1 is the Social Security equivalent — calculated the same way and taxed the same way. Tier 2 is an extra pension only railroad workers get, based on your railroad service years and earnings. Tier 1 gets the full COLA like Social Security, but Tier 2 COLA is only 32.5% of the CPI increase.',
    answerFirstFacts: [
      'Tier 1 uses the same Primary Insurance Amount formula as Social Security',
      'Tier 2 formula: approximately 0.7% per year of service × average monthly earnings',
      'Tier 1 is taxed like Social Security (up to 85% taxable); Tier 2 is fully taxable like a pension',
      'Tier 2 COLA is only 32.5% of CPI — meaning it falls behind inflation over time',
    ],
  ...
  'railroad-retirement-vs-social-security': {
    ...
    answerFirst: 'Railroad Retirement pays about 30-40% more than Social Security alone because of the extra Tier 2 pension. Railroad workers can also retire earlier — at age 60 with 30 years of service compared to 62-67 for Social Security. The tradeoff is higher payroll taxes: railroad employees pay about 12.55% vs 7.65% for Social Security.',
    answerFirstFacts: [
      'Railroad Retirement benefits are generally 30-40% higher than Social Security',
      'Railroad workers can retire at 60 with 30 years vs age 62 earliest for Social Security',
      'Railroad employee total payroll tax rate is 12.55% vs 7.65% for Social Security',
      'Spouse benefits include 50% of Tier 1 plus 45% of Tier 2 — more than Social Security provides',
    ],
