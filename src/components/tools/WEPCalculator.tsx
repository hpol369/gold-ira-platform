            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full bg-[#121423] border border-slate-700 rounded-lg px-4 py-3 text-[#F6F4EF] focus:outline-none focus:border-orange-500"
                >
          ...
          <div className="bg-[#0C0D18] backdrop-blur-sm rounded-xl p-6 border border-[#2A2D42]">
            <div className="flex items-center justify-between mb-6">
              ...
              <label className="flex items-center gap-2 cursor-pointer">
                ...
                />
                <span className="text-sm text-[#A8A39A]">Include GPO</span>
              </label>
            </div>
        ...
        <div className="space-y-6">
          ...
          <div className={`bg-gradient-to-br ${
            ...
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                <h3 className="text-sm text-[#A8A39A]">
            ...
            {!calculations.isWEPEliminated && (
              <div className="space-y-3 bg-[#0C0D18] rounded-lg p-4">
                <div className="flex justify-between items-center">
                  <span className="text-[#D0CCC4] text-sm">Your PIA (before WEP)</span>
                  <span className="font-semibold text-[#F6F4EF]">
                    {formatCurrency(calculations.estimatedPIA)}
                  </span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-[#D0CCC4] text-sm">WEP Reduction ({calculations.wepPercentage}%)</span>
                ...
                <div className="flex justify-between items-center pt-2 border-t border-[#2A2D42]">
                  <span className="text-[#D0CCC4] text-sm font-semibold">Adjusted Benefit</span>
                  <span className="font-bold text-[#F6F4EF] text-lg">
          ...
          {showGPO && (
            <div className="bg-[rgba(197,149,46,0.08)] border border-[rgba(197,149,46,0.32)] rounded-xl p-6">
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-center">
                  <span className="text-[#D0CCC4] text-sm">Spousal Benefit (before GPO)</span>
                  <span className="font-semibold text-[#F6F4EF]">
                    {formatCurrency(spouseBenefit)}
                  </span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-[#D0CCC4] text-sm">GPO Reduction (2/3 of pension)</span>
                  <span className="font-semibold text-red-600">
                    -{formatCurrency(calculations.gpoReduction)}
                  </span>
                </div>
                <div className="flex justify-between items-center pt-2 border-t border-[#2A2D42]">
                  <span className="text-[#D0CCC4] text-sm">Adjusted Spousal Benefit</span>
            ...
            <div className="bg-[#0C0D18] backdrop-blur-sm rounded-xl p-6 border border-[#2A2D42]">
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-center pb-4 border-b border-[#2A2D42]">
                  <span className="text-[#A8A39A]">Monthly Loss</span>
                  <span className="text-xl font-bold text-red-600">
                    {formatCurrency(calculations.totalMonthlyLoss)}
                  </span>
                </div>
                <div className="flex justify-between items-center pb-4 border-b border-[#2A2D42]">
                  <span className="text-[#A8A39A]">Annual Loss</span>
                  <span className="text-xl font-bold text-red-600">
                    {formatCurrency(calculations.totalMonthlyLoss * 12)}
                  </span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-[#A8A39A]">20-Year Lifetime Loss</span>
                  <span className="text-xl font-bold text-red-600">
                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="border-b border-[#2A2D42]">
                      <th className="py-2 px-2 text-left text-[#A8A39A]">+Years</th>
                      <th className="py-2 px-2 text-right text-[#A8A39A]">Total</th>
                      <th className="py-2 px-2 text-right text-[#A8A39A]">WEP %</th>
                      <th className="py-2 px-2 text-right text-[#A8A39A]">Monthly Gain</th>
                    </tr>
                  </thead>
                  <tbody>
      ...
      <div className="max-w-4xl mx-auto mt-16">
        <div className="bg-[#0C0D18] backdrop-blur-sm rounded-xl p-8 border border-[#2A2D42]">
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-8">
            <div>
              <div className="text-[#D4A94E] font-semibold mb-2">Income Diversification</div>
            ...
            <div>
              <div className="text-[#D4A94E] font-semibold mb-2">Inflation Protection</div>
              <p className="text-[#D0CCC4] text-sm">
