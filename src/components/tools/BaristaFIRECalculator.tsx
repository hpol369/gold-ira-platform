        ...
        <div className="space-y-6">
          ...
          <div className={`rounded-xl p-6 border ${
            ...
            <div className="flex items-center gap-3 mb-4">
              {calculations.canStartNow ? (
                ...
                <Coffee className="h-8 w-8 text-[#D4A94E]" />
              )}
              <div>
          ...
          <div className="bg-[#0C0D18] backdrop-blur-sm rounded-xl p-6 border border-[#2A2D42]">
            ...
            <div className="space-y-4">
              <div>
                <div className="flex justify-between text-sm mb-2">
                  <span className="text-[#A8A39A]">Part-time covers expenses</span>
                  <span className="font-semibold">{calculations.coveragePercent.toFixed(0)}%</span>
                </div>
                <div className="w-full bg-[#121423] rounded-full h-2 overflow-hidden">
                  <div
              ...
              <div className="grid grid-cols-2 gap-4 pt-2">
                <div>
                  <div className="text-xs text-[#A8A39A] mb-1">Monthly Income</div>
                  <div className="text-lg font-semibold text-green-600">
                    {formatCurrency(partTimeIncome)}
                  </div>
                </div>
                <div>
                  <div className="text-xs text-[#A8A39A] mb-1">Monthly Gap</div>
          ...
          <div className="bg-[#0C0D18] backdrop-blur-sm rounded-xl p-6 border border-[#2A2D42]">
            ...
            <div className="space-y-4">
              ...
              <div className="flex justify-between items-center pb-4 border-b border-[#2A2D42]">
                <span className="text-[#A8A39A]">Barista FIRE Number</span>
              ...
              <div className="flex justify-between items-center pb-4 border-b border-[#2A2D42]">
                <span className="text-[#A8A39A]">Savings Needed</span>
              ...
              <div className="flex justify-between items-center">
                <span className="text-[#A8A39A]">Monthly from Portfolio</span>
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1">
                    <div className="text-sm text-[#A8A39A]">Years to Barista FIRE</div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1">
                    <div className="text-sm text-[#A8A39A]">Age at Barista FIRE</div>
      ...
      <div className="max-w-4xl mx-auto mt-16">
        <div className="bg-[#0C0D18] backdrop-blur-sm rounded-xl p-8 border border-[#2A2D42]">
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-8">
            <div>
              <div className="text-[#D4A94E] font-semibold mb-2">Long-Term Stability</div>
            ...
            <div>
              <div className="text-[#D4A94E] font-semibold mb-2">Income Protection</div>
              <p className="text-[#D0CCC4] text-sm">
            ...
            <div>
              <div className="text-[#D4A94E] font-semibold mb-2">Peace of Mind</div>
              <p className="text-[#D0CCC4] text-sm">
