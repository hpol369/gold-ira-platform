        ...
        <div className="space-y-6">
          ...
          <div className={`rounded-xl p-6 border ${
            ...
            <div className="flex items-center gap-3 mb-4">
              {calculations.canStartNow ? (
                ...
                <Coffee className="h-8 w-8 text-[#B22234]" />
              )}
              <div>
          ...
          <div className="bg-slate-50 backdrop-blur-sm rounded-xl p-6 border border-slate-200">
            ...
            <div className="space-y-4">
              <div>
                <div className="flex justify-between text-sm mb-2">
                  <span className="text-slate-500">Part-time covers expenses</span>
              ...
              <div className="grid grid-cols-2 gap-4 pt-2">
                ...
                <div>
                  <div className="text-xs text-slate-500 mb-1">Monthly Gap</div>
          ...
          <div className="bg-slate-50 backdrop-blur-sm rounded-xl p-6 border border-slate-200">
            ...
            <div className="space-y-4">
              ...
              <div className="flex justify-between items-center pb-4 border-b border-slate-200">
                <span className="text-slate-500">Barista FIRE Number</span>
              ...
              <div className="flex justify-between items-center pb-4 border-b border-slate-200">
                <span className="text-slate-500">Savings Needed</span>
              ...
              <div className="flex justify-between items-center">
                <span className="text-slate-500">Monthly from Portfolio</span>
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1">
                    <div className="text-sm text-slate-500">Years to Barista FIRE</div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1">
                    <div className="text-sm text-slate-500">Age at Barista FIRE</div>
      ...
      <div className="max-w-4xl mx-auto mt-16">
        <div className="bg-slate-50 backdrop-blur-sm rounded-xl p-8 border border-slate-200">
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-8">
            <div>
              <div className="text-[#B22234] font-semibold mb-2">Long-Term Stability</div>
            ...
            <div>
              <div className="text-[#B22234] font-semibold mb-2">Income Protection</div>
              <p className="text-slate-600 text-sm">
            ...
            <div>
              <div className="text-[#B22234] font-semibold mb-2">Peace of Mind</div>
              <p className="text-slate-600 text-sm">
