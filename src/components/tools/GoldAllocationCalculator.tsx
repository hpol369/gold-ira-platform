        ...
        <div className="space-y-6">
          ...
          <div className="bg-gradient-to-br from-amber-500/20 to-yellow-500/20 backdrop-blur-sm rounded-xl p-8 border border-amber-500/30">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h3 className="text-sm text-slate-400">Recommended Gold Allocation</h3>
            ...
            <div className="space-y-2 text-sm bg-slate-800/50 rounded-lg p-4 mt-4">
              ...
              >
                <div className="absolute inset-4 bg-slate-900 rounded-full flex items-center justify-center">
                  <div className="text-center">
                    <div className="text-2xl font-bold text-amber-400">{calculations.goldPercentage}%</div>
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="flex items-center gap-2 bg-slate-800/50 rounded-lg p-3">
                ...
                <div className="flex-1">
                  <div className="text-sm font-semibold text-amber-400">Gold {calculations.goldPercentage}%</div>
              ...
              <div className="flex items-center gap-2 bg-slate-800/50 rounded-lg p-3">
                ...
                <div className="flex-1">
                  <div className="text-sm font-semibold text-blue-400">Stocks {calculations.stocksPercentage}%</div>
            ...
            <div className="space-y-4">
              ...
              <div className="bg-slate-800/50 rounded-lg p-4">
                <div className="flex justify-between items-center mb-3">
                  <div>
                    <h4 className="font-semibold text-white">Ray Dalio&apos;s All-Weather</h4>
                    <p className="text-xs text-slate-500">Designed to perform in any economic environment</p>
                  </div>
                  <div className="text-right">
                    <div className="text-lg font-bold text-amber-400">{rayDalioAllWeather.gold}%</div>
                ...
                <div className="flex justify-between text-xs text-slate-500 mt-2">
                  ...
                  <span className={calculations.goldPercentage >= rayDalioAllWeather.gold ? "text-green-400" : "text-amber-400"}>
              ...
              <div className="bg-slate-800/50 rounded-lg p-4">
                <div className="flex justify-between items-center mb-3">
                  <div>
                    <h4 className="font-semibold text-white">Harry Browne&apos;s Permanent Portfolio</h4>
                    <p className="text-xs text-slate-500">Equal parts for maximum crisis protection</p>
                  </div>
                  <div className="text-right">
                    <div className="text-lg font-bold text-amber-400">{harryBrownePermanent.gold}%</div>
                    <div className="text-xs text-slate-500">Gold</div>
                  </div>
                </div>
                ...
                <div className="flex justify-between text-xs text-slate-500 mt-2">
                  <span>Your gold: {calculations.goldPercentage}%</span>
                  <span className={calculations.goldPercentage >= harryBrownePermanent.gold ? "text-green-400" : "text-amber-400"}>
        ...
        <div className="prose prose-invert max-w-none">
          ...
          <div className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                <h4 className="font-semibold text-amber-400 mb-2">During 2008 Financial Crisis</h4>
              ...
              <div>
                <h4 className="font-semibold text-amber-400 mb-2">During 2020 COVID Crash</h4>
                <ul className="text-sm text-slate-400 space-y-1">
