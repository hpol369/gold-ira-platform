        ...
        <div className="space-y-6">
          ...
          <div className="bg-[rgba(220,38,38,0.06)] backdrop-blur-sm rounded-xl p-8 border border-[rgba(197,149,46,0.32)]">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h3 className="text-sm text-[#A8A39A]">Recommended Gold Allocation</h3>
            ...
            <div className="space-y-2 text-sm bg-[#0C0D18] rounded-lg p-4 mt-4">
              <div className="flex justify-between">
                <span className="text-[#A8A39A]">Gold Value</span>
                <span className="font-semibold text-[#D4A94E]">
                  {formatFullCurrency(goldAmount)}
                </span>
              </div>
              <div className="flex justify-between">
                <span className="text-[#A8A39A]">Risk Profile</span>
          ...
          <div className="bg-[#0C0D18] backdrop-blur-sm rounded-xl p-6 border border-[#2A2D42]">
            ...
            <div className="flex items-center justify-center mb-6">
              ...
              >
                <div className="absolute inset-4 bg-[rgba(197,149,46,0.12)] rounded-full flex items-center justify-center">
                  <div className="text-center">
                    <div className="text-2xl font-bold text-[#D4A94E]">{calculations.goldPercentage}%</div>
                    <div className="text-xs text-[#A8A39A]">Gold</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div className="flex items-center gap-2 bg-[#0C0D18] rounded-lg p-3">
                ...
                <div className="flex-1">
                  ...
                  <div className="text-xs text-[#A8A39A]">{formatCurrency(bondsAmount)}</div>
                </div>
              </div>
              <div className="flex items-center gap-2 bg-[#0C0D18] rounded-lg p-3">
                <div className="w-4 h-4 rounded bg-gray-500" />
                <div className="flex-1">
                  <div className="text-sm font-semibold text-[#A8A39A]">Cash {calculations.cashPercentage}%</div>
                  <div className="text-xs text-[#A8A39A]">{formatCurrency(cashAmount)}</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-[#0C0D18] backdrop-blur-sm rounded-xl p-6 border border-[#2A2D42]">
            ...
            <ul className="space-y-3">
              {calculations.explanation.map((reason, index) => (
                <li key={index} className="flex gap-3 text-sm text-[#D0CCC4]">
            ...
            <div className="space-y-4">
              ...
              <div className="bg-[#0C0D18] rounded-lg p-4">
                <div className="flex justify-between items-center mb-3">
                  <div>
                    <h4 className="font-semibold text-[#F6F4EF]">Ray Dalio&apos;s All-Weather</h4>
                    <p className="text-xs text-[#A8A39A]">Designed to perform in any economic environment</p>
                  </div>
                  <div className="text-right">
                    <div className="text-lg font-bold text-[#D4A94E]">{rayDalioAllWeather.gold}%</div>
                    <div className="text-xs text-[#A8A39A]">Gold</div>
                  </div>
                </div>
                ...
                <div className="flex justify-between text-xs text-[#A8A39A] mt-2">
                  ...
                  <span className={calculations.goldPercentage >= rayDalioAllWeather.gold ? "text-green-600" : "text-[#D4A94E]"}>
              ...
              <div className="bg-[#0C0D18] rounded-lg p-4">
                <div className="flex justify-between items-center mb-3">
                  <div>
                    <h4 className="font-semibold text-[#F6F4EF]">Harry Browne&apos;s Permanent Portfolio</h4>
                    <p className="text-xs text-[#A8A39A]">Equal parts for maximum crisis protection</p>
                  </div>
                  <div className="text-right">
                    <div className="text-lg font-bold text-[#D4A94E]">{harryBrownePermanent.gold}%</div>
                    <div className="text-xs text-[#A8A39A]">Gold</div>
                  </div>
                </div>
                ...
                <div className="flex justify-between text-xs text-[#A8A39A] mt-2">
                  <span>Your gold: {calculations.goldPercentage}%</span>
                  <span className={calculations.goldPercentage >= harryBrownePermanent.gold ? "text-green-600" : "text-[#D4A94E]"}>
        ...
        <div className="prose max-w-none">
          ...
          <div className="bg-[#0C0D18] backdrop-blur-sm rounded-xl p-6 border border-[#2A2D42]">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                <h4 className="font-semibold text-[#D4A94E] mb-2">During 2008 Financial Crisis</h4>
                <ul className="text-sm text-[#A8A39A] space-y-1">
                  <li>S&P 500: -37%</li>
                  <li>Gold: +5.5%</li>
                  <li>Bonds: +5.2%</li>
                </ul>
              ...
              <div>
                <h4 className="font-semibold text-[#D4A94E] mb-2">During 2020 COVID Crash</h4>
                <ul className="text-sm text-[#A8A39A] space-y-1">
