            ...
            <div className="space-y-4">
              ...
              <div className="bg-slate-800/50 rounded-lg p-4">
                <div className="flex justify-between items-center">
                  <span className="text-slate-400">Total Guaranteed Income</span>
                  <span className="text-xl font-bold text-green-400">
                    {formatFullCurrency(calculations.totalMonthlyIncome)}/mo
                  </span>
                </div>
                <div className="flex justify-between items-center mt-2">
                  <span className="text-slate-400">Net from Savings Needed</span>
          ...
          <div className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10">
            ...
            <div className="space-y-4">
              ...
              <div className="bg-slate-800/50 rounded-lg p-4 mt-4">
                <div className="flex justify-between items-center">
                  <span className="text-slate-400">Real Return (After Inflation)</span>
                  <span className={`text-xl font-bold ${
                    calculations.realReturn > 0 ? "text-green-400" : "text-red-400"
                  }`}>
        ...
        <div className="space-y-6">
          ...
          <div className={`bg-gradient-to-br rounded-xl p-8 border ${
            ...
            <div className="text-center">
              <div className="text-sm text-slate-400 mb-2">YOUR MONEY WILL LAST</div>
              <div className={`text-6xl font-bold mb-2 ${
                calculations.isAtRisk ? "text-red-400" : "text-green-400"
              }`}>
                {calculations.yearsUntilDepletion >= 50
                  ? "50+"
                  : calculations.yearsUntilDepletion}
              </div>
              <div className="text-xl text-slate-300">years</div>

              {calculations.ageAtDepletion && calculations.ageAtDepletion < 100 && (
                <div className={`mt-4 pt-4 border-t border-white/10 ${
                  calculations.ageAtDepletion < 95 ? "text-red-400" : "text-amber-400"
                }`}>
          ...
          {calculations.isAtRisk && calculations.ageAtDepletion && calculations.ageAtDepletion < 95 && (
            <div className="bg-red-500/10 border border-red-500/30 rounded-xl p-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h4 className="font-semibold text-red-400 mb-1">Warning: Plan at Risk</h4>
          ...
          <div className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10">
            ...
            <div className="space-y-4">
              <div className="bg-green-500/10 border border-green-500/30 rounded-lg p-4">
                <div className="text-sm text-green-400 mb-1">Safe Monthly Withdrawal for 30 Years</div>
              ...
              <div className="flex justify-between items-center pb-3 border-b border-white/10">
                <span className="text-slate-400">Your Current Withdrawal</span>
                <span className="font-semibold">{formatFullCurrency(monthlyWithdrawal)}/mo</span>
              </div>

              <div className="flex justify-between items-center pb-3 border-b border-white/10">
                <span className="text-slate-400">Initial Withdrawal Rate</span>
          ...
          <div className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10">
            ...
            <div className="space-y-3">
              <div className="flex justify-between items-center p-3 bg-slate-800/50 rounded-lg">
                <div>
                  <div className="text-slate-300">Reduce by 10%</div>
              ...
              <div className="flex justify-between items-center p-3 bg-slate-800/50 rounded-lg">
                <div>
                  <div className="text-slate-300">Reduce by 20%</div>
                  <div className="text-sm text-slate-500">
              ...
              <table className="w-full text-sm">
                ...
                <tbody>
                  {calculations.yearData.filter((_, i) => i % 5 === 0 || i === calculations.yearsUntilDepletion - 1).slice(0, 8).map((data) => (
                    <tr key={data.year} className="border-b border-white/5">
                      <td className="py-2">{data.year}</td>
                      <td className="py-2">{data.age}</td>
                      <td className={`py-2 text-right ${data.endBalance === 0 ? "text-red-400" : ""}`}>
          ...
          <div className="space-y-6 text-slate-300">
            ...
            <div className="grid md:grid-cols-3 gap-4">
              <div className="bg-slate-800/50 rounded-lg p-4">
                ...
                <h4 className="font-semibold text-white mb-1">Investment Returns</h4>
              ...
              <div className="bg-slate-800/50 rounded-lg p-4">
                ...
                <h4 className="font-semibold text-white mb-1">Inflation Impact</h4>
                <p className="text-sm text-slate-400">
              ...
              <div className="bg-slate-800/50 rounded-lg p-4">
                ...
                <h4 className="font-semibold text-white mb-1">Withdrawal Rate</h4>
                <p className="text-sm text-slate-400">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="space-y-4">
              <div className="flex gap-3">
                ...
                <div>
                  <h4 className="font-semibold text-white">Reduce Fixed Expenses</h4>
                  <p className="text-sm text-slate-400">
              ...
              <div className="flex gap-3">
                <CheckCircle2 className="h-5 w-5 text-green-400 flex-shrink-0 mt-0.5" />
                <div>
                  <h4 className="font-semibold text-white">Delay Social Security</h4>
                  <p className="text-sm text-slate-400">
              ...
              <div className="flex gap-3">
                <CheckCircle2 className="h-5 w-5 text-green-400 flex-shrink-0 mt-0.5" />
                <div>
                  <h4 className="font-semibold text-white">Part-Time Work</h4>
                  <p className="text-sm text-slate-400">
            ...
            <div className="space-y-4">
              <div className="flex gap-3">
                <CheckCircle2 className="h-5 w-5 text-green-400 flex-shrink-0 mt-0.5" />
                <div>
                  <h4 className="font-semibold text-white">Geographic Arbitrage</h4>
                  <p className="text-sm text-slate-400">
              ...
              <div className="flex gap-3">
                <CheckCircle2 className="h-5 w-5 text-green-400 flex-shrink-0 mt-0.5" />
                <div>
                  <h4 className="font-semibold text-white">Downsize Housing</h4>
                  <p className="text-sm text-slate-400">
              ...
              <div className="flex gap-3">
                <CheckCircle2 className="h-5 w-5 text-green-400 flex-shrink-0 mt-0.5" />
                <div>
                  <h4 className="font-semibold text-white">Inflation-Protected Assets</h4>
                  <p className="text-sm text-slate-400">
          ...
          <div className="bg-green-500/10 border border-green-500/30 rounded-lg p-4 mb-6">
            <div className="flex items-start gap-3">
              ...
              <div className="text-sm">
                <strong className="text-green-400">Historical Fact:</strong>{" "}
