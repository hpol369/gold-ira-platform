              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-slate-800 border border-amber-500/30 rounded-lg px-10 py-3 text-white focus:outline-none focus:border-amber-500"
                    min="0"
                    step="10000"
                  />
                </div>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-gradient-to-br from-amber-500/20 to-orange-500/20 backdrop-blur-sm rounded-xl p-8 border border-amber-500/30">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h3 className="text-sm text-slate-400">Your Fat FIRE Number</h3>
          ...
          <div className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10">
            ...
            <div className="space-y-4">
              ...
              <div className="flex justify-between items-center pb-4 border-b border-white/10">
                <span className="text-slate-400">Projected at Age {targetAge}</span>
            ...
            <div className="space-y-3">
              <div className="flex justify-between items-center">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm text-slate-400">Housing (30%)</span>
                </div>
              ...
              <div className="flex justify-between items-center">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm text-slate-400">Travel (20%)</span>
                </div>
              ...
              <div className="flex justify-between items-center">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm text-slate-400">Dining (15%)</span>
                </div>
              ...
              <div className="flex justify-between items-center">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm text-slate-400">Vehicles (10%)</span>
                </div>
              ...
              <div className="flex justify-between items-center">
                <span className="text-sm text-slate-400">Entertainment (10%)</span>
              ...
              <div className="flex justify-between items-center">
                <span className="text-sm text-slate-400">Other (15%)</span>
      ...
      <div className="max-w-4xl mx-auto mt-16">
        <div className="bg-white/5 backdrop-blur-sm rounded-xl p-8 border border-white/10">
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-8">
            ...
            <div>
              <div className="text-amber-400 font-semibold mb-2">Portfolio Stability</div>
              <p className="text-slate-400 text-sm">
            ...
            <div>
              <div className="text-amber-400 font-semibold mb-2">Multi-Generational Planning</div>
              <p className="text-slate-400 text-sm">
