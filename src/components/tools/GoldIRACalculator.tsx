  ...
  return (
    <Container className="py-12 md:py-20">
          ...
          <div className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10">
            ...
            <div className="space-y-4">
              ...
              <div>
                <label className="text-sm text-slate-400 mb-2 block">
                  Gold Allocation:{" "}
                  <span className="text-amber-400 font-bold">{goldAllocation}%</span>
                </label>
                <input
                  type="range"
                  min="5"
            ...
            >
              ...
              <div
                className={`text-xl font-bold ${
                  calculations.difference >= 0 ? "text-green-400" : "text-amber-400"
                }`}
              >
                {calculations.difference >= 0 ? "+" : ""}
          ...
          <div className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10">
            ...
            <div className="space-y-4">
              ...
              <div className="flex justify-between items-center pb-3 border-b border-white/10">
                <div>
                  <div className="text-slate-400 text-sm">Volatility (Std Dev)</div>
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1 flex gap-1">
                  ...
                  />
                  <div className="text-xs text-red-400">-37%</div>
                </div>
              </div>
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1 flex gap-1">
                  ...
                  />
                  <div className="text-xs text-amber-400">+5.5%</div>
                </div>
              </div>
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1 flex gap-1">
                  ...
                  />
                  <div className="text-xs text-red-400">-18%</div>
                </div>
              </div>
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1 flex gap-1">
                  <div
                    ...
                    style={{ width: "2%" }}
                  />
                  <div className="text-xs text-slate-400">-0.3%</div>
                </div>
              </div>
            </div>
      ...
      <div className="max-w-4xl mx-auto mt-16">
        <div className="bg-gradient-to-br from-slate-800 via-slate-900 to-slate-800 rounded-2xl p-8 border border-white/10">
          ...
          <div className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10">
            ...
            <div className="grid grid-cols-3 gap-4">
              ...
              <div className="bg-amber-500/10 rounded-lg p-4 text-center border border-amber-500/30">
                <div className="text-2xl font-bold text-amber-400 mb-1">10-15%</div>
              ...
              <div className="bg-slate-800 rounded-lg p-4 text-center">
                <div className="text-2xl font-bold text-purple-400 mb-1">15-25%</div>
