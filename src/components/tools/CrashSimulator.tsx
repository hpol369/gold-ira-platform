      ...
      <Container>
        <div className="max-w-5xl mx-auto">
          ...
          >
            ...
            <h2 className="text-3xl md:text-5xl font-bold text-[#F6F4EF] mb-4">
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="bg-[#161828] border border-[#2A2D42] shadow-sm rounded-2xl p-6 md:p-8"
            >
              <h3 className="text-xl font-bold text-[#F6F4EF] mb-6">Your Portfolio</h3>
              ...
              <div className="mb-6">
                <label className="block text-[#D0CCC4] text-sm mb-2">
                  Gold Allocation: <span className="text-[#D4A94E] font-bold">{goldAllocation}%</span>
                </label>
                <input
                  type="range"
                  min="0"
                    ...
                    <button
                      ...
                      className={`p-3 rounded-xl text-left transition-all ${
                        selectedScenario.id === scenario.id
                          ? "bg-[rgba(220,38,38,0.1)] border-[#B22234]/50 border"
                          : "bg-[#121423] border border-[#2A2D42] hover:border-[#3F4460]"
                      }`}
                    >
                      <div className={`text-sm font-semibold ${
                        selectedScenario.id === scenario.id ? "text-[#D4A94E]" : "text-[#F6F4EF]"
                      }`}>
                        {scenario.name}
                      </div>
              ...
              <button
                ...
                className="w-full py-4 bg-[#DC2626] hover:bg-[#991B1B] text-white font-bold text-lg rounded-xl transition-all flex items-center justify-center gap-2"
              >
            ...
            <motion.div
              ...
              className="bg-[#161828] border border-[#2A2D42] shadow-sm rounded-2xl p-6 md:p-8"
            >
              <h3 className="text-xl font-bold text-[#F6F4EF] mb-6">Simulation Results</h3>

              {result ? (
                <div className="space-y-6">
                  {/* Scenario Info */}
                  <div className="bg-[#0C0D18] rounded-xl p-4">
                    <div className="text-[#D4A94E] font-semibold mb-1">{result.scenario}</div>
                  ...
                  <div className="bg-[rgba(46,139,87,0.08)] border border-[rgba(46,139,87,0.32)] rounded-xl p-4">
                    ...
                    <div className={result.portfolioWithGold >= portfolioValue ? "text-green-600" : "text-[#D4A94E]"}>
                  ...
                  <div className="bg-[rgba(220,38,38,0.1)] border border-[rgba(197,149,46,0.32)] rounded-xl p-4 text-center">
                    ...
                    <div className="text-[#D0CCC4] text-sm">more of your retirement</div>
                  </div>

                  {/* CTA */}
                  <Link
                    href="/get-started"
                    className="block w-full py-4 bg-[#DC2626] hover:bg-[#991B1B] text-white font-bold text-center rounded-xl transition-all"
                  >
                ...
                <div className="h-full flex flex-col items-center justify-center text-center py-12">
                  <div className="w-16 h-16 bg-[#121423] rounded-2xl flex items-center justify-center mb-4">
                    <Percent className="h-8 w-8 text-[#A8A39A]" />
                  </div>
          ...
          {/* Disclaimer */}
          <p className="text-center text-[#A8A39A] text-sm mt-8 max-w-2xl mx-auto">
