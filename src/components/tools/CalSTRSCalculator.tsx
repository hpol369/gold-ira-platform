        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            ...
            <div className="bg-[#161828] border border-[#2A2D42] shadow-sm rounded-2xl p-6 md:p-8">
              <h3 className="text-xl font-bold text-[#F6F4EF] mb-6">Your Teaching Career</h3>
              ...
              <div className="mb-6">
                ...
                <input
                  ...
                  min={1970}
                  max={2024}
                  className="w-full px-4 py-3 bg-[#121423] border border-[#2A2D42] rounded-xl text-[#F6F4EF] text-lg focus:outline-none focus:border-blue-500"
                />
                {membershipYear >= 2013 ? (
              ...
              <div className="mb-6">
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  >
                    <span className="text-[#F6F4EF] font-semibold block">2% @ 60</span>
                    <span className="text-[#A8A39A] text-xs">Pre-2013 members</span>
                  </button>
                  <button
                  ...
                  >
                    <span className="text-[#F6F4EF] font-semibold block">2% @ 62</span>
                    <span className="text-[#A8A39A] text-xs">PEPRA (2013+)</span>
                  </button>
                </div>
            ...
            {/* Results Panel */}
            <div className="bg-[#161828] border border-[#2A2D42] shadow-sm rounded-2xl p-6 md:p-8">
              <h3 className="text-xl font-bold text-[#F6F4EF] mb-6">Your CalSTRS Estimate</h3>
              ...
              {result ? (
                <div className="space-y-6">
                  ...
                  <div className="bg-[#0C0D18] rounded-xl p-4">
                    <h4 className="text-[#F6F4EF] font-semibold mb-3">Benefit Formula</h4>
                    <div className="space-y-2 text-sm">
                      <div className="flex justify-between">
                        <span className="text-[#A8A39A]">Formula</span>
                        <span className="text-[#F6F4EF]">{result.formula}</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-[#A8A39A]">Service Credit</span>
                        <span className="text-[#F6F4EF]">{serviceYears} years</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-[#A8A39A]">Age Factor</span>
                        <span className="text-blue-600">{result.ageFactor.toFixed(2)}%</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-[#A8A39A]">Final Compensation</span>
                        <span className="text-[#F6F4EF]">{formatCurrency(finalCompensation)}</span>
                      </div>
                      <div className="border-t border-[#2A2D42] pt-2 mt-2">
                  ...
                  {/* Survivor Options */}
                  <div className="bg-[#0C0D18] rounded-xl p-4">
                    <div className="flex items-center gap-2 text-[#F6F4EF] font-semibold mb-3">
                    ...
                    <div className="space-y-3 text-sm">
                      <div className="flex justify-between items-center">
                        <div>
                          <span className="text-[#D0CCC4]">100% Survivor</span>
                          <span className="text-[#A8A39A] text-xs block">~12% reduction</span>
                        </div>
                        <span className="text-[#F6F4EF] font-semibold">{formatCurrency(result.survivor100)}/mo</span>
                      </div>
                      <div className="flex justify-between items-center">
                        <div>
                          <span className="text-[#D0CCC4]">75% Survivor</span>
                          <span className="text-[#A8A39A] text-xs block">~8% reduction</span>
                        </div>
                        <span className="text-[#F6F4EF] font-semibold">{formatCurrency(result.survivor75)}/mo</span>
                      </div>
                      <div className="flex justify-between items-center">
                        <div>
                          <span className="text-[#D0CCC4]">50% Survivor</span>
                          <span className="text-[#A8A39A] text-xs block">~5% reduction</span>
                        </div>
                        <span className="text-[#F6F4EF] font-semibold">{formatCurrency(result.survivor50)}/mo</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-[#0C0D18] rounded-xl p-4">
                    ...
                    <div className="space-y-2 text-sm">
                      <div className="flex justify-between">
                        <span className="text-[#A8A39A]">After 10 Years</span>
                        <span className="text-green-600">{formatCurrency(result.colaAdjusted10yr)}/year</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-[#A8A39A]">After 20 Years</span>
                  ...
                  <div className="bg-[#0C0D18] rounded-xl p-4">
                    <h4 className="text-[#F6F4EF] font-semibold mb-3">Lifetime Benefit Projections</h4>
                    <div className="space-y-2 text-sm">
                      <div className="flex justify-between">
                        <span className="text-[#A8A39A]">Total by Age 80</span>
                        <span className="text-[#F6F4EF]">{formatCurrency(result.lifetimeBenefitAt80)}</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-[#A8A39A]">Total by Age 85</span>
                        <span className="text-[#F6F4EF]">{formatCurrency(result.lifetimeBenefitAt85)}</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-[#A8A39A]">Total by Age 90</span>
                        <span className="text-[#F6F4EF]">{formatCurrency(result.lifetimeBenefitAt90)}</span>
                      </div>
                    </div>
                  </div>
                ...
                <div className="h-full flex flex-col items-center justify-center text-center py-12">
                  <div className="w-16 h-16 bg-[#121423] rounded-2xl flex items-center justify-center mb-4">
                    <GraduationCap className="h-8 w-8 text-[#A8A39A]" />
                  </div>
          ...
          {/* Age Factor Table */}
          <div className="mt-12">
            <h3 className="text-xl font-bold text-[#F6F4EF] mb-6 text-center">CalSTRS Age Factor Tables</h3>
                ...
                <div className="p-4">
                  <div className="grid grid-cols-4 gap-2 text-sm">
                    {Object.entries(AGE_FACTORS_2AT60).slice(0, 8).map(([age, factor]) => (
                      <div key={age} className="flex justify-between p-2 bg-[#0C0D18] rounded">
                        <span className="text-[#A8A39A]">{age}</span>
                        <span className="text-[#F6F4EF] font-medium">{factor}%</span>
                      </div>
                    ))}
                  </div>
                  <p className="text-[#A8A39A] text-xs mt-3">Max: 2.4% at age 63+</p>
                </div>
              </div>

              {/* 2% @ 62 PEPRA Table */}
              <div className="bg-[#161828] border border-[#2A2D42] shadow-sm rounded-xl overflow-hidden">
                <div className="bg-[rgba(220,38,38,0.1)] p-4 border-b border-[#2A2D42]">
                  <h4 className="text-[#F6F4EF] font-semibold">2% @ 62 (PEPRA Members)</h4>
                  <p className="text-[#D0CCC4] text-sm">For members hired on/after January 1, 2013</p>
                </div>
                <div className="p-4">
                  <div className="grid grid-cols-4 gap-2 text-sm">
                  ...
                  <p className="text-[#A8A39A] text-xs mt-3">Max: 2.3% at age 65+</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="mt-12 grid md:grid-cols-3 gap-6">
            <div className="bg-[#161828] border border-[#2A2D42] shadow-sm rounded-xl p-6">
              ...
              <h4 className="text-[#F6F4EF] font-semibold mb-2">No Social Security</h4>
              <p className="text-[#D0CCC4] text-sm">
                Most CalSTRS members do not pay into Social Security. Your CalSTRS pension is your primary retirement income.
              </p>
            </div>
            <div className="bg-[#161828] border border-[#2A2D42] shadow-sm rounded-xl p-6">
              <TrendingUp className="h-8 w-8 text-[#D4A94E] mb-4" />
              <h4 className="text-[#F6F4EF] font-semibold mb-2">2% Annual COLA</h4>
              <p className="text-[#D0CCC4] text-sm">
            ...
            <div className="bg-[#161828] border border-[#2A2D42] shadow-sm rounded-xl p-6">
              ...
              <h4 className="text-[#F6F4EF] font-semibold mb-2">403(b) Supplement</h4>
              <p className="text-[#D0CCC4] text-sm">
