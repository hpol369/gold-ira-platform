      ...
      <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-8">
            ...
            <div className="space-y-4">
              <div>
                <label className="text-sm text-slate-400 mb-2 block">
                  Your Age: <span className="text-white font-semibold">{age}</span>
                </label>
                <input
                  type="range"
                  min="62"
              ...
              <div className="flex items-center gap-3 p-3 bg-slate-800/50 rounded-lg">
                ...
                />
                <label htmlFor="hasSpouse" className="text-sm text-slate-300">
              ...
              {hasSpouse && (
                <div>
                  <label className="text-sm text-slate-400 mb-2 block">
                    Spouse Age: <span className="text-white font-semibold">{spouseAge || "Enter age"}</span>
                  </label>
                  <input
                    type="number"
                    value={spouseAge || ""}
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-slate-800 border border-slate-700 rounded-lg px-10 py-3 text-white focus:outline-none focus:border-emerald-500"
                    min="100000"
                    step="25000"
                  />
                </div>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-gradient-to-br from-emerald-500/20 to-teal-500/20 backdrop-blur-sm rounded-xl p-6 border border-emerald-500/30">
            ...
            <div className="space-y-2 text-sm">
              <div className="flex justify-between">
                <span className="text-slate-400">Assessed Value (max ${formatNumber(HECM_LIMIT_2024)})</span>
                <span className="text-white">{formatCurrency(calculations.hecmAssessedValue)}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-slate-400">PLF (Age {calculations.effectiveAge})</span>
                <span className="text-white">{(calculations.hecmPLF * 100).toFixed(1)}%</span>
              </div>
              <div className="flex justify-between">
                <span className="text-slate-400">Principal Limit</span>
                <span className="text-white">{formatCurrency(calculations.hecmPrincipalLimit)}</span>
              </div>
            ...
            <div className="mt-4 p-3 bg-slate-800/50 rounded-lg">
              <div className="flex justify-between text-sm">
                <span className="text-slate-400">Annual MIP (ongoing)</span>
                <span className="text-amber-400">0.5% of balance/year</span>
              </div>
            </div>
          </div>
          ...
          <div className={`bg-white/5 backdrop-blur-sm rounded-xl p-6 border ${
            ...
            <div className="space-y-2 text-sm">
              <div className="flex justify-between">
                <span className="text-slate-400">Full Home Value Used</span>
                <span className="text-white">{formatCurrency(homeValue)}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-slate-400">PLF (Typically Lower)</span>
                <span className="text-white">{(calculations.proprietaryPLF * 100).toFixed(1)}%</span>
              </div>
              <div className="flex justify-between">
                <span className="text-slate-400">Principal Limit</span>
                <span className="text-white">{formatCurrency(calculations.proprietaryPrincipalLimit)}</span>
              </div>
              <div className="flex justify-between pt-2 border-t border-white/10">
            ...
            <div className="mt-4 p-3 bg-emerald-500/10 rounded-lg">
              <div className="flex justify-between text-sm">
                <span className="text-slate-400">No Annual MIP!</span>
          ...
          <div className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10">
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between p-3 bg-slate-800/50 rounded-lg">
                <span className="text-slate-400">Initial Proceeds</span>
                <div className="flex items-center gap-2">
              ...
              <div className="flex items-center justify-between p-3 bg-slate-800/50 rounded-lg">
                <span className="text-slate-400">Balance at Year 10</span>
                <div className="flex items-center gap-2">
              ...
              <div className="flex items-center justify-between p-3 bg-slate-800/50 rounded-lg">
                <span className="text-slate-400">FHA Insurance</span>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-white/10">
                  ...
                  <th className="py-2 text-right text-amber-400">MIP Paid (HECM)</th>
                </tr>
              </thead>
              <tbody>
                {calculations.hecmProjection.filter((_, i) => i % 3 === 0 || i === 10 || i === 15).map((proj, idx) => (
                  <tr key={proj.year} className={idx % 2 === 0 ? "bg-white/[0.02]" : ""}>
                    ...
                    <td className="py-2 text-right text-amber-400">{formatCurrency(proj.mipPaid)}</td>
                  </tr>
                ))}
              </tbody>
            </table>
