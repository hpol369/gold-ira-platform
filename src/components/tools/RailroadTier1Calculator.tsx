          ...
          {!showResults ? (
                  ...
                  <div className="space-y-6">
                    <div className="space-y-4">
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        ...
                        >
                          <p className="font-semibold text-[#F6F4EF]">No</p>
                        ...
                        >
                          <p className="font-semibold text-[#F6F4EF]">Yes</p>
                          <p className="text-[#D0CCC4] text-sm mt-1">
            ...
            >
              ...
              <div className="bg-gradient-to-b from-blue-500/10 to-transparent border-2 border-blue-500/30 rounded-2xl p-8 text-center">
                ...
                {calculations.hasWEP && (
                  <div className="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-[rgba(220,38,38,0.1)] text-[#D4A94E]">
              ...
              <div className="bg-[#161828] border border-[#2A2D42] shadow-sm rounded-2xl p-8">
                ...
                <div className="space-y-4 mb-8">
                  ...
                  <div className="flex justify-between items-center py-3 border-b border-[#2A2D42]">
                    <span className="text-[#A8A39A]">Base Tier I (before adjustments)</span>
                  ...
                  {calculations.hasWEP && (
                    <div className="flex justify-between items-center py-3 border-b border-[#2A2D42]">
                      <span className="text-[#D4A94E]">WEP Reduction</span>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="bg-[#0C0D18] rounded-xl p-6">
                    ...
                    <div className="space-y-3">
                      <div className="flex justify-between">
                        <span className="text-[#A8A39A]">Railroad Years</span>
                        <span className="text-blue-600 font-semibold">
                          {calculations.railroadYears}
                        </span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-[#A8A39A]">Non-Railroad Years</span>
                        <span className="text-[#D4A94E] font-semibold">
                          {calculations.nonRailroadYears}
                        </span>
                      </div>
                      <div className="flex justify-between border-t border-[#2A2D42] pt-3">
                        <span className="text-[#F6F4EF]">Total Coverage</span>
                  ...
                  <div className="bg-[#0C0D18] rounded-xl p-6">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex justify-between">
                        <span className="text-[#A8A39A]">Annual</span>
                        <span className="text-blue-600 font-bold">
                          {formatCurrency(calculations.finalBenefit * 12)}
                        </span>
                      </div>
                      <div className="flex justify-between border-t border-[#2A2D42] pt-3">
                        <span className="text-[#A8A39A]">SS Equivalent</span>
