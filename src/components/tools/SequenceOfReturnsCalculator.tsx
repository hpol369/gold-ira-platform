            ...
            <div className="space-y-4">
              ...
              <div className="bg-slate-800/50 rounded-lg p-4 mt-4">
                <div className="flex justify-between items-center">
                  <span className="text-slate-400">Average Annual Return</span>
            ...
            <div className={`rounded-lg p-4 ${
              ...
              <div className="text-center">
                ...
                <div className={`text-3xl font-bold ${
                  calculations.difference > 0 ? "text-green-400" : "text-red-400"
                }`}>
          ...
          <div className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10">
            ...
            <div className="flex justify-center gap-6 text-sm">
              <div className="flex items-center gap-2">
                ...
                <span className="text-slate-400">Bull Then Bear</span>
              </div>
              <div className="flex items-center gap-2">
                <div className="w-4 h-4 bg-red-500/50 rounded" />
                <span className="text-slate-400">Bear Then Bull</span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10">
            ...
            <div className="space-y-3 text-sm">
              <div className="flex justify-between items-center pb-3 border-b border-white/10">
                <span className="text-slate-400">Initial Portfolio</span>
              ...
              <div className="flex justify-between items-center pb-3 border-b border-white/10">
                <span className="text-slate-400">Total Withdrawals ({retirementYears} years)</span>
                <span className="font-semibold">{formatFullCurrency(calculations.totalWithdrawals)}</span>
              </div>
              <div className="flex justify-between items-center pb-3 border-b border-white/10">
                <span className="text-slate-400">Average Return (Same for Both)</span>
                <span className="font-semibold text-amber-400">{calculations.avgReturn.toFixed(1)}%</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white/5 backdrop-blur-sm rounded-xl p-8 border border-white/10 mb-8">
          ...
          <div className="space-y-6 text-slate-300">
            <p>
              ...
              It demonstrates that <strong className="text-white">when</strong> you receive investment returns
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="space-y-4">
              <div className="flex gap-3">
                ...
                <div>
                  <h4 className="font-semibold text-white">Gold Allocation (10-15%)</h4>
                  <p className="text-sm text-slate-400">
              ...
              <div className="flex gap-3">
                <CheckCircle2 className="h-5 w-5 text-green-400 flex-shrink-0 mt-0.5" />
                <div>
                  <h4 className="font-semibold text-white">Cash Reserve (1-2 Years)</h4>
                  <p className="text-sm text-slate-400">
              ...
              <div className="flex gap-3">
                <CheckCircle2 className="h-5 w-5 text-green-400 flex-shrink-0 mt-0.5" />
                <div>
                  <h4 className="font-semibold text-white">Flexible Withdrawal Strategy</h4>
                  <p className="text-sm text-slate-400">
            ...
            <div className="space-y-4">
              <div className="flex gap-3">
                <CheckCircle2 className="h-5 w-5 text-green-400 flex-shrink-0 mt-0.5" />
                <div>
                  <h4 className="font-semibold text-white">Bond Ladder</h4>
                  <p className="text-sm text-slate-400">
              ...
              <div className="flex gap-3">
                <CheckCircle2 className="h-5 w-5 text-green-400 flex-shrink-0 mt-0.5" />
                <div>
                  <h4 className="font-semibold text-white">Lower Initial Withdrawal Rate</h4>
                  <p className="text-sm text-slate-400">
              ...
              <div className="flex gap-3">
                <CheckCircle2 className="h-5 w-5 text-green-400 flex-shrink-0 mt-0.5" />
                <div>
                  <h4 className="font-semibold text-white">Part-Time Income</h4>
                  <p className="text-sm text-slate-400">
