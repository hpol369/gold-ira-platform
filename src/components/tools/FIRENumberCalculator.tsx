        ...
        <div className="space-y-6">
          ...
          <div className="bg-gradient-to-br from-orange-500/20 to-red-500/20 backdrop-blur-sm rounded-xl p-8 border border-orange-500/30">
            ...
            <div className="space-y-2 text-sm bg-[#0C0D18] rounded-lg p-4 mt-4">
              <div className="flex justify-between">
                <span className="text-[#A8A39A]">Monthly Passive Income</span>
                <span className="font-semibold text-green-600">
                  {formatFullCurrency(calculations.monthlyPassiveIncome)}
                </span>
              </div>
              <div className="flex justify-between">
                <span className="text-[#A8A39A]">Annual Passive Income</span>
                <span className="font-semibold text-green-600">
          ...
          <div className={`rounded-xl p-6 border ${
            ...
            {!calculations.hasReachedFIRE && (
              <div className="mt-4 pt-4 border-t border-[#2A2D42]">
                <div className="text-sm text-[#A8A39A] mb-1">Still needed</div>
          ...
          <div className="bg-[#0C0D18] backdrop-blur-sm rounded-xl p-6 border border-[#2A2D42]">
            ...
            <div className="space-y-4">
              <div className="flex justify-between items-center pb-4 border-b border-[#2A2D42]">
                <span className="text-[#A8A39A]">FI Ratio</span>
              ...
              <div className="flex justify-between items-center pb-4 border-b border-[#2A2D42]">
                <span className="text-[#A8A39A]">Current Annual Withdrawal</span>
              ...
              <div className="flex justify-between items-center pb-4 border-b border-[#2A2D42]">
                <span className="text-[#A8A39A]">Inflation-Adjusted FIRE</span>
              ...
              <div className="flex justify-between items-center">
                <span className="text-[#A8A39A]">Monthly Savings</span>
          ...
          <div className="bg-[#0C0D18] backdrop-blur-sm rounded-xl p-6 border border-[#2A2D42]">
            ...
            <div className="space-y-3">
              <div className="flex justify-between items-center">
                <span className="text-[#A8A39A]">Current Age</span>
              ...
              <div className="flex justify-between items-center">
                <span className="text-[#A8A39A]">Years to Freedom</span>
