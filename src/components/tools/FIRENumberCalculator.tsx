        ...
        <div className="space-y-6">
          ...
          <div className="bg-gradient-to-br from-orange-500/20 to-red-500/20 backdrop-blur-sm rounded-xl p-8 border border-orange-500/30">
            ...
            <div className="space-y-2 text-sm bg-slate-800/50 rounded-lg p-4 mt-4">
              ...
              <div className="flex justify-between">
                <span className="text-slate-400">Annual Passive Income</span>
                <span className="font-semibold text-green-400">
          ...
          <div className={`rounded-xl p-6 border ${
            ...
            {!calculations.hasReachedFIRE && (
              <div className="mt-4 pt-4 border-t border-white/10">
                <div className="text-sm text-slate-400 mb-1">Still needed</div>
          ...
          <div className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10">
            ...
            <div className="space-y-4">
              <div className="flex justify-between items-center pb-4 border-b border-white/10">
                <span className="text-slate-400">FI Ratio</span>
              ...
              <div className="flex justify-between items-center pb-4 border-b border-white/10">
                <span className="text-slate-400">Current Annual Withdrawal</span>
              ...
              <div className="flex justify-between items-center pb-4 border-b border-white/10">
                <span className="text-slate-400">Inflation-Adjusted FIRE</span>
          ...
          <div className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10">
            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-between items-center">
                <span className="text-slate-400">Years to Freedom</span>
              ...
              {!calculations.hasReachedFIRE && (
                <div className="mt-4 pt-4 border-t border-white/10 bg-blue-500/10 rounded-lg p-3">
