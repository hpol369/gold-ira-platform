    ...
    <section id="verdict" className="scroll-mt-24">
      <div className={cn(
        ...
        isFeatured
          ...
          : "bg-gradient-to-br from-[#0C0D18] to-slate-100/50 border border-[#2A2D42]"
      )}>
        {/* Header */}
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            <h2 className="text-2xl font-bold text-[#F6F4EF]">Our Verdict</h2>
            <p className="text-[#D0CCC4]">Final assessment of {company.name}</p>
          </div>
        </div>

        {/* Rating Summary */}
        <div className="flex flex-wrap items-center gap-4 mb-6 pb-6 border-b border-[#2A2D42]">
          <div className="text-5xl font-bold text-[#F6F4EF]">
        ...
        {/* Key Takeaways */}
        <div className="bg-[#161828] rounded-xl p-6 mb-6 border border-[#2A2D42]">
          <h3 className="font-bold text-[#F6F4EF] mb-4">Key Takeaways</h3>
            ...
            <div className="flex-1">
              ...
              <div className="flex items-center gap-4 text-sm">
                <div className="flex items-center gap-1">
                  <span className="font-bold text-[#F6F4EF]">{augusta.rating}</span>
                  <CompanyRating rating={augusta.rating} size="sm" showValue={false} />
                </div>
                <span className="text-[#A8A39A]">|</span>
                <span className="text-[#D0CCC4]">BBB: {augusta.bbbRating}</span>
                <span className="text-[#A8A39A]">|</span>
                <span className="text-[#D0CCC4] whitespace-nowrap">${augusta.minInvestment.toLocaleString()} min</span>
              </div>
            </div>
