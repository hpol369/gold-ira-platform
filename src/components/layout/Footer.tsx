                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8 mb-12">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            ...
                            <li><Link href="/gold-ira-rollover" className="text-gray-400 hover:text-white transition-colors text-sm">Gold IRA Rollover Guide</Link></li>
                            <li><Link href="/is-gold-a-good-investment" className="text-gray-400 hover:text-white transition-colors text-sm">Is Gold a Good Investment?</Link></li>
