  ...
  return (
    <div className="mt-8 bg-gradient-to-br from-[#000080]/5 to-[#B22234]/5 border border-[#000080]/20 rounded-2xl p-6 md:p-8">
      <div className="flex items-start gap-4">
        <div className="flex-shrink-0 w-12 h-12 bg-[rgba(220,38,38,0.1)] rounded-xl flex items-center justify-center">
        ...
        <div className="flex-1">
          ...
          <p className="text-[#D0CCC4] mb-4">{message.subtext}</p>
          <a
            href={`/get-started?${params.toString()}`}
            className="inline-flex items-center gap-2 bg-[#DC2626] hover:bg-[#9a1d2d] text-white font-bold py-3 px-6 rounded-xl transition-all"
          >
            {message.buttonText}
            <ArrowRight className="h-5 w-5" />
          </a>
          {resultValue && (
            <p className="text-[#A8A39A] text-sm mt-3 flex items-center gap-1">
