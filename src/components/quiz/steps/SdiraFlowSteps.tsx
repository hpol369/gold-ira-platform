          ...
          <div className="grid grid-cols-1 gap-4">
            {currentStep.options.map((option) => (
              <button
                ...
                className="group relative flex items-center justify-between p-6 text-left rounded-xl border-2 border-white/10 hover:border-emerald-500/50 hover:bg-[#1E2134]/10 transition-all duration-200 bg-white/5 backdrop-blur-sm"
              >
