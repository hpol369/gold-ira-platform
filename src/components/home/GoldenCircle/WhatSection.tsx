    ...
    <section className="py-20 md:py-28 bg-[#161828] border-b border-[#2A2D42]">
      <Container>
        <div className="max-w-6xl mx-auto">
          ...
          <FadeIn delay={0.4} className="bg-[rgba(197,149,46,0.1)] rounded-3xl overflow-hidden shadow-2xl relative" id="featured-partner">
            {/* Texture */}
                ...
                <div className="lg:w-3/5">
                  ...
                  <div className="flex flex-col sm:flex-row gap-4">
                    ...
                    <Button
                      size="lg"
                      variant="outline"
                      className="border-white/20 text-[#F6F4EF] hover:bg-white/10 font-bold text-lg"
                      asChild
                    >
