...
export function HowSection() {
  return (
    <section id="how-it-works" className="py-16 md:py-24 bg-[#0C0D18] border-b border-[#2A2D42] scroll-mt-20">
      <Container>
        <div className="max-w-5xl mx-auto">
          ...
          <FadeIn>
            <div className="text-center mb-14">
              ...
              <p className="text-lg text-[#D0CCC4] max-w-2xl mx-auto font-medium">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-14">
            <FadeIn delay={0.1} className="h-full">
              <div className="relative group h-full">
                ...
                <div className="bg-[#161828] border border-[#2A2D42] rounded-3xl p-8 h-full shadow-sm group-hover:shadow-lg group-hover:border-[#C5A55A]/30 transition-all duration-300">
                  <div className="w-14 h-14 rounded-2xl bg-[rgba(197,149,46,0.1)] text-white flex items-center justify-center font-black text-xl mb-6 shadow-lg shadow-blue-900/20 group-hover:scale-105 transition-transform">
                    1
                  </div>
                  <h3 className="text-xl font-bold text-[#F6F4EF] mb-3">Open Your Gold IRA</h3>
                  <p className="text-[#D0CCC4] mb-5 font-medium">
          ...
          <FadeIn delay={0.4}>
            <div className="text-center">
              <Link
                ...
                className="inline-flex items-center justify-center px-8 py-4 bg-[rgba(197,149,46,0.1)] hover:bg-[#000060] text-white font-bold text-lg rounded-xl transition-all duration-300 shadow-xl hover:-translate-y-1 group"
              >
