...
export function UrgencySection() {
  ...
  return (
    <section className="py-16 md:py-20 bg-gradient-to-b from-slate-900 to-slate-800 relative overflow-hidden">
      ...
      <Container className="relative z-10">
        ...
        >
          ...
          <div className="text-center mb-12">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-red-500/20 border border-red-500/30 rounded-full text-red-400 text-sm font-bold mb-6">
              <AlertTriangle className="h-4 w-4" />
              Why Smart Money Is Moving NOW
            </div>
            <h2 className="text-3xl md:text-5xl font-serif font-bold text-white mb-4">
              The Window Is <span className="text-amber-400">Closing</span>
            </h2>
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-12">
            {urgencyPoints.map((point, index) => (
              ...
              >
                ...
                <div className="text-sm font-semibold text-slate-300 mb-1">{point.label}</div>
          ...
          <motion.div
            ...
            className="bg-gradient-to-r from-amber-500/10 via-amber-500/5 to-amber-500/10 border border-amber-500/20 rounded-2xl p-8 mb-10"
          >
            <div className="flex flex-col md:flex-row items-center gap-6">
              ...
              <div className="flex-grow text-center md:text-left">
                ...
                <p className="text-slate-300">
                  While most Americans keep their retirement in paper assets, <span className="text-amber-400 font-semibold">central banks added 1,037 tons of gold</span> to their reserves in 2023 alone. China, Russia, India—they're all preparing.
                  <span className="text-white font-semibold"> The question is: are you?</span>
                </p>
              </div>
            </div>
          </motion.div>
          ...
          <div className="text-center">
            <Button
              size="xl"
              className="bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-600 hover:to-amber-700 text-slate-900 font-bold text-lg px-10 shadow-lg shadow-amber-500/25"
              asChild
            >
