        ...
        <div className="bg-background-subtle rounded-2xl p-8 border border-primary/5 mt-16 flex flex-col md:flex-row gap-8 items-center md:items-start">
            ...
            <div className="flex-1 text-center md:text-left">
                ...
                <p className="text-text-muted mb-4 leading-relaxed">
                    Thomas is a former wealth manager with 20+ years of experience. He founded Gold IRA Guide to expose the flaws of traditional "paper asset" retirement planning and educate Americans on the stability of physical precious metals.
                </p>
