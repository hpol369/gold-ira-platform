    ...
    return (
        <div className="py-8 w-full max-w-4xl mx-auto">
            ...
            <motion.div
                ...
                className="bg-[#161828] rounded-3xl p-8 md:p-12 border border-[#2A2D42] shadow-2xl mb-8 relative overflow-hidden"
            >
                <div className="absolute top-0 right-0 w-64 h-64 bg-[rgba(220,38,38,0.1)] rounded-full blur-[80px] -translate-y-1/2 translate-x-1/2" />

                <div className="flex flex-col md:flex-row items-center justify-between gap-10 relative z-10">
                    <div className="text-center md:text-left">
                        <div className="inline-flex items-center gap-2 px-3 py-1 bg-[#0C0D18] border border-[#2A2D42] rounded-full text-xs font-mono text-[#A8A39A] mb-4">
                            <span className="w-2 h-2 rounded-full bg-emerald-500 animate-pulse" />
                            AUDIT REPORT #8021
                        </div>
                        <h1 className="text-3xl md:text-4xl font-serif font-bold text-[#F6F4EF] mb-2">
                            Exposure Analysis
                        </h1>
                        <p className="text-[#A8A39A]">
                            Based on your goal to protect against <span className="text-[#F6F4EF] font-semibold">{primaryFear}</span>.
                        </p>
                    </div>

                    <div className="flex flex-col items-center justify-center p-6 bg-[#0C0D18] rounded-2xl border border-[#2A2D42] min-w-[200px]">
                        <span className="text-sm uppercase tracking-widest text-[#A8A39A] font-bold mb-2">Risk Score</span>
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-12">
                ...
                >
                    <div className="flex items-center gap-3 mb-6">
                        ...
                        <h3 className="text-xl font-bold text-[#F6F4EF]">The Sovereign Shield</h3>
                    </div>
                    ...
                    <div className="space-y-3">
                        <div className="flex items-center gap-3 bg-[#0C0D18] p-3 rounded-lg border border-[#2A2D42]">
                            <Lock className="w-5 h-5 text-[#D4A94E]" />
                            <span className="text-sm text-[#F6F4EF]">Tax-Free "Penalty-Free" Rollover Logic</span>
                        </div>
                        <div className="flex items-center gap-3 bg-[#0C0D18] p-3 rounded-lg border border-[#2A2D42]">
                            <CheckCircle2 className="w-5 h-5 text-[#D4A94E]" />
                            <span className="text-sm text-[#F6F4EF]">IRS-Approved Legal Loophole</span>
                        </div>
                    </div>
                </motion.div>
            </div>
            ...
            >
                ...
                <Button size="xl" className="bg-white text-[#D4A94E] hover:bg-[#121423] font-bold text-lg min-w-[280px]" onClick={() => openModal("default", "audit-results")}>
