                ...
                <div className="max-w-3xl mx-auto">
                    <FadeIn delay={0.1}>
                        <article className="prose prose-lg prose-headings:font-serif prose-headings:text-[#F6F4EF] prose-p:text-[#D0CCC4] prose-strong:text-[#F6F4EF] prose-li:text-[#D0CCC4] max-w-none">
                            ...
                            <p>
                                For more details, see our <Link href="/editorial-policy" className="text-[#D4A94E] hover:underline">Editorial Policy</Link>.
                            </p>
                            ...
                            <p>
                                If you spot an error, please <Link href="/contact" className="text-[#D4A94E] hover:underline">let us know</Link> and we&apos;ll correct it.
                            </p>
                            ...
                            <h2>Contact</h2>
                            <p>
                                Questions about these terms? Email us at <a href="mailto:legal@richdadretirement.com" className="text-[#D4A94E] hover:underline">legal@richdadretirement.com</a> or visit our <Link href="/contact" className="text-[#D4A94E] hover:underline">contact page</Link>.
                            </p>
