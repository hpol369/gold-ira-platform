                ...
                <Container className="relative z-10">
                    <div className="max-w-4xl">
                        ...
                        <h1 className="text-4xl md:text-5xl font-serif font-bold mb-6 leading-tight">
                            ...
                            <span className="text-[#D0CCC4]">America&apos;s Largest Silver Dealer</span>
                        </h1>
                    ...
                    <div className="bg-[#0C0D18] backdrop-blur-sm border border-[#2A2D42] rounded-2xl p-6 md:p-8">
                        <div className="grid md:grid-cols-3 gap-8 items-center">
                            <div className="md:col-span-2">
                                ...
                                <h2 className="text-2xl font-serif font-bold text-[#F6F4EF] mb-4">Best for Selection, Not Price</h2>
                            ...
                            <div className="bg-[#0C0D18] rounded-xl p-6 text-center">
                                <div className="text-5xl font-bold text-[#F6F4EF] mb-2">4.7</div>
                                <StarRating rating={4.7} />
                    ...
                    <article className="lg:col-span-2">
                        <div className="prose prose-lg max-w-none text-[#D0CCC4] prose-headings:text-[#F6F4EF] prose-strong:text-[#F6F4EF] prose-a:text-[#D4A94E]">
                            ...
                            <div className="grid md:grid-cols-3 gap-4 my-8 not-prose">
                                <div className="bg-[#0C0D18] border border-[#2A2D42] rounded-xl p-4 text-center">
                                    <div className="text-2xl font-bold text-[#D4A94E]">2000</div>
                                ...
                                <div className="bg-[#0C0D18] border border-[#2A2D42] rounded-xl p-4 text-center">
                                    <div className="text-2xl font-bold text-[#D4A94E]">20,000+</div>
                                    <div className="text-sm text-[#D0CCC4]">Products</div>
                                </div>
                            </div>
                        ...
                        <div className="prose prose-lg max-w-none text-[#D0CCC4] prose-headings:text-[#F6F4EF] prose-strong:text-[#F6F4EF] prose-a:text-[#D4A94E]">
                            ...
                            <div className="bg-[#0C0D18] border border-[#2A2D42] rounded-xl p-6 my-8 not-prose">
                                <div className="flex items-start gap-3">
                                    <Info className="w-5 h-5 text-[#D4A94E] shrink-0 mt-1" />
                                    <div>
                                        <h4 className="font-bold text-[#F6F4EF] mb-2">Premium Comparison (Approximate)</h4>
                                        ...
                                        <div className="grid grid-cols-2 gap-4 text-sm">
                                            <div>
                                                ...
                                                <span className="text-[#F6F4EF] font-semibold ml-2">$6-8 over spot</span>
                                            </div>
                                            <div>
                                                <span className="text-[#D0CCC4]">JM Bullion:</span>
                                                <span className="text-[#F6F4EF] font-semibold ml-2">$5-7 over spot</span>
                                            </div>
                                            <div>
                                                <span className="text-[#D0CCC4]">SD Bullion:</span>
                                                <span className="text-[#F6F4EF] font-semibold ml-2">$4-6 over spot</span>
                                            </div>
                                            <div>
                        ...
                        <div className="grid md:grid-cols-3 gap-4 my-8">
                            <div className="bg-[#0C0D18] border border-[#2A2D42] rounded-xl p-6 text-center">
                                ...
                                <div className="text-sm text-[#D0CCC4]">Orders over $199</div>
                            </div>
                            <div className="bg-[#0C0D18] border border-[#2A2D42] rounded-xl p-6 text-center">
                                <Clock className="w-8 h-8 text-green-700 mx-auto mb-3" />
                                <div className="font-bold text-[#F6F4EF] mb-1">Processing</div>
                                <div className="text-sm text-[#D0CCC4]">1-3 business days</div>
                            </div>
                            <div className="bg-[#0C0D18] border border-[#2A2D42] rounded-xl p-6 text-center">
                        ...
                        <div className="mt-12">
                            ...
                            <div className="space-y-4">
                                <div className="bg-[#0C0D18] border border-[#2A2D42] rounded-xl p-6">
                                    <h3 className="font-bold text-[#F6F4EF] mb-2">Is APMEX a legitimate silver dealer?</h3>
                                    <p className="text-[#D0CCC4]">Yes, APMEX is one of the most established and reputable precious metals dealers in the United States. Founded in 2000, they have an A+ BBB rating and have served millions of customers.</p>
                                </div>
                                <div className="bg-[#0C0D18] border border-[#2A2D42] rounded-xl p-6">
                                    <h3 className="font-bold text-[#F6F4EF] mb-2">Does APMEX have good prices on silver?</h3>
                                    <p className="text-[#D0CCC4]">APMEX prices tend to be slightly higher than discount dealers like SD Bullion or JM Bullion. However, APMEX justifies this with the largest selection in the industry and excellent customer service.</p>
                                </div>
                                <div className="bg-[#0C0D18] border border-[#2A2D42] rounded-xl p-6">
                                    <h3 className="font-bold text-[#F6F4EF] mb-2">Does APMEX offer IRA services?</h3>
                                    <p className="text-[#D0CCC4]">APMEX sells IRA-eligible precious metals products, but they partner with third-party custodians for IRA administration. For a more integrated Silver IRA experience, consider specialists like Augusta Precious Metals.</p>
                                </div>
                                <div className="bg-[#0C0D18] border border-[#2A2D42] rounded-xl p-6">
                                    <h3 className="font-bold text-[#F6F4EF] mb-2">How fast does APMEX ship silver orders?</h3>
                                    <p className="text-[#D0CCC4]">APMEX typically processes orders within 1-3 business days. Once shipped, delivery usually takes 3-5 business days via insured carriers. Free shipping is available on orders over $199.</p>
                                </div>
                                <div className="bg-[#0C0D18] border border-[#2A2D42] rounded-xl p-6">
                                    <h3 className="font-bold text-[#F6F4EF] mb-2">Does APMEX buy back silver?</h3>
                                    <p className="text-[#D0CCC4]">Yes, APMEX has a buyback program where they purchase precious metals from customers. They typically pay competitive rates near spot price for standard bullion products.</p>
                                </div>
                            </div>
                        </div>
                    </article>
                    ...
                    <aside className="lg:col-span-1">
                        <div className="sticky top-24 space-y-8">
                            ...
                            <div className="bg-[#0C0D18] backdrop-blur-sm border border-[#2A2D42] rounded-xl p-6">
                                <h3 className="font-bold text-[#F6F4EF] mb-4">APMEX Quick Stats</h3>
                                <div className="space-y-4">
                                    <div className="flex justify-between items-center">
                                        <span className="text-[#D0CCC4]">Our Rating</span>
                                        <div className="flex items-center gap-1">
                                            <Star className="w-4 h-4 text-[#D4A94E] fill-[#B22234]" />
                                            <span className="text-[#F6F4EF] font-bold">4.7/5</span>
                                        </div>
                                    </div>
                                    <div className="flex justify-between items-center">
                                    ...
                                    <div className="flex justify-between items-center">
                                        ...
                                        <span className="text-[#F6F4EF] font-bold">2000</span>
                                    </div>
                                    <div className="flex justify-between items-center">
                                        <span className="text-[#D0CCC4]">Min Order</span>
                                        <span className="text-[#F6F4EF] font-bold">$99</span>
                                    </div>
                                    <div className="flex justify-between items-center">
                                        <span className="text-[#D0CCC4]">Free Shipping</span>
                                        <span className="text-[#F6F4EF] font-bold">$199+</span>
                                    </div>
                                    <div className="flex justify-between items-center">
                                        <span className="text-[#D0CCC4]">Products</span>
                                        <span className="text-[#F6F4EF] font-bold">20,000+</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="bg-[#0C0D18] backdrop-blur-sm border border-[#2A2D42] rounded-xl p-6">
                                ...
                                <div className="space-y-3">
                                    ...
                                    <Link href="/silver-dealer-reviews/money-metals-exchange" className="flex justify-between items-center text-sm hover:bg-[#121423] p-2 rounded transition-colors">
                                        <span className="text-[#D0CCC4]">Money Metals</span>
                                        <span className="text-[#D4A94E] flex items-center gap-1"><Star className="w-3 h-3 fill-[#B22234]" /> 4.5</span>
                                    </Link>
