        ...
        <Container>
          <div className="max-w-3xl">
            <nav className="flex items-center gap-2 text-sm text-slate-500 mb-4">
              ...
              <span className="text-slate-700">Editorial Board</span>
            </nav>
      ...
      <Container className="py-12">
        <div className="max-w-4xl">
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-serif font-bold text-[#000080] mb-4">Who We Are</h2>
          ...
          {/* Review Process */}
          <section className="mb-12">
            <h2 className="text-2xl font-serif font-bold text-[#000080] mb-4">Our Review Process</h2>
            <div className="grid md:grid-cols-3 gap-6 mb-6">
              <div className="bg-slate-50 rounded-xl p-6 border border-slate-200">
                <FileText className="h-6 w-6 text-[#B22234] mb-3" />
                <h3 className="font-bold text-slate-900 mb-2">1. Research &amp; Draft</h3>
                <p className="text-sm text-slate-600">Content is researched using primary sources (IRS.gov, SSA.gov, OPM.gov, BLS.gov) and verified against company disclosures.</p>
              </div>
              <div className="bg-slate-50 rounded-xl p-6 border border-slate-200">
                <Scale className="h-6 w-6 text-[#B22234] mb-3" />
                <h3 className="font-bold text-slate-900 mb-2">2. Fact-Check</h3>
                <p className="text-sm text-slate-600">Every claim, statistic, and regulation is verified against the original source. Fee data is confirmed directly with companies.</p>
              </div>
              <div className="bg-slate-50 rounded-xl p-6 border border-slate-200">
                <ShieldCheck className="h-6 w-6 text-[#B22234] mb-3" />
                <h3 className="font-bold text-slate-900 mb-2">3. Editorial Review</h3>
                <p className="text-sm text-slate-600">The editorial board reviews for accuracy, completeness, and compliance with our editorial standards before publication.</p>
              </div>
            </div>
          </section>
          ...
          {/* What We Check */}
          <section className="mb-12">
            <h2 className="text-2xl font-serif font-bold text-[#000080] mb-4">What We Verify</h2>
          ...
          {/* Primary Sources */}
          <section className="mb-12">
            <h2 className="text-2xl font-serif font-bold text-[#000080] mb-4">Primary Sources We Consult</h2>
            <p className="text-slate-600 mb-4">We verify all content against authoritative government and industry sources:</p>
            <div className="grid md:grid-cols-2 gap-3">
              {primarySources.map((source) => (
                <a key={source.name} href={source.url} target="_blank" rel="noopener noreferrer" className="flex items-start gap-3 bg-slate-50 rounded-lg p-4 border border-slate-200 hover:border-blue-300 transition-colors group">
                  <ExternalLink className="h-4 w-4 text-blue-600 flex-shrink-0 mt-0.5" />
                  <div>
                    <p className="font-medium text-sm text-slate-900 group-hover:text-blue-600">{source.name}</p>
          ...
          {/* Update Cycle */}
          <section className="mb-12">
            <h2 className="text-2xl font-serif font-bold text-[#000080] mb-4">Content Update Cycle</h2>
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                <Clock className="h-5 w-5 text-slate-400 flex-shrink-0 mt-0.5" />
                <div>
                  <p className="font-medium text-slate-900">Quarterly reviews</p>
                  <p className="text-sm text-slate-600">All company reviews and fee data are re-verified every 90 days.</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <Clock className="h-5 w-5 text-slate-400 flex-shrink-0 mt-0.5" />
                <div>
                  ...
                  <p className="text-sm text-slate-600">When the IRS or SSA updates regulations (contribution limits, RMD tables, etc.), affected content is updated within 48 hours.</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <Clock className="h-5 w-5 text-slate-400 flex-shrink-0 mt-0.5" />
                <div>
                  <p className="font-medium text-slate-900">Annual comprehensive review</p>
                  <p className="text-sm text-slate-600">Every article undergoes a full review once per year, regardless of regulatory changes.</p>
                </div>
              </div>
            </div>
          </section>
