...
export const metadata = {
    title: "Best Gold IRA Companies - Coming Soon | Rich Dad Retirement",
    description: "Our comprehensive comparison of the best Gold IRA companies is coming soon.",
};
            ...
            <div className="flex-grow flex items-center justify-center py-12 md:py-24">
                <Container className="text-center">
                    ...
                    <p className="text-lg text-text-muted max-w-md mx-auto mb-8">
                        Our comprehensive comparison of the best Gold IRA companies is currently being prepared.
                    </p>
