          ...
          <div className="max-w-4xl mx-auto">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              <div className="bg-[#0C0D18] backdrop-blur-sm border border-[#2A2D42] rounded-xl p-6 text-center">
                ...
                <div className="text-2xl font-bold text-[#F6F4EF]">1899</div>
                <div className="text-sm text-[#D0CCC4]">Founded</div>
              </div>
              <div className="bg-[#0C0D18] backdrop-blur-sm border border-[#2A2D42] rounded-xl p-6 text-center">
                <Shield className="h-8 w-8 text-green-400 mx-auto mb-2" />
                <div className="text-2xl font-bold text-[#F6F4EF]">.9999</div>
                <div className="text-sm text-[#D0CCC4]">Coin Purity</div>
              </div>
              <div className="bg-[#0C0D18] backdrop-blur-sm border border-[#2A2D42] rounded-xl p-6 text-center">
                <Award className="h-8 w-8 text-[#D0CCC4] mx-auto mb-2" />
                <div className="text-2xl font-bold text-[#F6F4EF]">Gov&apos;t</div>
                <div className="text-sm text-[#D0CCC4]">Backed</div>
              </div>
              <div className="bg-[#0C0D18] backdrop-blur-sm border border-[#2A2D42] rounded-xl p-6 text-center">
                <DollarSign className="h-8 w-8 text-green-400 mx-auto mb-2" />
                <div className="text-2xl font-bold text-[#F6F4EF]">3-12%</div>
            ...
            <article className="prose prose-lg prose-invert prose-headings:text-[#F6F4EF] prose-p:text-[#D0CCC4] prose-strong:text-[#F6F4EF] prose-li:text-[#D0CCC4] max-w-none">
              ...
              <div className="not-prose bg-[#0C0D18] backdrop-blur-sm border border-[#2A2D42] rounded-xl p-6 mb-8">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h2 className="text-2xl font-bold text-[#F6F4EF] m-0">About Perth Mint</h2>
                </div>
                ...
                <table className="w-full text-left border-collapse bg-[#0C0D18] backdrop-blur-sm rounded-xl border border-[#2A2D42]">
                  <thead className="bg-[#0C0D18]">
                    <tr>
                      ...
                      <th className="p-4 border-b border-[#2A2D42] font-bold text-[#F6F4EF]">IRA</th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-[#2A2D42] text-sm">
                    {perthProducts.map((product) => (
                      <tr key={product.name} className={product.popular ? "bg-[rgba(220,38,38,0.06)]" : ""}>
                        <td className="p-4 font-semibold text-[#F6F4EF]">
                          {product.name}
                          {product.popular && (
                            <span className="ml-2 text-xs bg-[rgba(220,38,38,0.18)] text-[#D4A94E] px-2 py-0.5 rounded">
                              Popular
                            </span>
                          )}
                        </td>
                        <td className="p-4 text-[#D0CCC4]">{product.type}</td>
                        <td className="p-4 text-[#D4A94E]">{product.purity}</td>
                        <td className="p-4 text-[#D0CCC4]">{product.premium}</td>
                        <td className="p-4">
                          {product.iraEligible ? (
                            <CheckCircle className="h-5 w-5 text-green-400" />
                          ) : (
                            <span className="text-[#D0CCC4]">No</span>
                          )}
                        </td>
                      </tr>
                    ))}
              ...
              <div className="not-prose bg-[#0C0D18] backdrop-blur-sm border border-[rgba(197,149,46,0.32)] rounded-xl p-6 my-8">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div>
                    <h4 className="text-lg font-semibold text-[#D4A94E] mb-2">Why Investors Like It</h4>
              ...
              <div className="not-prose grid md:grid-cols-2 gap-6 my-8">
                <div className="bg-[#0C0D18] backdrop-blur-sm border border-[#2A2D42] rounded-xl p-6">
                  <h3 className="text-lg font-bold text-[#F6F4EF] mb-4">Perth Mint Cast Bars</h3>
                  <p className="text-[#D0CCC4] mb-4">
                ...
                <div className="bg-[#0C0D18] backdrop-blur-sm border border-[#2A2D42] rounded-xl p-6">
                  <h3 className="text-lg font-bold text-[#F6F4EF] mb-4">Perth Mint Minted Bars</h3>
                  <p className="text-[#D0CCC4] mb-4">
