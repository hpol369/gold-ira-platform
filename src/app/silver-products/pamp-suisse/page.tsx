          ...
          <div className="max-w-4xl mx-auto">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6 text-center">
                ...
                <div className="text-2xl font-bold text-white">1977</div>
              ...
              <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6 text-center">
                ...
                <div className="text-2xl font-bold text-white">Assay</div>
                <div className="text-sm text-slate-400">Card Included</div>
              </div>
              <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6 text-center">
            ...
            <article className="prose prose-lg prose-invert prose-headings:text-white prose-p:text-slate-300 prose-strong:text-white prose-li:text-slate-300 max-w-none">
              ...
              <div className="not-prose bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6 mb-8">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h2 className="text-2xl font-bold text-white m-0">About PAMP Suisse</h2>
                </div>
              ...
              <div className="not-prose grid md:grid-cols-2 gap-6 my-8">
                <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6">
                  <h3 className="text-lg font-bold text-white mb-4">Design Elements</h3>
              ...
              <div className="not-prose bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6 my-8">
                <h3 className="text-lg font-bold text-white mb-4">Authentic Assay Card Features</h3>
              ...
              <div className="not-prose overflow-x-auto my-8">
                <table className="w-full text-left border-collapse bg-white/5 backdrop-blur-sm rounded-xl border border-white/10">
                  ...
                  <tbody className="divide-y divide-white/10 text-sm">
                    <tr>
                      <td className="p-4 font-semibold text-white">Lady Fortuna Bar</td>
                      <td className="p-4 text-slate-300">1 oz</td>
                      <td className="p-4 text-amber-400">20-25% over spot</td>
                      <td className="p-4 text-slate-300">Collectors, gifts</td>
                    </tr>
                    <tr>
                      <td className="p-4 font-semibold text-white">Lady Fortuna Bar</td>
                      <td className="p-4 text-slate-300">10 oz</td>
                      <td className="p-4 text-slate-300">15-20% over spot</td>
                      <td className="p-4 text-slate-300">Serious investors</td>
                    </tr>
                    <tr>
                      <td className="p-4 font-semibold text-white">Lady Fortuna Bar</td>
                      <td className="p-4 text-slate-300">100 oz</td>
                      <td className="p-4 text-green-400">10-15% over spot</td>
                      <td className="p-4 text-slate-300">Large positions</td>
                    </tr>
                    <tr>
                      <td className="p-4 font-semibold text-white">Kilo Bar</td>
                      <td className="p-4 text-slate-300">32.15 oz</td>
                      <td className="p-4 text-slate-300">12-18% over spot</td>
                      <td className="p-4 text-slate-300">Mid-size investors</td>
                    </tr>
                    <tr>
                      <td className="p-4 font-semibold text-white">Rosa Bar (Limited)</td>
                      <td className="p-4 text-slate-300">Various</td>
                      <td className="p-4 text-amber-400">25%+ over spot</td>
              ...
              <div className="not-prose grid md:grid-cols-2 gap-6 my-8">
                <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6">
                  <h3 className="text-lg font-bold text-white mb-4">Worth the Premium</h3>
                  <ul className="space-y-3">
                    <li className="flex items-start gap-3 text-slate-300">
                      <CheckCircle className="h-5 w-5 text-green-400 flex-shrink-0 mt-0.5" />
              ...
              <div className="not-prose bg-amber-500/10 border border-amber-500/30 rounded-xl p-6 my-8">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="text-lg font-bold text-amber-400 mb-2">Best Use Cases for PAMP</h4>
                    <p className="text-slate-300">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              >
                ...
                <p className="text-sm text-slate-400">MintMark SI security at lower premiums</p>
              </Link>
              <Link
                href="/silver-products/engelhard"
                className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6 hover:bg-white/10 transition-colors group"
              >
                <h3 className="text-lg font-bold text-white group-hover:text-slate-300 mb-2">Engelhard</h3>
                <p className="text-sm text-slate-400">Vintage collector silver</p>
              </Link>
              <Link
              ...
              >
                ...
                <p className="text-sm text-slate-400">Lowest premiums for pure stacking</p>
              </Link>
            </div>
          </div>
        </Container>
