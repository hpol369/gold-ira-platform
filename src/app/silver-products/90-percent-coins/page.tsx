          ...
          <div className="max-w-4xl mx-auto">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              ...
              <div className="bg-[#0C0D18] backdrop-blur-sm border border-[#2A2D42] rounded-xl p-6 text-center">
                ...
                <div className="text-2xl font-bold text-[#F6F4EF]">1892-1964</div>
                <div className="text-sm text-[#D0CCC4]">Era of 90% Silver</div>
              </div>
              <div className="bg-[#0C0D18] backdrop-blur-sm border border-[#2A2D42] rounded-xl p-6 text-center">
          ...
          <div className="max-w-4xl mx-auto">
            <article className="prose prose-lg prose-invert prose-headings:text-[#F6F4EF] prose-p:text-[#D0CCC4] prose-strong:text-[#F6F4EF] prose-li:text-[#D0CCC4] max-w-none">
              ...
              <h2 className="flex items-center gap-3">
                <CircleDollarSign className="h-6 w-6 text-[#D0CCC4]" />
                ...
                {coinTypes.map((coin) => (
                  ...
                  >
                    <div className="flex justify-between items-start mb-2">
                      <h3 className="text-lg font-bold text-[#F6F4EF]">{coin.name}</h3>
                      {coin.highlight && (
                        <span className="text-xs bg-[rgba(220,38,38,0.18)] text-[#D4A94E] px-2 py-0.5 rounded">
                          Collector Favorite
                        </span>
                      )}
                    </div>
                    <div className="flex gap-4 text-sm mb-2">
                      <span className="text-[#D0CCC4]">Years: <span className="text-[#D0CCC4]">{coin.years}</span></span>
                      <span className="text-[#D0CCC4]">Silver: <span className="text-[#D4A94E]">{coin.silverOz} oz</span></span>
                    </div>
                    <p className="text-[#D0CCC4] text-sm mb-2">{coin.notes}</p>
                    <div className="flex items-center gap-1">
                      {[1, 2, 3, 4, 5].map((star) => (
                        <Star
                          key={star}
                          className={`h-3 w-3 ${
                            star <= coin.popularity ? "text-[#D4A94E] fill-[#B22234]" : "text-[#D0CCC4]"
                          }`}
                        />
                      ))}
                      <span className="text-xs text-[#D0CCC4] ml-1">Popularity</span>
                    </div>
                  </div>
                ))}
              </div>
                ...
                <table className="w-full text-left border-collapse bg-[#0C0D18] backdrop-blur-sm rounded-xl border border-[#2A2D42]">
                  <thead className="bg-[#0C0D18]">
                    <tr>
                      ...
                      <th className="p-4 border-b border-[#2A2D42] font-bold text-[#F6F4EF]">Face Value</th>
                      <th className="p-4 border-b border-[#2A2D42] font-bold text-[#F6F4EF]">Silver (oz)</th>
                      <th className="p-4 border-b border-[#2A2D42] font-bold text-[#F6F4EF]">Melt Value*</th>
                      <th className="p-4 border-b border-[#2A2D42] font-bold text-[#F6F4EF]">Per $1 Face</th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-[#2A2D42] text-sm">
                    <tr>
                      <td className="p-4 font-semibold text-[#F6F4EF]">Dime</td>
                      <td className="p-4 text-[#D0CCC4]">$0.10</td>
                      <td className="p-4 text-[#D4A94E]">0.0715 oz</td>
                      <td className="p-4 text-[#D0CCC4]">$1.79</td>
                      <td className="p-4 text-[#D0CCC4]">10 coins</td>
                    </tr>
                    <tr>
                      <td className="p-4 font-semibold text-[#F6F4EF]">Quarter</td>
                      <td className="p-4 text-[#D0CCC4]">$0.25</td>
                      <td className="p-4 text-[#D4A94E]">0.1788 oz</td>
                      <td className="p-4 text-[#D0CCC4]">$4.47</td>
                      <td className="p-4 text-[#D0CCC4]">4 coins</td>
                    </tr>
                    <tr>
                      <td className="p-4 font-semibold text-[#F6F4EF]">Half Dollar</td>
                      <td className="p-4 text-[#D0CCC4]">$0.50</td>
                      <td className="p-4 text-[#D4A94E]">0.3575 oz</td>
                      <td className="p-4 text-[#D0CCC4]">$8.94</td>
                      <td className="p-4 text-[#D0CCC4]">2 coins</td>
                    </tr>
                    <tr>
                      <td className="p-4 font-semibold text-[#F6F4EF]">Silver Dollar</td>
                      <td className="p-4 text-[#D0CCC4]">$1.00</td>
                      <td className="p-4 text-[#D4A94E]">0.7734 oz</td>
                    ...
                    <tr className="bg-green-500/10">
                      ...
                      <td className="p-4 text-[#D0CCC4]">$17.88</td>
                      <td className="p-4 text-[#D0CCC4]">Any combo</td>
                    </tr>
                  </tbody>
                </table>
                <p className="text-xs text-[#D0CCC4] mt-2">*Melt value at $25/oz spot. Silver dollars (Morgan/Peace) are slightly different.</p>
              </div>

              <h2 className="flex items-center gap-3">
                <Star className="h-6 w-6 text-[#D4A94E]" />
              ...
              <div className="not-prose bg-[#0C0D18] backdrop-blur-sm border border-[#B22234]/30 rounded-xl p-6 my-8">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div>
                    <h4 className="text-lg font-semibold text-[#D4A94E] mb-2">Key Dates</h4>
                    <ul className="space-y-1 text-[#D0CCC4] text-sm">
                      <li>1916-D: Most valuable ($1,000+)</li>
                      <li>1921, 1921-D: Low mintage</li>
                      <li>1942/41: Overdate error</li>
                    </ul>
                    <p className="text-[#D0CCC4] text-sm mt-3">
              ...
              <div className="not-prose grid md:grid-cols-2 gap-6 my-8">
                <div className="bg-[#0C0D18] backdrop-blur-sm border border-[#2A2D42] rounded-xl p-6">
                  <h3 className="text-lg font-bold text-[#F6F4EF] mb-4">For Bulk (Face Value)</h3>
                  <ul className="space-y-2 text-[#D0CCC4]">
                ...
                <div className="bg-[#0C0D18] backdrop-blur-sm border border-[#2A2D42] rounded-xl p-6">
                  <h3 className="text-lg font-bold text-[#F6F4EF] mb-4">For Specific Dates</h3>
                  <ul className="space-y-2 text-[#D0CCC4]">
              ...
              <div className="not-prose bg-[rgba(220,38,38,0.1)] border border-[#B22234]/30 rounded-xl p-6 my-8">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="text-lg font-bold text-[#D4A94E] mb-2">Buying Tip</h4>
                    <p className="text-[#D0CCC4]">
