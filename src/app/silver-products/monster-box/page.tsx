          ...
          <div className="max-w-4xl mx-auto">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              <div className="bg-[#0C0D18] backdrop-blur-sm border border-[#2A2D42] rounded-xl p-6 text-center">
                <Coins className="h-8 w-8 text-[#D0CCC4] mx-auto mb-2" />
                <div className="text-2xl font-bold text-[#F6F4EF]">500</div>
                <div className="text-sm text-[#D0CCC4]">Coins Per Box</div>
              </div>
              <div className="bg-[#0C0D18] backdrop-blur-sm border border-[#2A2D42] rounded-xl p-6 text-center">
                <Scale className="h-8 w-8 text-[#D0CCC4] mx-auto mb-2" />
                <div className="text-2xl font-bold text-[#F6F4EF]">~37 lbs</div>
                <div className="text-sm text-[#D0CCC4]">Total Weight</div>
              </div>
              <div className="bg-[#0C0D18] backdrop-blur-sm border border-[#2A2D42] rounded-xl p-6 text-center">
                <DollarSign className="h-8 w-8 text-green-400 mx-auto mb-2" />
                <div className="text-2xl font-bold text-[#F6F4EF]">$0.50-2</div>
                <div className="text-sm text-[#D0CCC4]">Savings Per Coin</div>
              </div>
              <div className="bg-[#0C0D18] backdrop-blur-sm border border-[#2A2D42] rounded-xl p-6 text-center">
                <Warehouse className="h-8 w-8 text-[#D4A94E] mx-auto mb-2" />
                <div className="text-2xl font-bold text-[#F6F4EF]">$13K+</div>
                <div className="text-sm text-[#D0CCC4]">Typical Cost</div>
              </div>
            </div>
          </div>
        </Container>
            ...
            <article className="prose prose-lg prose-invert prose-headings:text-[#F6F4EF] prose-p:text-[#D0CCC4] prose-strong:text-[#F6F4EF] prose-li:text-[#D0CCC4] max-w-none">
              ...
              <div className="not-prose bg-[#0C0D18] backdrop-blur-sm border border-[#2A2D42] rounded-xl p-6 mb-8">
                <div className="flex items-center gap-3 mb-4">
                  <div className="p-2 bg-[rgba(220,38,38,0.1)] rounded-lg">
                    <Package className="h-6 w-6 text-[#D0CCC4]" />
                  </div>
                  <h2 className="text-2xl font-bold text-[#F6F4EF] m-0">What is a Silver Monster Box?</h2>
                </div>
                ...
                <table className="w-full text-left border-collapse bg-[#0C0D18] backdrop-blur-sm rounded-xl border border-[#2A2D42]">
                  <thead className="bg-[#0C0D18]">
                    <tr>
                      ...
                      <th className="p-4 border-b border-[#2A2D42] font-bold text-[#F6F4EF]">Single Coin Premium</th>
                      <th className="p-4 border-b border-[#2A2D42] font-bold text-[#F6F4EF]">Monster Box Premium</th>
                      <th className="p-4 border-b border-[#2A2D42] font-bold text-[#F6F4EF]">Savings (500 coins)</th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-[#2A2D42] text-sm">
                    <tr>
                      <td className="p-4 font-semibold text-[#F6F4EF]">American Silver Eagle</td>
                      <td className="p-4 text-[#D0CCC4]">$6-8 over spot</td>
                    ...
                    <tr>
                      ...
                      <td className="p-4 text-[#D0CCC4]">$4-5 over spot</td>
                      <td className="p-4 text-green-400">$3-3.50 over spot</td>
                      <td className="p-4 text-green-400 font-bold">$500-750</td>
                    </tr>
                    <tr>
                      <td className="p-4 font-semibold text-[#F6F4EF]">Austrian Philharmonic</td>
                      <td className="p-4 text-[#D0CCC4]">$3.50-4.50 over spot</td>
                      <td className="p-4 text-green-400">$2.50-3 over spot</td>
                      <td className="p-4 text-green-400 font-bold">$500-750</td>
                    </tr>
                    <tr>
                      <td className="p-4 font-semibold text-[#F6F4EF]">British Britannia</td>
                      <td className="p-4 text-[#D0CCC4]">$4-5 over spot</td>
                      <td className="p-4 text-green-400">$3-3.50 over spot</td>
                      <td className="p-4 text-green-400 font-bold">$500-750</td>
                    </tr>
                    <tr>
                      <td className="p-4 font-semibold text-[#F6F4EF]">Silver Krugerrand</td>
                      <td className="p-4 text-[#D0CCC4]">$3-4 over spot</td>
              ...
              <div className="not-prose grid md:grid-cols-2 gap-6 my-8">
                <div className="bg-[#0C0D18] backdrop-blur-sm border border-[#2A2D42] rounded-xl p-6">
                  <h3 className="text-lg font-bold text-[#F6F4EF] mb-4">American Silver Eagles</h3>
                ...
                <div className="bg-[#0C0D18] backdrop-blur-sm border border-[#2A2D42] rounded-xl p-6">
                  <h3 className="text-lg font-bold text-[#F6F4EF] mb-4">Canadian Maple Leafs</h3>
                  <ul className="space-y-3">
                    <li className="flex items-start gap-3 text-[#D0CCC4]">
                      <CheckCircle className="h-5 w-5 text-green-400 flex-shrink-0 mt-0.5" />
                ...
                <table className="w-full text-left border-collapse bg-[#0C0D18] backdrop-blur-sm rounded-xl border border-[#2A2D42]">
                  <thead className="bg-[#0C0D18]">
                    <tr>
                      ...
                      <th className="p-4 border-b border-[#2A2D42] font-bold text-[#F6F4EF]">Capacity</th>
                  ...
                  <tbody className="divide-y divide-[#2A2D42] text-sm">
                    <tr>
                      <td className="p-4 font-semibold text-[#F6F4EF]">Home Safe (500 lb)</td>
                      <td className="p-4 text-[#D0CCC4]">3-5 boxes</td>
                      <td className="p-4 text-green-400">Immediate access, no fees</td>
                      <td className="p-4 text-[#D0CCC4]">Security risk, insurance cost</td>
                    </tr>
                    <tr>
                      <td className="p-4 font-semibold text-[#F6F4EF]">Bank Safe Deposit</td>
                      <td className="p-4 text-[#D0CCC4]">1-2 boxes (large box)</td>
                      <td className="p-4 text-green-400">Low cost, local access</td>
                      <td className="p-4 text-[#D0CCC4]">Not insured, limited size</td>
                    </tr>
                    <tr>
                      <td className="p-4 font-semibold text-[#F6F4EF]">Professional Vault</td>
                      <td className="p-4 text-[#D0CCC4]">Unlimited</td>
                      <td className="p-4 text-green-400">Fully insured, secure, liquid</td>
                      <td className="p-4 text-[#D0CCC4]">Annual fees (0.5% of value)</td>
                    </tr>
                    <tr>
                      <td className="p-4 font-semibold text-[#F6F4EF]">IRA Depository</td>
                      <td className="p-4 text-[#D0CCC4]">Unlimited</td>
                      <td className="p-4 text-green-400">Required for IRA, segregated</td>
                      <td className="p-4 text-[#D0CCC4]">Annual custody fees</td>
                    </tr>
                  </tbody>
                </table>
              </div>
              ...
              <div className="not-prose bg-[rgba(220,38,38,0.1)] border border-[#B22234]/30 rounded-xl p-6 my-8">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="text-lg font-bold text-[#D4A94E] mb-2">Keep Boxes Sealed</h4>
                    <p className="text-[#D0CCC4]">
        ...
        <Container>
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              >
                <h3 className="text-lg font-bold text-[#F6F4EF] group-hover:text-[#F6F4EF] mb-2">Silver Krugerrand</h3>
                <p className="text-sm text-[#D0CCC4]">South African sovereign coins at competitive premiums</p>
              </Link>
              <Link
              ...
              >
                ...
                <p className="text-sm text-[#D0CCC4]">Lowest premiums for pure bullion stackers</p>
              </Link>
              <Link
              ...
              >
                ...
                <p className="text-sm text-[#D0CCC4]">Premium private mint with security features</p>
              </Link>
            </div>
          </div>
        </Container>
