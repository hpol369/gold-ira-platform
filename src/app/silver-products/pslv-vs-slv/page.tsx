            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="bg-[rgba(46,139,87,0.08)]0/10 border border-green-500/30 rounded-xl p-6">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-[#F6F4EF]">PSLV</h3>
                ...
                <ul className="space-y-2 text-[#D0CCC4]">
                  ...
                  <li className="flex items-center gap-2">
                    <span className="text-[#D4A94E]">0.61%</span> expense ratio
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-[#0C0D18] border border-[#2A2D42] rounded-xl p-6">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-[#F6F4EF]">SLV</h3>
                    <p className="text-sm text-[#D0CCC4]">iShares Silver Trust</p>
                  </div>
                </div>
                <ul className="space-y-2 text-[#D0CCC4]">
                  <li className="flex items-center gap-2">
                    <CheckCircle className="h-4 w-4 text-[#D0CCC4]" />
            ...
            <article className="prose prose-lg prose-invert prose-headings:text-[#F6F4EF] prose-p:text-[#D0CCC4] prose-strong:text-[#F6F4EF] prose-li:text-[#D0CCC4] max-w-none">
              ...
              <div className="not-prose bg-[#0C0D18] backdrop-blur-sm border border-[#2A2D42] rounded-xl p-6 mb-8">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h2 className="text-2xl font-bold text-[#F6F4EF] m-0">The Fundamental Difference</h2>
                </div>
              ...
              <h2 className="flex items-center gap-3">
                <BarChart3 className="h-6 w-6 text-[#D0CCC4]" />
                ...
                <table className="w-full text-left border-collapse bg-[#0C0D18] backdrop-blur-sm rounded-xl border border-[#2A2D42]">
                  <thead className="bg-[#0C0D18]">
                    <tr>
                      ...
                      <th className="p-4 border-b border-[#2A2D42] font-bold text-green-400">PSLV (Sprott)</th>
                      <th className="p-4 border-b border-[#2A2D42] font-bold text-[#D0CCC4]">SLV (iShares)</th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-[#2A2D42] text-sm">
                    <tr>
                      <td className="p-4 font-semibold text-[#F6F4EF]">Fund Type</td>
                      <td className="p-4 text-[#D0CCC4]">Closed-End Trust</td>
                      <td className="p-4 text-[#D0CCC4]">Open-End ETF</td>
                    </tr>
                    <tr>
                      <td className="p-4 font-semibold text-[#F6F4EF]">Custodian</td>
                      <td className="p-4 text-green-400">Royal Canadian Mint</td>
                      <td className="p-4 text-[#D0CCC4]">JPMorgan Chase</td>
                    </tr>
                    <tr>
                      <td className="p-4 font-semibold text-[#F6F4EF]">Silver Allocation</td>
                      <td className="p-4 text-green-400">Fully allocated, serialized</td>
                      <td className="p-4 text-[#D0CCC4]">Allocated (custodian model)</td>
                    </tr>
                    <tr>
                      <td className="p-4 font-semibold text-[#F6F4EF]">Silver Leasing</td>
                      <td className="p-4 text-green-400">Not permitted</td>
                      <td className="p-4 text-[#D4A94E]">Permitted per prospectus</td>
                    </tr>
                    <tr>
                      <td className="p-4 font-semibold text-[#F6F4EF]">Physical Redemption</td>
                    ...
                    <tr>
                      ...
                      <td className="p-4 text-[#D0CCC4]">0.61%</td>
                      <td className="p-4 text-green-400">0.50%</td>
                    </tr>
                    <tr>
                      <td className="p-4 font-semibold text-[#F6F4EF]">AUM</td>
                      <td className="p-4 text-[#D0CCC4]">~$4 billion</td>
                      <td className="p-4 text-[#D0CCC4]">~$10 billion</td>
                    </tr>
                    <tr>
                      <td className="p-4 font-semibold text-[#F6F4EF]">Average Spread</td>
                      <td className="p-4 text-[#D0CCC4]">0.10-0.20%</td>
                      <td className="p-4 text-green-400">0.01-0.02%</td>
                    </tr>
                    <tr>
                      <td className="p-4 font-semibold text-[#F6F4EF]">Tax Treatment</td>
                      <td className="p-4 text-[#D0CCC4]">PFIC (complex for US)</td>
                      <td className="p-4 text-[#D0CCC4]">Grantor trust (collectibles)</td>
                    </tr>
                  </tbody>
                </table>
              </div>
              ...
              <div className="not-prose grid md:grid-cols-2 gap-6 my-8">
                ...
                <div className="bg-[#0C0D18] border border-[#2A2D42] rounded-xl p-6">
                  <h3 className="text-lg font-bold text-[#D0CCC4] mb-4">SLV Advantages</h3>
                  <ul className="space-y-3 text-[#D0CCC4]">
                    <li className="flex items-start gap-3">
              ...
              <div className="not-prose bg-[rgba(220,38,38,0.1)] border border-[rgba(197,149,46,0.32)] rounded-xl p-6 my-8">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="text-lg font-bold text-[#D4A94E] mb-2">Important Note</h4>
                    <p className="text-[#D0CCC4]">
              ...
              <div className="not-prose grid md:grid-cols-2 gap-6 my-8">
                ...
                <div className="bg-[#0C0D18] border border-[#2A2D42] rounded-xl p-6">
                  <h3 className="text-lg font-bold text-[#D0CCC4] mb-4">Choose SLV If:</h3>
                  <ul className="space-y-2 text-[#D0CCC4]">
                    <li className="flex items-center gap-2">
                      <ArrowRight className="h-4 w-4 text-[#D0CCC4]" />
              ...
              <div className="not-prose overflow-x-auto my-8">
                <table className="w-full text-left border-collapse bg-[#0C0D18] backdrop-blur-sm rounded-xl border border-[#2A2D42]">
                  <thead className="bg-[#0C0D18]">
                    <tr>
                      <th className="p-4 border-b border-[#2A2D42] font-bold text-[#F6F4EF]">Cost Factor</th>
                      <th className="p-4 border-b border-[#2A2D42] font-bold text-green-400">PSLV</th>
                      <th className="p-4 border-b border-[#2A2D42] font-bold text-[#D0CCC4]">SLV</th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-[#2A2D42] text-sm">
                    <tr>
                      <td className="p-4 font-semibold text-[#F6F4EF]">Expense Ratio (10 yr)</td>
                      <td className="p-4 text-[#D0CCC4]">~$6,100</td>
                      <td className="p-4 text-green-400">~$5,000</td>
                    </tr>
                    <tr>
                      <td className="p-4 font-semibold text-[#F6F4EF]">Bid-Ask Spread (round trip)</td>
                      <td className="p-4 text-[#D0CCC4]">~$150</td>
                      <td className="p-4 text-green-400">~$20</td>
                    </tr>
                    <tr>
                      <td className="p-4 font-semibold text-[#F6F4EF]">Premium/Discount Risk</td>
                      <td className="p-4 text-[#D4A94E]">Can be +/-3%</td>
                      <td className="p-4 text-green-400">Minimal</td>
                    </tr>
                    <tr className="bg-[#0C0D18]">
                      <td className="p-4 font-semibold text-[#F6F4EF]">Total Explicit Cost</td>
                      <td className="p-4 text-[#D0CCC4]">~$6,250</td>
                      <td className="p-4 text-green-400 font-bold">~$5,020</td>
                    </tr>
                  </tbody>
                </table>
                <p className="text-xs text-[#D0CCC4] mt-2">
