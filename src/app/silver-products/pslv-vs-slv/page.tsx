  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <section className="py-12 bg-slate-50">
        <Container>
          <div className="max-w-4xl mx-auto">
            <h2 className="text-xl font-bold text-slate-900 text-center mb-8">At a Glance</h2>
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="bg-green-500/10 border border-green-500/30 rounded-xl p-6">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-slate-900">PSLV</h3>
                ...
                <ul className="space-y-2 text-slate-600">
                  ...
                  <li className="flex items-center gap-2">
                    <span className="text-[#B22234]">0.61%</span> expense ratio
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-slate-50 border border-slate-200 rounded-xl p-6">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-slate-900">SLV</h3>
                    <p className="text-sm text-slate-600">iShares Silver Trust</p>
                  </div>
                </div>
                <ul className="space-y-2 text-slate-600">
                  <li className="flex items-center gap-2">
            ...
            <article className="prose prose-lg prose-invert prose-headings:text-[#000080] prose-p:text-slate-600 prose-strong:text-slate-900 prose-li:text-slate-600 max-w-none">
              ...
              <div className="not-prose bg-slate-50 backdrop-blur-sm border border-slate-200 rounded-xl p-6 mb-8">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h2 className="text-2xl font-bold text-slate-900 m-0">The Fundamental Difference</h2>
                </div>
                ...
                <table className="w-full text-left border-collapse bg-slate-50 backdrop-blur-sm rounded-xl border border-slate-200">
                  <thead className="bg-slate-50">
                    <tr>
                      ...
                      <th className="p-4 border-b border-slate-200 font-bold text-green-400">PSLV (Sprott)</th>
                      <th className="p-4 border-b border-slate-200 font-bold text-slate-600">SLV (iShares)</th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-slate-200 text-sm">
                    <tr>
                      <td className="p-4 font-semibold text-slate-900">Fund Type</td>
                      <td className="p-4 text-slate-600">Closed-End Trust</td>
                      <td className="p-4 text-slate-600">Open-End ETF</td>
                    </tr>
                    <tr>
                      <td className="p-4 font-semibold text-slate-900">Custodian</td>
                      <td className="p-4 text-green-400">Royal Canadian Mint</td>
                      <td className="p-4 text-slate-600">JPMorgan Chase</td>
                    </tr>
                    <tr>
                      <td className="p-4 font-semibold text-slate-900">Silver Allocation</td>
                      <td className="p-4 text-green-400">Fully allocated, serialized</td>
                      <td className="p-4 text-slate-600">Allocated (custodian model)</td>
                    </tr>
                    <tr>
                      <td className="p-4 font-semibold text-slate-900">Silver Leasing</td>
                      <td className="p-4 text-green-400">Not permitted</td>
                      <td className="p-4 text-[#B22234]">Permitted per prospectus</td>
                    </tr>
                    <tr>
                      <td className="p-4 font-semibold text-slate-900">Physical Redemption</td>
                    ...
                    <tr>
                      ...
                      <td className="p-4 text-slate-600">0.61%</td>
                      <td className="p-4 text-green-400">0.50%</td>
                    </tr>
                    <tr>
                      <td className="p-4 font-semibold text-slate-900">AUM</td>
                      <td className="p-4 text-slate-600">~$4 billion</td>
                      <td className="p-4 text-slate-600">~$10 billion</td>
                    </tr>
                    <tr>
                      <td className="p-4 font-semibold text-slate-900">Average Spread</td>
                      <td className="p-4 text-slate-600">0.10-0.20%</td>
                      <td className="p-4 text-green-400">0.01-0.02%</td>
                    </tr>
                    <tr>
                      <td className="p-4 font-semibold text-slate-900">Tax Treatment</td>
                      <td className="p-4 text-slate-600">PFIC (complex for US)</td>
                      <td className="p-4 text-slate-600">Grantor trust (collectibles)</td>
                    </tr>
                  </tbody>
                </table>
              </div>
              ...
              <div className="not-prose grid md:grid-cols-2 gap-6 my-8">
                ...
                <div className="bg-slate-50 border border-slate-200 rounded-xl p-6">
                  <h3 className="text-lg font-bold text-slate-600 mb-4">SLV Advantages</h3>
                  <ul className="space-y-3 text-slate-600">
                    <li className="flex items-start gap-3">
              ...
              <div className="not-prose bg-[#B22234]/10 border border-[#B22234]/30 rounded-xl p-6 my-8">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="text-lg font-bold text-[#B22234] mb-2">Important Note</h4>
                    <p className="text-slate-600">
              ...
              <div className="not-prose grid md:grid-cols-2 gap-6 my-8">
                ...
                <div className="bg-slate-50 border border-slate-200 rounded-xl p-6">
                  <h3 className="text-lg font-bold text-slate-600 mb-4">Choose SLV If:</h3>
                  <ul className="space-y-2 text-slate-600">
                    <li className="flex items-center gap-2">
              ...
              <div className="not-prose overflow-x-auto my-8">
                <table className="w-full text-left border-collapse bg-slate-50 backdrop-blur-sm rounded-xl border border-slate-200">
                  <thead className="bg-slate-50">
                    <tr>
                      <th className="p-4 border-b border-slate-200 font-bold text-slate-900">Cost Factor</th>
                      <th className="p-4 border-b border-slate-200 font-bold text-green-400">PSLV</th>
                      <th className="p-4 border-b border-slate-200 font-bold text-slate-600">SLV</th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-slate-200 text-sm">
                    <tr>
                      <td className="p-4 font-semibold text-slate-900">Expense Ratio (10 yr)</td>
                      <td className="p-4 text-slate-600">~$6,100</td>
                      <td className="p-4 text-green-400">~$5,000</td>
                    </tr>
                    <tr>
                      <td className="p-4 font-semibold text-slate-900">Bid-Ask Spread (round trip)</td>
                      <td className="p-4 text-slate-600">~$150</td>
                      <td className="p-4 text-green-400">~$20</td>
                    </tr>
                    <tr>
                      <td className="p-4 font-semibold text-slate-900">Premium/Discount Risk</td>
                      <td className="p-4 text-[#B22234]">Can be +/-3%</td>
                      <td className="p-4 text-green-400">Minimal</td>
                    </tr>
                    <tr className="bg-slate-50">
                      <td className="p-4 font-semibold text-slate-900">Total Explicit Cost</td>
                      <td className="p-4 text-slate-600">~$6,250</td>
