                    ...
                    <article className="flex-1 prose prose-lg prose-headings:font-serif prose-headings:text-[#F6F4EF] prose-p:text-[#D0CCC4] prose-strong:text-[#F6F4EF] prose-li:text-[#D0CCC4] max-w-none">
                        ...
                        <section id="key-differences" className="scroll-mt-32">
                            ...
                            <div className="not-prose space-y-6 my-8">
                                <div className="flex gap-4 p-6 rounded-xl bg-[#161828] border border-[#2A2D42] shadow-sm">
                                    ...
                                    <div>
                                        <h4 className="font-bold text-[#D4A94E] text-lg">1. Inflation Protection</h4>
                                        <p className="text-[#D0CCC4] mt-1"><strong>Gold IRA:</strong> Gold has averaged 8-10% annual returns over the past 20 years, consistently outpacing inflation. Your purchasing power is preserved.</p>
                                        <p className="text-[#D0CCC4] mt-1"><strong>Annuity:</strong> Fixed payments lose value every year. A COLA rider costs extra and still may not keep up with real inflation.</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex gap-4 p-6 rounded-xl bg-[#161828] border border-[#2A2D42] shadow-sm">
                                    ...
                                    <div>
                                        <h4 className="font-bold text-[#D4A94E] text-lg">2. Liquidity &amp; Access</h4>
                                        <p className="text-[#D0CCC4] mt-1"><strong>Gold IRA:</strong> You can sell your metals at any time. After 59&frac12;, withdrawals are penalty-free. No surrender charges, ever.</p>
                                        <p className="text-[#D0CCC4] mt-1"><strong>Annuity:</strong> Surrender charges of 2-10% trap your money for the first 5-10 years. Need $50k for an emergency? You&apos;re paying a penalty.</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex gap-4 p-6 rounded-xl bg-[#161828] border border-[#2A2D42] shadow-sm">
                                    ...
                                    <div>
                                        <h4 className="font-bold text-[#D4A94E] text-lg">3. Fees &amp; Costs</h4>
                                        <p className="text-[#D0CCC4] mt-1"><strong>Gold IRA:</strong> Transparent fees of $150-300/year for storage and custodian services. On a $300k account, that&apos;s about 0.1%.</p>
                                        <p className="text-[#D0CCC4] mt-1"><strong>Annuity:</strong> Mortality and expense charges (1.25%), administrative fees (0.15%), rider charges (0.5-1%). Total often exceeds 2-3% annually. On $300k, that&apos;s $6,000-$9,000/year.</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex gap-4 p-6 rounded-xl bg-[#161828] border border-[#2A2D42] shadow-sm">
                                    ...
                                    <div>
                                        <h4 className="font-bold text-[#D4A94E] text-lg">4. Growth Potential</h4>
                                        <p className="text-[#D0CCC4] mt-1"><strong>Gold IRA:</strong> Gold has gone from $300/oz in 2000 to over $2,800/oz in 2026. That&apos;s over 800% growth &mdash; far outpacing inflation and most fixed annuity returns.</p>
                                        <p className="text-[#D0CCC4] mt-1"><strong>Annuity:</strong> Fixed annuities lock in a rate (typically 3-5%). Variable annuities depend on sub-account performance minus heavy fees.</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex gap-4 p-6 rounded-xl bg-[#161828] border border-[#2A2D42] shadow-sm">
                                    ...
                                    <div>
                                        <h4 className="font-bold text-[#D4A94E] text-lg">5. Estate Planning</h4>
                                        <p className="text-[#D0CCC4] mt-1"><strong>Gold IRA:</strong> Full balance passes to your beneficiaries. They inherit the physical metals and can sell or keep them.</p>
                                        <p className="text-[#D0CCC4] mt-1"><strong>Annuity:</strong> Depends on the contract. Some annuities have no death benefit &mdash; if you die early, the insurance company keeps the balance. Joint-life options cost more.</p>
                                    </div>
                                </div>
                            </div>
                        </section>
                        ...
                        <section id="can-have-both" className="scroll-mt-32">
                            ...
                            <div className="bg-[#0C0D18] rounded-2xl p-6 border border-[#2A2D42] not-prose my-8">
                                <h4 className="font-bold text-[#D4A94E] text-lg mb-4">A Practical Split for $400k in Savings</h4>
                                <div className="space-y-4">
                                    <div className="flex items-start gap-3">
                                        <div className="w-8 h-8 rounded-full bg-[#DC2626] text-white flex items-center justify-center text-sm font-bold shrink-0">1</div>
                                        <div>
                                            <strong className="text-[#F6F4EF]">$100k in a Fixed Annuity &mdash; Cover your floor expenses</strong>
                                            <p className="text-sm text-[#D0CCC4]">This buys roughly $600-700/month in guaranteed lifetime income. Combine with Social Security to cover rent, food, and utilities. You&apos;ll never worry about the basics.</p>
                                        </div>
                                    </div>
                                    <div className="flex items-start gap-3">
                                        <div className="w-8 h-8 rounded-full bg-[#DC2626] text-white flex items-center justify-center text-sm font-bold shrink-0">2</div>
                                        <div>
                                            <strong className="text-[#F6F4EF]">$80k-$100k in a Gold IRA &mdash; Inflation protection</strong>
                                            <p className="text-sm text-[#D0CCC4]">Physical gold preserves purchasing power. When the dollar weakens, gold strengthens. This portion protects you from the one thing annuities can&apos;t: rising prices.</p>
                                        </div>
                                    </div>
                                    <div className="flex items-start gap-3">
                                        <div className="w-8 h-8 rounded-full bg-[#DC2626] text-white flex items-center justify-center text-sm font-bold shrink-0">3</div>
                                        <div>
                                            <strong className="text-[#F6F4EF]">$200k+ in diversified investments &mdash; Growth and flexibility</strong>
                                            <p className="text-sm text-[#D0CCC4]">Keep the rest in a mix of stocks, bonds, or other investments for growth and liquidity. This is your &quot;optionality&quot; money.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
