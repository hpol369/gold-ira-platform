                    ...
                    <article className="flex-1 prose prose-lg prose-headings:font-serif prose-headings:text-primary max-w-none">
                        ...
                        <section id="key-differences" className="scroll-mt-32">
                            ...
                            <div className="grid md:grid-cols-2 gap-6 not-prose my-8">
                                <div className="p-6 rounded-xl bg-background-subtle border border-primary/10">
                                    <h4 className="font-bold text-primary mb-2">Gold IRA</h4>
                                    <ul className="list-disc pl-5 space-y-2 text-sm">
                                        <li><strong>Goal:</strong> Wealth Preservation</li>
                                        <li><strong>Asset:</strong> Real, tangible metal</li>
                                        <li><strong>Best Time:</strong> Crises, Inflation, Uncertainty</li>
                                    </ul>
                                </div>
                                <div className="p-6 rounded-xl bg-background-subtle border border-primary/10">
                                    <h4 className="font-bold text-primary mb-2">Traditional Stock IRA</h4>
                                    <ul className="list-disc pl-5 space-y-2 text-sm">
                                        <li><strong>Goal:</strong> Wealth Accumulation</li>
                                        <li><strong>Asset:</strong> Shares of companies (paper)</li>
                                        <li><strong>Best Time:</strong> Economic booms, Low inflation</li>
                                    </ul>
                                </div>
                            </div>
                        </section>
