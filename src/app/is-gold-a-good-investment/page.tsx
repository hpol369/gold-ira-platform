            ...
            <div className="max-w-3xl mx-auto">
              ...
              <div className="mt-6 bg-amber-50 border border-amber-200 rounded-xl p-5">
                <p className="text-slate-700 leading-relaxed">
                  <strong className="text-[#000080]">The takeaway:</strong> Over
          ...
          <Container>
            <div className="max-w-3xl mx-auto">
              ...
              <div className="bg-white border border-slate-200 rounded-xl p-6 mb-6">
                <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
                  {[
                    ...
                    <div key={item.label}>
                      <p
                        className={`text-2xl md:text-3xl font-bold ${item.highlight ? "text-amber-600" : "text-[#000080]"}`}
                      >
                        {item.stat}
                        {item.unit && (
              ...
              <div className="mt-6 bg-blue-50 border border-blue-200 rounded-xl p-5">
                <p className="text-slate-700 leading-relaxed text-sm">
                  <strong className="text-[#000080]">Think about it this way:</strong>{" "}
          ...
          <Container>
            <div className="max-w-3xl mx-auto">
              ...
              <div className="mt-6 space-y-4 text-slate-600 leading-relaxed">
                <p>
                  <strong className="text-[#000080]">For retirement savings,
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <Link
                      ...
                      className="inline-flex items-center gap-1 text-sm font-semibold text-[#B22234] hover:text-[#8b1c2a] mt-2"
                    >
