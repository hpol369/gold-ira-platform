        ...
        <div className="min-h-screen bg-white text-[#F6F4EF] font-serif">
            ...
            <header className="relative py-12 md:py-20 bg-[#0C0D18] border-b-4 border-[#000080]">
                <div className="max-w-4xl mx-auto px-4 text-center">
                    ...
                    <LeadCaptureButton
                        ...
                        className="inline-flex items-center gap-2 bg-[rgba(197,149,46,0.08)] text-[#F6F4EF] px-4 py-2 rounded-full font-sans text-sm font-semibold mb-6 hover:bg-[rgba(197,149,46,0.14)] transition-colors cursor-pointer"
                    >
                    ...
                    >
                        <h1 className="text-4xl md:text-6xl font-extrabold text-[#F6F4EF] mb-6 leading-tight uppercase">
                            ...
                            <span className="text-[#D4A94E] underline decoration-4 underline-offset-8">Who Can You Trust?</span>
                        </h1>
                    </LeadCaptureButton>
                    ...
                    >
                        <p className="text-xl md:text-2xl text-[#D0CCC4] font-sans max-w-2xl mx-auto">
                    ...
                    >
                        <div className="text-center">
                            <div className="text-3xl md:text-4xl font-black text-[#F6F4EF]">15+</div>
                            <div className="text-sm text-[#D0CCC4]">Companies Reviewed</div>
                        </div>
                        <div className="text-center">
                            <div className="text-3xl md:text-4xl font-black text-[#D4A94E]">0</div>
                            <div className="text-sm text-[#D0CCC4]">BBB Complaints (#1 Pick)</div>
                        </div>
                        <div className="text-center">
                            <div className="text-3xl md:text-4xl font-black text-[#F6F4EF]">4.9★</div>
                            <div className="text-sm text-[#D0CCC4]">Customer Rating</div>
                        </div>
                    </LeadCaptureButton>
            ...
            <section className="py-16 bg-white font-sans text-lg md:text-xl leading-relaxed text-[#F6F4EF]">
                <div className="max-w-3xl mx-auto px-4">
                    ...
                    <p className="text-center text-[#D0CCC4] mb-10">
                        After reviewing 15+ silver IRA companies, here&apos;s why Augusta stands above the rest:
                    </p>

                    <ul className="space-y-4 bg-[#0C0D18] p-6 md:p-8 rounded-xl border border-[#2A2D42]">
                    ...
                    {/* Quick Comparison */}
                    <div className="mt-10 bg-[rgba(197,149,46,0.06)] p-6 rounded-xl border border-[#000080]/20">
                        <h3 className="text-xl font-bold text-[#F6F4EF] mb-4 flex items-center gap-2">
                            <Users className="h-5 w-5" />
                            Quick Company Comparison
                        </h3>
                        <div className="space-y-3 text-base">
                            <div className="flex justify-between items-center py-2 border-b border-[#2A2D42]">
                                <span className="font-semibold text-[#F6F4EF]">Augusta Precious Metals</span>
                            ...
                            <div className="flex justify-between items-center py-2 border-b border-[#2A2D42]">
                                <span>Goldco</span>
                                <span className="text-[#A8A39A]">$25K min, some complaints</span>
                            </div>
                            <div className="flex justify-between items-center py-2 border-b border-[#2A2D42]">
                                <span>Birch Gold</span>
                                <span className="text-[#A8A39A]">$10K min, mixed reviews</span>
                            </div>
                            <div className="flex justify-between items-center py-2">
                                <span>Noble Gold</span>
                                <span className="text-[#A8A39A]">$2K min, newer company</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section className="py-16 bg-[#121423] font-sans">
                <div className="max-w-3xl mx-auto px-4 text-center">
                    <h2 className="text-3xl md:text-4xl font-bold text-[#F6F4EF] font-serif mb-6">
                        Why Silver in 2026?
                    </h2>
                    ...
                    <div className="grid md:grid-cols-3 gap-6 text-left">
                        <div className="bg-[#161828] p-6 rounded-xl shadow-sm border border-[#2A2D42]">
                            ...
                            <div className="font-semibold text-[#F6F4EF] mb-2">Industrial Demand</div>
                            <p className="text-[#D0CCC4] text-sm">Solar panels, EVs, electronics &mdash; silver is irreplaceable in modern technology.</p>
                        </div>
                        <div className="bg-[#161828] p-6 rounded-xl shadow-sm border border-[#2A2D42]">
                            <div className="text-3xl font-black text-[#D4A94E] mb-2">5,000</div>
                            <div className="font-semibold text-[#F6F4EF] mb-2">Years of Value</div>
                            <p className="text-[#D0CCC4] text-sm">Silver has been money since ancient times. No currency has matched its staying power.</p>
                        </div>
                        <div className="bg-[#161828] p-6 rounded-xl shadow-sm border border-[#2A2D42]">
                            <div className="text-3xl font-black text-[#D4A94E] mb-2">Tax-Free</div>
                            <div className="font-semibold text-[#F6F4EF] mb-2">IRA Rollover</div>
                            <p className="text-[#D0CCC4] text-sm">Move your 401(k) or IRA to physical silver without paying taxes on the transfer.</p>
                        </div>
                    </div>
                </div>
            </section>
