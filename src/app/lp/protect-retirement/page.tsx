...
export default function ProtectRetirementPage() {
    ...
    return (
        <div className="min-h-screen bg-[#0C0D18] text-[#F6F4EF] font-serif">
            ...
            {/* Top Warning Bar */}
            <div className="bg-[#DC2626] text-white p-3 text-center font-bold uppercase tracking-wider text-sm">
            ...
            <header className="relative py-12 md:py-20 bg-[#0C0D18] border-b-4 border-[#000080]">
                <div className="max-w-4xl mx-auto px-4 text-center">
                    ...
                    {/* Badge */}
                    <div className="inline-flex items-center gap-2 bg-[rgba(220,38,38,0.1)] text-[#D4A94E] px-4 py-2 rounded-full font-sans text-sm font-semibold mb-6">
                        <AlertTriangle className="h-4 w-4" />
                        2026 Market Alert
                    </div>
                    ...
                    <h1 className="text-4xl md:text-6xl font-extrabold text-[#F6F4EF] mb-6 leading-tight uppercase">
                        ...
                        <span className="text-[#D4A94E] underline decoration-4 underline-offset-8">Protected</span> From the Next Crash?
                    </h1>
                    ...
                    <div className="flex flex-wrap justify-center gap-6 md:gap-10 mb-10 font-sans">
                        <div className="text-center">
                            <div className="text-3xl md:text-4xl font-black text-[#D4A94E]">$34T</div>
                            <div className="text-sm text-[#D0CCC4]">National Debt</div>
                        </div>
                        <div className="text-center">
                            <div className="text-3xl md:text-4xl font-black text-[#D4A94E]">40-Year</div>
                            <div className="text-sm text-[#D0CCC4]">High Inflation</div>
                        </div>
                        <div className="text-center">
                            <div className="text-3xl md:text-4xl font-black text-[#F6F4EF]">+400%</div>
                            <div className="text-sm text-[#D0CCC4]">Gold Since 2000</div>
                        </div>
                    </div>
            ...
            <section className="py-16 bg-[#0C0D18] font-sans">
                <div className="max-w-4xl mx-auto px-4">
                    ...
                    <div className="grid md:grid-cols-3 gap-6">
                        <div className="bg-[#0C0D18] p-6 rounded-xl border-2 border-[#B22234]/20 hover:border-[#B22234] transition-colors">
                            <div className="w-12 h-12 bg-[rgba(220,38,38,0.1)] rounded-full flex items-center justify-center mb-4">
                                <DollarSign className="h-6 w-6 text-[#D4A94E]" />
                            </div>
                            <div className="text-3xl font-black text-[#D4A94E] mb-2">$34 Trillion</div>
                            <div className="font-semibold text-[#F6F4EF] mb-2">National Debt Crisis</div>
                            <p className="text-[#D0CCC4] text-sm">The U.S. debt has never been higher. When governments print money to pay debt, your savings lose purchasing power.</p>
                        </div>

                        <div className="bg-[#0C0D18] p-6 rounded-xl border-2 border-[#B22234]/20 hover:border-[#B22234] transition-colors">
                            <div className="w-12 h-12 bg-[rgba(220,38,38,0.1)] rounded-full flex items-center justify-center mb-4">
                                <TrendingDown className="h-6 w-6 text-[#D4A94E]" />
                            </div>
                            <div className="text-3xl font-black text-[#D4A94E] mb-2">-50%</div>
                            <div className="font-semibold text-[#F6F4EF] mb-2">2008 Stock Losses</div>
                            <p className="text-[#D0CCC4] text-sm">Millions of Americans lost half their retirement savings in 2008. Most didn&apos;t have gold to protect them.</p>
                        </div>
                        ...
                        <div className="bg-[#0C0D18] p-6 rounded-xl border-2 border-[#B22234]/20 hover:border-[#B22234] transition-colors">
                            ...
                            <div className="text-3xl font-black text-[#D4A94E] mb-2">40-Year High</div>
                            <div className="font-semibold text-[#F6F4EF] mb-2">Inflation Erosion</div>
                            <p className="text-[#D0CCC4] text-sm">Inflation hit 40-year highs. Your dollar buys less every year. Gold has historically preserved purchasing power.</p>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="py-16 bg-[#0C0D18] font-sans">
                <div className="max-w-4xl mx-auto px-4">
                    ...
                    <p className="text-center text-[#D0CCC4] mb-10 text-lg max-w-2xl mx-auto">
                        History shows us what happens when crisis hits. The numbers speak for themselves.
                    </p>

                    {/* 2008 Comparison */}
                    <div className="bg-[#161828] rounded-2xl shadow-lg border border-[#2A2D42] overflow-hidden mb-10">
                        <div className="bg-[rgba(197,149,46,0.1)] text-white p-4 text-center">
                            <h3 className="text-xl font-bold">2008 Financial Crisis: A Tale of Two Investments</h3>
                        </div>
                        <div className="grid md:grid-cols-2">
                            <div className="p-8 border-b md:border-b-0 md:border-r border-[#2A2D42] text-center">
                                <TrendingDown className="h-12 w-12 text-[#D4A94E] mx-auto mb-4" />
                                <div className="text-5xl font-black text-[#D4A94E] mb-2">-50%</div>
                                <div className="text-xl font-bold text-[#D0CCC4]">S&P 500</div>
                                <p className="text-[#A8A39A] mt-2 text-sm">Stocks crashed, taking retirement accounts with them</p>
                            </div>
                            <div className="p-8 text-center bg-[rgba(46,139,87,0.08)]/50">
                                <Shield className="h-12 w-12 text-green-600 mx-auto mb-4" />
                                <div className="text-5xl font-black text-green-600 mb-2">+25%</div>
                                <div className="text-xl font-bold text-[#D0CCC4]">Gold</div>
                                <p className="text-[#A8A39A] mt-2 text-sm">Gold rose while everything else fell</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="grid md:grid-cols-3 gap-6 text-center">
                        <div>
                            <div className="text-3xl font-black text-[#F6F4EF] mb-2">5,000+</div>
                            <div className="text-[#D0CCC4]">Years as a Store of Value</div>
                        </div>
                        <div>
                            <div className="text-3xl font-black text-[#F6F4EF] mb-2">$0</div>
                            <div className="text-[#D0CCC4]">Counterparty Risk</div>
                        </div>
                        <div>
                            <div className="text-3xl font-black text-[#F6F4EF] mb-2">Tax-Free</div>
                            <div className="text-[#D0CCC4]">Rollover Available</div>
                        </div>
                    </div>
                </div>
            </section>
