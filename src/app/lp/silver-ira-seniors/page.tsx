...
import { ShieldCheck, CheckCircle2, ArrowRight, Heart, Phone, Users, Clock, Shield, Award, Gem, HandHeart, TrendingUp } from "lucide-react";
import LeadCaptureButton from "@/components/lp/LeadCaptureButton";

export const metadata: Metadata = {
    title: "Silver IRA for Seniors Over 60 | The Affordable Safe-Haven Investment Guide",
    description: "At 60+, you can't afford to gamble with retirement. Learn why thousands of seniors choose silver IRAs for wealth preservation and peace of mind at an affordable entry point.",
    robots: {
        index: false,
        follow: false,
    },
...
// FAQ content specific to seniors and silver
const faqs = [
    {
        question: "Is there an age limit for opening a Silver IRA?",
        answer:
            "No! There's no upper age limit for opening or contributing to a Silver IRA. Whether you're 60, 70, or 80+, you can open a Silver IRA. You can also roll over existing retirement accounts at any age. Many of Augusta's clients are in their 60s, 70s, and beyond.",
    },
    {
        question: "What about Required Minimum Distributions (RMDs)?",
        answer:
            "Silver IRAs follow the same RMD rules as traditional IRAs. If you're 73 or older, you'll need to take RMDs. Augusta can help you understand how RMDs work with physical silver and plan your distributions accordingly.",
    },
    {
        question: "What's the minimum investment for a Silver IRA?",
        answer:
    ...
    {
        question: "Why choose silver over gold?",
        answer:
            "Silver costs significantly less per ounce than gold, making it more accessible for building a precious metals position. Silver also has higher percentage gain potential during bull markets, and massive industrial demand (solar panels, electronics, EVs) creates a price floor that gold doesn't have.",
    },
    {
        question: "Can I leave my Silver IRA to my children or grandchildren?",
        answer:
            "Absolutely. Your Silver IRA can be passed to your beneficiaries just like any other IRA. Physical silver in an IRA is a tangible legacy you can leave for future generations — real wealth that has held value for thousands of years.",
    },
];
...
export default function SilverIRASeniorsPage() {
