            ...
            <header className="relative py-12 md:py-20 bg-[#0C0D18] border-b-4 border-[#000080]">
                <div className="max-w-4xl mx-auto px-4 text-center">
                    ...
                    <h1 className="text-4xl md:text-6xl font-extrabold text-[#F6F4EF] mb-6 leading-tight uppercase">
                        ...
                        <span className="text-[#D4A94E] underline decoration-4 underline-offset-8">Tax-Free</span>
                    </h1>
                    ...
                    <div className="flex flex-wrap justify-center gap-6 md:gap-10 mb-10 font-sans">
                        ...
                        <div className="text-center">
                            ...
                            <div className="text-sm text-[#D0CCC4]">1-3 Week Process</div>
                        </div>
                    </div>
            ...
            <section className="py-16 bg-white font-sans">
                <div className="max-w-4xl mx-auto px-4">
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        <div className="relative bg-[#0C0D18] p-8 rounded-xl border border-[#2A2D42] text-center">
                            ...
                            <div className="w-16 h-16 bg-[rgba(197,149,46,0.08)] rounded-full flex items-center justify-center mx-auto mb-6 mt-4">
                                <Phone className="h-8 w-8 text-[#F6F4EF]" />
                            </div>
                            <h3 className="text-xl font-bold text-[#F6F4EF] mb-3">Free Consultation</h3>
                        ...
                        <div className="relative bg-[#0C0D18] p-8 rounded-xl border border-[#2A2D42] text-center">
                            ...
                            <div className="w-16 h-16 bg-[rgba(197,149,46,0.08)] rounded-full flex items-center justify-center mx-auto mb-6 mt-4">
                                <ArrowRightLeft className="h-8 w-8 text-[#F6F4EF]" />
                            </div>
                            <h3 className="text-xl font-bold text-[#F6F4EF] mb-3">Tax-Free Rollover</h3>
                            <p className="text-[#D0CCC4]">
                ...
                <div className="max-w-3xl mx-auto px-4">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                        {[
                            ...
                            <div key={index} className="bg-[#161828] p-5 rounded-xl border border-[#2A2D42] text-center">
                                <div className="w-12 h-12 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-3">
                                    <item.icon className="h-6 w-6 text-green-600" />
                                </div>
                                <p className="font-bold text-[#F6F4EF]">{item.label}</p>
                ...
                <div className="max-w-3xl mx-auto px-4">
                    ...
                    <div className="bg-[#0C0D18] p-6 md:p-8 rounded-xl border border-[#2A2D42] mt-10">
                        <ul className="space-y-5 text-lg">
                            ...
                            <li className="flex items-start gap-4">
                                <div className="flex-shrink-0 w-10 h-10 bg-[rgba(197,149,46,0.08)] rounded-full flex items-center justify-center">
                                    <ArrowRightLeft className="h-5 w-5 text-[#F6F4EF]" />
                                </div>
