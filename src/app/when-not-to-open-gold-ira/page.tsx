...
function SectionIcon({ icon: Icon }: { icon: React.ElementType }) {
  return (
    <span className="inline-flex items-center justify-center w-10 h-10 rounded-lg bg-[#B22234]/10 mr-3 flex-shrink-0">
      ...
      <header className="bg-slate-50 border-b border-slate-200 py-16 md:py-20 relative overflow-hidden">
        ...
        <Container className="relative z-10">
          <div className="max-w-3xl">
            <div className="inline-flex items-center gap-2 rounded-full bg-red-50 px-4 py-1.5 text-sm font-semibold text-[#B22234] mb-6 border border-red-200">
              <Shield className="h-3.5 w-3.5" />
              Honest Guide
            </div>
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-serif font-bold leading-tight mb-6 text-[#000080]">
              When <span className="text-[#B22234]">NOT</span> to Open a Gold IRA
            </h1>
              ...
              <table className="w-full border-collapse text-sm">
                ...
                <tbody>
                  <tr className="border-b border-slate-200 bg-red-50">
                    <td className="px-4 py-3 font-medium text-slate-900">$25,000</td>
                  ...
                  <tr className="border-b border-slate-200 bg-amber-50">
                    <td className="px-4 py-3 font-medium text-slate-900">$50,000</td>
                    <td className="px-4 py-3 text-center text-slate-700">$300</td>
                  ...
                  <tr className="bg-emerald-50">
                    <td className="px-4 py-3 font-medium text-slate-900 rounded-bl-lg">
                      $100,000
                    </td>
                    <td className="px-4 py-3 text-center text-slate-700">$300</td>
          ...
          <section className="mt-16" id="red-flags">
            <div className="rounded-2xl border border-red-200 bg-red-50 p-6 md:p-8">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-serif font-bold text-[#B22234]">
              ...
              <ul className="space-y-3">
                {[
                  ...
                  <li key={i} className="flex items-start gap-3">
                    <XCircle className="h-5 w-5 text-[#B22234] mt-0.5 flex-shrink-0" />
              ...
              <table className="w-full border-collapse text-sm">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td className="px-4 py-3 text-center text-slate-700 rounded-br-lg">
