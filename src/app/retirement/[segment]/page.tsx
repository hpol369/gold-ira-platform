...
// Light Patriot theme: bg-white, text-slate-900, #B22234 accents, #000080 headings
  ...
  return (
    <main className="bg-white text-slate-900 min-h-screen">
      ...
      <Container className="py-8 md:py-12">
        ...
        <nav aria-label="Breadcrumb" className="mb-8">
          <ol className="flex flex-wrap items-center gap-1.5 text-sm text-slate-500">
            <li className="flex items-center">
              <Link
                href="/"
                className="hover:text-[#B22234] transition-colors flex items-center gap-1"
              >
            ...
            <li className="flex items-center">
              <ChevronRight className="w-3.5 h-3.5 mx-1 text-slate-300" />
              <span className="font-semibold text-[#000080]" aria-current="page">
                {hub.title.split(":")[0]}
              </span>
            </li>
          </ol>
        ...
        {/* ── H1 Title ───────────────────────────────────────────── */}
        <h1 className="text-3xl md:text-4xl lg:text-5xl font-serif font-bold text-[#000080] leading-tight mb-6">
          {hub.title}
        </h1>
        ...
        <div className="flex items-center gap-3 text-sm text-slate-500 mb-8 pb-8 border-b border-slate-200">
          ...
          <div>
            <span className="text-slate-700 font-medium">Thomas Richardson</span>
          ...
          <div className="lg:col-span-2">
            ...
            <div className="mb-8">
              ...
              <div className="flex flex-wrap gap-2">
                {hub.accountTypes.map((type) => (
                  <span
                    key={type}
                    className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-sm font-medium bg-[#000080]/5 text-[#000080] border border-[#000080]/15"
                  >
            ...
            {hub.sections.map((section, i) => (
              <section key={i} className="mb-10">
                <h2 className="text-xl md:text-2xl font-serif font-bold text-[#000080] mb-4">
                  {section.heading}
                </h2>
            ...
            <div className="mt-12 bg-slate-50 rounded-2xl p-6 md:p-8 border border-slate-200">
              <div className="flex flex-col md:flex-row gap-6 items-center md:items-start">
                <div className="w-24 h-24 md:w-28 md:h-28 rounded-xl bg-[#000080] shrink-0 overflow-hidden border-4 border-[#000080]/20 shadow-lg flex items-center justify-center">
                  <span className="text-3xl font-bold text-white/90">TR</span>
                </div>
                <div className="flex-1 text-center md:text-left">
                  <div className="flex flex-col md:flex-row md:items-center gap-2 mb-3">
                    <p className="text-xs font-bold tracking-widest text-[#B22234] uppercase">
                      Written &amp; Researched By
                    </p>
                    <span className="hidden md:inline text-slate-300">-</span>
                    <Link
                      href="/about-us"
                      className="text-xs text-slate-400 hover:text-[#B22234] transition-colors flex items-center gap-1 justify-center md:justify-start"
                    >
                      Read my story
                  ...
                  <p className="text-slate-500 mb-4 leading-relaxed text-sm md:text-base">
                  ...
                  <div className="flex flex-wrap justify-center md:justify-start gap-2">
                    <span className="inline-flex items-center gap-1.5 text-xs font-medium text-slate-600 bg-white px-3 py-1.5 rounded-full border border-slate-200">
                      <Briefcase className="h-3 w-3 text-[#B22234]" />
                      20+ Years Finance
                    </span>
                    <span className="inline-flex items-center gap-1.5 text-xs font-medium text-slate-600 bg-white px-3 py-1.5 rounded-full border border-slate-200">
                      <FileSearch className="h-3 w-3 text-[#B22234]" />
              ...
              <div className="mt-6 pt-6 border-t border-slate-200 flex flex-wrap justify-center md:justify-start gap-x-6 gap-y-2 text-xs text-slate-400">
          ...
          <aside className="lg:col-span-1">
            <div className="sticky top-24 space-y-6">
              ...
              <div className="bg-slate-50 rounded-xl p-5 border border-slate-200">
                <h3 className="font-bold text-[#000080] mb-4 text-sm uppercase tracking-wider">
                  Quick Facts
                </h3>
                <dl className="space-y-3 text-sm">
                  <div>
                    <dt className="text-slate-500">Average Savings</dt>
                    <dd className="font-semibold text-slate-800">
                      {hub.avgSavings}
                    </dd>
                  </div>
                  <div>
                    <dt className="text-slate-500">Account Types</dt>
                    <dd className="font-semibold text-slate-800">
                ...
                <ul className="space-y-2 text-sm">
                  <li>
                    <Link
                      ...
                      className="text-[#000080] hover:text-[#B22234] transition-colors hover:underline"
                    >
