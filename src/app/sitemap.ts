...
export default function sitemap(): MetadataRoute.Sitemap {
    return [
        ...
        {
            url: "https://goldiraguide.com/guide/silver-ira-guide",
            lastModified: new Date(),
            changeFrequency: "monthly",
            priority: 0.9,
        },
        {
            url: "https://goldiraguide.com/guide/401k-to-gold-rollover",
            lastModified: new Date(),
            changeFrequency: "monthly",
            priority: 0.9,
        },
        {
            url: "https://goldiraguide.com/guide/gold-ira-fees",
            lastModified: new Date(),
            changeFrequency: "monthly",
            priority: 0.8,
        },
        ...
        {
            url: "https://goldiraguide.com/compare/gold-ira-vs-roth-ira",
            lastModified: new Date(),
            changeFrequency: "monthly",
            priority: 0.8,
        },
        {
            url: "https://goldiraguide.com/compare/gold-ira-vs-physical-gold",
            lastModified: new Date(),
            changeFrequency: "monthly",
            priority: 0.8,
        },
        {
            url: "https://goldiraguide.com/compare/gold-vs-silver-ira",
            lastModified: new Date(),
            changeFrequency: "monthly",
            priority: 0.8,
        },
        ...
        {
            url: "https://goldiraguide.com/learn/gold-ira-tax-rules",
            lastModified: new Date(),
            changeFrequency: "monthly",
            priority: 0.8,
        },
        {
            url: "https://goldiraguide.com/learn/gold-ira-scams",
            lastModified: new Date(),
            changeFrequency: "monthly",
            priority: 0.8,
        },
        {
            url: "https://goldiraguide.com/learn/ira-approved-gold-coins",
            lastModified: new Date(),
            changeFrequency: "monthly",
            priority: 0.8,
        },
