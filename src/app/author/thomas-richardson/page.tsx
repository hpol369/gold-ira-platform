                    ...
                    <div className="flex flex-col md:flex-row gap-12 items-start">
                        ...
                        <div className="w-full md:w-1/3 flex flex-col items-center text-center">
                            ...
                            <div className="flex gap-4 mb-8">
                                <a href="https://www.linkedin.com/in/thomas-richardson-gold" target="_blank" rel="noopener noreferrer" className="p-3 bg-slate-100 rounded-full hover:bg-blue-100 hover:text-blue-600 transition-colors text-slate-500">
                                    <Linkedin className="w-5 h-5" />
                                </a>
                                <a href="https://twitter.com/ThomasGoldIRA" target="_blank" rel="noopener noreferrer" className="p-3 bg-slate-100 rounded-full hover:bg-blue-100 hover:text-blue-600 transition-colors text-slate-500">
                            ...
                            <div className="w-full bg-white rounded-xl p-6 text-left space-y-4 border border-slate-200">
                                <h3 className="text-xs font-bold text-slate-400 uppercase tracking-wider mb-3">Credentials</h3>
                                <div className="flex items-start gap-3">
                                    <Award className="w-5 h-5 text-[#B22234] shrink-0 mt-1" />
                                    <div>
                                        <p className="font-bold text-sm text-slate-900">20+ Years in Finance</p>
                                        <p className="text-xs text-slate-500">Former Wealth Manager, Regional Director</p>
                                    </div>
                                </div>
                                <div className="flex items-start gap-3">
                                    <ShieldCheck className="w-5 h-5 text-[#B22234] shrink-0 mt-1" />
                                    <div>
                                        <p className="font-bold text-sm text-slate-900">CFP Certified</p>
                                        <p className="text-xs text-slate-500">Certified Financial Planner</p>
                                    </div>
                                </div>
                                <div className="flex items-start gap-3">
                                    <Building2 className="w-5 h-5 text-[#B22234] shrink-0 mt-1" />
                                    <div>
                                        <p className="font-bold text-sm text-slate-900">University of Virginia</p>
                                        <p className="text-xs text-slate-500">B.S. in Finance</p>
                                    </div>
                                </div>
                                <div className="flex items-start gap-3">
                                    <Users className="w-5 h-5 text-[#B22234] shrink-0 mt-1" />
                                    <div>
                                        <p className="font-bold text-sm text-slate-900">15+ Companies Investigated</p>
                                        <p className="text-xs text-slate-500">Independent, hands-on research</p>
                                    </div>
                                </div>
                                <div className="flex items-start gap-3">
                                    <FileText className="w-5 h-5 text-[#B22234] shrink-0 mt-1" />
                                    <div>
                                        <p className="font-bold text-sm text-slate-900">500+ Articles Published</p>
                                        <p className="text-xs text-slate-500">Guides, reviews, and analysis</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="flex-1 prose prose-lg prose-headings:font-serif prose-headings:text-[#000080] prose-p:text-slate-600 prose-strong:text-slate-900 prose-li:text-slate-600 max-w-none">
                            ...
                            <div className="not-prose mt-12 pt-12 border-t border-slate-200">
                                <h3 className="font-serif font-bold text-2xl text-[#000080] mb-6">Featured Articles by Thomas</h3>
                                <div className="grid md:grid-cols-2 gap-4">
                                    {featuredArticles.map((article) => (
                                        <Link key={article.href} href={article.href} className="group block bg-white rounded-xl p-5 hover:bg-slate-50 transition-all border border-slate-200 hover:border-[#B22234]">
                                            <BookOpen className="w-5 h-5 text-[#B22234] mb-2 group-hover:scale-110 transition-transform" />
                                            <h4 className="font-bold text-sm text-slate-900 mb-1 group-hover:text-[#B22234] transition-colors">{article.title}</h4>
