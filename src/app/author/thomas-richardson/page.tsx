    ...
    return (
        <main className="min-h-screen bg-background pb-24">
            ...
            <Container className="pt-12 pb-24">
                <Link href="/about-us" className="inline-flex items-center text-sm text-text-muted hover:text-primary mb-8 transition-colors">
                ...
                <div className="bg-white rounded-3xl p-8 md:p-12 shadow-sm border border-gray-100">
                    <div className="flex flex-col md:flex-row gap-12 items-start">
                        ...
                        <div className="w-full md:w-1/3 flex flex-col items-center text-center">
                            <div className="w-64 h-64 rounded-full border-8 border-background mb-8 shadow-xl relative overflow-hidden">
                                <Image
                            ...
                            <h1 className="text-3xl font-serif font-bold text-primary mb-2">Thomas Richardson</h1>
                            <p className="text-secondary font-medium tracking-wide text-sm uppercase mb-6">Founder & Lead Analyst</p>

                            <div className="flex gap-4 mb-8">
                                <a href="#" className="p-3 bg-gray-50 rounded-full hover:bg-blue-50 hover:text-blue-600 transition-colors">
                                    <Linkedin className="w-5 h-5" />
                                </a>
                                <a href="#" className="p-3 bg-gray-50 rounded-full hover:bg-blue-50 hover:text-blue-400 transition-colors">
                                    <Twitter className="w-5 h-5" />
                                </a>
                            </div>

                            <div className="w-full bg-background-subtle rounded-xl p-6 text-left space-y-4">
                                <div className="flex items-start gap-3">
                                    <Award className="w-5 h-5 text-secondary shrink-0 mt-1" />
                                    <div>
                                        <p className="font-bold text-sm text-primary">20+ Years Experience</p>
                                        <p className="text-xs text-text-muted">Former Wealth Manager</p>
                                    </div>
                                </div>
                                <div className="flex items-start gap-3">
                                    <ShieldCheck className="w-5 h-5 text-secondary shrink-0 mt-1" />
                                    <div>
                                        <p className="font-bold text-sm text-primary">Fiduciary Standard</p>
                                        <p className="text-xs text-text-muted">Always putting readers first</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        {/* Content Column */}
                        <div className="flex-1 prose prose-lg prose-headings:font-serif prose-headings:text-primary max-w-none">
                            ...
                            <div className="not-prose mt-12 pt-12 border-t border-gray-100">
                                <h3 className="font-serif font-bold text-2xl text-primary mb-6">Popular Articles by Thomas</h3>
                                <div className="grid md:grid-cols-2 gap-6">
                                    <Link href="/guide/gold-ira-guide" className="group block bg-gray-50 rounded-xl p-6 hover:bg-white hover:shadow-md transition-all border border-transparent hover:border-gray-200">
                                        <BookOpen className="w-6 h-6 text-secondary mb-3 group-hover:scale-110 transition-transform" />
                                        <h4 className="font-bold text-primary mb-2 group-hover:text-secondary transition-colors">Gold IRA Guide 2026</h4>
                                        <p className="text-sm text-text-muted">The ultimate beginner's handbook to precious metals IRAs.</p>
                                    </Link>
                                    <Link href="/guide/401k-to-gold-rollover" className="group block bg-gray-50 rounded-xl p-6 hover:bg-white hover:shadow-md transition-all border border-transparent hover:border-gray-200">
                                        <BookOpen className="w-6 h-6 text-secondary mb-3 group-hover:scale-110 transition-transform" />
                                        <h4 className="font-bold text-primary mb-2 group-hover:text-secondary transition-colors">401k Rollover Rules</h4>
                                        <p className="text-sm text-text-muted">How to move your funds without paying taxes or penalties.</p>
                                    </Link>
                                </div>
                            </div>
                        </div>
