        ...
        <Container>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            <div>
              ...
              <div className="text-sm text-[#A8A39A]">Annual Gift Exclusion</div>
            </div>
            <div>
              <div className="text-3xl font-bold text-green-600">$90K</div>
              <div className="text-sm text-[#A8A39A]">5-Year Superfunding</div>
            </div>
            <div>
              <div className="text-3xl font-bold text-green-600">Tax-Free</div>
              <div className="text-sm text-[#A8A39A]">529 Growth</div>
            </div>
            <div>
              <div className="text-3xl font-bold text-green-600">∞</div>
              <div className="text-sm text-[#A8A39A]">Direct Tuition Gifts</div>
            </div>
          </div>
        </Container>
      </section>
        ...
        <Container>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-[#0C0D18] border border-[#2A2D42] rounded-xl p-6">
              ...
              <h3 className="font-bold text-[#F6F4EF] mb-2">529 Education Plans</h3>
            ...
            <div className="bg-[#0C0D18] border border-[#2A2D42] rounded-xl p-6">
              ...
              <h3 className="font-bold text-[#F6F4EF] mb-2">Trust Funds</h3>
              <p className="text-[#A8A39A] text-sm">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {articles.map((article) => (
              <Link
                ...
                className="bg-white hover:bg-[#121423] border border-[#2A2D42] hover:border-green-300 rounded-xl p-6 transition-all group"
              >
                <h3 className="text-lg font-bold text-[#F6F4EF] group-hover:text-green-600 transition-colors mb-2 leading-snug">
                  {article.title}
                </h3>
