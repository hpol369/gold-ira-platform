        ...
        <Container className="relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-serif font-bold text-[#000080] mb-6">
              Grandchildren{" "}
              <span className="text-green-600">Legacy Hub</span>
            </h1>
      ...
      <section className="py-8 border-y border-slate-200 bg-white">
        <Container>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            <div>
              <div className="text-3xl font-bold text-green-600">$18K</div>
              <div className="text-sm text-slate-500">Annual Gift Exclusion</div>
            </div>
            <div>
              <div className="text-3xl font-bold text-green-600">$90K</div>
              <div className="text-sm text-slate-500">5-Year Superfunding</div>
            </div>
            <div>
              <div className="text-3xl font-bold text-green-600">Tax-Free</div>
              <div className="text-sm text-slate-500">529 Growth</div>
            </div>
            <div>
              <div className="text-3xl font-bold text-green-600">∞</div>
              <div className="text-sm text-slate-500">Direct Tuition Gifts</div>
            </div>
          </div>
        </Container>
      </section>
        ...
        <Container>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-slate-50 border border-slate-200 rounded-xl p-6">
              ...
              <h3 className="font-bold text-slate-900 mb-2">529 Education Plans</h3>
            ...
            <div className="bg-slate-50 border border-slate-200 rounded-xl p-6">
              ...
              <h3 className="font-bold text-slate-900 mb-2">Trust Funds</h3>
              <p className="text-slate-500 text-sm">
            ...
            <div className="bg-slate-50 border border-slate-200 rounded-xl p-6">
              ...
              <h3 className="font-bold text-slate-900 mb-2">Direct Gifts</h3>
              <p className="text-slate-500 text-sm">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {articles.map((article) => (
              <Link
                ...
                className="bg-white hover:bg-slate-50 border border-slate-200 hover:border-green-300 rounded-xl p-6 transition-all group"
              >
                <h3 className="text-lg font-bold text-slate-900 group-hover:text-green-600 transition-colors mb-2 leading-snug">
                  {article.title}
                </h3>
