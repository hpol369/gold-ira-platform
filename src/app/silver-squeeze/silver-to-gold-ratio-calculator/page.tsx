      ...
      <main className="pt-8 pb-16">
        <Container>
          ...
          <nav className="flex items-center gap-2 text-sm text-slate-600 mb-8">
            ...
            <ChevronRight className="h-4 w-4" />
            <span className="text-slate-900">Silver to Gold Ratio Calculator</span>
          </nav>

          {/* Header */}
          <div className="max-w-4xl mx-auto text-center mb-12">
            <div className="inline-flex items-center gap-2 bg-[#B22234]/20 text-[#B22234] px-4 py-2 rounded-full text-sm font-semibold mb-6 border border-[#B22234]/30">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-slate-50 backdrop-blur-xl rounded-2xl p-6 md:p-8 border border-slate-200 shadow-[0_8px_32px_rgba(0,0,0,0.3)]">
                <div className="flex items-center gap-3 mb-6">
                  <div className="p-2 bg-[#B22234]/20 rounded-lg border border-[#B22234]/30">
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    <label className="text-sm text-slate-600 mb-2 flex items-center gap-2">
                      <Coins className="h-4 w-4 text-[#B22234]" />
                      Gold Price (USD/oz)
                    </label>
                    <div className="relative">
                      <DollarSign className="absolute left-3 top-1/2 -translate-y-1/2 h-5 w-5 text-slate-600" />
                      <input
                        type="number"
                        value={goldPrice}
                        onChange={(e) => setGoldPrice(Number(e.target.value))}
                        className="w-full bg-slate-800/80 border border-slate-700 rounded-lg px-10 py-3 text-slate-900 text-lg focus:outline-none focus:border-amber-500 transition-colors"
                        min="0"
                        step="10"
                      />
                    </div>
                ...
                <div className="mt-8 p-6 bg-gradient-to-br from-[#B22234]/20 to-yellow-500/10 rounded-xl border border-[#B22234]/30">
                  <div className="text-center">
                    ...
                    <div className="text-5xl font-bold text-[#B22234] mb-2">
              ...
              <div className="bg-slate-50 backdrop-blur-xl rounded-2xl p-6 md:p-8 border border-slate-200 shadow-[0_8px_32px_rgba(0,0,0,0.3)]">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between p-4 bg-slate-50 rounded-lg">
                    <div>
                      ...
                      <p className="text-sm text-slate-600">2004-2024</p>
                    </div>
                    <div className="text-right">
                      <p className="text-xl font-bold text-slate-200">
                ...
                {/* Insight Box */}
                <div className="mt-4 p-4 bg-[#B22234]/10 rounded-lg border border-amber-500/20">
                  <div className="flex gap-3">
                    <AlertTriangle className="h-5 w-5 text-[#B22234] flex-shrink-0 mt-0.5" />
                    <div className="text-sm text-slate-600">
                      <p className="font-semibold text-[#B22234] mb-1">
                        Ratio Analysis
                      </p>
                      <p>
            ...
            <div className="bg-slate-50 backdrop-blur-xl rounded-2xl p-6 md:p-8 border border-slate-200 shadow-[0_8px_32px_rgba(0,0,0,0.3)]">
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-600">1970-2026</p>
                </div>
              </div>
              ...
              <div className="mt-6 flex flex-wrap gap-4 justify-center">
                {keyEvents.map((event, idx) => (
                  ...
                  >
                    ...
                    <span className="text-slate-600">{event.year}:</span>
                    <span className="text-slate-900 font-medium">
                      {event.label}
                    </span>
                    <span className="text-[#B22234]">({event.ratio}:1)</span>
                  </div>
                ))}
              </div>
          ...
          <div className="max-w-4xl mx-auto mb-16">
            <div className="bg-gradient-to-br from-slate-800/90 via-slate-900/90 to-slate-800/90 rounded-2xl p-8 md:p-10 border border-amber-500/20 shadow-[0_8px_32px_rgba(0,0,0,0.3),0_0_60px_rgba(212,175,55,0.1)]">
              <div className="text-center mb-6">
                <div className="inline-flex items-center gap-2 bg-[#B22234]/20 text-[#B22234] px-4 py-2 rounded-full text-sm font-semibold mb-4 border border-[#B22234]/30">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <Link
                  href="/quiz"
                  className="flex items-center justify-center gap-2 bg-gradient-to-r from-[#B22234] to-[#8b1c2a] text-slate-900 font-bold py-4 px-6 rounded-xl hover:scale-105 transition-transform shadow-[0_0_30px_rgba(212,175,55,0.3)]"
                >
            ...
            <div className="prose prose-invert max-w-none">
              ...
              <div className="grid md:grid-cols-2 gap-6 mb-8">
                ...
                <div className="bg-slate-50 backdrop-blur-xl rounded-xl p-6 border border-slate-200">
                  ...
                  <ul className="text-slate-600 text-sm space-y-2">
                    <li className="flex gap-2">
                      <span className="text-[#B22234] font-bold">47:1</span>
                      <span>- 100-year historical average</span>
                    </li>
                    <li className="flex gap-2">
                      <span className="text-[#B22234] font-bold">17:1</span>
                      <span>- Natural geological ratio</span>
                    </li>
                    <li className="flex gap-2">
                      <span className="text-[#B22234] font-bold">50-60:1</span>
                      <span>- Most analyst consensus range</span>
                    </li>
                    <li className="flex gap-2">
                      <span className="text-[#B22234] font-bold">16:1</span>
              ...
              {/* FAQ Section */}
              <div className="bg-slate-50 backdrop-blur-xl rounded-xl p-6 md:p-8 border border-slate-200 mb-8">
