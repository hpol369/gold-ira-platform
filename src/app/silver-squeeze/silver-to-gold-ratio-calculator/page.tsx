  ...
  if (active && payload && payload.length) {
    return (
      <div className="bg-slate-800 border border-slate-700 rounded-lg p-3 shadow-lg">
        <p className="text-[#F6F4EF] font-semibold">{label}</p>
  ...
  return (
    <div className="min-h-screen bg-white text-[#F6F4EF]">
      ...
      <main className="pt-8 pb-16">
        <Container>
          {/* Breadcrumb */}
          <nav className="flex items-center gap-2 text-sm text-[#D0CCC4] mb-8">
            <Link href="/" className="hover:text-[#D4A94E] transition-colors">
              Home
            </Link>
            ...
            <ChevronRight className="h-4 w-4" />
            <span className="text-[#F6F4EF]">Silver to Gold Ratio Calculator</span>
          </nav>
          ...
          <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-8 mb-16">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-[#0C0D18] backdrop-blur-xl rounded-2xl p-6 md:p-8 border border-[#2A2D42] shadow-[0_8px_32px_rgba(0,0,0,0.3)]">
                ...
                <div className="space-y-6">
                  {/* Gold Price Input */}
                  <div>
                    <label className="text-sm text-[#D0CCC4] mb-2 flex items-center gap-2">
                      <Coins className="h-4 w-4 text-[#D4A94E]" />
                      Gold Price (USD/oz)
                    </label>
                    <div className="relative">
                      <DollarSign className="absolute left-3 top-1/2 -translate-y-1/2 h-5 w-5 text-[#D0CCC4]" />
                      <input
                        type="number"
                        value={goldPrice}
                        onChange={(e) => setGoldPrice(Number(e.target.value))}
                        className="w-full bg-slate-800/80 border border-slate-700 rounded-lg px-10 py-3 text-[#F6F4EF] text-lg focus:outline-none focus:border-amber-500 transition-colors"
                        min="0"
                        step="10"
                      />
                    </div>
                ...
                <div className="mt-8 p-6 bg-gradient-to-br from-[#B22234]/20 to-yellow-500/10 rounded-xl border border-[#B22234]/30">
                  <div className="text-center">
                    ...
                    <div className="text-5xl font-bold text-[#D4A94E] mb-2">
              ...
              <div className="bg-[#0C0D18] backdrop-blur-xl rounded-2xl p-6 md:p-8 border border-[#2A2D42] shadow-[0_8px_32px_rgba(0,0,0,0.3)]">
                ...
                <div className="space-y-4">
                  {/* Long-term Average */}
                  <div className="flex items-center justify-between p-4 bg-[#0C0D18] rounded-lg">
                    <div>
                    ...
                    <div className="text-right">
                      <p className="text-xl font-bold text-[#3F4460]">
                  ...
                  <div className="flex items-center justify-between p-4 bg-[#0C0D18] rounded-lg">
                    <div>
                      ...
                      <p className="text-sm text-[#D0CCC4]">2004-2024</p>
                    </div>
                    <div className="text-right">
                      <p className="text-xl font-bold text-[#3F4460]">
                ...
                {/* Insight Box */}
                <div className="mt-4 p-4 bg-[rgba(220,38,38,0.1)] rounded-lg border border-amber-500/20">
                  <div className="flex gap-3">
                    <AlertTriangle className="h-5 w-5 text-[#D4A94E] flex-shrink-0 mt-0.5" />
                    <div className="text-sm text-[#D0CCC4]">
                      <p className="font-semibold text-[#D4A94E] mb-1">
                        Ratio Analysis
                      </p>
                      <p>
            ...
            <div className="space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="p-5 bg-gradient-to-r from-green-500/10 to-emerald-500/5 rounded-xl border border-green-500/20">
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <span className="text-xs text-[#D0CCC4] bg-[#121423] px-2 py-1 rounded">
                        Conservative
                      </span>
                    </div>
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <div className="text-right">
                        <p className="text-sm text-[#D0CCC4]">Potential gain</p>
                        <p className="text-2xl font-bold text-green-700">
              ...
              {/* Quick Facts */}
              <div className="bg-[#0C0D18] backdrop-blur-xl rounded-2xl p-6 border border-[#2A2D42] shadow-[0_8px_32px_rgba(0,0,0,0.3)]">
                <div className="flex items-center gap-3 mb-4">
                  <Info className="h-5 w-5 text-blue-700" />
                  <h3 className="text-lg font-semibold">Key Ratio Facts</h3>
                </div>
                <ul className="space-y-3 text-sm">
                  <li className="flex gap-3 text-[#D0CCC4]">
            ...
            <div className="bg-[#0C0D18] backdrop-blur-xl rounded-2xl p-6 md:p-8 border border-[#2A2D42] shadow-[0_8px_32px_rgba(0,0,0,0.3)]">
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  ...
                  <p className="text-sm text-[#D0CCC4]">1970-2026</p>
                </div>
              </div>
              ...
              <div className="mt-6 flex flex-wrap gap-4 justify-center">
                {keyEvents.map((event, idx) => (
                  <div
                    key={idx}
                    className="flex items-center gap-2 bg-[#0C0D18] px-3 py-2 rounded-lg text-sm"
                  >
                    <div className="w-2 h-2 rounded-full bg-amber-400" />
                    <span className="text-[#D0CCC4]">{event.year}:</span>
                    <span className="text-[#F6F4EF] font-medium">
                      {event.label}
                    </span>
                    <span className="text-[#D4A94E]">({event.ratio}:1)</span>
                  </div>
                ))}
              </div>

              <p className="text-xs text-center text-[#D0CCC4] mt-4">
          ...
          <div className="max-w-4xl mx-auto mb-16">
            <div className="bg-gradient-to-br from-slate-800/90 via-slate-900/90 to-slate-800/90 rounded-2xl p-8 md:p-10 border border-amber-500/20 shadow-[0_8px_32px_rgba(0,0,0,0.3),0_0_60px_rgba(212,175,55,0.1)]">
              <div className="text-center mb-6">
                ...
                <p className="text-[#D0CCC4] max-w-2xl mx-auto mb-6">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                ...
                <Link
                  href="/silver-ira"
                  className="flex items-center justify-center gap-2 bg-[#121423] text-[#F6F4EF] font-semibold py-4 px-6 rounded-xl border border-[#3F4460] hover:bg-[#1E2134]/20 transition-colors"
                >
          ...
          <div className="max-w-4xl mx-auto">
            <div className="prose prose-invert max-w-none">
              ...
              <div className="grid md:grid-cols-2 gap-6 mb-8">
                {/* What Is It */}
                <div className="bg-[#0C0D18] backdrop-blur-xl rounded-xl p-6 border border-[#2A2D42]">
                ...
                <div className="bg-[#0C0D18] backdrop-blur-xl rounded-xl p-6 border border-[#2A2D42]">
                  ...
                  <ul className="text-[#D0CCC4] text-sm space-y-2">
                    <li className="flex gap-2">
                      <span className="text-[#D4A94E] font-bold">47:1</span>
                      <span>- 100-year historical average</span>
                    </li>
                    <li className="flex gap-2">
                      <span className="text-[#D4A94E] font-bold">17:1</span>
                      <span>- Natural geological ratio</span>
                    </li>
                    <li className="flex gap-2">
                      <span className="text-[#D4A94E] font-bold">50-60:1</span>
                      <span>- Most analyst consensus range</span>
                    </li>
                    <li className="flex gap-2">
                      <span className="text-[#D4A94E] font-bold">16:1</span>
              ...
              {/* FAQ Section */}
              <div className="bg-[#0C0D18] backdrop-blur-xl rounded-xl p-6 md:p-8 border border-[#2A2D42] mb-8">
