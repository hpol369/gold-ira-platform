                ...
                <Container className="relative z-10">
                    <div className="max-w-4xl mx-auto">
                        <nav className="flex items-center gap-2 text-sm text-[#A8A39A] mb-6">
                            ...
                            <span>/</span>
                            <span className="text-[#F6F4EF]">ROBS vs SBA Loan</span>
                        </nav>
                            ...
                            <table className="w-full border-collapse">
                                ...
                                <tbody>
                                    {comparisonData.map((row, idx) => (
                                        <tr key={row.feature} className={idx % 2 === 1 ? "bg-[#0C0D18]/50" : ""}>
                                            <td className="px-4 py-3 border-b border-[#2A2D42] font-medium text-[#D0CCC4] text-sm">{row.feature}</td>
                                            <td className="px-4 py-3 border-b border-[#2A2D42] text-[#D0CCC4] text-sm">{row.robs}</td>
                                            <td className="px-4 py-3 border-b border-[#2A2D42] text-[#D0CCC4] text-sm">{row.sba}</td>
                                        </tr>
                                    ))}
                                </tbody>
                            </table>
                ...
                <Container>
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="grid md:grid-cols-2 gap-8">
                            <div className="bg-[#161828] rounded-xl border border-orange-200 p-6">
                                <div className="flex items-center gap-3 mb-4">
                                    <div className="w-10 h-10 bg-orange-100 rounded-lg flex items-center justify-center">
                                        <Zap className="w-5 h-5 text-orange-600" />
                                    </div>
                                    <h3 className="text-xl font-bold text-[#F6F4EF]">Choose ROBS If...</h3>
                                </div>
                            ...
                            <div className="bg-[#161828] rounded-xl border border-blue-200 p-6">
                                <div className="flex items-center gap-3 mb-4">
                                    ...
                                    <h3 className="text-xl font-bold text-[#F6F4EF]">Choose SBA Loan If...</h3>
                                </div>
                                <ul className="space-y-3">
                                    <li className="flex items-start gap-2 text-[#D0CCC4] text-sm">
                                        <CheckCircle2 className="w-4 h-4 text-green-500 mt-0.5 flex-shrink-0" />
                        ...
                        <div className="bg-[rgba(46,139,87,0.08)] border border-[rgba(46,139,87,0.32)] rounded-xl p-6">
                            ...
                            <div className="space-y-3 text-sm">
                                <div className="flex justify-between border-b border-green-100 pb-2">
                                    <span className="text-[#D0CCC4]">Total franchise cost</span>
                                    <span className="font-semibold text-[#F6F4EF]">$250,000</span>
                                </div>
                                <div className="flex justify-between border-b border-green-100 pb-2">
                                    <span className="text-[#D0CCC4]">ROBS from 401k (equity injection - 20%)</span>
                                    <span className="font-semibold text-orange-600">$50,000</span>
                                </div>
                                <div className="flex justify-between border-b border-green-100 pb-2">
                                    <span className="text-[#D0CCC4]">SBA 7(a) loan (80%)</span>
                                    <span className="font-semibold text-blue-600">$200,000</span>
                                </div>
                                <div className="flex justify-between border-b border-green-100 pb-2">
                                    <span className="text-[#D0CCC4]">Personal savings used</span>
                                    <span className="font-semibold text-green-600">$0</span>
                                </div>
                                <div className="flex justify-between pt-2">
                                    <span className="text-[#D0CCC4]">Remaining retirement (not used)</span>
