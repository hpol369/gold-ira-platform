                    ...
                    <div className="max-w-3xl mx-auto">
                        <article className="prose prose-lg prose-headings:font-serif prose-headings:text-[#000080] prose-p:text-slate-600 prose-strong:text-[#000080] prose-li:text-slate-600 prose-a:text-[#B22234] max-w-none">
                            ...
                            <div className="flex items-center gap-4 mb-4 not-prose">
                                ...
                                <h2 className="text-2xl md:text-3xl font-serif font-bold text-[#000080] m-0">The Numbers Don&apos;t Lie</h2>
                            </div>
                            <p>
                                ...
                                <table className="w-full text-left border-collapse bg-white rounded-xl border border-slate-200 shadow-sm">
                                    <thead className="bg-slate-50">
                                        <tr>
                                            ...
                                            <th className="p-4 border-b border-slate-200 font-bold text-[#000080]">Central Bank Gold Purchases</th>
                                            <th className="p-4 border-b border-slate-200 font-bold text-[#000080]">Notable Buyers</th>
                                        </tr>
                                    </thead>
                                    <tbody className="divide-y divide-slate-200 text-sm text-slate-600">
                                        <tr>
                                            <td className="p-4 text-[#000080]">2022</td>
                                            <td className="p-4 font-semibold text-[#B22234]">1,136 tonnes</td>
                                            <td className="p-4">Turkey, China, Egypt, Qatar</td>
                                        </tr>
                                        <tr>
                                            <td className="p-4 text-[#000080]">2023</td>
                                            <td className="p-4 font-semibold text-[#B22234]">1,037 tonnes</td>
                                            <td className="p-4">China, Poland, Singapore, Libya</td>
                                        </tr>
                                        <tr>
                                            <td className="p-4 text-[#000080]">2024</td>
                                            <td className="p-4 font-semibold text-[#B22234]">1,100+ tonnes (est.)</td>
                            ...
                            <div className="flex items-center gap-4 mb-4 mt-12 not-prose">
                                ...
                                <h2 className="text-2xl md:text-3xl font-serif font-bold text-[#000080] m-0">Why Are They Doing This?</h2>
                            </div>
                            ...
                            <div className="flex items-center gap-4 mb-4 mt-12 not-prose">
                                ...
                                <h2 className="text-2xl md:text-3xl font-serif font-bold text-[#000080] m-0">Who&apos;s Buying the Most?</h2>
                            </div>

                            <div className="grid gap-4 not-prose my-8">
                                <div className="bg-white rounded-xl border border-slate-200 p-6 shadow-sm">
                                    <h4 className="font-bold text-[#000080] text-lg mb-2">China</h4>
                                    <p className="text-slate-500 text-sm mb-2">They say 2,200+ tonnes. Probably 3-4x more.</p>
                                    <p className="text-slate-600">China produces more gold than anyone. And they&apos;re still buying more on top of that. They&apos;re not doing this for fun.</p>
                                </div>
                                <div className="bg-white rounded-xl border border-slate-200 p-6 shadow-sm">
                                    <h4 className="font-bold text-[#000080] text-lg mb-2">Poland</h4>
                                    <p className="text-slate-500 text-sm mb-2">130+ tonnes in 2023 alone</p>
                                    <p className="text-slate-600">Poland shares a border with Ukraine. Their central bank said openly: &quot;uncertain geopolitical environment.&quot; They&apos;re not kidding around.</p>
                                </div>
                                <div className="bg-white rounded-xl border border-slate-200 p-6 shadow-sm">
                                    <h4 className="font-bold text-[#000080] text-lg mb-2">Turkey</h4>
                                    <p className="text-slate-500 text-sm mb-2">Massive buyer 2022-2023</p>
                                    <p className="text-slate-600">Turkey&apos;s currency lost 80% of its value in 5 years. Their central bank watched their people&apos;s savings evaporate. Now they&apos;re buying gold like their lives depend on it.</p>
                                </div>
                                <div className="bg-white rounded-xl border border-slate-200 p-6 shadow-sm">
                                    <h4 className="font-bold text-[#000080] text-lg mb-2">India</h4>
                                    <p className="text-slate-500 text-sm mb-2">Steady buyer since 2017</p>
                                    <p className="text-slate-600">India&apos;s people have trusted gold for generations. Their central bank is following the people&apos;s wisdom.</p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-center gap-4 mb-4 mt-12 not-prose">
                                ...
                                <h2 className="text-2xl md:text-3xl font-serif font-bold text-[#000080] m-0">What This Means for You</h2>
                            </div>
                            ...
                            <div className="flex items-center gap-4 mb-4 mt-12 not-prose">
                                ...
                                <h2 className="text-2xl md:text-3xl font-serif font-bold text-[#000080] m-0">What&apos;s Happening to Gold Prices</h2>
                            </div>
                            ...
                            <div className="flex items-center gap-4 mb-4 mt-12 not-prose">
                                ...
                                <h2 className="text-2xl md:text-3xl font-serif font-bold text-[#000080] m-0">Let&apos;s Be Honest About Risks</h2>
                            </div>
                            ...
                            <div className="my-12 bg-slate-50 rounded-2xl p-8 text-center relative overflow-hidden not-prose border border-slate-200">
                                <div className="relative z-10">
                                    <h3 className="text-2xl font-serif font-bold mb-4 text-[#000080]">Do What the Central Banks Do</h3>
                                    <p className="mb-6 text-slate-600">Move some of your paper savings into physical gold - the same thing central banks are doing.</p>
                            ...
                            <div className="flex items-center gap-4 mb-4 mt-12 not-prose">
                                ...
                                <h2 className="text-2xl md:text-3xl font-serif font-bold text-[#000080] m-0">The Simple Truth</h2>
                            </div>
