                        ...
                        <article className="prose prose-lg prose-headings:font-serif prose-headings:text-[#F6F4EF] prose-p:text-[#D0CCC4] prose-strong:text-[#F6F4EF] prose-li:text-[#D0CCC4] prose-a:text-[#D4A94E] max-w-none">
                                ...
                                <table className="w-full text-left border-collapse bg-[#161828] rounded-xl border border-[#2A2D42] shadow-sm">
                                    <thead className="bg-[#0C0D18]">
                                        <tr>
                                            ...
                                            <th className="p-4 border-b border-[#2A2D42] font-bold text-[#F6F4EF]">Central Bank Gold Purchases</th>
                                            <th className="p-4 border-b border-[#2A2D42] font-bold text-[#F6F4EF]">Notable Buyers</th>
                                        </tr>
                                    </thead>
                                    <tbody className="divide-y divide-[#2A2D42] text-sm text-[#D0CCC4]">
                                        <tr>
                                            <td className="p-4 text-[#F6F4EF]">2022</td>
                                            <td className="p-4 font-semibold text-[#D4A94E]">1,136 tonnes</td>
                                            <td className="p-4">Turkey, China, Egypt, Qatar</td>
                                        </tr>
                                        <tr>
                                            <td className="p-4 text-[#F6F4EF]">2023</td>
                                            <td className="p-4 font-semibold text-[#D4A94E]">1,037 tonnes</td>
                                            <td className="p-4">China, Poland, Singapore, Libya</td>
                                        </tr>
                                        <tr>
                                            <td className="p-4 text-[#F6F4EF]">2024</td>
                                            <td className="p-4 font-semibold text-[#D4A94E]">1,100+ tonnes (est.)</td>
                            ...
                            <div className="grid gap-4 not-prose my-8">
                                <div className="bg-[#161828] rounded-xl border border-[#2A2D42] p-6 shadow-sm">
                                    <h4 className="font-bold text-[#F6F4EF] text-lg mb-2">China</h4>
                                    <p className="text-[#A8A39A] text-sm mb-2">They say 2,200+ tonnes. Probably 3-4x more.</p>
                                    <p className="text-[#D0CCC4]">China produces more gold than anyone. And they&apos;re still buying more on top of that. They&apos;re not doing this for fun.</p>
                                </div>
                                <div className="bg-[#161828] rounded-xl border border-[#2A2D42] p-6 shadow-sm">
                                    <h4 className="font-bold text-[#F6F4EF] text-lg mb-2">Poland</h4>
                                    <p className="text-[#A8A39A] text-sm mb-2">130+ tonnes in 2023 alone</p>
                                    <p className="text-[#D0CCC4]">Poland shares a border with Ukraine. Their central bank said openly: &quot;uncertain geopolitical environment.&quot; They&apos;re not kidding around.</p>
                                </div>
                                <div className="bg-[#161828] rounded-xl border border-[#2A2D42] p-6 shadow-sm">
                                    <h4 className="font-bold text-[#F6F4EF] text-lg mb-2">Turkey</h4>
                                    <p className="text-[#A8A39A] text-sm mb-2">Massive buyer 2022-2023</p>
                                    <p className="text-[#D0CCC4]">Turkey&apos;s currency lost 80% of its value in 5 years. Their central bank watched their people&apos;s savings evaporate. Now they&apos;re buying gold like their lives depend on it.</p>
                                </div>
                                <div className="bg-[#161828] rounded-xl border border-[#2A2D42] p-6 shadow-sm">
                                    <h4 className="font-bold text-[#F6F4EF] text-lg mb-2">India</h4>
                                    <p className="text-[#A8A39A] text-sm mb-2">Steady buyer since 2017</p>
                                    <p className="text-[#D0CCC4]">India&apos;s people have trusted gold for generations. Their central bank is following the people&apos;s wisdom.</p>
                                </div>
                            </div>
                            ...
                            <div className="my-12 bg-[#0C0D18] rounded-2xl p-8 text-center relative overflow-hidden not-prose border border-[#2A2D42]">
                                <div className="relative z-10">
                                    <h3 className="text-2xl font-serif font-bold mb-4 text-[#F6F4EF]">Do What the Central Banks Do</h3>
                                    <p className="mb-6 text-[#D0CCC4]">Move some of your paper savings into physical gold - the same thing central banks are doing.</p>
                            ...
                            <div className="flex items-center gap-4 mb-4 mt-12 not-prose">
                                ...
                                <h2 className="text-2xl md:text-3xl font-serif font-bold text-[#F6F4EF] m-0">The Simple Truth</h2>
                            </div>
