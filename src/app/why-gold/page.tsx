        ...
        <Container>
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-slate-600 leading-relaxed mb-8">
              ...
              That&apos;s the difference between hoping the market recovers and <strong className="text-[#000080]">actually protecting</strong> what you&apos;ve built.
            </p>
            <div className="grid md:grid-cols-3 gap-6">
              <div className="bg-white rounded-xl p-6 border border-slate-200 shadow-sm">
                <div className="text-4xl font-bold text-red-600 mb-2">-37%</div>
                <div className="text-slate-600">S&P 500 in 2008 (many lost more)</div>
              </div>
              <div className="bg-white rounded-xl p-6 border border-slate-200 shadow-sm">
                <div className="text-4xl font-bold text-green-600 mb-2">+5.5%</div>
                <div className="text-slate-600">Gold in 2008 (held its ground)</div>
              </div>
              <div className="bg-white rounded-xl p-6 border border-slate-200 shadow-sm">
                <div className="text-4xl font-bold text-[#B22234] mb-2">$35T+</div>
                <div className="text-slate-600">US debt (they&apos;re printing money)</div>
              </div>
            </div>
          </div>
        </Container>
              ...
              <div className="flex gap-6">
                ...
                <div className="flex-1">
                  ...
                  <Link
                    ...
                    className="inline-flex items-center gap-2 text-[#B22234] font-semibold hover:text-[#8B0000]"
                  >
        ...
        <Container>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-white rounded-xl p-6 border border-slate-200 shadow-sm">
                <h3 className="font-bold text-[#000080] mb-4">2008 Financial Crisis</h3>
                <div className="space-y-3">
                  <div className="flex justify-between items-center">
                    <span className="text-slate-600">All stocks</span>
                    <span className="text-red-600 font-bold">Lost $185,000</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-slate-600">80% stocks / 20% gold</span>
                    <span className="text-[#B22234] font-bold">Lost $142,000</span>
                  </div>
                  <p className="text-xs text-slate-500 pt-2">Gold helped save $43,000 in losses</p>
                </div>
              </div>
              <div className="bg-white rounded-xl p-6 border border-slate-200 shadow-sm">
                <h3 className="font-bold text-[#000080] mb-4">2020 COVID Crash</h3>
                <div className="space-y-3">
                  <div className="flex justify-between items-center">
                    <span className="text-slate-600">All stocks (March)</span>
                    <span className="text-red-600 font-bold">Lost $170,000</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-slate-600">80% stocks / 20% gold</span>
                    <span className="text-[#B22234] font-bold">Lost $111,000</span>
                  </div>
                  <p className="text-xs text-slate-500 pt-2">Gold helped save $59,000 in losses</p>
                </div>
              </div>
              <div className="bg-white rounded-xl p-6 border border-slate-200 shadow-sm">
                <h3 className="font-bold text-[#000080] mb-4">2000-2002 Dot-Com Crash</h3>
                <div className="space-y-3">
                  <div className="flex justify-between items-center">
                    <span className="text-slate-600">All stocks (NASDAQ)</span>
                    <span className="text-red-600 font-bold">Lost $390,000</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-slate-600">With gold allocation</span>
                    <span className="text-green-600 font-bold">Gold up 12%</span>
                  </div>
                  <p className="text-xs text-slate-500 pt-2">Many tech-heavy 401ks were devastated</p>
                </div>
              </div>
              <div className="bg-white rounded-xl p-6 border border-slate-200 shadow-sm">
                <h3 className="font-bold text-[#000080] mb-4">The Pattern Is Clear</h3>
        ...
        <Container>
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            <Link
              ...
              className="group block bg-white rounded-xl border border-slate-200 p-6 hover:border-[#B22234] hover:shadow-md transition-all"
            >
              <h3 className="font-bold text-[#000080] group-hover:text-[#B22234] transition-colors mb-2">
                What Is a Gold IRA?
              </h3>
            ...
            >
              ...
              <p className="text-sm text-slate-600 mb-4">
                Explore our guide to <Link href="/gold-stocks/" className="text-[#B22234] hover:underline">comparing gold investment options</Link>.
              </p>
              <span className="text-[#B22234] text-sm font-semibold flex items-center gap-1">
                Read More
                <ArrowRight className="h-4 w-4 group-hover:translate-x-1 transition-transform" />
