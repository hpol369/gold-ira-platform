...
export default function WhyGoldPage() {
  return (
    <main className="min-h-screen flex flex-col bg-white">
      ...
      {/* The Big Picture */}
      <section className="py-16 bg-[#0C0D18] border-b border-[#2A2D42]">
        <Container>
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-[#D0CCC4] leading-relaxed mb-8">
              ...
              That&apos;s the difference between hoping the market recovers and <strong className="text-[#F6F4EF]">actually protecting</strong> what you&apos;ve built.
            </p>
            <div className="grid md:grid-cols-3 gap-6">
              <div className="bg-[#161828] rounded-xl p-6 border border-[#2A2D42] shadow-sm">
                ...
                <div className="text-[#D0CCC4]">S&P 500 in 2008 (many lost more)</div>
              </div>
              <div className="bg-[#161828] rounded-xl p-6 border border-[#2A2D42] shadow-sm">
                <div className="text-4xl font-bold text-green-600 mb-2">+5.5%</div>
                <div className="text-[#D0CCC4]">Gold in 2008 (held its ground)</div>
              </div>
              <div className="bg-[#161828] rounded-xl p-6 border border-[#2A2D42] shadow-sm">
                <div className="text-4xl font-bold text-[#D4A94E] mb-2">$35T+</div>
                <div className="text-[#D0CCC4]">US debt (they&apos;re printing money)</div>
              </div>
            </div>
          </div>
        </Container>
            ...
            <div className="space-y-8">
              ...
              <div className="flex gap-6">
                ...
                <div className="flex-1">
                  <h3 className="text-xl font-bold text-[#F6F4EF] mb-3">
                  ...
                  <Link
                    ...
                    className="inline-flex items-center gap-2 text-[#D4A94E] font-semibold hover:text-[#8B0000]"
                  >
        ...
        <Container>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-[#161828] rounded-xl p-6 border border-[#2A2D42] shadow-sm">
                <h3 className="font-bold text-[#F6F4EF] mb-4">2008 Financial Crisis</h3>
                <div className="space-y-3">
                  <div className="flex justify-between items-center">
                    <span className="text-[#D0CCC4]">All stocks</span>
                    <span className="text-red-600 font-bold">Lost $185,000</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-[#D0CCC4]">80% stocks / 20% gold</span>
                    <span className="text-[#D4A94E] font-bold">Lost $142,000</span>
                  </div>
                  <p className="text-xs text-[#A8A39A] pt-2">Gold helped save $43,000 in losses</p>
                </div>
              </div>
              <div className="bg-[#161828] rounded-xl p-6 border border-[#2A2D42] shadow-sm">
                <h3 className="font-bold text-[#F6F4EF] mb-4">2020 COVID Crash</h3>
                <div className="space-y-3">
                  <div className="flex justify-between items-center">
                    <span className="text-[#D0CCC4]">All stocks (March)</span>
                    <span className="text-red-600 font-bold">Lost $170,000</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-[#D0CCC4]">80% stocks / 20% gold</span>
                    <span className="text-[#D4A94E] font-bold">Lost $111,000</span>
                  </div>
                  <p className="text-xs text-[#A8A39A] pt-2">Gold helped save $59,000 in losses</p>
                </div>
              </div>
              <div className="bg-[#161828] rounded-xl p-6 border border-[#2A2D42] shadow-sm">
                <h3 className="font-bold text-[#F6F4EF] mb-4">2000-2002 Dot-Com Crash</h3>
                <div className="space-y-3">
                  <div className="flex justify-between items-center">
                    <span className="text-[#D0CCC4]">All stocks (NASDAQ)</span>
                    <span className="text-red-600 font-bold">Lost $390,000</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-[#D0CCC4]">With gold allocation</span>
                    <span className="text-green-600 font-bold">Gold up 12%</span>
                  </div>
                  <p className="text-xs text-[#A8A39A] pt-2">Many tech-heavy 401ks were devastated</p>
                </div>
              </div>
              <div className="bg-[#161828] rounded-xl p-6 border border-[#2A2D42] shadow-sm">
                <h3 className="font-bold text-[#F6F4EF] mb-4">The Pattern Is Clear</h3>
                <div className="space-y-3 text-[#D0CCC4] text-sm">
      ...
      <section className="py-16 bg-[#0C0D18] text-[#F6F4EF]">
        <Container>
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg text-[#A8A39A] mb-6">
            ...
            <p className="text-[#D4A94E] font-semibold">
        ...
        <Container>
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            <Link
              ...
              className="group block bg-[#161828] rounded-xl border border-[#2A2D42] p-6 hover:border-[#B22234] hover:shadow-md transition-all"
            >
            ...
            >
              ...
              <p className="text-sm text-[#D0CCC4] mb-4">
                Explore our guide to <Link href="/gold-stocks/" className="text-[#D4A94E] hover:underline">comparing gold investment options</Link>.
              </p>
              <span className="text-[#D4A94E] text-sm font-semibold flex items-center gap-1">
                Read More
                <ArrowRight className="h-4 w-4 group-hover:translate-x-1 transition-transform" />
