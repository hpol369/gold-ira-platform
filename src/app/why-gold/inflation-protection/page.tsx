          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-12">
              <div className="bg-white rounded-xl p-6 border border-slate-200 shadow-sm">
                <h3 className="font-bold text-[#000080] mb-4 flex items-center gap-2">
              ...
              <div className="bg-white rounded-xl p-6 border border-slate-200 shadow-sm">
                ...
                <p className="text-xs text-slate-500 mt-4">This isn&apos;t news to you. You live it every day.</p>
              </div>
            </div>
          </div>
        </Container>
            ...
            <div className="space-y-8">
              ...
              <div className="bg-amber-50 rounded-xl p-8 border border-amber-200">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    <h4 className="font-semibold text-slate-700 mb-2">1920</h4>
                    <p className="text-slate-600">
                      One ounce of gold ($20) bought a quality suit for a working man.
                    </p>
                  </div>
                  <div>
                    <h4 className="font-semibold text-slate-700 mb-2">Today</h4>
                    <p className="text-slate-600">
                      One ounce of gold (~$2,000) still buys that same quality suit.
                    </p>
                  </div>
                </div>
                <p className="mt-4 text-sm text-[#B22234]">
              ...
              <div className="bg-white rounded-xl p-8 border border-slate-200 shadow-sm">
                ...
                <div className="space-y-6">
                  <div className="grid md:grid-cols-3 gap-4 pb-4 border-b border-slate-200">
                    <div>
                      <h4 className="font-semibold text-[#000080]">1970s - Your Parents Remember</h4>
                      <p className="text-sm text-slate-500">Gas lines, interest rates at 18%</p>
                    </div>
                    <div>
                      <div className="text-sm text-slate-500">Inflation</div>
                      <div className="text-lg font-bold text-red-600">7.4%/year for a decade</div>
                    </div>
                    <div>
                      <div className="text-sm text-slate-500">Gold</div>
                      <div className="text-lg font-bold text-green-600">Up 1,335%</div>
                    </div>
                  </div>
                  <div className="grid md:grid-cols-3 gap-4 pb-4 border-b border-slate-200">
                    <div>
                      <h4 className="font-semibold text-[#000080]">2008-2012 - You Remember This</h4>
                      <p className="text-sm text-slate-500">Bailouts, money printing</p>
                    </div>
                    <div>
                      <div className="text-sm text-slate-500">Fed printed</div>
                  ...
                  <div className="grid md:grid-cols-3 gap-4">
                    <div>
                      <h4 className="font-semibold text-[#000080]">2020-2024 - Right Now</h4>
                      <p className="text-sm text-slate-500">COVID, stimulus checks</p>
                    </div>
                    <div>
                      <div className="text-sm text-slate-500">Prices up</div>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-white rounded-xl p-6 border border-slate-200 shadow-sm">
                <div className="w-12 h-12 rounded-xl bg-amber-100 flex items-center justify-center mb-4">
                  <BarChart3 className="h-6 w-6 text-[#B22234]" />
                </div>
                <h3 className="font-bold text-[#000080] mb-2">They Can&apos;t Print More Gold</h3>
              ...
              <div className="bg-white rounded-xl p-6 border border-slate-200 shadow-sm">
                ...
                <h3 className="font-bold text-[#000080] mb-2">5,000 Years of Proof</h3>
                <p className="text-sm text-slate-600">
              ...
              <div className="bg-white rounded-xl p-6 border border-slate-200 shadow-sm">
                ...
                <h3 className="font-bold text-[#000080] mb-2">When Dollars Fall, Gold Rises</h3>
                <p className="text-sm text-slate-600">
              ...
              <div className="bg-white rounded-xl p-6 border border-slate-200 shadow-sm">
                ...
                <h3 className="font-bold text-[#000080] mb-2">It&apos;s Real, Not a Promise</h3>
                <p className="text-sm text-slate-600">
          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                ...
                className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-white text-[#000080] font-bold rounded-xl hover:bg-slate-50 transition-all border border-slate-200"
              >
                How Gold IRAs Work
              </Link>
              <Link
