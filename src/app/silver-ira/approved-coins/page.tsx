    ...
    return (
        <main className="min-h-screen bg-white">
                ...
                <Container>
                    <div className="max-w-4xl mx-auto">
                        <div className="bg-white rounded-2xl p-8 border border-slate-200 text-center">
                            <div className="w-20 h-20 bg-[#B22234]/20 rounded-full flex items-center justify-center mx-auto mb-6">
                                <span className="text-3xl font-bold text-[#B22234]">.999</span>
                            </div>
                            <h2 className="text-2xl font-bold text-slate-900 mb-4">Minimum Purity Requirement</h2>
                            <p className="text-slate-600 max-w-2xl mx-auto">
                                The IRS requires all silver in an IRA to be at least <strong className="text-slate-900">.999 fine (99.9% pure)</strong>.
            ...
            <section className="py-16 bg-white">
                <Container>
                    <div className="max-w-5xl mx-auto">
                        <h2 className="text-3xl font-bold text-slate-900 text-center mb-4">IRA-Approved Silver Coins</h2>
                        ...
                        <div className="grid md:grid-cols-2 gap-6">
                            {approvedCoins.map((coin, index) => (
                                <div
                                    key={index}
                                    className={`rounded-xl p-6 border ${coin.featured ? 'bg-[#B22234]/10 border-[#B22234]/30' : 'bg-slate-50 border-slate-200'}`}
                                >
                                    <div className="flex items-start justify-between mb-4">
                                        ...
                                        {coin.featured && (
                                            <span className="px-2 py-1 bg-[#B22234]/20 text-[#B22234] text-xs font-bold rounded">
                                                POPULAR
                                            </span>
                                        )}
                                    </div>
                                    <p className="text-slate-600 text-sm mb-4">{coin.description}</p>

                                    <div className="grid grid-cols-2 gap-4 mb-4">
                                        <div className="bg-slate-50 rounded-lg p-3">
                                            <div className="text-xs text-slate-600 mb-1">Purity</div>
                                            <div className="font-semibold text-slate-900">{coin.purity}</div>
                                        </div>
                                        <div className="bg-slate-50 rounded-lg p-3">
                                            <div className="text-xs text-slate-600 mb-1">Premium</div>
                                            <div className="font-semibold text-slate-900">{coin.premium}</div>
                                        </div>
                                    </div>
            ...
            <section className="py-16 bg-slate-50">
                <Container>
                    <div className="max-w-5xl mx-auto">
                        <h2 className="text-3xl font-bold text-slate-900 text-center mb-4">IRA-Approved Silver Bars</h2>
                        <p className="text-slate-600 text-center mb-12 max-w-2xl mx-auto">
                                ...
                                <div key={index} className="bg-slate-50 border border-slate-200 rounded-xl p-6">
                                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                                        <div className="flex-1">
                                            <h3 className="text-lg font-bold text-slate-900 mb-1">{bar.name}</h3>
                                            <p className="text-sm text-slate-600 mb-2">{bar.description}</p>
                                        ...
                                        <div className="flex flex-wrap gap-2">
                                            {bar.sizes.map((size, idx) => (
                                                <span key={idx} className="px-3 py-1 bg-[#B22234]/20 text-[#B22234] text-sm font-semibold rounded">
                                                    {size}
                                                </span>
                                            ))}
                                        </div>
            ...
            <section className="py-16 bg-white">
                <Container>
                    <div className="max-w-4xl mx-auto">
                        <h2 className="text-3xl font-bold text-slate-900 text-center mb-4">Silver NOT Allowed in IRAs</h2>
                        <p className="text-slate-600 text-center mb-12 max-w-2xl mx-auto">
            ...
            <section className="py-16 bg-slate-50">
                <Container>
                    <div className="max-w-4xl mx-auto">
                        <h2 className="text-3xl font-bold text-slate-900 text-center mb-4">How to Choose the Right Silver</h2>
                        <p className="text-slate-600 text-center mb-12 max-w-2xl mx-auto">
                                    ...
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div>
                                            <div className="flex items-center gap-3 mb-2">
                                                ...
                                                <h3 className="font-bold text-slate-900">{item.priority}</h3>
                                            </div>
                                            <p className="text-slate-600 mb-1">
                                                <strong className="text-[#B22234]">Recommended:</strong> {item.recommendation}
                                            </p>
            ...
            <section className="py-16 bg-white">
                <Container>
                    <div className="max-w-3xl mx-auto text-center bg-white rounded-2xl p-8 border border-slate-200">
                        <h2 className="text-2xl font-bold text-slate-900 mb-4">Ready to Add Silver to Your IRA?</h2>
            ...
            <section className="py-16 bg-slate-50">
                <Container>
                    <div className="max-w-3xl mx-auto">
                        <h2 className="text-3xl font-bold text-slate-900 text-center mb-8">IRA Approved Silver FAQs</h2>
                        <div className="space-y-4">
                            {faqs.map((faq, index) => (
                                <details
                                    key={index}
                ...
                <Container>
                    ...
                    <div className="grid md:grid-cols-3 gap-6">
                        <Link href="/silver-ira/rules" className="group bg-slate-50 border border-slate-200 rounded-xl p-6 hover:bg-slate-100 transition-colors">
                            ...
                            <p className="text-sm text-slate-600">Full IRS requirements for Silver IRAs.</p>
                        </Link>
                        ...
                        <Link href="/silver-ira/vs-gold-ira" className="group bg-slate-50 border border-slate-200 rounded-xl p-6 hover:bg-slate-100 transition-colors">
                            <h3 className="font-bold text-slate-900 mb-2 group-hover:text-[#B22234] transition-colors">Silver IRA vs Gold IRA</h3>
                            <p className="text-sm text-slate-600">Compare the two metals for your IRA.</p>
                        </Link>
                    </div>
                </Container>
            </section>
