    ...
    return (
        <main className="min-h-screen bg-[#0C0D18]">
            ...
            <section className="py-16 bg-[#0C0D18]">
                <Container>
                    <div className="max-w-4xl mx-auto">
                        <div className="bg-[#161828] rounded-2xl p-8 border border-[#2A2D42] text-center">
                            <div className="w-20 h-20 bg-[rgba(220,38,38,0.18)] rounded-full flex items-center justify-center mx-auto mb-6">
                                <span className="text-3xl font-bold text-[#D4A94E]">.999</span>
                            </div>
                            <h2 className="text-2xl font-bold text-[#F6F4EF] mb-4">Minimum Purity Requirement</h2>
                            <p className="text-[#D0CCC4] max-w-2xl mx-auto">
                                The IRS requires all silver in an IRA to be at least <strong className="text-[#F6F4EF]">.999 fine (99.9% pure)</strong>.
                            ...
                            {approvedCoins.map((coin, index) => (
                                ...
                                >
                                    <div className="flex items-start justify-between mb-4">
                                        <div>
                                            <h3 className="text-xl font-bold text-[#F6F4EF]">{coin.name}</h3>
                                            <p className="text-sm text-[#D0CCC4] flex items-center gap-2">
                                                <Globe className="h-4 w-4" /> {coin.country}
                                            </p>
                                        </div>
                                        {coin.featured && (
                                            <span className="px-2 py-1 bg-[rgba(220,38,38,0.18)] text-[#D4A94E] text-xs font-bold rounded">
                                                POPULAR
                                            </span>
                                        )}
                                    </div>
                                    <p className="text-[#D0CCC4] text-sm mb-4">{coin.description}</p>

                                    <div className="grid grid-cols-2 gap-4 mb-4">
                                        <div className="bg-[#0C0D18] rounded-lg p-3">
                                            <div className="text-xs text-[#D0CCC4] mb-1">Purity</div>
                                            <div className="font-semibold text-[#F6F4EF]">{coin.purity}</div>
                                        </div>
                                        <div className="bg-[#0C0D18] rounded-lg p-3">
                                            <div className="text-xs text-[#D0CCC4] mb-1">Premium</div>
                                            <div className="font-semibold text-[#F6F4EF]">{coin.premium}</div>
                                        </div>
                                    </div>

                                    <div className="space-y-1">
                                        {coin.pros.map((pro, idx) => (
                                            <div key={idx} className="flex items-center gap-2 text-sm text-[#D0CCC4]">
            ...
            <section className="py-16 bg-[#0C0D18]">
                <Container>
                    <div className="max-w-5xl mx-auto">
                        <h2 className="text-3xl font-bold text-[#F6F4EF] text-center mb-4">IRA-Approved Silver Bars</h2>
                        <p className="text-[#D0CCC4] text-center mb-12 max-w-2xl mx-auto">
                                ...
                                <div key={index} className="bg-[#0C0D18] border border-[#2A2D42] rounded-xl p-6">
                                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                                        <div className="flex-1">
                                            <h3 className="text-lg font-bold text-[#F6F4EF] mb-1">{bar.name}</h3>
                                            <p className="text-sm text-[#D0CCC4] mb-2">{bar.description}</p>
                                        ...
                                        <div className="flex flex-wrap gap-2">
                                            {bar.sizes.map((size, idx) => (
                                                <span key={idx} className="px-3 py-1 bg-[rgba(220,38,38,0.18)] text-[#D4A94E] text-sm font-semibold rounded">
                                                    {size}
                                                </span>
                                            ))}
                                        </div>
                                ...
                                <div key={index} className="bg-[rgba(220,38,38,0.08)]0/10 border border-red-500/30 rounded-xl p-4">
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-[#D0CCC4]">{item.reason}</p>
                                        </div>
                                    </div>
                                </div>
                            ))}
            ...
            <section className="py-16 bg-[#0C0D18]">
                <Container>
                    <div className="max-w-4xl mx-auto">
                        <h2 className="text-3xl font-bold text-[#F6F4EF] text-center mb-4">How to Choose the Right Silver</h2>
                        <p className="text-[#D0CCC4] text-center mb-12 max-w-2xl mx-auto">
                                    ...
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div>
                                            <div className="flex items-center gap-3 mb-2">
                                                <span className="px-2 py-1 bg-[#121423] text-[#D0CCC4] text-xs font-bold rounded">
                                                    IF YOUR PRIORITY IS
                                                </span>
                                                <h3 className="font-bold text-[#F6F4EF]">{item.priority}</h3>
                                            </div>
                                            <p className="text-[#D0CCC4] mb-1">
                                                <strong className="text-[#D4A94E]">Recommended:</strong> {item.recommendation}
                                            </p>
            ...
            <section className="py-16 bg-[#0C0D18]">
                <Container>
                    <div className="max-w-3xl mx-auto">
                        <h2 className="text-3xl font-bold text-[#F6F4EF] text-center mb-8">IRA Approved Silver FAQs</h2>
                        <div className="space-y-4">
                            {faqs.map((faq, index) => (
                                <details
                                    key={index}
                ...
                <Container>
                    ...
                    <div className="grid md:grid-cols-3 gap-6">
                        <Link href="/silver-ira/rules" className="group bg-[#0C0D18] border border-[#2A2D42] rounded-xl p-6 hover:bg-[#1E2134] transition-colors">
                            ...
                            <p className="text-sm text-[#D0CCC4]">Full IRS requirements for Silver IRAs.</p>
                        </Link>
                        ...
                        <Link href="/silver-ira/vs-gold-ira" className="group bg-[#0C0D18] border border-[#2A2D42] rounded-xl p-6 hover:bg-[#1E2134] transition-colors">
                            <h3 className="font-bold text-[#F6F4EF] mb-2 group-hover:text-[#D4A94E] transition-colors">Silver IRA vs Gold IRA</h3>
                            <p className="text-sm text-[#D0CCC4]">Compare the two metals for your IRA.</p>
                        </Link>
                    </div>
                </Container>
            </section>
