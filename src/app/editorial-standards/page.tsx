      ...
      <Container className="py-12">
        <div className="max-w-3xl prose prose-lg prose-headings:font-serif prose-headings:text-[#F6F4EF] prose-p:text-[#D0CCC4] prose-li:text-[#D0CCC4] prose-strong:text-[#F6F4EF]">
          ...
          <div className="not-prose flex items-center gap-3 mb-4">
            <FileText className="h-6 w-6 text-[#D4A94E]" />
            <h2 className="text-2xl font-serif font-bold text-[#F6F4EF] m-0">How We Research</h2>
          </div>
          <p>
          ...
          <div className="not-prose flex items-center gap-3 mb-4 mt-12">
            <Users className="h-6 w-6 text-[#D4A94E]" />
            <h2 className="text-2xl font-serif font-bold text-[#F6F4EF] m-0">How We Write</h2>
          </div>
          <p>
          ...
          {/* How We Fact-Check */}
          <div className="not-prose flex items-center gap-3 mb-4 mt-12">
            <ShieldCheck className="h-6 w-6 text-[#D4A94E]" />
            <h2 className="text-2xl font-serif font-bold text-[#F6F4EF] m-0">How We Fact-Check</h2>
          </div>
          <p>
          ...
          <div className="not-prose flex items-center gap-3 mb-4 mt-12">
            ...
            <h2 className="text-2xl font-serif font-bold text-[#F6F4EF] m-0">How We Update Content</h2>
          </div>
          ...
          <div className="not-prose flex items-center gap-3 mb-4 mt-12">
            ...
            <h2 className="text-2xl font-serif font-bold text-[#F6F4EF] m-0">Affiliate Disclosure</h2>
          </div>
          <p>
          ...
          <div className="not-prose flex items-center gap-3 mb-4 mt-12">
            <Users className="h-6 w-6 text-[#D4A94E]" />
            <h2 className="text-2xl font-serif font-bold text-[#F6F4EF] m-0">Author Qualifications</h2>
          </div>
          <p>
