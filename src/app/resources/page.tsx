...
export default function ResourcesPage() {
    return (
        <main className="min-h-screen bg-[#0C0D18] pb-24">
                    ...
                    <div className="max-w-5xl mx-auto">
                        <FadeIn>
                            <div className="text-center mb-12">
                                <span className="text-[#D4A94E] font-bold tracking-widest uppercase text-xs">Start Here</span>
                                <h2 className="text-3xl font-serif font-bold text-[#F6F4EF] mt-3">In-Depth Guides</h2>
                                <p className="text-[#A8A39A] mt-4 max-w-2xl mx-auto">
                        ...
                        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {guides.map((guide, index) => (
                                <FadeIn key={guide.href} delay={0.1 * (index + 1)}>
                                    <Link
                                        href={guide.href}
                                        className="group bg-[#0C0D18] border border-[#2A2D42] rounded-xl p-6 h-full flex flex-col hover:border-[rgba(197,149,46,0.45)] hover:shadow-md transition-all"
                                    >
                                        {guide.tag && (
                                            <span className="inline-block bg-[rgba(220,38,38,0.1)] text-[#D4A94E] text-xs font-bold px-3 py-1 rounded-full mb-4 self-start">
                                                {guide.tag}
                                            </span>
                                        )}
                                        <div className="h-10 w-10 bg-[#121423] text-[#F6F4EF] rounded-lg flex items-center justify-center mb-4">
                                            <guide.icon className="h-5 w-5" />
                                        </div>
                                        <h3 className="text-lg font-bold font-serif text-[#F6F4EF] mb-2 group-hover:text-[#D4A94E] transition-colors">
                                            {guide.title}
                                        </h3>
                                        <p className="text-sm text-[#A8A39A] leading-relaxed flex-grow">
                                            {guide.description}
                                        </p>
                                        <div className="mt-4 text-[#D4A94E] text-sm font-semibold flex items-center gap-1 group-hover:gap-2 transition-all">
            ...
            {/* Learn Articles */}
            <section className="py-20 bg-[#0C0D18] border-y border-[#2A2D42]">
                <Container>
                    <div className="max-w-5xl mx-auto">
                        <FadeIn>
                            <div className="text-center mb-12">
                                <span className="text-[#D4A94E] font-bold tracking-widest uppercase text-xs">Learn</span>
                                <h2 className="text-3xl font-serif font-bold text-[#F6F4EF] mt-3">Educational Articles</h2>
                                <p className="text-[#A8A39A] mt-4">
                        ...
                        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
                            {learnArticles.map((article, index) => (
                                <FadeIn key={article.href} delay={0.05 * (index + 1)}>
                                    <Link
                                        href={article.href}
                                        className="group bg-[#161828] border border-[#2A2D42] rounded-lg p-5 hover:border-[rgba(197,149,46,0.45)] hover:shadow-sm transition-all"
                                    >
                                        <h3 className="font-bold text-[#F6F4EF] mb-1 group-hover:text-[#D4A94E] transition-colors">
                                            {article.title}
                                        </h3>
            ...
            <section className="py-20">
                <Container>
                    <div className="max-w-4xl mx-auto">
                        <FadeIn>
                            <div className="text-center mb-12">
                                <span className="text-[#D4A94E] font-bold tracking-widest uppercase text-xs">Compare</span>
                                <h2 className="text-3xl font-serif font-bold text-[#F6F4EF] mt-3">Side-by-Side Comparisons</h2>
                                <p className="text-[#A8A39A] mt-4">
                        ...
                        <FadeIn delay={0.1}>
                            <div className="bg-[#0C0D18] border border-[#2A2D42] rounded-2xl p-6 md:p-8">
                                <div className="flex items-center gap-3 mb-6">
                                    <div className="h-10 w-10 bg-[rgba(220,38,38,0.1)] text-[#D4A94E] rounded-full flex items-center justify-center">
                                        <Scale className="h-5 w-5" />
                                    </div>
                                    <h3 className="text-xl font-bold font-serif text-[#F6F4EF]">Investment Comparisons</h3>
                                </div>
                                <div className="grid sm:grid-cols-2 gap-3">
                                    {comparisons.map((comparison) => (
                                        <Link
                                            ...
                                            className="flex items-center gap-3 p-4 rounded-lg hover:bg-[#1E2134] transition-colors group"
                                        >
                                            <CheckCircle className="h-5 w-5 text-[#D4A94E] flex-shrink-0" />
                                            <span className="text-[#A8A39A] group-hover:text-[#F6F4EF] transition-colors">
                                                {comparison.title}
                                            </span>
                                        </Link>
                                    ))}
                                ...
                                <div className="grid sm:grid-cols-2 gap-3">
                                    {companyComparisons.map((comparison) => (
                                        <Link
                                            ...
                                            className="flex items-center gap-3 p-4 rounded-lg hover:bg-[#1E2134] transition-colors group"
                                        >
                                            <CheckCircle className="h-5 w-5 text-[#F6F4EF] flex-shrink-0" />
                                            <span className="text-[#A8A39A] group-hover:text-[#F6F4EF] transition-colors">
                                                {comparison.title}
                                            </span>
                                        </Link>
            ...
            <section className="py-16">
                <Container>
                    <FadeIn>
                        <div className="bg-[#0C0D18] rounded-3xl p-10 md:p-12 text-center relative overflow-hidden max-w-4xl mx-auto border border-[#2A2D42]">
                            ...
                            <div className="relative z-10 space-y-6">
                                <h2 className="text-2xl md:text-3xl font-serif font-bold text-[#F6F4EF]">Ready to Compare Companies?</h2>
                                <p className="text-[#D0CCC4] max-w-xl mx-auto">
            ...
            <section className="py-16">
                <Container>
                    <div className="max-w-4xl mx-auto">
                        <FadeIn>
                            <h2 className="text-2xl font-serif font-bold text-[#F6F4EF] mb-6 text-center">
                            ...
                            <div className="grid sm:grid-cols-2 gap-4">
                                <a
                                    ...
                                    className="flex items-center justify-between p-5 bg-[#0C0D18] border border-[#2A2D42] rounded-xl hover:border-[rgba(197,149,46,0.45)] transition-colors group"
                                >
                                    <div>
                                        <h3 className="font-bold text-[#F6F4EF] group-hover:text-[#D4A94E] transition-colors">IRS Publication 590-A</h3>
                                        <p className="text-sm text-[#A8A39A]">Contributions to IRAs</p>
                                    </div>
                                    <ExternalLink className="h-5 w-5 text-[#A8A39A] group-hover:text-[#D4A94E] transition-colors" />
                                </a>
                                <a
                                ...
                                >
                                    <div>
                                        <h3 className="font-bold text-[#F6F4EF] group-hover:text-[#D4A94E] transition-colors">IRS Publication 590-B</h3>
                                        <p className="text-sm text-[#A8A39A]">Distributions from IRAs</p>
                                    </div>
                                    <ExternalLink className="h-5 w-5 text-[#A8A39A] group-hover:text-[#D4A94E] transition-colors" />
                                </a>
                            </div>
