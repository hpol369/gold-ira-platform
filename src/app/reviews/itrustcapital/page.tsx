...
export default function ITrustCapitalReviewPage() {
    ...
    return (
        <main className="min-h-screen flex flex-col bg-white">
                    ...
                    <div className="grid lg:grid-cols-3 gap-12">
                        ...
                        <article className="lg:col-span-2">
                            ...
                            <div className="bg-[#0C0D18] rounded-xl border border-[#2A2D42] p-6 mb-8">
                                <h2 className="text-xl font-serif font-bold text-[#F6F4EF] mb-4">iTrustCapital at a Glance</h2>
                                <div className="grid sm:grid-cols-2 gap-4">
                                    ...
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            <p className="text-[#A8A39A] text-sm">Minimum Investment</p>
                                    ...
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            <p className="text-[#A8A39A] text-sm">Trading Fee</p>
                                            <p className="text-[#F6F4EF] font-medium">{companyData.tradingFee}</p>
                                        </div>
                                    </div>
                                    <div className="flex items-center gap-3">
                                    ...
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            <p className="text-[#A8A39A] text-sm">Assets</p>
                                            <p className="text-[#F6F4EF] font-medium">{companyData.supportedAssets}</p>
                                        </div>
                                    </div>
                                    <div className="flex items-center gap-3">
                            ...
                            {/* Article Content */}
                            <div className="prose prose-lg max-w-none text-[#D0CCC4] prose-headings:text-[#F6F4EF] prose-strong:text-[#F6F4EF] prose-a:text-blue-600 hover:prose-a:text-blue-700">
                                ...
                                <div className="bg-[#0C0D18] border border-[#2A2D42] rounded-xl overflow-hidden not-prose my-8">
                                    <table className="w-full text-sm">
                                        <thead className="bg-[#121423]">
                                            <tr>
                                                <th className="text-left p-4 text-[#F6F4EF] font-semibold">Fee Type</th>
                                                <th className="text-left p-4 text-[#F6F4EF] font-semibold">iTrustCapital</th>
                                                <th className="text-left p-4 text-[#F6F4EF] font-semibold">Industry Average</th>
                                            </tr>
                                        </thead>
                                        <tbody className="divide-y divide-[#2A2D42]">
                                            <tr>
                                                <td className="p-4 text-[#D0CCC4]">Account Setup</td>
                                                <td className="p-4 text-green-600 font-medium">$0</td>
                                                <td className="p-4 text-[#A8A39A]">$50-$100</td>
                                            </tr>
                                            <tr>
                                                <td className="p-4 text-[#D0CCC4]">Monthly Fee</td>
                                                <td className="p-4 text-green-600 font-medium">$0</td>
                                                <td className="p-4 text-[#A8A39A]">$20-$50</td>
                                            </tr>
                                            <tr>
                                                <td className="p-4 text-[#D0CCC4]">Trading Fee</td>
                                                <td className="p-4 text-[#D4A94E] font-medium">1% per trade</td>
                                                <td className="p-4 text-[#A8A39A]">1.5%-3%</td>
                                            </tr>
                                            <tr>
                                                <td className="p-4 text-[#D0CCC4]">Gold/Silver Fee</td>
                                                <td className="p-4 text-[#D4A94E] font-medium">1% over spot + $50/yr storage</td>
                                                <td className="p-4 text-[#A8A39A]">Varies widely</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                                    ...
                                    <table className="w-full text-sm">
                                        <thead className="bg-[#121423]">
                                            <tr>
                                                ...
                                                <th className="text-left p-4 text-[#F6F4EF] font-semibold">iTrustCapital</th>
                                                <th className="text-left p-4 text-[#F6F4EF] font-semibold">Alto IRA</th>
                                                <th className="text-left p-4 text-[#F6F4EF] font-semibold">Bitcoin IRA</th>
                                            </tr>
                                        </thead>
                                        <tbody className="divide-y divide-[#2A2D42]">
                                            <tr>
                                                ...
                                                <td className="p-4 text-[#D0CCC4]">1%</td>
                                            ...
                                            <tr>
                                                <td className="p-4 text-[#D0CCC4]">Minimum</td>
                                                <td className="p-4 text-[#D0CCC4]">$1,000</td>
                                                <td className="p-4 text-green-600 font-medium">$0</td>
                                                <td className="p-4 text-[#D0CCC4]">$3,000</td>
                                            </tr>
                                            <tr>
                                                <td className="p-4 text-[#D0CCC4]">24/7 Trading</td>
                                                <td className="p-4"><CheckCircle2 className="w-5 h-5 text-green-600" /></td>
                                                <td className="p-4"><CheckCircle2 className="w-5 h-5 text-green-600" /></td>
                                                <td className="p-4"><CheckCircle2 className="w-5 h-5 text-green-600" /></td>
                                            </tr>
                                            <tr>
                                                <td className="p-4 text-[#D0CCC4]">Gold/Silver</td>
                                                <td className="p-4"><CheckCircle2 className="w-5 h-5 text-green-600" /></td>
                                                <td className="p-4"><XCircle className="w-5 h-5 text-red-500" /></td>
                                                <td className="p-4"><CheckCircle2 className="w-5 h-5 text-green-600" /></td>
                                            </tr>
                                            <tr>
                                                <td className="p-4 text-[#D0CCC4]"># of Cryptos</td>
                                                <td className="p-4 text-[#D0CCC4]">30+</td>
                                                <td className="p-4 text-green-600 font-medium">200+</td>
                                                <td className="p-4 text-[#D0CCC4]">60+</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                            ...
                            {/* Bottom CTA */}
                            <div className="bg-[rgba(197,149,46,0.1)] text-white p-8 rounded-2xl text-center mt-12 relative overflow-hidden">
                        ...
                        <aside className="relative">
                            <div className="hidden lg:block sticky top-24 space-y-6">
                                ...
                                <div className="bg-[#0C0D18] p-6 rounded-xl border border-[#2A2D42]">
                                    <h3 className="font-serif font-bold text-lg mb-4 text-[#F6F4EF]">Quick Jump</h3>
                                    <nav className="flex flex-col gap-2 text-sm">
                                        <a href="#" className="text-blue-600 hover:text-blue-700 transition-colors font-medium">
                                            iTrustCapital Overview
                                        </a>
                                        <a href="#" className="text-[#D0CCC4] hover:text-[#F6F4EF] transition-colors">
                                            Fees Breakdown
                                        </a>
                                        <a href="#" className="text-[#D0CCC4] hover:text-[#F6F4EF] transition-colors">
                                            Supported Cryptos
                                ...
                                {/* Related Reviews */}
                                <div className="bg-[#0C0D18] p-6 rounded-xl border border-[#2A2D42]">
                                    <h3 className="font-serif font-bold text-lg mb-4 text-[#F6F4EF]">Compare Crypto IRAs</h3>
                                    <div className="space-y-3">
                                        <Link href="/reviews/alto-ira" className="block text-sm text-[#D0CCC4] hover:text-[#F6F4EF] transition-colors">
                                            Alto IRA Review →
                                        </Link>
                                        <Link href="/best-crypto-ira-companies" className="block text-sm text-[#D0CCC4] hover:text-[#F6F4EF] transition-colors">
                                            Best Crypto IRA Companies →
                                        </Link>
                                        <Link href="/crypto-ira" className="block text-sm text-[#D0CCC4] hover:text-[#F6F4EF] transition-colors">
                                            Crypto IRA Guide →
                                        </Link>
                                        <Link href="/learn/bitcoin-ira" className="block text-sm text-[#D0CCC4] hover:text-[#F6F4EF] transition-colors">
                                ...
                                <div className="bg-[#0C0D18] p-6 rounded-xl border border-[#2A2D42] text-center">
                                    ...
                                    <p className="text-[#F6F4EF] font-bold">4.7 / 5</p>
            ...
            <section className="bg-[#0C0D18] py-16">
                <Container>
                    <h2 className="text-2xl font-serif font-bold text-[#F6F4EF] mb-8 text-center">Related Crypto IRA Resources</h2>
                    <div className="grid md:grid-cols-3 gap-6">
                        <Link href="/crypto-ira" className="bg-[#161828] p-6 rounded-xl border border-[#2A2D42] hover:border-blue-500/50 transition-colors group">
                            ...
                            <p className="text-[#D0CCC4] text-sm">Everything you need to know about investing in cryptocurrency through an IRA.</p>
                        </Link>
                        <Link href="/best-crypto-ira-companies" className="bg-[#161828] p-6 rounded-xl border border-[#2A2D42] hover:border-blue-500/50 transition-colors group">
                            <h3 className="font-bold text-[#F6F4EF] mb-2 group-hover:text-blue-600 transition-colors">Best Crypto IRA Companies</h3>
                            <p className="text-[#D0CCC4] text-sm">Compare the top crypto IRA providers side-by-side.</p>
                        </Link>
                        <Link href="/compare/gold-ira-vs-crypto" className="bg-[#161828] p-6 rounded-xl border border-[#2A2D42] hover:border-blue-500/50 transition-colors group">
                            ...
                            <p className="text-[#D0CCC4] text-sm">Which is better for your retirement? We compare both options.</p>
                        </Link>
                    </div>
                </Container>
            </section>
