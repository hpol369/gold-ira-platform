                    ...
                    <div className="grid lg:grid-cols-3 gap-12">
                        ...
                        <article className="lg:col-span-2">
                            ...
                            <div className="bg-[#0C0D18] rounded-xl border border-[#2A2D42] p-6 mb-8">
                                <h2 className="text-xl font-serif font-bold text-[#F6F4EF] mb-4">Alto IRA at a Glance</h2>
                                <div className="grid sm:grid-cols-2 gap-4">
                                    ...
                                    <div className="flex items-center gap-3">
                                        <Coins className="w-5 h-5 text-[#F6F4EF]" />
                                        <div>
                                    ...
                                    <div className="flex items-center gap-3">
                                        <Zap className="w-5 h-5 text-[#F6F4EF]" />
                                        <div>
                                    ...
                                    <table className="w-full text-sm">
                                        <thead className="bg-[#121423]">
                                            <tr>
                                                ...
                                                <th className="text-left p-4 text-[#F6F4EF] font-semibold">Alto CryptoIRA</th>
                                            </tr>
                                        </thead>
                                        <tbody className="divide-y divide-[#2A2D42]">
                                            ...
                                            <tr>
                                                ...
                                                <td className="p-4 text-[#D4A94E] font-medium">1% + Coinbase spread</td>
                                            </tr>
                                            <tr>
                                                <td className="p-4 text-[#D0CCC4]">Minimum Investment</td>
                                                <td className="p-4 text-green-600 font-medium">$0</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                ...
                                <div className="bg-[#0C0D18] border border-[#2A2D42] rounded-xl overflow-hidden not-prose my-8">
                                    <table className="w-full text-sm">
                                        ...
                                        <tbody className="divide-y divide-[#2A2D42]">
                                            ...
                                            <tr>
                                                <td className="p-4 text-[#D0CCC4]">Alt Investments</td>
                                                <td className="p-4"><CheckCircle2 className="w-5 h-5 text-green-600" /></td>
                                                <td className="p-4"><XCircle className="w-5 h-5 text-red-500" /></td>
                                            </tr>
                                            <tr>
                                                <td className="p-4 text-[#D0CCC4]">Platform UX</td>
                                                <td className="p-4 text-[#D0CCC4]">Good</td>
                        ...
                        <aside className="relative">
                            <div className="hidden lg:block sticky top-24 space-y-6">
                                ...
                                <div className="bg-[#0C0D18] p-6 rounded-xl border border-[#2A2D42] text-center">
                                    ...
                                    <p className="text-[#F6F4EF] font-bold">4.5 / 5</p>
