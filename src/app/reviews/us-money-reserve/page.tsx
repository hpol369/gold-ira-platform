                ...
                <Container className="relative z-10">
                    <div className="max-w-4xl">
                        <div className="flex items-center gap-2 mb-6">
                            <span className="font-bold text-[#D4A94E] text-lg">3.8/5.0 Rating</span>
                        </div>
                        ...
                        <div className="flex flex-col-reverse lg:flex-col gap-8">
                            ...
                            <article className="prose prose-lg prose-headings:font-serif prose-headings:text-[#F6F4EF] prose-p:text-[#D0CCC4] prose-li:text-[#D0CCC4] prose-strong:text-[#F6F4EF] prose-a:text-[#D4A94E] max-w-none">
                                ...
                                <section id="complaints" className="scroll-mt-32">
                                    ...
                                    <p>
                                        We have a <Link href="/reviews/us-money-reserve-complaints" className="text-[#D4A94E] hover:underline">dedicated page on US Money Reserve complaints</Link>, but here are the highlights:
                                    </p>
                                    <ul>
