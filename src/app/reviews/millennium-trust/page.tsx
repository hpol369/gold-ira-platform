                            ...
                            <div className="bg-[#0C0D18] rounded-xl border border-[#2A2D42] p-6 mb-8">
                                ...
                                <div className="grid sm:grid-cols-2 gap-4">
                                    ...
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            <p className="text-[#A8A39A] text-sm">Total Accounts</p>
                                            <p className="text-[#F6F4EF] font-medium">{companyData.accounts}</p>
                                        </div>
                                    </div>
                                    <div className="flex items-center gap-3">
                                    ...
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-[#F6F4EF] font-medium text-sm">{companyData.specialty}</p>
                                        </div>
                                    </div>
                                    <div className="flex items-center gap-3">
                                    ...
                                    <table className="w-full text-sm">
                                        ...
                                        <tbody className="divide-y divide-[#2A2D42]">
                                            <tr>
                                                ...
                                                <td className="p-4 text-[#D4A94E] font-medium">$50</td>
                                            </tr>
                                            <tr>
                                                <td className="p-4 text-[#D0CCC4]">Asset-Based Fee (some plans)</td>
                                                <td className="p-4 text-[#D0CCC4]">0.65% annually</td>
                                            </tr>
                                            <tr>
                                                <td className="p-4 text-[#D0CCC4]">Distribution Fee</td>
                                                <td className="p-4 text-[#D0CCC4]">$35 - $50</td>
                                            </tr>
                                            <tr>
                                                <td className="p-4 text-[#D0CCC4]">Rollover Out Fee</td>
                                                <td className="p-4 text-[#D0CCC4]">$0 - $35</td>
                                            </tr>
                                            <tr>
                                                <td className="p-4 text-[#D0CCC4]">Paper Statement Fee</td>
                                                <td className="p-4 text-[#D0CCC4]">$2 per statement</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                        ...
                        <aside className="relative">
                            <div className="hidden lg:block sticky top-24 space-y-6">
                                <div className="bg-[#0C0D18] p-6 rounded-xl border border-[#2A2D42]">
                                    <h3 className="font-serif font-bold text-lg mb-4 text-[#F6F4EF]">Better Alternatives</h3>
                                    <div className="space-y-3">
                                        ...
                                        <Link href="/rollover" className="block text-sm text-[#D0CCC4] hover:text-[#F6F4EF] transition-colors">
                                ...
                                <div className="bg-[#0C0D18] p-6 rounded-xl border border-[#2A2D42] text-center">
                                    <div className="flex justify-center gap-1 mb-2">
                                        {[1,2,3,4,5].map(i => (
                                            <Star key={i} className={`w-5 h-5 ${i <= 3 ? 'text-[#D4A94E] fill-[#B22234]' : 'text-[#D4A94E]/30'}`} />
                                        ))}
                                    </div>
                                    <p className="text-[#F6F4EF] font-bold">3.5 / 5</p>
