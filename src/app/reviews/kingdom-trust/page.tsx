                    ...
                    <div className="grid lg:grid-cols-3 gap-12">
                        ...
                        <article className="lg:col-span-2">
                            ...
                            <div className="bg-[#0C0D18] rounded-xl border border-[#2A2D42] p-6 mb-8">
                                <h2 className="text-xl font-serif font-bold text-[#F6F4EF] mb-4">Kingdom Trust at a Glance</h2>
                                <div className="grid sm:grid-cols-2 gap-4">
                                    ...
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            <p className="text-[#A8A39A] text-sm">Assets Under Custody</p>
                                            <p className="text-[#F6F4EF] font-medium">{companyData.assetsUnderCustody}</p>
                                        </div>
                                    </div>
                                    <div className="flex items-center gap-3">
                                        <Bitcoin className="w-5 h-5 text-orange-600" />
                                        <div>
                                            <p className="text-[#A8A39A] text-sm">Crypto Support</p>
                                            <p className="text-[#F6F4EF] font-medium">{companyData.cryptoSupport}</p>
                                        </div>
                                    </div>
                                    <div className="flex items-center gap-3">
                                    ...
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-[#F6F4EF] font-medium text-sm">Crypto IRA investors</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <table className="w-full text-sm">
                                        ...
                                        <tbody className="divide-y divide-[#2A2D42]">
                                            <tr>
                                                ...
                                                <td className="p-4 text-[#D0CCC4]">$0 - $50 (varies by partner)</td>
                                            </tr>
                                            <tr>
                                                <td className="p-4 text-[#D0CCC4]">Annual Custody Fee</td>
                                                <td className="p-4 text-[#D0CCC4]">0.5% - 1% of assets (or flat fee)</td>
                                            </tr>
                                            <tr>
                                                <td className="p-4 text-[#D0CCC4]">Trading Fee (via Choice)</td>
                                                <td className="p-4 text-[#D0CCC4]">1% per trade</td>
                                            </tr>
                                            <tr>
                                                <td className="p-4 text-[#D0CCC4]">Wire Transfer</td>
                                                <td className="p-4 text-[#D0CCC4]">$25 - $30</td>
                                            </tr>
                                            <tr>
                                                <td className="p-4 text-[#D0CCC4]">Account Termination</td>
                                                <td className="p-4 text-[#D0CCC4]">$75 - $100</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                            ...
                            <div className="grid sm:grid-cols-2 gap-4 my-8">
                                <div className="bg-[#0C0D18] rounded-lg p-4 flex items-center gap-3 border border-[#2A2D42]">
                                    ...
                                    <span className="text-[#F6F4EF]">Bitcoin (BTC)</span>
                                </div>
                                <div className="bg-[#0C0D18] rounded-lg p-4 flex items-center gap-3 border border-[#2A2D42]">
                                    <TrendingUp className="w-6 h-6 text-blue-600" />
                                    <span className="text-[#F6F4EF]">Ethereum (ETH)</span>
                                </div>
                                <div className="bg-[#0C0D18] rounded-lg p-4 flex items-center gap-3 border border-[#2A2D42]">
                            ...
                            <div className="prose prose-lg max-w-none text-[#D0CCC4] prose-headings:text-[#F6F4EF] prose-strong:text-[#F6F4EF] prose-a:text-blue-600">
                                ...
                                <table className="w-full text-sm">
                                    <thead className="bg-[#121423]">
                                        <tr>
                                            ...
                                            <th className="text-left p-4 text-[#F6F4EF] font-semibold">Kingdom Trust</th>
                                    ...
                                    <tbody className="divide-y divide-[#2A2D42]">
                                        ...
                                        <tr>
                                            ...
                                            <td className="p-4 text-[#D0CCC4]">1% + spread</td>
                                        </tr>
                                        <tr>
                                            <td className="p-4 text-[#D0CCC4]">Precious Metals</td>
                                        ...
                                        <tr>
                                            <td className="p-4 text-[#D0CCC4]">Institutional Custody</td>
                                            <td className="p-4"><CheckCircle2 className="w-5 h-5 text-green-600" /></td>
                                            <td className="p-4"><CheckCircle2 className="w-5 h-5 text-green-600" /></td>
                                            <td className="p-4 text-[#D0CCC4]">Via Coinbase</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                            ...
                            <div className="hidden lg:block sticky top-24 space-y-6">
                                <div className="bg-[#0C0D18] p-6 rounded-xl border border-[#2A2D42]">
                                    ...
                                    <div className="space-y-3">
                                        <Link href="/reviews/itrustcapital" className="block text-sm text-[#D0CCC4] hover:text-[#F6F4EF] transition-colors">
                                ...
                                <div className="bg-[#0C0D18] p-6 rounded-xl border border-[#2A2D42] text-center">
                                    ...
                                    <p className="text-[#F6F4EF] font-bold">4.4 / 5</p>
