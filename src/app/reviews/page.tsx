        ...
        <Container>
          ...
          >
            <div className="flex items-center gap-4">
              <div className="flex items-center gap-2 bg-amber-500 text-white px-3 py-1.5 rounded-full text-sm font-bold">
            ...
            <div className="flex items-center gap-6">
              <div className="flex items-center gap-2">
                ...
                <span className="font-bold text-slate-900">{featuredCompany.rating}</span>
              </div>
      ...
      <section className="py-16">
        <Container>
                  ...
                  <div className="flex items-center gap-6 text-sm">
                    <div className="flex items-center gap-1">
                      <Star className={`w-4 h-4 fill-current ${
                        company.rating >= 4.5 ? "text-amber-500" : "text-slate-400"
                      }`} />
            ...
            <div className="grid md:grid-cols-2 gap-4">
              {investigationPages.map((page) => (
                <Link
                  ...
                  className="group p-4 bg-white rounded-xl border border-slate-200 hover:border-red-300 hover:shadow-md transition-all"
                >
          ...
          <div className="max-w-4xl mx-auto mt-16 p-8 bg-slate-50 rounded-2xl border border-slate-200">
            <h2 className="text-2xl font-bold text-slate-900 mb-4">How We Review Gold IRA Companies</h2>
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <strong className="text-slate-900">BBB & Review Sites</strong>
              ...
              <div className="flex items-start gap-3">
                <CheckCircle2 className="w-5 h-5 text-green-600 mt-0.5" />
                <div>
                  <strong className="text-slate-900">Fee Transparency</strong>
              ...
              <div className="flex items-start gap-3">
                <CheckCircle2 className="w-5 h-5 text-green-600 mt-0.5" />
                <div>
                  <strong className="text-slate-900">Investment Minimums</strong>
              ...
              <div className="flex items-start gap-3">
                <CheckCircle2 className="w-5 h-5 text-green-600 mt-0.5" />
                <div>
                  <strong className="text-slate-900">Customer Experience</strong>
          ...
          <div className="max-w-4xl mx-auto mt-12">
            ...
            <div className="grid md:grid-cols-3 gap-4">
              <Link href="/guide/gold-ira-fees" className="p-4 bg-white rounded-lg border border-slate-200 hover:border-amber-300 hover:shadow transition-all">
                <span className="text-sm font-semibold text-slate-900">Gold IRA Fees Guide →</span>
              </Link>
              <Link href="/learn/gold-ira-scams" className="p-4 bg-white rounded-lg border border-slate-200 hover:border-amber-300 hover:shadow transition-all">
                <span className="text-sm font-semibold text-slate-900">Scams to Avoid →</span>
              </Link>
              <Link href="/compare/gold-ira-vs-401k" className="p-4 bg-white rounded-lg border border-slate-200 hover:border-amber-300 hover:shadow transition-all">
                <span className="text-sm font-semibold text-slate-900">Gold IRA vs 401k →</span>
              </Link>
            </div>
          </div>
        </Container>
