...
export const metadata = {
    title: "Gold IRA Reviews - Coming Soon | Rich Dad Retirement",
    description: "Expert reviews of Gold IRA companies are coming soon.",
};
            ...
            <div className="flex-grow flex items-center justify-center py-12 md:py-24">
                <Container className="text-center">
                    ...
                    <p className="text-lg text-text-muted max-w-md mx-auto mb-8">
                        Expert reviews of Gold IRA companies are currently being prepared.
                    </p>
