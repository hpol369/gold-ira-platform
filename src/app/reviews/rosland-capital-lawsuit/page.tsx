                    ...
                    <article className="flex-1 prose prose-lg prose-headings:font-serif prose-headings:text-[#F6F4EF] prose-p:text-[#D0CCC4] prose-li:text-[#D0CCC4] prose-strong:text-[#F6F4EF] prose-a:text-[#D4A94E] max-w-none">
                        ...
                        <section id="safety" className="scroll-mt-32">
                            ...
                            <div className="not-prose my-8 grid md:grid-cols-3 gap-6">
                                ...
                                <div className="bg-[#0C0D18] p-6 rounded-xl shadow-sm border border-[#2A2D42] text-center">
                                    <div className="text-4xl font-bold text-[#F6F4EF] mb-2">$2k</div>
                                    <div className="text-sm text-[#D0CCC4]">Minimum</div>
                        ...
                        <section id="protect" className="scroll-mt-32">
                            ...
                            <div className="not-prose grid gap-3 my-6">
                                <div className="flex gap-4 p-4 bg-[#0C0D18] rounded-lg border border-[#2A2D42]">
                                    ...
                                    <div>
                                        <h4 className="font-bold text-[#F6F4EF]">Only buy standard bullion</h4>
                                        <p className="text-[#D0CCC4] text-sm">American Gold Eagles, Canadian Maple Leafs, or gold/silver bars. Avoid &quot;exclusive,&quot; &quot;proof,&quot; or &quot;collectible&quot; coins.</p>
                                    </div>
                                </div>
                                <div className="flex gap-4 p-4 bg-[#0C0D18] rounded-lg border border-[#2A2D42]">
                                    <CheckCircle2 className="w-6 h-6 text-green-600 shrink-0" />
                                    <div>
                                        <h4 className="font-bold text-[#F6F4EF]">Get the spread in writing</h4>
                                        <p className="text-[#D0CCC4] text-sm">Before you buy, ask: &quot;What is the premium above spot price, and what would you pay me if I sold this back tomorrow?&quot;</p>
                                    </div>
                                </div>
                                <div className="flex gap-4 p-4 bg-[#0C0D18] rounded-lg border border-[#2A2D42]">
                                    <CheckCircle2 className="w-6 h-6 text-green-600 shrink-0" />
                                    <div>
                                        <h4 className="font-bold text-[#F6F4EF]">Don&apos;t succumb to urgency</h4>
                                        <p className="text-[#D0CCC4] text-sm">If a sales rep says &quot;this deal expires today,&quot; it&apos;s a tactic. Legitimate offers can wait while you do your research.</p>
                                    </div>
                                </div>
                                <div className="flex gap-4 p-4 bg-[#0C0D18] rounded-lg border border-[#2A2D42]">
                                    <CheckCircle2 className="w-6 h-6 text-green-600 shrink-0" />
                                    <div>
                                        <h4 className="font-bold text-[#F6F4EF]">Compare prices</h4>
                                        <p className="text-[#D0CCC4] text-sm">Get quotes from multiple companies before committing. A 5% difference in spread adds up quickly on large purchases.</p>
                                    </div>
                                </div>
                            </div>
                        </section>
                        ...
                        <section id="alternatives" className="scroll-mt-32">
                            ...
                            <ul>
                                <li><Link href="/reviews/augusta-precious-metals" className="text-[#D4A94E] hover:underline">Augusta Precious Metals</Link> – Zero BBB complaints, education-first approach, but $50k minimum</li>
                                <li><Link href="/reviews/goldco" className="text-[#D4A94E] hover:underline">Goldco</Link> – A+ BBB, $25k minimum, strong buyback program</li>
                                <li><Link href="/reviews/noble-gold" className="text-[#D4A94E] hover:underline">Noble Gold</Link> – Clean record, $20k minimum, Texas storage option</li>
                            </ul>
                        </section>
                        ...
                        <section id="conclusion" className="scroll-mt-32">
                            ...
                            <p>
                                For our full company assessment, see our <Link href="/reviews/rosland-capital" className="text-[#D4A94E] hover:underline">Rosland Capital Review</Link>.
                            </p>
                        </section>
