                    ...
                    <div className="grid lg:grid-cols-3 gap-12">
                        ...
                        <article className="lg:col-span-2">
                            ...
                            <div className="bg-[#0C0D18] rounded-xl border border-[#2A2D42] p-6 mb-8">
                                <h2 className="text-xl font-serif font-bold text-[#F6F4EF] mb-4">Preferred Trust at a Glance</h2>
                                <div className="grid sm:grid-cols-2 gap-4">
                                    ...
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            <p className="text-[#A8A39A] text-sm">Headquarters</p>
                                            <p className="text-[#F6F4EF] font-medium">{companyData.headquarters}</p>
                                        </div>
                                    </div>
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-[#F6F4EF] font-medium">{companyData.minimumInvestment}</p>
                                        </div>
                                    </div>
                                    <div className="flex items-center gap-3">
                                    ...
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            <p className="text-[#A8A39A] text-sm">Best For</p>
                                            <p className="text-[#F6F4EF] font-medium text-sm">{companyData.bestFor}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            {/* Article Content */}
                            <div className="prose prose-lg max-w-none text-[#D0CCC4] prose-headings:text-[#F6F4EF] prose-strong:text-[#F6F4EF] prose-a:text-teal-600 hover:prose-a:text-teal-700">
                                ...
                                <div className="bg-[#0C0D18] border border-[#2A2D42] rounded-xl overflow-hidden not-prose my-8">
                                    <table className="w-full text-sm">
                                        ...
                                        <tbody className="divide-y divide-[#2A2D42]">
                                            ...
                                            <tr>
                                                <td className="p-4 text-[#D0CCC4]">Annual Account Fee</td>
                                                <td className="p-4 text-[#D0CCC4]">$275 - $495 (based on assets)</td>
                                            </tr>
                                            <tr>
                                                <td className="p-4 text-[#D0CCC4]">Transaction Fee</td>
                                                <td className="p-4 text-[#D0CCC4]">$95 - $150 per transaction</td>
                                            </tr>
                                            <tr>
                                                <td className="p-4 text-[#D0CCC4]">Wire Transfer</td>
                                                <td className="p-4 text-[#D0CCC4]">$25</td>
                                            </tr>
                                            <tr>
                                                <td className="p-4 text-[#D0CCC4]">Precious Metals Storage</td>
                                                <td className="p-4 text-[#D0CCC4]">$100 - $300/year (varies by depository)</td>
                                            </tr>
                                            <tr>
                                                <td className="p-4 text-[#D0CCC4]">Account Termination</td>
                            ...
                            <div className="grid sm:grid-cols-2 gap-4 my-8">
                                <div className="bg-[#0C0D18] rounded-lg p-4 flex items-center gap-3 border border-[#2A2D42]">
                                    ...
                                    <span className="text-[#F6F4EF]">Traditional Self-Directed IRA</span>
                                </div>
                                <div className="bg-[#0C0D18] rounded-lg p-4 flex items-center gap-3 border border-[#2A2D42]">
                                    <CheckCircle2 className="w-6 h-6 text-green-600" />
                                    <span className="text-[#F6F4EF]">Roth Self-Directed IRA</span>
                                </div>
                                <div className="bg-[#0C0D18] rounded-lg p-4 flex items-center gap-3 border border-[#2A2D42]">
                                    <CheckCircle2 className="w-6 h-6 text-green-600" />
                                    <span className="text-[#F6F4EF]">SEP IRA</span>
                                </div>
                                <div className="bg-[#0C0D18] rounded-lg p-4 flex items-center gap-3 border border-[#2A2D42]">
                                    <CheckCircle2 className="w-6 h-6 text-green-600" />
                                    <span className="text-[#F6F4EF]">SIMPLE IRA</span>
                                </div>
                                <div className="bg-[#0C0D18] rounded-lg p-4 flex items-center gap-3 border border-[#2A2D42]">
                                    <CheckCircle2 className="w-6 h-6 text-green-600" />
                                    <span className="text-[#F6F4EF]">Solo 401(k)</span>
                                </div>
                                <div className="bg-[#0C0D18] rounded-lg p-4 flex items-center gap-3 border border-[#2A2D42]">
                                    <CheckCircle2 className="w-6 h-6 text-green-600" />
                                    <span className="text-[#F6F4EF]">HSA (Health Savings Account)</span>
                                </div>
                            </div>

                            <div className="prose prose-lg max-w-none text-[#D0CCC4] prose-headings:text-[#F6F4EF] prose-strong:text-[#F6F4EF] prose-a:text-teal-600">
                            ...
                            <div className="grid sm:grid-cols-2 gap-4 my-8">
                                <div className="bg-[#0C0D18] rounded-lg p-4 flex items-center gap-3 border border-[#2A2D42]">
                                    ...
                                    <span className="text-[#F6F4EF]">Real Estate (residential, commercial, land)</span>
                                </div>
                                <div className="bg-[#0C0D18] rounded-lg p-4 flex items-center gap-3 border border-[#2A2D42]">
                                    <Coins className="w-6 h-6 text-[#D4A94E]" />
                                    <span className="text-[#F6F4EF]">Precious Metals (gold, silver, platinum)</span>
                                </div>
                                <div className="bg-[#0C0D18] rounded-lg p-4 flex items-center gap-3 border border-[#2A2D42]">
                                ...
                                <table className="w-full text-sm">
                                    <thead className="bg-[#121423]">
                                        <tr>
                                            ...
                                            <th className="text-left p-4 text-[#F6F4EF] font-semibold">Preferred Trust</th>
                                    ...
                                    <tbody className="divide-y divide-[#2A2D42]">
                                        <tr>
                                            <td className="p-4 text-[#D0CCC4]">Founded</td>
                                            <td className="p-4 text-[#D0CCC4]">2007</td>
                                            <td className="p-4 text-green-600 font-medium">1974</td>
                                            <td className="p-4 text-[#D0CCC4]">2018</td>
                                        </tr>
                                        <tr>
                                            <td className="p-4 text-[#D0CCC4]">BBB Rating</td>
                                            <td className="p-4 text-[#D0CCC4]">A</td>
                                        ...
                                        <tr>
                                            ...
                                            <td className="p-4 text-[#D0CCC4]">Extra fee</td>
                                            <td className="p-4"><CheckCircle2 className="w-5 h-5 text-green-600" /></td>
                                        </tr>
                                        <tr>
                                            <td className="p-4 text-[#D0CCC4]">Best For</td>
                                            <td className="p-4 text-[#D0CCC4]">Real estate</td>
                                            <td className="p-4 text-[#D0CCC4]">Long-term hold</td>
                            ...
                            <div className="hidden lg:block sticky top-24 space-y-6">
                                <div className="bg-[#0C0D18] p-6 rounded-xl border border-[#2A2D42]">
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <Link href="/reviews/equity-trust" className="block text-sm text-[#D0CCC4] hover:text-[#F6F4EF] transition-colors">
                                            Equity Trust Review
                                        </Link>
                                        <Link href="/reviews/rocket-dollar" className="block text-sm text-[#D0CCC4] hover:text-[#F6F4EF] transition-colors">
                                            Rocket Dollar Review
                                        </Link>
                                        <Link href="/best-gold-ira-companies" className="block text-sm text-[#D0CCC4] hover:text-[#F6F4EF] transition-colors">
                                ...
                                <div className="bg-[#0C0D18] p-6 rounded-xl border border-[#2A2D42] text-center">
                                    ...
                                    <p className="text-[#F6F4EF] font-bold">4.0 / 5</p>
