                    ...
                    <article className="flex-1 prose prose-lg prose-headings:font-serif prose-headings:text-[#F6F4EF] prose-p:text-[#D0CCC4] prose-li:text-[#D0CCC4] prose-strong:text-[#F6F4EF] prose-a:text-[#D4A94E] max-w-none">
                        ...
                        <section id="complaints" className="scroll-mt-32">
                            ...
                            <div className="not-prose grid gap-4 my-6">
                                <div className="p-5 bg-[#0C0D18] rounded-xl border border-[#2A2D42]">
                                    <h4 className="font-bold text-[#F6F4EF] mb-2">1. Spot Price Confusion</h4>
                                ...
                                <div className="p-5 bg-[#0C0D18] rounded-xl border border-[#2A2D42]">
                                    <h4 className="font-bold text-[#F6F4EF] mb-2">3. Premium Pricing on Some Products</h4>
                                    <p className="text-[#D0CCC4] text-sm">
                        ...
                        <section id="reputation" className="scroll-mt-32">
                            ...
                            <div className="not-prose my-8 grid md:grid-cols-4 gap-4">
                                ...
                                <div className="bg-[#0C0D18] p-6 rounded-xl border border-[#2A2D42] text-center">
                                    <div className="text-3xl font-bold text-[#D4A94E] mb-1">4.9/5</div>
                                    <div className="text-sm text-[#A8A39A]">Trustpilot</div>
                                </div>
                                <div className="bg-[#0C0D18] p-6 rounded-xl border border-[#2A2D42] text-center">
                                    <div className="text-3xl font-bold text-[#D4A94E] mb-1">$5k</div>
                                    <div className="text-sm text-[#A8A39A]">Minimum</div>
                                </div>
                                <div className="bg-[#0C0D18] p-6 rounded-xl border border-[#2A2D42] text-center">
                                    <div className="text-3xl font-bold text-[#D4A94E] mb-1">$0</div>
                                    <div className="text-sm text-[#A8A39A]">Buyback Fees</div>
                                </div>
                            </div>
                        </section>
                        ...
                        <section id="resolution" className="scroll-mt-32">
                            ...
                            <div className="not-prose my-6 space-y-3">
                                <div className="flex gap-3 items-start p-4 bg-[#0C0D18] rounded-xl border border-[#2A2D42]">
                                    ...
                                    <p className="text-[#D0CCC4]"><strong className="text-[#F6F4EF]">100% Customer Satisfaction Guarantee:</strong> They&apos;ll buy back your metals at current prices if you&apos;re not happy</p>
                                </div>
                                <div className="flex gap-3 items-start p-4 bg-[#0C0D18] rounded-xl border border-[#2A2D42]">
                                    <CheckCircle2 className="w-5 h-5 text-green-600 shrink-0 mt-1" />
                                    <p className="text-[#D0CCC4]"><strong className="text-[#F6F4EF]">Personal responses:</strong> Complaints typically get responses from senior staff, not form letters</p>
                                </div>
                                <div className="flex gap-3 items-start p-4 bg-[#0C0D18] rounded-xl border border-[#2A2D42]">
                                    <CheckCircle2 className="w-5 h-5 text-green-600 shrink-0 mt-1" />
                                    <p className="text-[#D0CCC4]"><strong className="text-[#F6F4EF]">No buyback fees:</strong> Unlike some competitors, they don&apos;t charge you to sell metals back to them</p>
                                </div>
                            </div>
                        </section>
                        ...
                        <section id="conclusion" className="scroll-mt-32">
                            ...
                            <p>
                                For our full company review, see our <Link href="/reviews/american-hartford-gold" className="text-[#D4A94E] hover:underline">American Hartford Gold Review</Link>. Or see how they compare: <Link href="/compare/goldco-vs-american-hartford-gold" className="text-[#D4A94E] hover:underline">Goldco vs American Hartford Gold</Link>.
                            </p>
                        </section>
