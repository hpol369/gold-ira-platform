...
function ComparisonTable({ current }: { current: RetirementAmountPage }) {
  return (
    <div className="overflow-x-auto border border-[#2A2D42] rounded-xl">
      <table className="w-full text-sm">
        <thead>
          <tr className="bg-[#0C0D18] border-b border-[#2A2D42]">
            <th className="text-left py-3 px-4 font-semibold text-[#F6F4EF]">Savings</th>
            <th className="text-left py-3 px-4 font-semibold text-[#F6F4EF]">Monthly (4%)</th>
            <th className="text-left py-3 px-4 font-semibold text-[#F6F4EF]">+ Social Security</th>
            <th className="text-left py-3 px-4 font-semibold text-[#F6F4EF]">Details</th>
          </tr>
        </thead>
        <tbody>
            ...
            return (
              ...
              >
                ...
                <td className="py-3 px-4">
                  {isCurrent ? (
                    <span className="text-[#A8A39A] text-sm">Current page</span>
                  ) : (
                    <Link
  ...
  return (
    <div className="overflow-x-auto border border-[#2A2D42] rounded-xl">
      <table className="w-full text-sm">
        <thead>
          <tr className="bg-[#0C0D18] border-b border-[#2A2D42]">
            <th className="text-left py-3 px-4 font-semibold text-[#F6F4EF]">State</th>
            <th className="text-left py-3 px-4 font-semibold text-[#F6F4EF]">Annual Cost of Living</th>
            <th className="text-left py-3 px-4 font-semibold text-[#F6F4EF]">Years {page.amountShort} Lasts*</th>
            <th className="text-left py-3 px-4 font-semibold text-[#F6F4EF]">Verdict</th>
          </tr>
        </thead>
        <tbody>
          {page.stateComparisons.map((state) => (
            <tr key={state.state} className="border-b border-[#2A2D42]">
              <td className="py-3 px-4 font-medium text-[#F6F4EF]">{state.state}</td>
              <td className="py-3 px-4 text-[#D0CCC4]">{state.annualCost}</td>
              <td className="py-3 px-4 text-[#D0CCC4]">{state.yearsLast} years</td>
              <td className="py-3 px-4">
                <span
      ...
      <p className="text-xs text-[#A8A39A] px-4 py-2 italic">
...
export default async function RetirementAmountSubPage({
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      {/* Hero */}
      <header className="bg-[#0C0D18] py-14 md:py-20 border-b border-[#2A2D42]">
        <Container>
          <div className="max-w-3xl">
            {/* Breadcrumb */}
            <nav className="flex items-center gap-1.5 text-sm text-[#A8A39A] mb-6">
              <Link href="/" className="hover:text-[#D4A94E]">Home</Link>
              <ChevronRight className="h-3 w-3" />
              <Link href="/is-enough-to-retire" className="hover:text-[#D4A94E]">
                Is Enough to Retire?
              </Link>
              <ChevronRight className="h-3 w-3" />
              <span className="text-[#D0CCC4] font-medium">{page.amountShort}</span>
            </nav>
            ...
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-serif font-bold leading-tight mb-5 text-[#F6F4EF]">
              {page.retirementAge
      ...
      <Container className="py-10 md:py-14">
        ...
        <section className="mb-14 max-w-4xl">
          ...
          <div className="grid sm:grid-cols-3 gap-4 mb-6">
            <div className="bg-[#0C0D18] border border-[#2A2D42] rounded-xl p-5 text-center">
              <p className="text-sm text-[#A8A39A] mb-1">Monthly Income (4% Rule)</p>
              <p className="text-2xl font-bold text-[#F6F4EF]">{page.monthlyIncome4Pct}</p>
            </div>
            <div className="bg-[#0C0D18] border border-[#2A2D42] rounded-xl p-5 text-center">
        ...
        <section className="mb-14 max-w-4xl">
          ...
          <div className="bg-[#0C0D18] border border-[#2A2D42] rounded-xl overflow-hidden mb-6">
            <div className="grid sm:grid-cols-3 divide-y sm:divide-y-0 sm:divide-x divide-[#2A2D42]">
              <div className="p-5 text-center">
                <p className="text-sm text-[#A8A39A] mb-1">Claim at 62 (early)</p>
              ...
              <div className="p-5 text-center">
                <p className="text-sm text-[#A8A39A] mb-1">Claim at 70 (max)</p>
                <p className="text-xl font-bold text-[#F6F4EF]">{page.withSocialSecurity70}/yr</p>
                <p className="text-xs text-[#A8A39A] mt-1">24% bonus over full</p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-14 max-w-4xl">
          ...
          <div className="bg-slate-900 text-white rounded-xl p-6 mb-6">
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              ...
              <div className="bg-white/10 rounded-lg p-4">
                <p className="text-sm text-[#3F4460] mb-1">85% Stocks + 15% Gold</p>
        ...
        <section className="mb-14 max-w-4xl">
          ...
          <div className="space-y-4">
            {page.strategies.map((strategy, i) => (
              <div
                key={i}
                className="flex gap-4 items-start bg-[#0C0D18] border border-[#2A2D42] rounded-xl p-5"
              >
                <span className="flex items-center justify-center w-8 h-8 rounded-full bg-[rgba(197,149,46,0.1)] text-white text-sm font-bold flex-shrink-0">
                  {i + 1}
                </span>
                <p className="text-[#D0CCC4] leading-relaxed">{strategy}</p>
              </div>
            ))}
          </div>
        </section>
        ...
        <section className="mb-14 max-w-4xl">
          ...
          <div className="bg-amber-50 border border-amber-200 rounded-xl p-6 md:p-8">
            ...
            <p className="text-[#D0CCC4] leading-relaxed text-lg italic">
        ...
        <section className="mb-14 max-w-4xl">
          <div className="bg-[rgba(197,149,46,0.1)] text-white rounded-2xl p-8 md:p-10">
            ...
            <p className="text-[#3F4460] leading-relaxed mb-6 max-w-2xl">
            ...
            <div className="grid sm:grid-cols-2 gap-4 mb-8">
              <div className="bg-white/10 rounded-lg p-4">
                ...
                <p className="text-sm text-[#A8A39A]">Conservative protection</p>
              </div>
              <div className="bg-white/10 rounded-lg p-4">
                <p className="text-sm text-amber-300">15% Gold Allocation</p>
                <p className="text-2xl font-bold">{page.goldAllocation15Pct}</p>
                <p className="text-sm text-[#A8A39A]">Full crash protection</p>
              </div>
            </div>
            <AugustaCTA
              variant="inline"
        ...
        <section className="mb-14 max-w-4xl">
          <Link
            ...
            className="group flex items-center justify-between bg-[#0C0D18] border border-[#2A2D42] rounded-xl p-6 hover:border-[rgba(197,149,46,0.45)] hover:shadow-md transition-all"
          >
            <div className="flex items-center gap-4">
              <div className="p-3 rounded-lg bg-[rgba(220,38,38,0.1)]">
                <Calculator className="h-6 w-6 text-[#D4A94E]" />
              </div>
              <div>
                <h3 className="font-bold text-[#F6F4EF] text-lg group-hover:text-[#D4A94E] transition-colors">
            ...
            <ArrowRight className="h-5 w-5 text-[#A8A39A] group-hover:text-[#D4A94E] transition-colors" />
          </Link>
        </section>
