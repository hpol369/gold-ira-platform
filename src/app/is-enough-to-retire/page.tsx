  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <Container className="py-12">
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="bg-slate-50 border-b border-slate-200">
                  <th className="text-left py-4 px-5 font-semibold text-[#000080]">
                    Savings
                  </th>
                  <th className="text-left py-4 px-5 font-semibold text-[#000080]">
                    Monthly (4% Rule)
              ...
              <tbody>
                {amounts.map((row) => (
                  ...
                  >
                    <td className="py-4 px-5 font-bold text-[#000080] text-lg">
                      {row.amount}
                    </td>
                    <td className="py-4 px-5 text-slate-700">{row.monthly}</td>
                    <td className="py-4 px-5 text-slate-700">{row.annual}</td>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-slate-50 border border-slate-200 rounded-xl p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="font-bold text-[#000080]">Annual Spending</h3>
              </div>
        ...
        {/* Gold Protection CTA */}
        <section className="mb-16 bg-[#000080]/5 border border-[#000080]/10 rounded-2xl p-8">
            ...
            {[
              ...
              >
                <div className="flex items-center gap-2 mb-2">
                  <Calculator className="h-4 w-4 text-[#B22234]" />
