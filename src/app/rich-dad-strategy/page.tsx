...
export default function RichDadStrategyPage() {
    return (
        <main className="min-h-screen bg-white">
            ...
            {/* Hero Section */}
            <section className="bg-[#0C0D18] py-24 relative overflow-hidden">
                <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top,rgba(178,34,52,0.08),transparent_50%)]" />
                <Container className="relative z-10">
                    <FadeIn>
                        <div className="max-w-3xl mx-auto text-center space-y-6">
                            <div className="inline-flex items-center gap-2 rounded-full bg-[rgba(220,38,38,0.1)] px-4 py-1.5 text-sm font-semibold text-[#D4A94E] shadow-sm ring-1 ring-inset ring-[#B22234]/20">
                                <span className="flex h-2 w-2 rounded-full bg-[#DC2626] animate-pulse"></span>
                                Insider Knowledge
                            </div>
                            <h1 className="text-4xl md:text-6xl font-serif font-bold leading-tight text-[#F6F4EF]">
                                Why "Savers Are Losers"
                            </h1>
                            <p className="text-xl md:text-2xl text-[#D0CCC4] font-light">
                ...
                <Container>
                    <FadeIn delay={0.2}>
                        <div className="max-w-4xl mx-auto">
                            <h2 className="text-3xl font-serif font-bold text-[#F6F4EF] mb-8 text-center">The "Middle Class" Trap: Paper Assets</h2>
                            <div className="grid md:grid-cols-2 gap-12 items-center">
                                <div className="space-y-6 text-lg text-[#D0CCC4] leading-relaxed">
                                    <p>
                                        Most people are taught to go to school, get a job, and save money in a 401(k). But Robert Kiyosaki and other financial experts have been warning for years: <strong className="text-[#F6F4EF]">this is a trap.</strong>
                                    </p>
                                    <p>
                                ...
                                {/* Chart Placeholder */}
                                <div className="bg-[#0C0D18] p-8 rounded-2xl border border-[#2A2D42] flex flex-col items-center justify-center min-h-[300px]">
                                    <div className="w-full h-48 bg-[#161828] rounded-lg relative overflow-hidden flex items-end justify-between px-4 pb-4 border border-[#2A2D42]">
                                        {/* Bars representing declining dollar value */}
                                        <div className="w-8 h-[90%] bg-[#DC2626]/80 rounded-t-sm relative group">
                                            <span className="absolute -top-6 left-1/2 -translate-x-1/2 text-xs font-bold text-[#A8A39A]">1971</span>
                                        </div>
                                    ...
                                    <p className="mt-4 text-center font-bold text-[#A8A39A] text-sm uppercase tracking-widest">Purchasing Power of $1</p>
                                </div>
                            </div>
                        </div>
                    </FadeIn>
                ...
                <Container>
                    <div className="max-w-4xl mx-auto">
                        <div className="text-center mb-16">
                            ...
                            <h2 className="text-3xl md:text-4xl font-serif font-bold text-[#F6F4EF] mt-2">Own Real Assets</h2>
                        </div>

                        <div className="grid md:grid-cols-3 gap-8">
                            <div className="bg-[#161828] p-8 rounded-xl border border-[#2A2D42] hover:border-[rgba(197,149,46,0.45)] transition-all shadow-sm">
                                <div className="h-12 w-12 bg-amber-100 text-[#D4A94E] rounded-full flex items-center justify-center mb-6 border border-amber-200">
                                    <ShieldCheck className="h-6 w-6" />
                                </div>
                                <h3 className="text-xl font-bold font-serif text-[#F6F4EF] mb-3">No Counterparty Risk</h3>
                            ...
                            <div className="bg-[#161828] p-8 rounded-xl border border-[#2A2D42] hover:border-[rgba(197,149,46,0.45)] transition-all shadow-sm">
                                ...
                                <h3 className="text-xl font-bold font-serif text-[#F6F4EF] mb-3">Wealth Preservation</h3>
                                <p className="text-[#D0CCC4] text-sm leading-relaxed">
                            ...
                            <div className="bg-[#161828] p-8 rounded-xl border border-[#2A2D42] hover:border-[rgba(197,149,46,0.45)] transition-all shadow-sm">
                                ...
                                <h3 className="text-xl font-bold font-serif text-[#F6F4EF] mb-3">Tax Advantages</h3>
                                <p className="text-[#D0CCC4] text-sm leading-relaxed">
                ...
                <Container>
                    <div className="bg-gradient-to-r from-[#000080] to-[#000060] rounded-3xl p-12 text-center text-white relative overflow-hidden">
                        ...
                        <div className="relative z-10 max-w-2xl mx-auto space-y-8">
                            ...
                            <Button size="xl" variant="gold" asChild className="w-full sm:w-auto shadow-2xl shadow-black/20 bg-[#DC2626] hover:bg-[#991B1B] text-white">
                                <Link href="/quiz">
                                    Calculate My Score
