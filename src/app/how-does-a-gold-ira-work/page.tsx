      ...
      <main className="bg-white min-h-screen">
        ...
        <section className="bg-[#0C0D18] border-b border-[#2A2D42] pt-28 pb-12 md:pt-32 md:pb-16">
          <Container>
            {/* Breadcrumb */}
            <nav
              className="flex items-center gap-2 text-sm text-[#A8A39A] mb-6"
            ...
            <article className="flex-1 max-w-3xl mx-auto">
              ...
              <section id="three-key-players" className="mb-12 scroll-mt-24">
                ...
                <div className="grid md:grid-cols-3 gap-6 mb-6">
                  ...
                  <div className="bg-[#0C0D18] border border-[#2A2D42] rounded-xl p-6 text-center">
                    <div className="w-14 h-14 bg-[rgba(197,149,46,0.08)] rounded-full flex items-center justify-center mx-auto mb-4">
                      <Users className="h-7 w-7 text-[#F6F4EF]" />
                    </div>
                  ...
                  {/* Player 2: Custodian */}
                  <div className="bg-[#0C0D18] border border-[#2A2D42] rounded-xl p-6 text-center">
                    <div className="w-14 h-14 bg-[rgba(220,38,38,0.1)] rounded-full flex items-center justify-center mx-auto mb-4">
                      <Building2 className="h-7 w-7 text-[#D4A94E]" />
                    </div>
                    <h3 className="font-bold text-[#F6F4EF] text-lg mb-2">
                      The Custodian
                    </h3>
              ...
              <section id="what-happens-to-your-gold" className="mb-12 scroll-mt-24">
                ...
                <div className="space-y-4 mb-6">
                  ...
                  <div className="flex items-start gap-4 bg-[#0C0D18] border border-[#2A2D42] rounded-xl p-5">
                    <div className="w-10 h-10 bg-[rgba(197,149,46,0.08)] rounded-lg flex items-center justify-center shrink-0">
                      <Lock className="h-5 w-5 text-[#F6F4EF]" />
                    </div>
                    <div>
                      <h3 className="font-bold text-[#F6F4EF] mb-1">
                  ...
                  <table className="w-full bg-[#0C0D18] border border-[#2A2D42] rounded-xl overflow-hidden text-sm">
                    ...
                    <tbody className="divide-y divide-[#2A2D42]">
                      <tr className="hover:bg-[#1E2134] transition-colors">
                        <td className="px-4 py-3 font-semibold text-[#F6F4EF]">
              ...
              <section id="taking-distributions" className="mb-12 scroll-mt-24">
                ...
                <p className="text-[#D0CCC4] leading-relaxed mt-4">
