                ...
                <div className="max-w-3xl mx-auto">
                    <FadeIn delay={0.1}>
                        <article className="prose prose-lg prose-headings:font-serif prose-headings:text-[#000080] prose-p:text-slate-600 prose-strong:text-slate-900 prose-li:text-slate-600 max-w-none">
                            ...
                            <p>
                                If you submit a Gold IRA information request form and provide your phone number, you may receive up to 3 transactional text messages from Rich Dad Retirement. Your phone number is used solely for sending form-related notifications (confirmation, call reminders, and follow-ups). We do not sell, share, or use your phone number for any other purpose. You can opt out at any time by replying STOP to any message. For help, reply HELP or email <a href="mailto:hello@richdadretirement.com" className="text-[#B22234] hover:underline">hello@richdadretirement.com</a>. Message and data rates may apply.
                            </p>
