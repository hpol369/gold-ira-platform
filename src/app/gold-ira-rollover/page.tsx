        ...
        <section className="bg-gradient-to-b from-slate-50 to-white border-b border-slate-100 pt-28 pb-12 md:pt-32 md:pb-16">
          <Container>
            ...
            <nav className="flex items-center gap-2 text-sm text-slate-500 mb-6" aria-label="Breadcrumb">
              ...
              <span>/</span>
              <span className="text-[#000080] font-medium">Gold IRA Rollover</span>
            </nav>
          ...
          <div className="flex gap-10">
            ...
            <article className="flex-1 max-w-3xl">
                  ...
                  <table className="w-full bg-slate-50 border border-slate-200 rounded-xl overflow-hidden text-sm">
                    ...
                    <tbody className="divide-y divide-slate-200">
                      <tr className="hover:bg-slate-100 transition-colors">
                        <td className="px-4 py-3 font-semibold text-[#000080]">Traditional 401(k)</td>
                        <td className="px-4 py-3 text-center text-green-600 font-bold">Yes</td>
                        <td className="px-4 py-3 text-center text-green-600 font-bold">Yes</td>
                        <td className="px-4 py-3 text-slate-600">Tax-free if direct</td>
                        <td className="px-4 py-3 text-slate-600">Must separate from employer or qualify for in-service withdrawal</td>
                      </tr>
                      <tr className="bg-white hover:bg-slate-100 transition-colors">
                        <td className="px-4 py-3 font-semibold text-[#000080]">Traditional IRA</td>
                        <td className="px-4 py-3 text-center text-green-600 font-bold">Yes</td>
                        <td className="px-4 py-3 text-center text-green-600 font-bold">Yes</td>
                        <td className="px-4 py-3 text-slate-600">Tax-free if direct</td>
                        <td className="px-4 py-3 text-slate-600">No separation from employer needed</td>
                      </tr>
                      <tr className="hover:bg-slate-100 transition-colors">
                        <td className="px-4 py-3 font-semibold text-[#000080]">Roth IRA</td>
                        <td className="px-4 py-3 text-center text-green-600 font-bold">Yes</td>
                        <td className="px-4 py-3 text-center text-green-600 font-bold">Yes</td>
                        <td className="px-4 py-3 text-slate-600">Tax-free (Roth to Roth)</td>
                        <td className="px-4 py-3 text-slate-600">Must roll into Roth Gold IRA to stay tax-free</td>
                      </tr>
                      <tr className="bg-white hover:bg-slate-100 transition-colors">
                        <td className="px-4 py-3 font-semibold text-[#000080]">Roth 401(k)</td>
                        <td className="px-4 py-3 text-center text-green-600 font-bold">Yes</td>
                        <td className="px-4 py-3 text-center text-green-600 font-bold">Yes</td>
                        <td className="px-4 py-3 text-slate-600">Tax-free (Roth to Roth)</td>
                        <td className="px-4 py-3 text-slate-600">Must separate from employer first</td>
                      </tr>
                      <tr className="hover:bg-slate-100 transition-colors">
                        <td className="px-4 py-3 font-semibold text-[#000080]">TSP (Thrift Savings Plan)</td>
                        <td className="px-4 py-3 text-center text-green-600 font-bold">Yes</td>
                        <td className="px-4 py-3 text-center text-green-600 font-bold">Yes</td>
                        <td className="px-4 py-3 text-slate-600">Tax-free if direct</td>
                        <td className="px-4 py-3 text-slate-600">Federal & military employees; age-based in-service withdrawal at 59&frac12;</td>
                      </tr>
                      <tr className="bg-white hover:bg-slate-100 transition-colors">
                        <td className="px-4 py-3 font-semibold text-[#000080]">403(b)</td>
                        <td className="px-4 py-3 text-center text-green-600 font-bold">Yes</td>
                        <td className="px-4 py-3 text-center text-green-600 font-bold">Yes</td>
                        <td className="px-4 py-3 text-slate-600">Tax-free if direct</td>
                        <td className="px-4 py-3 text-slate-600">Teachers, nurses, hospital workers, nonprofits</td>
                      </tr>
                      <tr className="hover:bg-slate-100 transition-colors">
                        <td className="px-4 py-3 font-semibold text-[#000080]">457(b)</td>
                        <td className="px-4 py-3 text-center text-green-600 font-bold">Yes</td>
                        <td className="px-4 py-3 text-center text-green-600 font-bold">Yes</td>
                        <td className="px-4 py-3 text-slate-600">Tax-free if direct</td>
                        <td className="px-4 py-3 text-slate-600">State & local government employees; no 10% early withdrawal penalty</td>
                      </tr>
                      <tr className="bg-white hover:bg-slate-100 transition-colors">
                        <td className="px-4 py-3 font-semibold text-[#000080]">SEP IRA</td>
                        <td className="px-4 py-3 text-center text-green-600 font-bold">Yes</td>
                        <td className="px-4 py-3 text-center text-green-600 font-bold">Yes</td>
                        <td className="px-4 py-3 text-slate-600">Tax-free if direct</td>
                        <td className="px-4 py-3 text-slate-600">Self-employed & small business owners</td>
                      </tr>
                      <tr className="hover:bg-slate-100 transition-colors">
                        <td className="px-4 py-3 font-semibold text-[#000080]">SIMPLE IRA</td>
                        <td className="px-4 py-3 text-center text-green-600 font-bold">Yes</td>
                        <td className="px-4 py-3 text-center text-green-600 font-bold">Yes</td>
                        <td className="px-4 py-3 text-slate-600">Tax-free if direct</td>
                        <td className="px-4 py-3 text-slate-600">Must have participated for at least 2 years</td>
                      </tr>
                      <tr className="bg-white hover:bg-slate-100 transition-colors">
                        <td className="px-4 py-3 font-semibold text-[#000080]">Pension / Defined Benefit</td>
                        <td className="px-4 py-3 text-center text-green-600 font-bold">Yes</td>
                        <td className="px-4 py-3 text-center text-orange-500 font-bold">Varies</td>
                        <td className="px-4 py-3 text-slate-600">Tax-free if eligible</td>
                        <td className="px-4 py-3 text-slate-600">Must take lump-sum distribution option; not all plans offer it</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
              ...
              <section id="tax-rules" className="mb-12 scroll-mt-24">
                ...
                <div className="space-y-4 mb-6">
                  <div className="bg-slate-50 border border-slate-200 rounded-xl p-5">
                    <h3 className="font-bold text-[#000080] flex items-center gap-2 mb-2">
                      <ShieldCheck className="h-5 w-5 text-green-600" />
                      Direct Rollover (Trustee-to-Trustee Transfer)
                    </h3>
                    <ul className="text-slate-600 text-sm space-y-1.5 ml-7">
              ...
              <section id="costs" className="mb-12 scroll-mt-24">
                ...
                <div className="overflow-x-auto">
                  <table className="w-full bg-slate-50 border border-slate-200 rounded-xl overflow-hidden text-sm">
                    ...
                    <tbody className="divide-y divide-slate-200">
                      <tr className="hover:bg-slate-100 transition-colors">
                        <td className="px-4 py-3 font-semibold text-[#000080]">Account Setup</td>
                        <td className="px-4 py-3 text-slate-700">$0 – $50</td>
                        <td className="px-4 py-3 text-slate-600">One-time</td>
                        <td className="px-4 py-3 text-slate-600">Many top companies waive this fee entirely</td>
                      </tr>
                      <tr className="bg-white hover:bg-slate-100 transition-colors">
                        <td className="px-4 py-3 font-semibold text-[#000080]">Annual Custodian Fee</td>
                        <td className="px-4 py-3 text-slate-700">$50 – $100/year</td>
                        <td className="px-4 py-3 text-slate-600">Annually</td>
                        <td className="px-4 py-3 text-slate-600">Covers account administration and IRS reporting</td>
                      </tr>
                      <tr className="hover:bg-slate-100 transition-colors">
                        <td className="px-4 py-3 font-semibold text-[#000080]">Storage Fee</td>
                        <td className="px-4 py-3 text-slate-700">$100 – $300/year</td>
                        <td className="px-4 py-3 text-slate-600">Annually</td>
                        <td className="px-4 py-3 text-slate-600">Segregated storage costs more but keeps your metals separate</td>
                      </tr>
                      <tr className="bg-white hover:bg-slate-100 transition-colors">
                        <td className="px-4 py-3 font-semibold text-[#000080]">Insurance</td>
                        <td className="px-4 py-3 text-slate-700">Included</td>
                        <td className="px-4 py-3 text-slate-600">Annually</td>
                        <td className="px-4 py-3 text-slate-600">Usually included in storage fee at approved depositories</td>
                      </tr>
                      <tr className="hover:bg-slate-100 transition-colors">
                        <td className="px-4 py-3 font-semibold text-[#000080]">Transaction / Dealer Spread</td>
                        <td className="px-4 py-3 text-slate-700">Varies (3% – 5% over spot)</td>
                        <td className="px-4 py-3 text-slate-600">Per purchase/sale</td>
                        <td className="px-4 py-3 text-slate-600">The markup on gold products; compare prices between dealers</td>
                      </tr>
                      <tr className="bg-white hover:bg-slate-100 transition-colors">
                        <td className="px-4 py-3 font-semibold text-[#000080]">Wire Transfer Fee</td>
                        <td className="px-4 py-3 text-slate-700">$25 – $30</td>
                        <td className="px-4 py-3 text-slate-600">Per transfer</td>
                        <td className="px-4 py-3 text-slate-600">Charged when funds are wired between institutions</td>
                      </tr>
                      <tr className="hover:bg-slate-100 transition-colors">
                        <td className="px-4 py-3 font-semibold text-[#000080]">Account Closure</td>
                        <td className="px-4 py-3 text-slate-700">$0 – $250</td>
                        <td className="px-4 py-3 text-slate-600">One-time</td>
                        <td className="px-4 py-3 text-slate-600">Charged if you close the account or transfer out</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
              ...
              <section id="best-companies" className="mb-12 scroll-mt-24">
                ...
                <div className="space-y-4 mb-6">
                  <div className="bg-slate-50 border-2 border-[#B22234]/30 rounded-xl p-5">
                    <div className="flex items-start gap-4">
                      <div className="w-12 h-12 bg-[#B22234]/10 rounded-lg flex items-center justify-center shrink-0">
                        <Building2 className="h-6 w-6 text-[#B22234]" />
                      </div>
                      <div>
                        <div className="flex items-center gap-2 mb-1">
                          <h3 className="font-bold text-[#000080] text-lg">Augusta Precious Metals</h3>
                          <span className="text-xs bg-[#B22234] text-white px-2 py-0.5 rounded-full font-semibold">#1 Rated</span>
                        </div>
                  ...
                  <div className="bg-slate-50 border border-slate-200 rounded-xl p-5">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <h3 className="font-bold text-[#000080] text-lg mb-1">Goldco</h3>
                        <p className="text-slate-600 text-sm mb-2">
                  ...
                  <div className="bg-slate-50 border border-slate-200 rounded-xl p-5">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <h3 className="font-bold text-[#000080] text-lg mb-1">American Hartford Gold</h3>
                        <p className="text-slate-600 text-sm mb-2">
                ...
                <p className="text-slate-700 leading-relaxed">
                  ...
                  <Link href="/best-gold-ira-companies" className="text-[#B22234] hover:underline font-semibold">
                    ...
                    >
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-slate-500 text-sm mt-1">{guide.desc}</p>
                        </div>
                      </div>
