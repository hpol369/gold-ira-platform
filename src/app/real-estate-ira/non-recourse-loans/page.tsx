                ...
                <Container className="relative z-10">
                    <div className="max-w-4xl mx-auto">
                        <nav className="flex items-center gap-2 text-sm text-slate-500 mb-6">
                            ...
                            <span>/</span>
                            <span className="text-slate-900">Non-Recourse Loans</span>
                        </nav>
                            ...
                            <table className="w-full border-collapse bg-white rounded-xl overflow-hidden">
                                <thead>
                                    <tr className="bg-slate-100">
                                        <th className="text-left px-5 py-3 text-slate-900 font-semibold">Feature</th>
                                        <th className="text-left px-5 py-3 text-slate-900 font-semibold">Non-Recourse (IRA)</th>
                                        <th className="text-left px-5 py-3 text-slate-900 font-semibold">Conventional Mortgage</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr className="border-t border-slate-100">
                                        <td className="px-5 py-3 font-medium text-slate-700">Down Payment</td>
                                        <td className="px-5 py-3 text-slate-600">40-50%</td>
                                        <td className="px-5 py-3 text-slate-600">20-25%</td>
                                    </tr>
                                    <tr className="border-t border-slate-100 bg-slate-50/50">
                                        <td className="px-5 py-3 font-medium text-slate-700">Interest Rate</td>
                                        <td className="px-5 py-3 text-slate-600">1-2% above conventional</td>
                                        <td className="px-5 py-3 text-slate-600">Market rate</td>
                                    </tr>
                                    <tr className="border-t border-slate-100">
                                        <td className="px-5 py-3 font-medium text-slate-700">Loan Term</td>
                                        <td className="px-5 py-3 text-slate-600">15-20 years (some 25-30)</td>
                                        <td className="px-5 py-3 text-slate-600">15-30 years</td>
                                    </tr>
                                    <tr className="border-t border-slate-100 bg-slate-50/50">
                                        <td className="px-5 py-3 font-medium text-slate-700">Personal Guarantee</td>
                                        <td className="px-5 py-3 text-green-600 font-medium">None (prohibited)</td>
                                        <td className="px-5 py-3 text-slate-600">Required</td>
                                    </tr>
                                    <tr className="border-t border-slate-100">
                                        <td className="px-5 py-3 font-medium text-slate-700">Credit Check</td>
                                        <td className="px-5 py-3 text-slate-600">Property-based underwriting</td>
                                        <td className="px-5 py-3 text-slate-600">Personal credit score</td>
                                    </tr>
                                    <tr className="border-t border-slate-100 bg-slate-50/50">
                                        <td className="px-5 py-3 font-medium text-slate-700">Minimum Loan</td>
                                        <td className="px-5 py-3 text-slate-600">$50,000-$100,000</td>
                                        <td className="px-5 py-3 text-slate-600">Varies</td>
                                    </tr>
                                    <tr className="border-t border-slate-100">
                                        <td className="px-5 py-3 font-medium text-slate-700">UBIT Implications</td>
                                        <td className="px-5 py-3 text-red-600 font-medium">Triggers UBIT on leveraged income</td>
                                        <td className="px-5 py-3 text-slate-600">N/A (personal property)</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                ...
                <Container>
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="space-y-4">
                            {lenders.map((lender) => (
                                <div key={lender.name} className="bg-white rounded-xl border border-slate-200 p-5">
                                    <h3 className="font-bold text-[#000080] mb-2">{lender.name}</h3>
                                    <div className="grid grid-cols-2 md:grid-cols-4 gap-3 text-sm">
                                        <div>
                                            <span className="text-slate-500 block text-xs">LTV</span>
                                            <span className="text-slate-900 font-medium">{lender.ltv}</span>
                                        </div>
                                        <div>
                                            <span className="text-slate-500 block text-xs">Term</span>
                                            <span className="text-slate-900 font-medium">{lender.term}</span>
                                        </div>
                                        <div>
                                            <span className="text-slate-500 block text-xs">Min Loan</span>
                                            <span className="text-slate-900 font-medium">{lender.minLoan}</span>
                                        </div>
                                        <div>
                                            <span className="text-slate-500 block text-xs">Notes</span>
                                            <span className="text-slate-900 font-medium">{lender.notes}</span>
                                        </div>
                                    </div>
                                </div>
                            ))}
