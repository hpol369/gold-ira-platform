                ...
                <Container className="relative z-10">
                    <div className="max-w-4xl mx-auto">
                        <nav className="flex items-center gap-2 text-sm text-[#A8A39A] mb-6">
                            ...
                            <span>/</span>
                            <span className="text-[#F6F4EF]">UBIT Rules</span>
                        </nav>
                            ...
                            <table className="w-full border-collapse bg-[#161828] rounded-xl overflow-hidden">
                                <thead>
                                    <tr className="bg-[#121423]">
                                        <th className="text-left px-5 py-3 text-[#F6F4EF] font-semibold">Taxable Income</th>
                                        <th className="text-left px-5 py-3 text-[#F6F4EF] font-semibold">Tax Rate</th>
                                        <th className="text-left px-5 py-3 text-[#F6F4EF] font-semibold">Tax Owed</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr className="border-t border-[#2A2D42]">
                                        <td className="px-5 py-3 text-[#D0CCC4]">$0 - $1,000</td>
                                        <td className="px-5 py-3 text-green-600 font-medium">0% (standard deduction)</td>
                                        <td className="px-5 py-3 text-[#D0CCC4]">$0</td>
                                    </tr>
                                    <tr className="border-t border-[#2A2D42] bg-[#0C0D18]/50">
                                        <td className="px-5 py-3 text-[#D0CCC4]">$1,001 - $3,150</td>
                                        <td className="px-5 py-3 text-[#D0CCC4] font-medium">10%</td>
                                        <td className="px-5 py-3 text-[#D0CCC4]">Up to $215</td>
                                    </tr>
                                    <tr className="border-t border-[#2A2D42]">
                                    ...
                                    <tr className="border-t border-[#2A2D42] bg-[#0C0D18]/50">
                                        <td className="px-5 py-3 text-[#D0CCC4]">$11,451 - $15,650</td>
                                        <td className="px-5 py-3 text-orange-600 font-medium">35%</td>
                                        <td className="px-5 py-3 text-[#D0CCC4]">$2,207 + 35% of excess</td>
                                    </tr>
                                    <tr className="border-t border-[#2A2D42]">
                                        <td className="px-5 py-3 text-[#D0CCC4]">Over $15,650</td>
                                        <td className="px-5 py-3 text-red-600 font-medium">37%</td>
                                        <td className="px-5 py-3 text-[#D0CCC4]">$3,677 + 37% of excess</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                ...
                <Container>
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="bg-[#0C0D18] border border-[#2A2D42] rounded-xl p-6">
                            <h3 className="font-bold text-[#F6F4EF] mb-4">Scenario: IRA Buys Rental Property with Mortgage</h3>
                            <div className="space-y-3 text-sm">
                                <div className="flex justify-between border-b border-[#2A2D42] pb-2">
                                    <span className="text-[#D0CCC4]">Property purchase price</span>
                                    <span className="font-semibold text-[#F6F4EF]">$200,000</span>
                                </div>
                                <div className="flex justify-between border-b border-[#2A2D42] pb-2">
                                    <span className="text-[#D0CCC4]">IRA cash invested</span>
                                    <span className="font-semibold text-[#F6F4EF]">$100,000 (50%)</span>
                                </div>
                                <div className="flex justify-between border-b border-[#2A2D42] pb-2">
                                    <span className="text-[#D0CCC4]">Non-recourse mortgage</span>
                                    <span className="font-semibold text-[#F6F4EF]">$100,000 (50%)</span>
                                </div>
                                <div className="flex justify-between border-b border-[#2A2D42] pb-2">
                                    <span className="text-[#D0CCC4]">Annual net rental income</span>
                                    <span className="font-semibold text-[#F6F4EF]">$20,000</span>
                                </div>
                                <div className="flex justify-between border-b border-[#2A2D42] pb-2">
                                    <span className="text-[#D0CCC4]">Debt percentage (average acquisition indebtedness)</span>
                                    <span className="font-semibold text-[#D4A94E]">50%</span>
                                </div>
                                <div className="flex justify-between border-b border-[#2A2D42] pb-2">
                                    <span className="text-[#D0CCC4]">UDFI (50% of $20,000)</span>
                                    <span className="font-semibold text-[#D4A94E]">$10,000</span>
                                </div>
                                <div className="flex justify-between border-b border-[#2A2D42] pb-2">
                                    <span className="text-[#D0CCC4]">Less $1,000 deduction</span>
                                    <span className="font-semibold text-green-600">-$1,000</span>
                                </div>
                                <div className="flex justify-between pt-2">
                                    <span className="text-[#F6F4EF] font-bold">Taxable UBIT</span>
                                    <span className="font-bold text-[#D4A94E]">$9,000</span>
                                </div>
                                <div className="flex justify-between border-t border-[#3F4460] pt-2">
                                    <span className="text-[#F6F4EF] font-bold">Estimated UBIT Tax Owed</span>
                                    <span className="font-bold text-[#D4A94E]">~$1,619</span>
                                </div>
                            </div>
                        </div>
                    </div>
