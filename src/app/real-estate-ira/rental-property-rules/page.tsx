                ...
                <Container className="relative z-10">
                    <div className="max-w-4xl mx-auto">
                        <nav className="flex items-center gap-2 text-sm text-slate-500 mb-6">
                            ...
                            <span>/</span>
                            <span className="text-slate-900">Rental Property Rules</span>
                        </nav>
                    ...
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="bg-red-50 border border-red-200 rounded-xl p-6 mb-6">
                            ...
                            <div className="grid md:grid-cols-2 gap-4">
                                <div className="flex items-start gap-2">
                                    ...
                                    <span className="text-slate-700 text-sm">Live in or vacation in the property</span>
                                </div>
                                <div className="flex items-start gap-2">
                                    <Ban className="w-4 h-4 text-red-500 mt-0.5 flex-shrink-0" />
                                    <span className="text-slate-700 text-sm">Let family members live in or use it</span>
                                </div>
                                <div className="flex items-start gap-2">
                                    <Ban className="w-4 h-4 text-red-500 mt-0.5 flex-shrink-0" />
                                    <span className="text-slate-700 text-sm">Do repairs or improvements yourself</span>
                                </div>
                                <div className="flex items-start gap-2">
                                    <Ban className="w-4 h-4 text-red-500 mt-0.5 flex-shrink-0" />
                                    <span className="text-slate-700 text-sm">Hire your spouse, children, or parents to manage it</span>
                                </div>
                                <div className="flex items-start gap-2">
                                    <Ban className="w-4 h-4 text-red-500 mt-0.5 flex-shrink-0" />
                                    <span className="text-slate-700 text-sm">Pay property expenses from personal funds</span>
                                </div>
                                <div className="flex items-start gap-2">
                                    <Ban className="w-4 h-4 text-red-500 mt-0.5 flex-shrink-0" />
                                    <span className="text-slate-700 text-sm">Receive rental income personally</span>
                                </div>
                                <div className="flex items-start gap-2">
                                    <Ban className="w-4 h-4 text-red-500 mt-0.5 flex-shrink-0" />
                                    <span className="text-slate-700 text-sm">Buy property from yourself or family</span>
                                </div>
                                <div className="flex items-start gap-2">
                                    <Ban className="w-4 h-4 text-red-500 mt-0.5 flex-shrink-0" />
                                    <span className="text-slate-700 text-sm">Sell IRA property to yourself or family</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-amber-50 border border-amber-200 rounded-xl p-5">
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    <p className="text-slate-700 text-sm font-bold mb-1">Disqualified Persons (IRC 4975)</p>
                ...
                <Container>
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="bg-blue-50 border border-blue-200 rounded-xl p-6">
                            <h3 className="font-bold text-[#000080] mb-4">Typical Non-Recourse Loan Terms for IRAs</h3>
                            <div className="grid md:grid-cols-2 gap-4">
                                ...
                                <div className="flex justify-between text-sm border-b border-blue-100 pb-2">
                                    ...
                                    <span className="font-semibold text-slate-900">1-2% above conventional</span>
                                </div>
                                <div className="flex justify-between text-sm border-b border-blue-100 pb-2">
                                    <span className="text-slate-600">Loan Term</span>
                                    <span className="font-semibold text-slate-900">15-20 years</span>
                                </div>
                                <div className="flex justify-between text-sm border-b border-blue-100 pb-2">
                            ...
                            <p className="text-slate-500 text-xs mt-4">
                                Note: Leveraged income triggers UBIT. See our <Link href="/real-estate-ira/ubit-rules" className="text-[#B22234] underline">UBIT rules guide</Link> for details.
                            </p>
                        </div>
                    </div>
                </Container>
