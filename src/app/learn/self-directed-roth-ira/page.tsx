            ...
            <header className="relative py-20 overflow-hidden">
                ...
                <Container className="relative z-10">
                    <div className="max-w-4xl">
                        ...
                        <p className="text-xl text-[#D0CCC4] max-w-2xl leading-relaxed mb-8">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4">
                            ...
                            <Button variant="outline" size="lg" className="border-white/20 text-[#F6F4EF] hover:bg-[#1E2134]/10" asChild>
                    ...
                    <div className="max-w-5xl mx-auto">
                        <div className="grid md:grid-cols-3 gap-6">
                            ...
                            <div className="bg-[#0C0D18] backdrop-blur-sm p-6 rounded-xl border border-[#2A2D42] text-center">
                                ...
                                <p className="text-[#A8A39A] text-sm">Invest in real estate, crypto, gold, startups, and more beyond stocks.</p>
                            </div>
                            <div className="bg-[#0C0D18] backdrop-blur-sm p-6 rounded-xl border border-[#2A2D42] text-center">
                                <div className="w-12 h-12 bg-purple-500/20 rounded-lg flex items-center justify-center mx-auto mb-4">
                                    <Lock className="w-6 h-6 text-purple-700" />
                                </div>
                                <h3 className="text-lg font-bold text-[#F6F4EF] mb-2">Full Control</h3>
                                <p className="text-[#A8A39A] text-sm">You choose your investments—not a fund manager or financial advisor.</p>
                            </div>
                        </div>
                    </div>
                </Container>
                ...
                <Container>
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="bg-[#0C0D18] border border-[#2A2D42] rounded-xl overflow-hidden my-8">
                            <table className="w-full text-sm">
                                <tbody className="divide-y divide-white/10">
                                    <tr>
                                        <td className="p-4 text-[#A8A39A] font-medium">Contribution Limit (2026)</td>
                                        <td className="p-4 text-[#F6F4EF]">$7,000 ($8,000 if 50+)</td>
                                    </tr>
                                    <tr>
                                        <td className="p-4 text-[#A8A39A] font-medium">Income Limit (Single)</td>
                                        <td className="p-4 text-[#F6F4EF]">$161,000 (phases out up to $176,000)</td>
                                    </tr>
                                    <tr>
                                        <td className="p-4 text-[#A8A39A] font-medium">Income Limit (Married)</td>
                                        <td className="p-4 text-[#F6F4EF]">$240,000 (phases out up to $250,000)</td>
                                    </tr>
                                    <tr>
                                        <td className="p-4 text-[#A8A39A] font-medium">Qualified Withdrawals</td>
                                        <td className="p-4 text-[#F6F4EF]">After age 59½ and 5-year rule met</td>
                                    </tr>
                                    <tr>
                                        <td className="p-4 text-[#A8A39A] font-medium">Required Minimum Distributions</td>
                        ...
                        <div className="grid sm:grid-cols-2 gap-4 my-8">
                            <div className="bg-[#0C0D18] rounded-lg p-4 flex items-center gap-3">
                                <Home className="w-6 h-6 text-green-700" />
                                <div>
                                    <p className="text-[#F6F4EF] font-medium">Real Estate</p>
                                    <p className="text-[#A8A39A] text-sm">Rental, commercial, land, REITs</p>
                                </div>
                            </div>
                            <div className="bg-[#0C0D18] rounded-lg p-4 flex items-center gap-3">
                                <TrendingUp className="w-6 h-6 text-blue-700" />
                                <div>
                                    <p className="text-[#F6F4EF] font-medium">Cryptocurrency</p>
                                    <p className="text-[#A8A39A] text-sm">Bitcoin, Ethereum, altcoins</p>
                                </div>
                            </div>
                            <div className="bg-[#0C0D18] rounded-lg p-4 flex items-center gap-3">
                                <Coins className="w-6 h-6 text-amber-700" />
                                <div>
                                    <p className="text-[#F6F4EF] font-medium">Precious Metals</p>
                                    <p className="text-[#A8A39A] text-sm">Gold, silver, platinum</p>
                                </div>
                            </div>
                            <div className="bg-[#0C0D18] rounded-lg p-4 flex items-center gap-3">
                                <DollarSign className="w-6 h-6 text-purple-700" />
                                <div>
                                    <p className="text-[#F6F4EF] font-medium">Private Equity</p>
                                    <p className="text-[#A8A39A] text-sm">Startups, LLCs, private companies</p>
                                </div>
                            </div>
                        </div>
                            ...
                            <table className="w-full text-sm">
                                <thead className="bg-[#0C0D18]">
                                    <tr>
                                        ...
                                        <th className="text-left p-4 text-[#F6F4EF] font-semibold">Self-Directed Roth</th>
                                        <th className="text-left p-4 text-[#F6F4EF] font-semibold">Self-Directed Traditional</th>
                                    </tr>
                                </thead>
                                <tbody className="divide-y divide-white/10">
                                    <tr>
                                        <td className="p-4 text-[#D0CCC4]">Contributions</td>
                                        <td className="p-4 text-[#D0CCC4]">After-tax</td>
                                        <td className="p-4 text-green-700">Pre-tax (deductible)</td>
                                    </tr>
                                    <tr>
                                        <td className="p-4 text-[#D0CCC4]">Withdrawals</td>
                                        <td className="p-4 text-green-700 font-medium">Tax-free</td>
                                        <td className="p-4 text-[#D0CCC4]">Taxed as income</td>
                                    </tr>
                                    <tr>
                                        <td className="p-4 text-[#D0CCC4]">Required Distributions</td>
                                        <td className="p-4 text-green-700 font-medium">None</td>
                                        <td className="p-4 text-[#D0CCC4]">Starting at 73</td>
                                    </tr>
                                    <tr>
                                        <td className="p-4 text-[#D0CCC4]">Income Limits</td>
                                    ...
                                    <tr>
                                        ...
                                        <td className="p-4 text-[#D0CCC4]">Expecting higher taxes later</td>
                                        <td className="p-4 text-[#D0CCC4]">Need tax break now</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                        ...
                        <div className="bg-[rgba(46,139,87,0.08)]0/10 border border-green-500/20 rounded-xl p-6 my-8">
                            <div className="flex gap-4">
                                ...
                                <div>
                                    <h4 className="font-bold text-[#F6F4EF] mb-2">The Backdoor Roth Strategy</h4>
                        ...
                        <div className="grid md:grid-cols-2 gap-6 my-8">
                            <div className="bg-[#0C0D18] backdrop-blur-sm rounded-xl border border-purple-500/50 p-6">
                                <span className="bg-purple-500 text-[#F6F4EF] text-xs font-bold px-2 py-1 rounded">CHECKBOOK CONTROL</span>
                                <h3 className="text-xl font-bold text-[#F6F4EF] mt-3 mb-2">Rocket Dollar</h3>
                                <p className="text-[#A8A39A] text-sm mb-4">Best for real estate and active investors. $15/month flat fee.</p>
                        ...
                        <div className="mt-12">
                            ...
                            <div className="space-y-4">
                                {[
                                    ...
                                    <div key={i} className="bg-[#0C0D18] backdrop-blur-sm rounded-xl border border-[#2A2D42] p-6">
            ...
            <section className="py-16 bg-[#0C0D18]">
                <Container>
                    ...
                    <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
                        <Link href="/self-directed-ira" className="bg-[#0C0D18] backdrop-blur-sm p-6 rounded-xl border border-[#2A2D42] hover:border-green-500/50 transition-colors group">
                            <h3 className="font-bold text-[#F6F4EF] mb-2 group-hover:text-green-700 transition-colors">Self-Directed IRA Guide</h3>
                            <p className="text-[#A8A39A] text-sm">Complete guide to SDIRA investing.</p>
                        </Link>
                        <Link href="/learn/checkbook-ira" className="bg-[#0C0D18] backdrop-blur-sm p-6 rounded-xl border border-[#2A2D42] hover:border-green-500/50 transition-colors group">
                            <h3 className="font-bold text-[#F6F4EF] mb-2 group-hover:text-green-700 transition-colors">Checkbook IRA Guide</h3>
                            <p className="text-[#A8A39A] text-sm">Take direct control of your IRA.</p>
                        </Link>
                        <Link href="/crypto-ira" className="bg-[#0C0D18] backdrop-blur-sm p-6 rounded-xl border border-[#2A2D42] hover:border-green-500/50 transition-colors group">
                            <h3 className="font-bold text-[#F6F4EF] mb-2 group-hover:text-green-700 transition-colors">Crypto IRA Guide</h3>
                            <p className="text-[#A8A39A] text-sm">Tax-free crypto investing.</p>
                        </Link>
                    </div>
                </Container>
            </section>
