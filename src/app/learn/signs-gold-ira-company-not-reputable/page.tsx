          ...
          <Container>
            <article className="max-w-3xl mx-auto prose prose-lg prose-headings:font-serif prose-headings:text-[#000080] prose-p:text-slate-700 prose-strong:text-slate-900 prose-li:text-slate-700 max-w-none">
              ...
              <p>
                ...
                <Link href="/reviews/augusta-precious-metals" className="text-[#B22234] font-semibold hover:underline">
              ...
              <p>
                ...
                For more on{" "}
                <Link href="/learn/gold-ira-scams" className="text-[#B22234] font-semibold hover:underline">
                  Gold IRA scams
                </Link>{" "}
