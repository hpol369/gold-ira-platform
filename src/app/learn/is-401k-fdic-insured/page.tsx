                ...
                <div className="flex flex-col lg:flex-row gap-12 max-w-6xl mx-auto">
                    ...
                    <article className="flex-1 prose prose-lg  prose-headings:font-serif prose-headings:text-[#F6F4EF] prose-p:text-[#D0CCC4] prose-strong:text-[#F6F4EF] prose-li:text-[#D0CCC4] max-w-none">
                            ...
                            <div className="overflow-x-auto not-prose my-8">
                                <table className="w-full text-left border-collapse bg-[#0C0D18] backdrop-blur-sm rounded-xl shadow-sm border border-[#2A2D42]">
                                    <thead className="bg-[#0C0D18]">
                                        <tr>
                                            <th className="p-4 border-b border-[#2A2D42] font-bold text-[#F6F4EF]">Protection Type</th>
                                            <th className="p-4 border-b border-[#2A2D42] font-bold text-[#F6F4EF]">What It Covers</th>
                                            <th className="p-4 border-b border-[#2A2D42] font-bold text-[#F6F4EF]">401(k)?</th>
                                        </tr>
                                    </thead>
                                    <tbody className="divide-y divide-white/10 text-sm">
                                        <tr>
                                            <td className="p-4 text-[#F6F4EF] font-semibold">FDIC Insurance</td>
                                            <td className="p-4 text-[#A8A39A]">Bank deposits (checking, savings, CDs)</td>
                                            <td className="p-4 text-red-700 font-semibold">NO</td>
                                        </tr>
                                        <tr>
                                            <td className="p-4 text-[#F6F4EF] font-semibold">SIPC Coverage</td>
                                            <td className="p-4 text-[#A8A39A]">Brokerage account assets if broker fails</td>
                                            <td className="p-4 text-green-700 font-semibold">YES (up to $500k)</td>
                                        </tr>
                                        <tr>
                                            <td className="p-4 text-[#F6F4EF] font-semibold">ERISA Protection</td>
                                            <td className="p-4 text-[#A8A39A]">Employer bankruptcy, fiduciary duties</td>
                                            <td className="p-4 text-green-700 font-semibold">YES</td>
                                        </tr>
                                        <tr>
                                            <td className="p-4 text-[#F6F4EF] font-semibold">Market Loss Protection</td>
                                            <td className="p-4 text-[#A8A39A]">Stock market declines</td>
                        ...
                        <section id="erisa" className="scroll-mt-32">
                            ...
                            <div className="space-y-4 not-prose my-8">
                                <div className="bg-[#0C0D18] backdrop-blur-sm rounded-xl border border-[#2A2D42] p-6">
                                    <h4 className="font-bold text-[#F6F4EF] text-lg mb-2">Separation of Assets</h4>
                                    <p className="text-[#A8A39A]">Your 401(k) assets must be held in a trust, completely separate from your employer&apos;s business assets. Your company can&apos;t touch your retirement funds, even if they&apos;re in financial trouble.</p>
                                </div>
                                <div className="bg-[#0C0D18] backdrop-blur-sm rounded-xl border border-[#2A2D42] p-6">
                                    <h4 className="font-bold text-[#F6F4EF] text-lg mb-2">Fiduciary Duty</h4>
                                    <p className="text-[#A8A39A]">Plan administrators have a legal obligation to act in your best interest. They can be personally liable for breaches - not just fines, but personal financial responsibility.</p>
                                </div>
                                <div className="bg-[#0C0D18] backdrop-blur-sm rounded-xl border border-[#2A2D42] p-6">
                                    <h4 className="font-bold text-[#F6F4EF] text-lg mb-2">Creditor Protection</h4>
                                    <p className="text-[#A8A39A]">In most cases, your 401(k) is protected from creditors, lawsuits, and even bankruptcy proceedings. This is actually stronger protection than FDIC provides.</p>
                                </div>
                                <div className="bg-[#0C0D18] backdrop-blur-sm rounded-xl border border-[#2A2D42] p-6">
                                    <h4 className="font-bold text-[#F6F4EF] text-lg mb-2">Reporting Requirements</h4>
                                    <p className="text-[#A8A39A]">Plan sponsors must provide regular statements, disclose fees, and file annual reports. Transparency is legally mandated.</p>
                                </div>
                            </div>
                            ...
                            <div className="bg-blue-500/10 rounded-2xl p-6 border border-blue-500/20 not-prose my-8">
                                ...
                                <div className="space-y-3">
                                    <div className="flex justify-between items-center p-3 bg-[#0C0D18] backdrop-blur-sm border border-[#2A2D42] rounded-lg">
                                        <span className="text-[#D0CCC4]">Total Coverage</span>
                                        <span className="font-semibold text-blue-700">$500,000 per customer</span>
                                    </div>
                                    <div className="flex justify-between items-center p-3 bg-[#0C0D18] backdrop-blur-sm border border-[#2A2D42] rounded-lg">
                                        <span className="text-[#D0CCC4]">Cash Coverage</span>
                                        <span className="font-semibold text-blue-700">$250,000 (within total)</span>
                                    </div>
                                    <div className="flex justify-between items-center p-3 bg-[#0C0D18] backdrop-blur-sm border border-[#2A2D42] rounded-lg">
                                        <span className="text-[#D0CCC4]">Securities Coverage</span>
                        ...
                        <section id="broker-failure" className="scroll-mt-32">
                            <div className="flex items-center gap-4 mb-4 not-prose">
                                <div className="p-3 bg-[#121423] rounded-lg text-[#A8A39A]">
                                    <Building2 className="w-6 h-6" />
                                </div>
                                <h2 className="text-2xl md:text-3xl font-serif font-bold text-[#F6F4EF] m-0">What If Your Custodian or Broker Fails?</h2>
                            </div>
                            <p>
                            ...
                            <div className="space-y-4 not-prose my-8">
                                <div className="flex gap-4 p-5 rounded-xl bg-[#0C0D18] backdrop-blur-sm border border-[#2A2D42]">
                                    <div className="w-10 h-10 rounded-full bg-secondary text-[#F6F4EF] flex items-center justify-center font-bold flex-shrink-0">1</div>
                                    <div>
                                        <h4 className="font-bold text-[#F6F4EF]">SIPC Steps In</h4>
                                        <p className="text-sm text-[#A8A39A] mt-1">SIPC works to recover and return customer assets. Most recoveries happen within 1-3 months.</p>
                                    </div>
                                </div>
                                <div className="flex gap-4 p-5 rounded-xl bg-[#0C0D18] backdrop-blur-sm border border-[#2A2D42]">
                                    <div className="w-10 h-10 rounded-full bg-secondary text-[#F6F4EF] flex items-center justify-center font-bold flex-shrink-0">2</div>
                                    <div>
                                        <h4 className="font-bold text-[#F6F4EF]">Assets Are Transferred</h4>
                                        <p className="text-sm text-[#A8A39A] mt-1">Your securities are typically transferred to another brokerage firm. The actual stocks and bonds still exist - they just change custodians.</p>
                                    </div>
                                </div>
                                <div className="flex gap-4 p-5 rounded-xl bg-[#0C0D18] backdrop-blur-sm border border-[#2A2D42]">
                                    <div className="w-10 h-10 rounded-full bg-secondary text-[#F6F4EF] flex items-center justify-center font-bold flex-shrink-0">3</div>
                                    <div>
                                        <h4 className="font-bold text-[#F6F4EF]">Coverage Fills Gaps</h4>
                                        <p className="text-sm text-[#A8A39A] mt-1">If securities are missing (fraud), SIPC coverage of up to $500,000 helps make you whole.</p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <section id="market-risk" className="scroll-mt-32">
                            ...
                            <div className="overflow-x-auto not-prose my-8">
                                <table className="w-full text-left border-collapse bg-[#0C0D18] backdrop-blur-sm rounded-xl shadow-sm border border-[#2A2D42]">
                                    <thead className="bg-[#0C0D18]">
                                        <tr>
                                            <th className="p-4 border-b border-[#2A2D42] font-bold text-[#F6F4EF]">Market Event</th>
                                            <th className="p-4 border-b border-[#2A2D42] font-bold text-[#F6F4EF]">S&P 500 Loss</th>
                                            <th className="p-4 border-b border-[#2A2D42] font-bold text-[#F6F4EF]">$500k 401(k) Becomes</th>
                                        </tr>
                                    </thead>
                                    <tbody className="divide-y divide-white/10 text-sm">
                                        <tr>
                                            <td className="p-4 text-[#F6F4EF]">Dot-Com Crash (2000-02)</td>
                                            <td className="p-4 text-red-700 font-semibold">-49%</td>
                                            <td className="p-4 text-red-700 font-semibold">$255,000</td>
                                        </tr>
                                        <tr>
                                            <td className="p-4 text-[#F6F4EF]">Financial Crisis (2008)</td>
                                            <td className="p-4 text-red-700 font-semibold">-57%</td>
                                            <td className="p-4 text-red-700 font-semibold">$215,000</td>
                                        </tr>
                                        <tr>
                                            <td className="p-4 text-[#F6F4EF]">COVID Crash (2020)</td>
                                            <td className="p-4 text-red-700 font-semibold">-34%</td>
                                            <td className="p-4 text-red-700 font-semibold">$330,000</td>
                                        </tr>
                                        <tr>
                                            <td className="p-4 text-[#F6F4EF]">2022 Bear Market</td>
                        ...
                        <section id="gold-ira" className="scroll-mt-32">
                                ...
                                <div className="grid md:grid-cols-2 gap-4">
                                    <div className="space-y-3">
                                        <div className="flex items-start gap-2">
                                            <ShieldCheck className="w-5 h-5 text-[#D4A94E] flex-shrink-0 mt-0.5" />
                            ...
                            <div className="overflow-x-auto not-prose my-8">
                                <table className="w-full text-left border-collapse bg-[#0C0D18] backdrop-blur-sm rounded-xl shadow-sm border border-[#2A2D42]">
                                    <thead className="bg-[#0C0D18]">
                                        <tr>
                                            <th className="p-4 border-b border-[#2A2D42] font-bold text-[#F6F4EF]">Crisis</th>
                                            <th className="p-4 border-b border-[#2A2D42] font-bold text-[#F6F4EF]">S&P 500</th>
                                            <th className="p-4 border-b border-[#2A2D42] font-bold text-[#F6F4EF]">Gold</th>
                                        </tr>
                                    </thead>
                                    <tbody className="divide-y divide-white/10 text-sm">
                                        <tr>
                                            <td className="p-4 text-[#F6F4EF]">2008 Financial Crisis</td>
                                            <td className="p-4 text-red-700 font-semibold">-37%</td>
                                            <td className="p-4 text-green-700 font-semibold">+5.5%</td>
                                        </tr>
                                        <tr>
                                            <td className="p-4 text-[#F6F4EF]">2020 COVID Crash</td>
                                            <td className="p-4 text-red-700 font-semibold">-34%</td>
                                        ...
                                        <tr>
                                            ...
                                            <td className="p-4 text-[#D4A94E] font-semibold">+0.4%</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
