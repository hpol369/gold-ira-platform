        ...
        <section className="bg-gradient-to-b from-slate-50 to-white border-b border-slate-100 pt-28 pb-12 md:pt-32 md:pb-16">
          <Container>
            <nav className="flex items-center gap-2 text-sm text-slate-500 mb-6" aria-label="Breadcrumb">
              ...
              <span>/</span>
              <span className="text-[#000080] font-medium">Gold IRA Rollover Checklist</span>
            </nav>
          ...
          <article className="max-w-3xl mx-auto">
            ...
            <section id="before-you-start" className="mb-12 scroll-mt-24">
              ...
              <p className="text-slate-600 mb-4">
                Before moving money, ask yourself: Why am I doing this? How much of my retirement should really go into metals? Am I giving up income, liquidity, or growth I may need later? A gold IRA usually works best as a modest diversification move, not an all-in bet. If you are not sure a gold IRA is right, check our guide on <Link href="/when-not-to-open-gold-ira" className="text-[#B22234] font-medium hover:underline">when not to open a gold IRA</Link>.
              </p>
            </section>
                ...
                <ol className="space-y-3">
                  {beforeChecklist.map((item, i) => (
                    <li key={i} className="flex items-start gap-3 text-slate-600">
                      <span className="w-7 h-7 rounded-full bg-[#000080] text-white flex items-center justify-center font-bold text-xs shrink-0 mt-0.5">{i + 1}</span>
                      <span>{item}</span>
                    </li>
                  ))}
                </ol>
              ...
              <div className="bg-slate-50 border border-slate-200 rounded-xl p-6">
                <ol className="space-y-3" start={11}>
                  {duringChecklist.map((item, i) => (
                    <li key={i} className="flex items-start gap-3 text-slate-600">
                      <span className="w-7 h-7 rounded-full bg-[#B22234] text-white flex items-center justify-center font-bold text-xs shrink-0 mt-0.5">{i + 11}</span>
                      <span>{item}</span>
                    </li>
                  ))}
                </ol>
            ...
            <section id="direct-rollovers" className="mb-12 scroll-mt-24">
              ...
              <p className="text-slate-600">
                For a full breakdown of the tax implications, see our article on <Link href="/learn/401k-to-gold-ira-tax-rules" className="text-[#B22234] font-medium hover:underline">401(k) to Gold IRA tax rules</Link>. And to compare providers, read our <Link href="/reviews/augusta-precious-metals" className="text-[#B22234] font-medium hover:underline">Augusta Precious Metals review</Link>.
              </p>
            </section>
            ...
            <section id="bottom-line" className="mb-12 scroll-mt-24">
              ...
              <p className="text-slate-600">
                If you handle those basics, you will avoid most of the common first-time mistakes. For more on fee structures, read <Link href="/learn/gold-ira-fees-explained" className="text-[#B22234] font-medium hover:underline">Gold IRA Fees Explained</Link>.
              </p>
            </section>
