        ...
        <section className="bg-[#0C0D18] border-b border-[#2A2D42] pt-28 pb-12 md:pt-32 md:pb-16">
          <Container>
            <nav className="flex items-center gap-2 text-sm text-[#A8A39A] mb-6" aria-label="Breadcrumb">
              ...
              <span>/</span>
              <span className="text-[#F6F4EF] font-medium">Gold IRA vs Silver IRA</span>
            </nav>
          ...
          <article className="max-w-3xl mx-auto">
            ...
            <section id="volatility" className="mb-12 scroll-mt-24">
              ...
              <div className="bg-[#0C0D18] border border-[#2A2D42] rounded-xl p-6 my-6">
                <h3 className="font-bold text-[#F6F4EF] mb-3">Think of It This Way</h3>
              ...
              <p className="text-[#D0CCC4]">
                If your goal is to sleep better at night, gold tends to fit better. If your goal is bigger upside and you accept bigger downside, silver may appeal more. Understanding <Link href="/learn/how-much-gold-in-retirement-portfolio" className="text-[#D4A94E] font-medium hover:underline">how much gold to hold in a retirement portfolio</Link> is the next step.
              </p>
            </section>
            ...
            <section id="ira-rules" className="mb-12 scroll-mt-24">
              ...
              <div className="grid md:grid-cols-2 gap-4 my-6">
                ...
                <div className="bg-[#121423] border border-[#3F4460] rounded-xl p-5 text-center">
                  <p className="text-3xl font-bold text-[#D0CCC4] mb-1">99.9%</p>
                  <p className="text-sm text-[#D0CCC4] font-medium">Silver Purity Requirement</p>
                </div>
              </div>
              <p className="text-[#D0CCC4]">
            ...
            <section id="who-is-this-for" className="mb-12 scroll-mt-24">
              ...
              <p className="text-[#D0CCC4] mt-4">
                If a gold IRA does not seem right, read our guide on <Link href="/when-not-to-open-gold-ira" className="text-[#D4A94E] font-medium hover:underline">when not to open a gold IRA</Link> for a full breakdown.
              </p>
            </section>
            ...
            <section id="bottom-line" className="mb-12 scroll-mt-24">
              ...
              <p className="text-[#D0CCC4]">
                If you are choosing just one for a retirement IRA, gold is usually the more conservative choice. For a deeper dive, check our <Link href="/reviews/augusta-precious-metals" className="text-[#D4A94E] font-medium hover:underline">Augusta Precious Metals review</Link> to see how top providers handle both metals.
              </p>
            </section>
