                    ...
                    <article className="flex-1 prose prose-lg prose-headings:font-serif prose-headings:text-[#F6F4EF] prose-p:text-[#D0CCC4] prose-strong:text-[#F6F4EF] prose-li:text-[#D0CCC4] max-w-none">
                        ...
                        <section id="inflation" className="scroll-mt-32">
                            <div className="flex items-center gap-4 mb-4 not-prose">
                                ...
                                <h2 className="text-2xl md:text-3xl font-serif font-bold text-[#F6F4EF] m-0">1. Inflation Protection</h2>
                            </div>
                            <p>
                            ...
                            <div className="bg-[#0C0D18] rounded-2xl p-6 border border-[#2A2D42] not-prose my-8">
                                <h4 className="font-bold text-[#F6F4EF] text-lg mb-4">The Inflation Math</h4>
                                <p className="text-[#D0CCC4] mb-4">Consider what happens to $100,000 in savings over 20 years at different inflation rates:</p>
                                <div className="grid grid-cols-3 gap-4 text-center">
                                    <div className="p-4 bg-[#161828] rounded-xl border border-[#2A2D42]">
                                    ...
                                    <div className="p-4 bg-[#161828] rounded-xl border border-[#2A2D42]">
                                        ...
                                        <div className="text-xs text-[#A8A39A]">@ 4% inflation</div>
                                    </div>
                                    <div className="p-4 bg-[#161828] rounded-xl border border-[#2A2D42]">
                                        <div className="text-2xl font-bold text-red-700">$31,180</div>
                                        <div className="text-xs text-[#A8A39A]">@ 6% inflation</div>
                                    </div>
                                </div>
                                <p className="text-sm text-[#D0CCC4] mt-4">Your savings lose purchasing power even when the balance stays the same. Gold protects against this erosion.</p>
                            </div>
                        ...
                        <section id="diversification" className="scroll-mt-32">
                            <div className="flex items-center gap-4 mb-4 not-prose">
                                ...
                                <h2 className="text-2xl md:text-3xl font-serif font-bold text-[#F6F4EF] m-0">2. True Portfolio Diversification</h2>
                            </div>
                            <p>
                        ...
                        <section id="tax-benefits" className="scroll-mt-32">
                            <div className="flex items-center gap-4 mb-4 not-prose">
                                ...
                                <h2 className="text-2xl md:text-3xl font-serif font-bold text-[#F6F4EF] m-0">3. Powerful Tax Advantages</h2>
                            </div>
                            <p>
                        ...
                        <section id="control" className="scroll-mt-32">
                            <div className="flex items-center gap-4 mb-4 not-prose">
                                ...
                                <h2 className="text-2xl md:text-3xl font-serif font-bold text-[#F6F4EF] m-0">4. True Ownership & Control</h2>
                            </div>
                            <p>
                        ...
                        <section id="crisis-protection" className="scroll-mt-32">
                            <div className="flex items-center gap-4 mb-4 not-prose">
                                ...
                                <h2 className="text-2xl md:text-3xl font-serif font-bold text-[#F6F4EF] m-0">5. Protection During Crises</h2>
                            </div>
                            <p>
                                ...
                                <table className="w-full text-left border-collapse bg-[#0C0D18] rounded-xl shadow-sm border border-[#2A2D42]">
                                    <thead className="bg-[#121423]">
                                        <tr>
                                            ...
                                            <th className="p-4 border-b border-[#2A2D42] font-bold text-[#F6F4EF]">Stock Performance</th>
                                            <th className="p-4 border-b border-[#2A2D42] font-bold text-[#F6F4EF]">Gold Performance</th>
                                        </tr>
                                    </thead>
                                    <tbody className="divide-y divide-[#2A2D42] text-sm">
                                        ...
                                        <tr>
                                            <td className="p-4 text-[#F6F4EF]">2020 COVID Crash (Feb-Mar)</td>
                        ...
                        <section id="legacy" className="scroll-mt-32">
                            <div className="flex items-center gap-4 mb-4 not-prose">
                                ...
                                <h2 className="text-2xl md:text-3xl font-serif font-bold text-[#F6F4EF] m-0">6. Generational Wealth Transfer</h2>
                            </div>
                            <p>
                        ...
                        <section id="central-banks" className="scroll-mt-32">
                            <div className="flex items-center gap-4 mb-4 not-prose">
                                ...
                                <h2 className="text-2xl md:text-3xl font-serif font-bold text-[#F6F4EF] m-0">7. The Central Bank Signal</h2>
                            </div>
                            <p>
