                    ...
                    <article className="flex-1 prose prose-lg  prose-headings:font-serif prose-headings:text-[#F6F4EF] prose-p:text-[#D0CCC4] prose-strong:text-[#F6F4EF] prose-li:text-[#D0CCC4] max-w-none">
                            ...
                            <div className="overflow-x-auto not-prose my-8">
                                <table className="w-full text-left border-collapse bg-[#0C0D18] backdrop-blur-sm rounded-xl shadow-sm border border-[#2A2D42]">
                                    <thead className="bg-[#0C0D18]">
                                        <tr>
                                            <th className="p-4 border-b border-[#2A2D42] font-bold text-[#F6F4EF]">Starting Age</th>
                                            <th className="p-4 border-b border-[#2A2D42] font-bold text-[#F6F4EF]">Monthly Savings</th>
                                            <th className="p-4 border-b border-[#2A2D42] font-bold text-[#F6F4EF]">At Age 65 (7% return)</th>
                                        </tr>
                                    </thead>
                                    <tbody className="divide-y divide-white/10 text-sm">
                                        <tr>
                                            <td className="p-4 text-[#F6F4EF]">25</td>
                                            <td className="p-4 text-[#A8A39A]">$500</td>
                                            <td className="p-4 text-green-700 font-semibold">$1,199,000</td>
                                        </tr>
                                        <tr>
                                            <td className="p-4 text-[#F6F4EF]">35</td>
                                            <td className="p-4 text-[#A8A39A]">$500</td>
                                            <td className="p-4 font-semibold text-[#D0CCC4]">$566,000</td>
                                        </tr>
                                        <tr>
                                            <td className="p-4 text-[#F6F4EF]">45</td>
                                            <td className="p-4 text-[#A8A39A]">$500</td>
                        ...
                        <section id="sequence" className="scroll-mt-32">
                            <div className="flex items-center gap-4 mb-4 not-prose">
                                ...
                                <h2 className="text-2xl md:text-3xl font-serif font-bold text-[#F6F4EF] m-0">4. Ignoring Sequence of Returns Risk</h2>
                            </div>
                            <p>
                        ...
                        <div className="my-12 bg-primary rounded-2xl p-8 text-[#F6F4EF] text-center relative overflow-hidden not-prose">
                            ...
                            <div className="relative z-10">
                                <h3 className="text-2xl font-serif font-bold mb-4 text-[#F6F4EF]">You've Built It. Now Protect It.</h3>
                        ...
                        <section id="fees" className="scroll-mt-32">
                            <div className="flex items-center gap-4 mb-4 not-prose">
                                ...
                                <h2 className="text-2xl md:text-3xl font-serif font-bold text-[#F6F4EF] m-0">7. Ignoring Investment Fees</h2>
                            </div>
                            <p>
                        ...
                        <section id="taxes" className="scroll-mt-32">
                            <div className="flex items-center gap-4 mb-4 not-prose">
                                ...
                                <h2 className="text-2xl md:text-3xl font-serif font-bold text-[#F6F4EF] m-0">9. Tax Inefficiency</h2>
                            </div>
                            <p>
                        ...
                        <section id="plan" className="scroll-mt-32">
                            <div className="flex items-center gap-4 mb-4 not-prose">
                                ...
                                <h2 className="text-2xl md:text-3xl font-serif font-bold text-[#F6F4EF] m-0">10. No Written Retirement Plan</h2>
                            </div>
                            <p>
                        ...
                        <div className="my-12 bg-gradient-to-br from-primary to-primary-dark rounded-2xl p-8 text-[#F6F4EF] relative overflow-hidden not-prose">
                            ...
                            <div className="relative z-10 text-center">
                                <h3 className="text-3xl font-serif font-bold mb-4 text-[#F6F4EF]">You've Done the Hard Part. Don't Blow It Now.</h3>
