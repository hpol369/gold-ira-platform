                ...
                <Container className="relative z-10">
                    <div className="max-w-4xl">
                        ...
                        <p className="text-xl text-[#D0CCC4] mb-8 leading-relaxed max-w-3xl">
                            Ran your own plumbing business for 20 years? Electrician who went independent? Contractor tired of working for someone else? A Solo 401k lets you save up to <strong className="text-[#F6F4EF]">$70,000</strong> a year (or <strong className="text-[#F6F4EF]">$77,500</strong> if you&apos;re 50+)—way more than a regular IRA. Here&apos;s how it works.
                        </p>
                        ...
                        <div className="grid sm:grid-cols-3 gap-4 mb-8">
                            <div className="bg-[#0C0D18] border border-[#2A2D42] rounded-xl p-4 text-center">
                                ...
                                <div className="text-sm text-[#A8A39A]">Employee Deferral</div>
                            </div>
                            <div className="bg-[#0C0D18] border border-[#2A2D42] rounded-xl p-4 text-center">
                                <div className="text-3xl font-bold text-purple-700 mb-1">25%</div>
                                <div className="text-sm text-[#A8A39A]">Employer Contribution</div>
                            </div>
                            <div className="bg-[#0C0D18] border border-[#2A2D42] rounded-xl p-4 text-center">
                                <div className="text-3xl font-bold text-purple-700 mb-1">$70,000</div>
                                <div className="text-sm text-[#A8A39A]">Total Maximum</div>
                            </div>
                        </div>
                    </div>
                </Container>
                        ...
                        <div className="grid md:grid-cols-2 gap-8 mb-12">
                            ...
                            <div className="bg-[#0C0D18] border border-[#2A2D42] rounded-2xl p-8">
                                <div className="flex items-center gap-3 mb-6">
                                    ...
                                    <h3 className="text-xl font-bold text-[#F6F4EF]">Under Age 50</h3>
                                </div>

                                <div className="space-y-4">
                                    <div className="flex justify-between items-center py-3 border-b border-[#2A2D42]">
                                        <span className="text-[#D0CCC4]">Employee Deferral</span>
                                        <span className="text-[#F6F4EF] font-semibold">$23,500</span>
                                    </div>
                                    <div className="flex justify-between items-center py-3 border-b border-[#2A2D42]">
                                        <span className="text-[#D0CCC4]">Employer Contribution</span>
                                        <span className="text-[#F6F4EF] font-semibold">Up to 25%*</span>
                                    </div>
                                    <div className="flex justify-between items-center py-3 border-b border-[#2A2D42]">
                            ...
                            <div className="bg-gradient-to-br from-purple-500/10 to-purple-600/5 backdrop-blur-sm border border-purple-500/20 rounded-2xl p-8">
                                <div className="flex items-center gap-3 mb-6">
                                    ...
                                    <div>
                                        <h3 className="text-xl font-bold text-[#F6F4EF]">Age 50 and Over</h3>
                    ...
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="grid md:grid-cols-2 gap-8">
                            ...
                            <div className="bg-[#0C0D18] border border-[#2A2D42] rounded-2xl p-8">
                                ...
                                <div className="space-y-3">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <span className="text-[#D0CCC4]">Fixed at $23,500 for 2026</span>
                                    </div>
                                    <div className="flex items-center gap-3">
                                        <CheckCircle className="w-5 h-5 text-green-700 flex-shrink-0" />
                                        <span className="text-[#D0CCC4]">Can be Traditional (pre-tax) or Roth</span>
                                    </div>
                                    <div className="flex items-center gap-3">
                                        <CheckCircle className="w-5 h-5 text-green-700 flex-shrink-0" />
                                        <span className="text-[#D0CCC4]">No income requirement to max out</span>
                                    </div>
                                    <div className="flex items-center gap-3">
                                        <CheckCircle className="w-5 h-5 text-green-700 flex-shrink-0" />
                                        <span className="text-[#D0CCC4]">+$7,500 catch-up if 50+</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="bg-[#0C0D18] border border-[#2A2D42] rounded-2xl p-8">
                                ...
                                <h3 className="text-2xl font-bold text-[#F6F4EF] mb-4">Employer Contribution</h3>
                                <p className="text-[#A8A39A] mb-6">
                                ...
                                <div className="space-y-3">
                                    <div className="flex items-center gap-3">
                                        <CheckCircle className="w-5 h-5 text-green-700 flex-shrink-0" />
                                        <span className="text-[#D0CCC4]">Up to 25% of W-2 wages</span>
                                    </div>
                                    <div className="flex items-center gap-3">
                                        <CheckCircle className="w-5 h-5 text-green-700 flex-shrink-0" />
                                        <span className="text-[#D0CCC4]">~20% of net SE income (sole props)</span>
                                    </div>
                                    <div className="flex items-center gap-3">
                                        <CheckCircle className="w-5 h-5 text-green-700 flex-shrink-0" />
                                        <span className="text-[#D0CCC4]">Always pre-tax (Traditional only)</span>
                                    </div>
                                    <div className="flex items-center gap-3">
                                        <CheckCircle className="w-5 h-5 text-green-700 flex-shrink-0" />
                                        <span className="text-[#D0CCC4]">Scales with your business income</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <Container>
                    <div className="max-w-4xl mx-auto">
                        <div className="flex items-center gap-3 justify-center mb-4">
                            ...
                            <h2 className="text-3xl md:text-4xl font-serif font-bold text-[#F6F4EF]">
                            ...
                            <div className="grid md:grid-cols-2 gap-8">
                                <div>
                                    <p className="text-[#A8A39A] mb-4">
                                        <strong className="text-[#F6F4EF]">Scenario:</strong> Self-employed consultant with
                                        $200,000 net self-employment income (after SE tax deduction).
                                    </p>
                                    <div className="space-y-2 text-sm">
                                        <div className="flex justify-between py-2 border-b border-[#2A2D42]">
                                            <span className="text-[#A8A39A]">Net SE Income</span>
                                            <span className="text-[#F6F4EF]">$200,000</span>
                                        </div>
                                        <div className="flex justify-between py-2 border-b border-[#2A2D42]">
                                            <span className="text-[#A8A39A]">Employee Deferral</span>
                                            <span className="text-[#F6F4EF]">$23,500</span>
                                        </div>
                                        <div className="flex justify-between py-2 border-b border-[#2A2D42]">
                                            <span className="text-[#A8A39A]">Employer (20% of $200K)</span>
                                            <span className="text-[#F6F4EF]">$40,000</span>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div className="bg-[#0C0D18] border border-[#2A2D42] rounded-2xl p-8 mb-6">
                            <div className="flex items-center justify-between mb-6">
                                <h3 className="text-xl font-bold text-[#F6F4EF]">Example 2: Part-Time Freelancer (Age 52)</h3>
                            ...
                            <div className="grid md:grid-cols-2 gap-8">
                                <div>
                                    <p className="text-[#A8A39A] mb-4">
                                        <strong className="text-[#F6F4EF]">Scenario:</strong> Freelance designer with
                                        $75,000 net self-employment income.
                                    </p>
                                    <div className="space-y-2 text-sm">
                                        <div className="flex justify-between py-2 border-b border-[#2A2D42]">
                                            <span className="text-[#A8A39A]">Net SE Income</span>
                                            <span className="text-[#F6F4EF]">$75,000</span>
                                        </div>
                                        <div className="flex justify-between py-2 border-b border-[#2A2D42]">
                                            <span className="text-[#A8A39A]">Employee Deferral</span>
                                            <span className="text-[#F6F4EF]">$23,500</span>
                                        ...
                                        <div className="flex justify-between py-2 border-b border-[#2A2D42]">
                                            <span className="text-[#A8A39A]">Catch-Up (50+)</span>
                                            <span className="text-green-700">+ $7,500</span>
                                        </div>
                                        <div className="flex justify-between py-2 border-b border-[#2A2D42]">
                                            <span className="text-[#A8A39A]">Employer (20% of $75K)</span>
                                            <span className="text-[#F6F4EF]">$15,000</span>
                                        </div>
                                    </div>
                                </div>
                                <div className="bg-purple-500/10 rounded-xl p-6 flex flex-col justify-center">
                        ...
                        <div className="bg-[#0C0D18] border border-[#2A2D42] rounded-2xl p-8">
                            ...
                            <div className="grid md:grid-cols-2 gap-8">
                                <div>
                                    <p className="text-[#A8A39A] mb-4">
                                        <strong className="text-[#F6F4EF]">Scenario:</strong> S-Corp owner paying themselves
                                        $120,000 in W-2 wages.
                                    </p>
                                    <div className="space-y-2 text-sm">
                                        <div className="flex justify-between py-2 border-b border-[#2A2D42]">
                                            <span className="text-[#A8A39A]">W-2 Wages</span>
                                            <span className="text-[#F6F4EF]">$120,000</span>
                                        </div>
                                        <div className="flex justify-between py-2 border-b border-[#2A2D42]">
                                            <span className="text-[#A8A39A]">Employee Deferral</span>
                                            <span className="text-[#F6F4EF]">$23,500</span>
                                        ...
                                        <div className="flex justify-between py-2 border-b border-[#2A2D42]">
                                            <span className="text-[#A8A39A]">Employer (25% of $120K)</span>
                                            <span className="text-[#F6F4EF]">$30,000</span>
                                        </div>
                                    </div>
                                </div>
                                <div className="bg-purple-500/10 rounded-xl p-6 flex flex-col justify-center">
                    ...
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="grid md:grid-cols-2 gap-8">
                            ...
                            <div className="bg-[#0C0D18] border border-[#2A2D42] rounded-2xl p-8">
                                ...
                                <h3 className="text-xl font-bold text-[#F6F4EF] mb-3">Employer Contribution Deadline</h3>
                                ...
                                <table className="w-full">
                                    <thead>
                                        <tr className="border-b border-[#2A2D42]">
                                            <th className="text-left p-4 text-[#A8A39A] font-medium">Net SE Income</th>
                                    ...
                                    <tbody>
                                        <tr className="border-b border-[#2A2D42]">
                                            <td className="p-4 text-[#F6F4EF]">$50,000</td>
