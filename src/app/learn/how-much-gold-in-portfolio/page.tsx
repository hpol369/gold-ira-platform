                    ...
                    <div className="max-w-4xl mx-auto">
                        <div className="bg-[rgba(220,38,38,0.1)] border border-[#B22234]/30 rounded-2xl p-8 text-center">
                            ...
                            <p className="text-lg text-[#D0CCC4]">
                                Most experts say <strong className="text-[#F6F4EF]">5-15% of your total savings</strong> should be in gold and precious metals. That&apos;s enough protection to matter if markets crash, but not so much that you&apos;re betting the farm.
                            </p>
                        </div>
                    </div>
                </Container>
            ...
            <section className="py-16">
                <Container>
                    <div className="max-w-4xl mx-auto">
                        ...
                        {/* Why This Range */}
                        <div className="mb-16">
                            <h2 className="text-3xl font-bold text-[#F6F4EF] mb-6">Why 5-15%?</h2>
                        ...
                        <div className="mb-16">
                            <h2 className="text-3xl font-bold text-[#F6F4EF] mb-6">Recommended Allocation by Age</h2>
                                ...
                                <table className="w-full bg-[#161828] border border-[#2A2D42] rounded-xl overflow-hidden shadow-sm">
                                    <thead>
                                        <tr className="border-b border-[#2A2D42] bg-[#0C0D18]">
                                            <th className="text-left p-4 text-[#F6F4EF] font-bold">Age</th>
                                            <th className="text-left p-4 text-[#F6F4EF] font-bold">Stocks</th>
                                            <th className="text-left p-4 text-[#F6F4EF] font-bold">Bonds</th>
                                            <th className="text-left p-4 text-[#D4A94E] font-bold">Gold</th>
                                        </tr>
                                    </thead>
                                    <tbody className="text-[#D0CCC4]">
                                        {allocationByAge.map((row, i) => (
                                            <tr key={i} className="border-b border-[#2A2D42]">
                                                <td className="p-4 font-medium text-[#F6F4EF]">{row.age}</td>
                                                <td className="p-4">{row.stocks}</td>
                                                <td className="p-4">{row.bonds}</td>
                                                <td className="p-4 text-[#D4A94E] font-semibold">{row.gold}</td>
                                            </tr>
                                        ))}
                                    </tbody>
                                </table>
                            ...
                            <div className="mt-6 space-y-3">
                                {allocationByAge.map((row, i) => (
                                    <div key={i} className="bg-[#161828] border border-[#2A2D42] rounded-lg p-4 shadow-sm">
                                        <p className="text-[#D0CCC4] text-sm">
                                            <strong className="text-[#F6F4EF]">{row.age}:</strong> {row.reasoning}
                                        </p>
                                    </div>
                                ))}
                            </div>
                        ...
                        {/* Expert Opinions */}
                        <div className="mb-16">
                            <h2 className="text-3xl font-bold text-[#F6F4EF] mb-6">What Experts Say</h2>
                            <div className="space-y-6">
                                {expertQuotes.map((item, i) => (
                                    <div key={i} className="bg-[#161828] border border-[#2A2D42] rounded-xl p-6 shadow-sm">
                                        <blockquote className="text-lg text-[#D0CCC4] italic mb-3">
                                            &quot;{item.quote}&quot;
                                        </blockquote>
                                        <p className="text-[#D4A94E] text-sm font-medium">— {item.source}</p>
                                    </div>
                                ))}
                            </div>
                        </div>
                        ...
                        {/* Factors to Consider */}
                        <div className="mb-16">
                            <h2 className="text-3xl font-bold text-[#F6F4EF] mb-6">Factors That Affect Your Ideal Allocation</h2>
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="bg-[#161828] border border-[#2A2D42] rounded-xl p-6 shadow-sm">
                                    <h3 className="font-bold text-[#F6F4EF] mb-2 flex items-center gap-2">
                                        <User className="h-5 w-5 text-[#D4A94E]" />
                                        Risk Tolerance
                                    </h3>
                                    <p className="text-[#D0CCC4] text-sm">
                        ...
                        {/* Practical Examples */}
                        <div className="mb-16">
                            <h2 className="text-3xl font-bold text-[#F6F4EF] mb-6">Practical Examples</h2>

                            <div className="grid md:grid-cols-2 gap-6">
                                <div className="bg-[#161828] border border-[#2A2D42] rounded-2xl p-6 shadow-sm">
                                    <h3 className="font-bold text-[#F6F4EF] mb-4">$100,000 Portfolio</h3>
                                    <div className="space-y-3">
                                        <div className="flex justify-between">
                                            <span className="text-[#D0CCC4]">5% Gold Allocation</span>
                                            <span className="text-[#D4A94E] font-bold">$5,000</span>
                                        </div>
                                        <div className="flex justify-between">
                                            <span className="text-[#D0CCC4]">10% Gold Allocation</span>
                                            <span className="text-[#D4A94E] font-bold">$10,000</span>
                                        </div>
                                        <div className="flex justify-between">
                                            <span className="text-[#D0CCC4]">15% Gold Allocation</span>
                                            <span className="text-[#D4A94E] font-bold">$15,000</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="bg-[#161828] border border-[#2A2D42] rounded-2xl p-6 shadow-sm">
                                    ...
                                    <div className="space-y-3">
                                        <div className="flex justify-between">
                                            <span className="text-[#D0CCC4]">5% Gold Allocation</span>
                                            <span className="text-[#D4A94E] font-bold">$25,000</span>
                                        </div>
                                        <div className="flex justify-between">
                                            <span className="text-[#D0CCC4]">10% Gold Allocation</span>
                                            <span className="text-[#D4A94E] font-bold">$50,000</span>
                                        </div>
                                        <div className="flex justify-between">
                                            <span className="text-[#D0CCC4]">15% Gold Allocation</span>
                                            <span className="text-[#D4A94E] font-bold">$75,000</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        {/* How to Implement */}
                        <div className="mb-16">
                            <h2 className="text-3xl font-bold text-[#F6F4EF] mb-6">How to Implement Your Gold Allocation</h2>

                            <div className="space-y-4">
                                <div className="flex gap-4 p-5 rounded-xl bg-[#161828] border border-[#2A2D42] shadow-sm">
                                    <div className="w-10 h-10 rounded-full bg-[#DC2626] text-white flex items-center justify-center font-bold shrink-0">1</div>
                                    <div>
                                        <h4 className="font-bold text-[#F6F4EF]">Calculate Your Target Amount</h4>
                                        <p className="text-sm text-[#A8A39A] mt-1">Total portfolio value x your chosen percentage = target gold allocation</p>
                                    </div>
                                </div>
                                <div className="flex gap-4 p-5 rounded-xl bg-[#161828] border border-[#2A2D42] shadow-sm">
                                    <div className="w-10 h-10 rounded-full bg-[#DC2626] text-white flex items-center justify-center font-bold shrink-0">2</div>
                                    <div>
                                        <h4 className="font-bold text-[#F6F4EF]">Choose Your Gold Vehicle</h4>
                                        <p className="text-sm text-[#A8A39A] mt-1">Physical gold in an IRA, gold ETFs, or a combination. Gold IRA offers tax advantages and physical ownership.</p>
                                    </div>
                                </div>
                                <div className="flex gap-4 p-5 rounded-xl bg-[#161828] border border-[#2A2D42] shadow-sm">
                                    <div className="w-10 h-10 rounded-full bg-[#DC2626] text-white flex items-center justify-center font-bold shrink-0">3</div>
                                    <div>
                                        <h4 className="font-bold text-[#F6F4EF]">Fund Gradually (Optional)</h4>
                                        <p className="text-sm text-[#A8A39A] mt-1">Consider dollar-cost averaging into gold over 6-12 months to reduce timing risk.</p>
                                    </div>
                                </div>
                                <div className="flex gap-4 p-5 rounded-xl bg-[#161828] border border-[#2A2D42] shadow-sm">
                                    <div className="w-10 h-10 rounded-full bg-[#DC2626] text-white flex items-center justify-center font-bold shrink-0">4</div>
                                    <div>
                                        <h4 className="font-bold text-[#F6F4EF]">Rebalance Annually</h4>
                                        <p className="text-sm text-[#A8A39A] mt-1">Check your allocation yearly. If gold has grown to 20%, sell some. If it&apos;s dropped to 5%, add more.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="mb-16">
                            <div className="bg-[rgba(220,38,38,0.1)] border border-[#B22234]/30 rounded-2xl p-8">
                                ...
                                <div className="grid md:grid-cols-3 gap-6 text-center">
                                    <div>
                                        <p className="text-[#A8A39A] text-sm mb-2">Conservative</p>
                                        <p className="text-3xl font-bold text-[#D4A94E]">5%</p>
                                        <p className="text-[#A8A39A] text-xs mt-1">Basic diversification</p>
                                    </div>
                                    <div>
                                        <p className="text-[#A8A39A] text-sm mb-2">Recommended</p>
                                        <p className="text-3xl font-bold text-[#D4A94E]">10%</p>
                                        <p className="text-[#A8A39A] text-xs mt-1">Balanced protection</p>
                                    </div>
                                    <div>
                                        <p className="text-[#A8A39A] text-sm mb-2">Aggressive</p>
                                        <p className="text-3xl font-bold text-[#D4A94E]">15%</p>
                                        <p className="text-[#A8A39A] text-xs mt-1">Maximum insurance</p>
                                    </div>
                                </div>
                            </div>
                        </div>
