        ...
        <section className="bg-gradient-to-b from-slate-50 to-white border-b border-slate-100 pt-28 pb-12 md:pt-32 md:pb-16">
          <Container>
            <nav className="flex items-center gap-2 text-sm text-slate-500 mb-6" aria-label="Breadcrumb">
              ...
              <span>/</span>
              <span className="text-[#000080] font-medium">How to Compare Gold IRA Companies</span>
            </nav>
          ...
          <article className="max-w-3xl mx-auto">
            ...
            <section id="sales-game" className="mb-12 scroll-mt-24">
              ...
              <p className="text-slate-600">
                For more on this topic, read our guide on <Link href="/learn/signs-gold-ira-company-not-reputable" className="text-[#B22234] font-medium hover:underline">signs a gold IRA company is not reputable</Link>.
              </p>
            </section>
            ...
            <section id="eight-factors" className="mb-12 scroll-mt-24">
              ...
              <div className="space-y-6">
                {scoringFactors.map((factor) => {
                  ...
                  return (
                    <div key={factor.number} className="bg-white border border-slate-200 rounded-xl p-6 shadow-sm">
            ...
            <section id="best-of-lists" className="mb-12 scroll-mt-24">
              ...
              <p className="text-slate-600">
                If every company on the page looks perfect, the page probably is not there to protect you. For honest cost breakdowns, read <Link href="/learn/gold-ira-fees-explained" className="text-[#B22234] font-medium hover:underline">Gold IRA Fees Explained</Link>. And for red flags to watch for, see <Link href="/when-not-to-open-gold-ira" className="text-[#B22234] font-medium hover:underline">when not to open a gold IRA</Link>.
              </p>
            </section>
