    ...
    return (
        <main className="min-h-screen flex flex-col bg-white">
            ...
            <section className="py-16">
                <Container>
                    <div className="max-w-4xl mx-auto">
                        ...
                        {/* Visual Comparison */}
                        <div className="mb-16">
                            <h2 className="text-3xl font-bold text-[#F6F4EF] mb-8 text-center">How Each Rollover Works</h2>
                                    ...
                                    <div className="space-y-4 mb-6">
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div className="flex-1">
                                                <p className="text-[#F6F4EF] font-medium">Old 401(k)/IRA</p>
                                            </div>
                                        </div>
                                        ...
                                        <div className="flex items-center gap-4">
                                            <div className="w-12 h-12 rounded-full bg-[rgba(220,38,38,0.1)] flex items-center justify-center">
                                                <Building2 className="h-5 w-5 text-[#D4A94E]" />
                                            </div>
                                            <div className="flex-1">
                                                <p className="text-[#F6F4EF] font-medium">New Gold IRA</p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div className="bg-red-50 border border-red-200 rounded-2xl p-6">
                                    ...
                                    <div className="space-y-4 mb-6">
                                        ...
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div className="flex-1">
                                                <p className="text-[#F6F4EF] font-medium">YOU (check in your name)</p>
                                        ...
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div className="flex-1">
                                                <p className="text-[#F6F4EF] font-medium">New Gold IRA</p>
                                                <p className="text-[#D4A94E] text-xs">Within 60 days!</p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <table className="w-full bg-[#161828] border border-[#2A2D42] rounded-xl overflow-hidden shadow-sm">
                                    ...
                                    <tbody className="text-[#D0CCC4]">
                                        <tr className="border-b border-[#2A2D42]">
                                            <td className="p-4 font-medium text-[#F6F4EF]">Tax Withholding</td>
                                        ...
                                        <tr className="border-b border-[#2A2D42]">
                                            <td className="p-4 font-medium text-[#F6F4EF]">Time Limit</td>
                                            <td className="p-4 text-green-700">
                                                <CheckCircle2 className="inline h-4 w-4 mr-1" />
                                                None
                                            </td>
                                        ...
                                        <tr className="border-b border-[#2A2D42]">
                                            <td className="p-4 font-medium text-[#F6F4EF]">Annual Limit</td>
                                            <td className="p-4 text-green-700">
                                                <CheckCircle2 className="inline h-4 w-4 mr-1" />
                                                Unlimited
                                            </td>
                        ...
                        <div className="mb-16">
                            <h2 className="text-3xl font-bold text-[#F6F4EF] mb-6">The 20% Withholding Trap</h2>
                            <p className="text-[#D0CCC4] mb-6">
                                Here&apos;s why indirect rollovers are so problematic. Let&apos;s say you have $100,000 in your 401(k):
                            </p>

                            <div className="bg-[#161828] border border-[#2A2D42] rounded-2xl p-6 mb-6 shadow-sm">
                                <h4 className="font-bold text-[#F6F4EF] mb-4">Example: $100,000 Indirect Rollover</h4>
                        ...
                        <div className="mb-16">
                            <div className="flex items-center gap-3 mb-6">
                                ...
                                <h2 className="text-3xl font-bold text-[#F6F4EF]">The 60-Day Deadline</h2>
                            </div>
                            <p className="text-[#D0CCC4] mb-6">
                            ...
                            <div className="bg-[rgba(220,38,38,0.1)] border border-[#B22234]/30 rounded-xl p-6">
                                ...
                                <ul className="space-y-2 text-red-800">
                                    <li className="flex items-start gap-2">
                                        <AlertTriangle className="h-4 w-4 mt-1 shrink-0 text-[#D4A94E]" />
                        ...
                        {/* One Per Year Rule */}
                        <div className="mb-16">
                            <h2 className="text-3xl font-bold text-[#F6F4EF] mb-6">The Once-Per-Year Rule</h2>
                            <p className="text-[#D0CCC4] mb-6">
                                There&apos;s another catch with indirect rollovers: you can only do <strong className="text-[#F6F4EF]">one indirect rollover per 12-month period</strong> across all your IRAs. Do more than one and the second becomes a taxable distribution.
                            </p>
                            <p className="text-[#D0CCC4]">
                        ...
                        <div className="mb-16">
                            <h2 className="text-3xl font-bold text-[#F6F4EF] mb-6">When Would You Use an Indirect Rollover?</h2>
                            <p className="text-[#D0CCC4] mb-6">
                            ...
                            <div className="bg-[#161828] border border-[#2A2D42] rounded-xl p-6 shadow-sm">
                                <h4 className="font-bold text-[#F6F4EF] mb-3">Example &quot;Bridge Loan&quot; Scenario:</h4>
                                ...
                                <p className="text-[#D4A94E] text-sm mt-3">
                        ...
                        <div className="mb-16">
                            <h2 className="text-3xl font-bold text-[#F6F4EF] mb-6">How to Request a Direct Rollover</h2>
                            <p className="text-[#D0CCC4] mb-6">
                            ...
                            <div className="bg-green-50 border border-green-200 rounded-2xl p-8">
                                ...
                                <div className="grid md:grid-cols-3 gap-6 text-center">
                                    <div>
                                        ...
                                        <h4 className="font-bold text-[#F6F4EF] mb-2">Zero Risk</h4>
                                        <p className="text-[#D0CCC4] text-sm">Direct rollovers have no withholding, no deadline, and no annual limits.</p>
                                    </div>
                                    <div>
                                        <DollarSign className="h-8 w-8 text-green-600 mx-auto mb-3" />
                                        <h4 className="font-bold text-[#F6F4EF] mb-2">No Out-of-Pocket</h4>
                                        <p className="text-[#D0CCC4] text-sm">You won&apos;t need to come up with 20% from your own funds.</p>
                                    </div>
                                    <div>
                                        <CheckCircle2 className="h-8 w-8 text-green-600 mx-auto mb-3" />
                                        <h4 className="font-bold text-[#F6F4EF] mb-2">Simple Process</h4>
                                        <p className="text-[#D0CCC4] text-sm">Your Gold IRA company handles most of the paperwork.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <section className="py-12 bg-[#0C0D18] border-t border-[#2A2D42]">
                <Container>
                    <h2 className="text-2xl font-bold text-[#F6F4EF] mb-8 text-center">Related Rollover Guides</h2>
                    <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
                        <Link href="/guide/401k-to-gold-rollover" className="group bg-[#161828] border border-[#2A2D42] rounded-xl p-6 hover:border-[#B22234]/50 transition-all shadow-sm">
                        ...
                        <Link href="/guide/tsp-to-gold-ira-rollover" className="group bg-[#161828] border border-[#2A2D42] rounded-xl p-6 hover:border-[#B22234]/50 transition-all shadow-sm">
                        ...
                        <Link href="/guide/457b-to-gold-ira-rollover" className="group bg-[#161828] border border-[#2A2D42] rounded-xl p-6 hover:border-[#B22234]/50 transition-all shadow-sm">
