...
export default function BitcoinIRAPage() {
    return (
        <main className="min-h-screen flex flex-col bg-white">
                ...
                <Container className="relative z-10">
                    <div className="max-w-4xl">
                        <div className="flex items-center gap-2 text-[#D4A94E] text-sm font-medium mb-4">
                            <span className="bg-[rgba(220,38,38,0.1)] px-3 py-1 rounded-full">Educational Guide</span>
                ...
                <Container>
                    <div className="max-w-4xl mx-auto">
                        <div className="prose prose-lg max-w-none text-[#D0CCC4] prose-headings:text-[#F6F4EF] prose-strong:text-[#F6F4EF] prose-a:text-[#D4A94E]">
                            ...
                            <div className="bg-[#161828] border border-[#2A2D42] rounded-xl overflow-hidden not-prose my-8 shadow-sm">
                                <table className="w-full text-sm">
                                    <thead className="bg-[#0C0D18]">
                                        <tr>
                                            <th className="text-left p-4 text-[#F6F4EF] font-semibold">Scenario</th>
                                    ...
                                    <tbody className="divide-y divide-[#2A2D42]">
                                        <tr>
                                            <td className="p-4 text-[#D0CCC4]">Buy $10,000 Bitcoin</td>
                                            <td className="p-4 text-[#D0CCC4]">$10,000</td>
                                            <td className="p-4 text-[#D0CCC4]">$10,000</td>
                                        </tr>
                                        <tr>
                                            <td className="p-4 text-[#D0CCC4]">Value grows to $100,000</td>
                                            <td className="p-4 text-[#D0CCC4]">$90,000 gain</td>
                                            <td className="p-4 text-[#D0CCC4]">$90,000 gain</td>
                                        </tr>
                                        <tr>
                                            <td className="p-4 text-[#D0CCC4]">Tax on gain (selling)</td>
                                            <td className="p-4 text-red-600">~$18,000 (20% cap gains)</td>
                                            <td className="p-4 text-green-600">$0 (Roth) or deferred</td>
                                        </tr>
                                        <tr>
                                            <td className="p-4 text-[#D0CCC4]">Tax on trades/swaps</td>
                            ...
                            <div className="bg-[#161828] border border-[#2A2D42] rounded-xl p-6 not-prose my-8 shadow-sm">
                        ...
                        {/* Best Providers */}
                        <div className="my-12">
                            <h2 className="text-2xl font-serif font-bold text-[#F6F4EF] mb-6">Best Bitcoin IRA Providers</h2>
                            <div className="grid md:grid-cols-2 gap-6">
                                <div className="bg-[#161828] rounded-xl border-2 border-[#B22234] p-6 shadow-sm">
                                    ...
                                    <h3 className="text-xl font-bold text-[#F6F4EF] mb-2">iTrustCapital</h3>
                                    <p className="text-[#A8A39A] text-sm mb-4">Best overall with 1% trading fee, no monthly charges, and gold/silver option.</p>
                                ...
                                <div className="bg-[#161828] rounded-xl border border-[#2A2D42] p-6 shadow-sm">
                                    <h3 className="text-xl font-bold text-[#F6F4EF] mb-2">Alto IRA</h3>
                                    <p className="text-[#A8A39A] text-sm mb-4">Best for crypto variety with 200+ coins via Coinbase integration.</p>
                                    <ul className="space-y-1 text-sm text-[#D0CCC4] mb-4">
                                        <li>• 1% + spread fee</li>
                                        <li>• $0 minimum</li>
                                        <li>• 200+ cryptocurrencies</li>
                                    </ul>
                                    <Button variant="outline" className="w-full border-[#3F4460] text-[#D0CCC4] hover:bg-[#121423]" asChild>
            ...
            <section className="py-16 bg-[#0C0D18]">
                <Container>
                    ...
                    <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
                        <Link href="/crypto-ira" className="bg-[#161828] p-6 rounded-xl border border-[#2A2D42] hover:border-[#B22234]/50 transition-colors group shadow-sm">
                            ...
                            <p className="text-[#A8A39A] text-sm">Complete guide to all cryptocurrency retirement options.</p>
                        </Link>
                        <Link href="/best-crypto-ira-companies" className="bg-[#161828] p-6 rounded-xl border border-[#2A2D42] hover:border-[#B22234]/50 transition-colors group shadow-sm">
                            <Shield className="w-8 h-8 text-[#F6F4EF] mb-3" />
                            <h3 className="font-bold text-[#F6F4EF] mb-2 group-hover:text-[#D4A94E] transition-colors">Best Crypto IRA Companies</h3>
                            <p className="text-[#A8A39A] text-sm">Compare the top Bitcoin IRA providers side-by-side.</p>
                        </Link>
                        <Link href="/compare/gold-ira-vs-crypto" className="bg-[#161828] p-6 rounded-xl border border-[#2A2D42] hover:border-[#B22234]/50 transition-colors group shadow-sm">
                            <TrendingUp className="w-8 h-8 text-[#D4A94E] mb-3" />
                            <h3 className="font-bold text-[#F6F4EF] mb-2 group-hover:text-[#D4A94E] transition-colors">Gold IRA vs Crypto IRA</h3>
                            <p className="text-[#A8A39A] text-sm">Which alternative asset is right for your retirement?</p>
                        </Link>
                    </div>
                </Container>
            </section>
            ...
            {/* Bottom CTA */}
            <section className="py-16 bg-[#121423] border-t border-[#2A2D42]">
                <Container>
