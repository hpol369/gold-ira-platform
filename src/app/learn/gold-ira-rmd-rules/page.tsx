          ...
          <Container>
            <article className="max-w-3xl mx-auto prose prose-lg prose-headings:font-serif prose-headings:text-[#F6F4EF] prose-p:text-[#D0CCC4] prose-strong:text-[#F6F4EF] prose-li:text-[#D0CCC4] max-w-none">
              ...
              <p>
                ...
                <Link href="/tools/rmd-calculator" className="text-[#D4A94E] font-semibold hover:underline">
                  RMD calculator
                </Link>.
              </p>
              ...
              <div className="bg-[#0C0D18] rounded-xl border border-[#2A2D42] p-6 my-6 not-prose">
                ...
                <p className="mt-3 text-sm text-[#D0CCC4]">
              ...
              <p>
                ...
                <Link href="/learn/gold-ira-tax-rules" className="text-[#D4A94E] font-semibold hover:underline">
              ...
              <p className="text-center font-bold text-lg text-[#F6F4EF]">
              ...
              <p>
                ...
                <Link href="/learn/how-much-gold-in-retirement-portfolio" className="text-[#D4A94E] font-semibold hover:underline">
