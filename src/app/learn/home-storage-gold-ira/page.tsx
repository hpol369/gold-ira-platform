                    ...
                    <article className="flex-1 prose prose-lg prose-headings:font-serif prose-headings:text-primary max-w-none">
                        ...
                        <section id="penalties" className="scroll-mt-32">
                            ...
                            <div className="not-prose my-8 p-6 bg-red-50 rounded-xl border border-red-100">
                                <p className="font-bold text-red-800 mb-4">Example: $100,000 Home Storage IRA</p>
                                <ul className="space-y-2 text-red-700">
                                    ...
                                    <li className="pt-2 border-t border-red-200"><strong>Total Loss:</strong> $40,000+ (possibly more)</li>
                                </ul>
