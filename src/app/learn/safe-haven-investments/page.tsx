        ...
        <main className="min-h-screen bg-white pb-24">
            ...
            <Container className="py-12">
                <div className="flex flex-col lg:flex-row gap-12 max-w-6xl mx-auto">
                    ...
                    {/* Content */}
                    <article className="flex-1 prose prose-lg  prose-headings:font-serif prose-headings:text-[#F6F4EF] prose-p:text-[#D0CCC4] prose-li:text-[#D0CCC4] prose-p:text-[#D0CCC4] prose-strong:text-[#F6F4EF] prose-li:text-[#D0CCC4] max-w-none">
                            ...
                            <div className="overflow-x-auto not-prose my-8">
                                <table className="w-full text-left border-collapse bg-[#0C0D18] backdrop-blur-sm rounded-xl shadow-sm border border-[#2A2D42]">
                                    ...
                                    <tbody className="divide-y divide-white/10 text-sm">
                                        ...
                                        <tr>
                                            <td className="p-4 text-[#F6F4EF]">2022 Rate Shock</td>
                                            <td className="p-4 text-red-700 font-semibold">-18%</td>
                                            <td className="p-4 text-yellow-400 font-semibold">0% (held value)</td>
                                        </tr>
                                        <tr>
                                            <td className="p-4 text-[#F6F4EF]">2024-2025 Geopolitical Tensions</td>
                                            <td className="p-4 text-[#A8A39A] font-semibold">Volatile</td>
                        ...
                        <section id="bonds" className="scroll-mt-32">
                            <div className="flex items-center gap-4 mb-4 not-prose">
                                ...
                                <h2 className="text-2xl md:text-3xl font-serif font-bold text-[#F6F4EF] m-0">2. US Treasury Bonds</h2>
                            </div>
                            <p>
                        ...
                        <section id="currencies" className="scroll-mt-32">
                            <div className="flex items-center gap-4 mb-4 not-prose">
                                ...
                                <h2 className="text-2xl md:text-3xl font-serif font-bold text-[#F6F4EF] m-0">3. Safe Haven Currencies</h2>
                            </div>
                            <p>
                        ...
                        <section id="cash" className="scroll-mt-32">
                            <div className="flex items-center gap-4 mb-4 not-prose">
                                <div className="p-3 bg-slate-700/50 rounded-lg text-[#A8A39A]">
                                    <Lock className="w-6 h-6" />
                                </div>
                                <h2 className="text-2xl md:text-3xl font-serif font-bold text-[#F6F4EF] m-0">4. Cash & Cash Equivalents</h2>
                            </div>
                            <p>
                        ...
                        <div className="my-12 bg-primary rounded-2xl p-8 text-[#F6F4EF] text-center relative overflow-hidden not-prose">
                            ...
                            <div className="relative z-10">
                                <h3 className="text-2xl font-serif font-bold mb-4 text-[#F6F4EF]">Add the Ultimate Safe Haven to Your Portfolio</h3>
                        ...
                        <section id="defensive" className="scroll-mt-32">
                            <div className="flex items-center gap-4 mb-4 not-prose">
                                ...
                                <h2 className="text-2xl md:text-3xl font-serif font-bold text-[#F6F4EF] m-0">5. Defensive Stocks</h2>
                            </div>
                            <p>
                        ...
                        <section id="land" className="scroll-mt-32">
                            <div className="flex items-center gap-4 mb-4 not-prose">
                                ...
                                <h2 className="text-2xl md:text-3xl font-serif font-bold text-[#F6F4EF] m-0">6. Farmland & Land</h2>
                            </div>
                            <p>
                        ...
                        <section id="allocation" className="scroll-mt-32">
                            <div className="flex items-center gap-4 mb-4 not-prose">
                                ...
                                <h2 className="text-2xl md:text-3xl font-serif font-bold text-[#F6F4EF] m-0">Building Your Safe Haven Strategy</h2>
                            </div>
                            <p>
                            ...
                            <div className="bg-[#0C0D18] backdrop-blur-sm rounded-2xl p-6 border border-[#2A2D42] not-prose my-8">
                                <h4 className="font-bold text-[#F6F4EF] text-lg mb-4">Sample Safe Haven Allocation</h4>
                                <div className="space-y-3">
                                    <div className="flex justify-between items-center p-3 bg-[#0C0D18] backdrop-blur-sm border border-[#2A2D42] rounded-lg">
                                        ...
                                        <span className="font-semibold text-[#D4A94E]">10-15%</span>
                                    </div>
                                    <div className="flex justify-between items-center p-3 bg-[#0C0D18] backdrop-blur-sm border border-[#2A2D42] rounded-lg">
                                        <span className="text-[#D0CCC4]">Treasury Bonds</span>
                                        <span className="font-semibold text-blue-700">15-25%</span>
                                    </div>
                                    <div className="flex justify-between items-center p-3 bg-[#0C0D18] backdrop-blur-sm border border-[#2A2D42] rounded-lg">
                                        <span className="text-[#D0CCC4]">Cash & Equivalents</span>
                                        <span className="font-semibold text-[#A8A39A]">5-15%</span>
                                    </div>
                                    <div className="flex justify-between items-center p-3 bg-[#0C0D18] backdrop-blur-sm border border-[#2A2D42] rounded-lg">
                                        <span className="text-[#D0CCC4]">Defensive Stocks</span>
                                        <span className="font-semibold text-purple-700">10-20%</span>
                                    </div>
                                    <div className="flex justify-between items-center p-3 bg-[#0C0D18] backdrop-blur-sm border border-[#2A2D42] rounded-lg">
                                        <span className="text-[#D0CCC4]">Growth Assets (Stocks)</span>
                                        <span className="font-semibold text-green-700">40-60%</span>
                                    </div>
                                </div>
                                <p className="text-sm text-[#A8A39A] mt-4">Adjust based on your risk tolerance, time horizon, and current market conditions.</p>
                            </div>
                        </section>
                            ...
                            <div className="space-y-4 not-prose">
                                <details className="group bg-[#0C0D18] backdrop-blur-sm rounded-xl border border-[#2A2D42] p-6 [&_summary::-webkit-details-marker]:hidden">
                                    <summary className="flex cursor-pointer items-center justify-between gap-1.5 text-[#F6F4EF]">
                                        ...
                                        <span className="shrink-0 rounded-full bg-[rgba(197,149,46,0.14)]/10 p-1.5 text-secondary sm:p-3">
                        ...
                        <div className="my-12 bg-gradient-to-br from-primary to-primary-dark rounded-2xl p-8 text-[#F6F4EF] relative overflow-hidden not-prose">
                            ...
                            <div className="relative z-10 text-center">
                                <h3 className="text-3xl font-serif font-bold mb-4 text-[#F6F4EF]">Build Your Safe Haven Portfolio</h3>
