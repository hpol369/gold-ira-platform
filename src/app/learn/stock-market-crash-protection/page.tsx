                    ...
                    <article className="flex-1 prose prose-lg prose-headings:font-serif prose-headings:text-[#F6F4EF] prose-p:text-[#D0CCC4] prose-strong:text-[#F6F4EF] prose-li:text-[#D0CCC4] max-w-none">
                            ...
                            <div className="overflow-x-auto not-prose my-8">
                                <table className="w-full text-left border-collapse bg-[#0C0D18] rounded-xl shadow-sm border border-[#2A2D42]">
                                    <thead className="bg-[#121423]">
                                        <tr>
                                            <th className="p-4 border-b border-[#2A2D42] font-bold text-[#F6F4EF]">Crash</th>
                                            <th className="p-4 border-b border-[#2A2D42] font-bold text-[#F6F4EF]">S&P 500 Decline</th>
                                            <th className="p-4 border-b border-[#2A2D42] font-bold text-[#F6F4EF]">Recovery Time</th>
                                        </tr>
                                    </thead>
                                    <tbody className="divide-y divide-white/10 text-sm">
                                        <tr>
                                            <td className="p-4 text-[#F6F4EF]">Dot-Com Crash (2000-2002)</td>
                                            <td className="p-4 text-red-700 font-semibold">-49%</td>
                                            <td className="p-4 text-[#A8A39A]">7 years</td>
                                        </tr>
                                        <tr>
                                            <td className="p-4 text-[#F6F4EF]">Financial Crisis (2007-2009)</td>
                                            <td className="p-4 text-red-700 font-semibold">-57%</td>
                                            <td className="p-4 text-[#A8A39A]">5.5 years</td>
                                        </tr>
                                        <tr>
                                            <td className="p-4 text-[#F6F4EF]">COVID Crash (2020)</td>
                                            <td className="p-4 text-red-700 font-semibold">-34%</td>
                                            <td className="p-4 text-[#A8A39A]">6 months</td>
                                        </tr>
                                        <tr>
                                            <td className="p-4 text-[#F6F4EF]">2022 Bear Market</td>
                                            <td className="p-4 text-red-700 font-semibold">-25%</td>
                                            <td className="p-4 text-[#A8A39A]">~2 years</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                        ...
                        <section id="retirement-risk" className="scroll-mt-32">
                            ...
                            <div className="bg-[rgba(220,38,38,0.08)]0/10 rounded-2xl p-6 border border-red-500/20 not-prose my-8">
                                ...
                                <div className="grid md:grid-cols-2 gap-4">
                                    <div className="bg-[#0C0D18] border border-[#2A2D42] p-4 rounded-xl">
                                        <h5 className="font-semibold text-green-700 mb-2">Retiree A: Crash in Year 20</h5>
                                        <p className="text-sm text-[#A8A39A]">Portfolio lasts 30+ years</p>
                                    </div>
                                    <div className="bg-[#0C0D18] border border-[#2A2D42] p-4 rounded-xl">
                                        <h5 className="font-semibold text-red-700 mb-2">Retiree B: Crash in Year 1</h5>
                                        <p className="text-sm text-[#A8A39A]">Portfolio depleted by year 18</p>
                                    </div>
                                </div>
                        ...
                        <div className="my-12 bg-[rgba(197,149,46,0.1)] rounded-2xl p-8 text-[#F6F4EF] text-center relative overflow-hidden not-prose">
                            ...
                            <div className="relative z-10">
                                <h3 className="text-2xl font-serif font-bold mb-4 text-[#F6F4EF]">Protect Your Retirement Now</h3>
                        ...
                        <section id="strategies" className="scroll-mt-32">
                            ...
                            <div className="bg-[#0C0D18] rounded-2xl p-6 border border-[#2A2D42] not-prose my-8">
                                <h4 className="font-bold text-[#F6F4EF] text-lg mb-4">Sample Crash-Protected Portfolio</h4>
                                <div className="grid md:grid-cols-2 gap-4">
                                    <div>
                                        <h5 className="font-semibold text-[#D0CCC4] mb-3">Traditional (Vulnerable)</h5>
                                    ...
                                    <div>
                                        <h5 className="font-semibold text-[#D0CCC4] mb-3">Protected (Resilient)</h5>
                                        <ul className="space-y-2 text-sm text-[#A8A39A]">
                        ...
                        <section id="action-plan" className="scroll-mt-32">
                            ...
                            <div className="space-y-4 not-prose my-8">
                                <div className="flex gap-4 p-5 rounded-xl bg-[#0C0D18] border border-[#2A2D42]">
                                    ...
                                    <div>
                                        <h4 className="font-bold text-[#F6F4EF]">Assess Your Current Exposure</h4>
                                        <p className="text-sm text-[#A8A39A] mt-1">Review your 401(k), IRA, and other accounts. What percentage is in stocks? How would a 50% crash affect you?</p>
                                    </div>
                                </div>
                                <div className="flex gap-4 p-5 rounded-xl bg-[#0C0D18] border border-[#2A2D42]">
                                    ...
                                    <div>
                                        <h4 className="font-bold text-[#F6F4EF]">Determine Your Gold Allocation</h4>
                                        <p className="text-sm text-[#A8A39A] mt-1">Most advisors recommend 10-20% in precious metals. Those closer to retirement may want more protection.</p>
                                    </div>
                                </div>
                                <div className="flex gap-4 p-5 rounded-xl bg-[#0C0D18] border border-[#2A2D42]">
                                    ...
                                    <div>
                                        <h4 className="font-bold text-[#F6F4EF]">Open a Gold IRA</h4>
                                        <p className="text-sm text-[#A8A39A] mt-1">Rollover a portion of your 401(k) or IRA into physical gold—tax-free. <Link href="/quiz" className="text-[#D4A94E] hover:underline">Take our quiz</Link> to find the best company for your situation.</p>
                                    </div>
                                </div>
                                <div className="flex gap-4 p-5 rounded-xl bg-[#0C0D18] border border-[#2A2D42]">
                                    ...
                                    <div>
                                        <h4 className="font-bold text-[#F6F4EF]">Build Your Cash Reserve</h4>
                                        <p className="text-sm text-[#A8A39A] mt-1">Aim for 1-2 years of living expenses in accessible cash. This prevents forced selling during crashes.</p>
                                    </div>
                                </div>
                            </div>
                        </section>
                            ...
                            <div className="space-y-4 not-prose">
                                <details className="group bg-[#0C0D18] rounded-xl border border-[#2A2D42] p-6 [&_summary::-webkit-details-marker]:hidden">
                                    ...
                                    <p className="mt-4 leading-relaxed text-[#A8A39A]">
                                        Key protection strategies include: diversifying into non-correlated assets like gold and precious metals (10-20% allocation), maintaining adequate cash reserves, reducing stock exposure as you near retirement, and considering defensive positioning with bonds and dividend stocks. A <Link href="/what-is-a-gold-ira" className="text-[#D4A94E] hover:underline">Gold IRA</Link> allows you to hold physical gold with tax advantages.
                                    </p>
                                </details>
                        ...
                        <div className="my-12 bg-[rgba(197,149,46,0.1)] rounded-2xl p-8 text-[#F6F4EF] relative overflow-hidden not-prose">
                            ...
                            <div className="relative z-10 text-center">
                                <h3 className="text-3xl font-serif font-bold mb-4 text-[#F6F4EF]">Don&apos;t Wait for the Next Crash</h3>
