                    ...
                    <article className="flex-1 prose prose-lg prose-headings:font-serif prose-headings:text-[#F6F4EF] prose-p:text-[#D0CCC4] prose-strong:text-[#F6F4EF] prose-li:text-[#D0CCC4] max-w-none">
                        ...
                        <section id="overview" className="scroll-mt-32">
                            ...
                            <div className="bg-[#0C0D18] rounded-2xl p-6 border border-[#2A2D42] not-prose my-8">
                                <h4 className="font-bold text-[#F6F4EF] text-lg mb-4">IRS Purity Requirements</h4>
                                <div className="space-y-3">
                                    <div className="flex items-center justify-between p-3 bg-[#161828] border border-[#2A2D42] rounded-lg">
                                        <span className="font-medium text-[#F6F4EF]">Gold</span>
                                        <span className="text-[#D4A94E] font-bold">99.5% pure (0.995)</span>
                                    </div>
                                    <div className="flex items-center justify-between p-3 bg-[#161828] border border-[#2A2D42] rounded-lg">
                                        <span className="font-medium text-[#F6F4EF]">Silver</span>
                                        <span className="text-[#D4A94E] font-bold">99.9% pure (0.999)</span>
                                    </div>
                                    <div className="flex items-center justify-between p-3 bg-[#161828] border border-[#2A2D42] rounded-lg">
                                        <span className="font-medium text-[#F6F4EF]">Platinum</span>
                                        <span className="text-[#D4A94E] font-bold">99.95% pure (0.9995)</span>
                                    </div>
                                    <div className="flex items-center justify-between p-3 bg-[#161828] border border-[#2A2D42] rounded-lg">
                                        <span className="font-medium text-[#F6F4EF]">Palladium</span>
                                        <span className="text-[#D4A94E] font-bold">99.95% pure (0.9995)</span>
                                    </div>
                                </div>
                            </div>
                                ...
                                <table className="w-full text-left border-collapse bg-[#0C0D18] rounded-xl shadow-sm border border-[#2A2D42]">
                                    <thead className="bg-[#121423]">
                                        <tr>
                                            ...
                                            <th className="p-4 border-b border-[#2A2D42] font-bold text-[#F6F4EF]">Minimum Fineness</th>
                                            <th className="p-4 border-b border-[#2A2D42] font-bold text-[#F6F4EF]">Country of Origin</th>
                                        </tr>
                                    </thead>
                                    <tbody className="divide-y divide-[#2A2D42] text-sm">
                                        <tr>
                                            <td className="p-4 font-semibold text-[#F6F4EF]">American Gold Eagle</td>
                                            <td className="p-4 text-[#D0CCC4]">Coin</td>
                                            <td className="p-4 text-[#D0CCC4]">91.67% (22k)*</td>
                                            <td className="p-4 text-[#D0CCC4]">United States</td>
                                        </tr>
                                        <tr className="bg-[#121423]/50">
                                            <td className="p-4 font-semibold text-[#F6F4EF]">American Gold Buffalo</td>
                                            <td className="p-4 text-[#D0CCC4]">Coin</td>
                                            <td className="p-4 text-[#D0CCC4]">99.99% (24k)</td>
                                            <td className="p-4 text-[#D0CCC4]">United States</td>
                                        </tr>
                                        <tr>
                                            <td className="p-4 font-semibold text-[#F6F4EF]">Canadian Gold Maple Leaf</td>
                                            <td className="p-4 text-[#D0CCC4]">Coin</td>
                                            <td className="p-4 text-[#D0CCC4]">99.99% (24k)</td>
                                            <td className="p-4 text-[#D0CCC4]">Canada</td>
                                        </tr>
                                        <tr className="bg-[#121423]/50">
                                            <td className="p-4 font-semibold text-[#F6F4EF]">Austrian Gold Philharmonic</td>
                                            <td className="p-4 text-[#D0CCC4]">Coin</td>
                                            <td className="p-4 text-[#D0CCC4]">99.99% (24k)</td>
                                            <td className="p-4 text-[#D0CCC4]">Austria</td>
                                        </tr>
                                        <tr>
                                            <td className="p-4 font-semibold text-[#F6F4EF]">Australian Gold Kangaroo</td>
                                            <td className="p-4 text-[#D0CCC4]">Coin</td>
                                            <td className="p-4 text-[#D0CCC4]">99.99% (24k)</td>
                                            <td className="p-4 text-[#D0CCC4]">Australia</td>
                                        </tr>
                                        <tr className="bg-[#121423]/50">
                                            <td className="p-4 font-semibold text-[#F6F4EF]">Credit Suisse Gold Bar</td>
                                            <td className="p-4 text-[#D0CCC4]">Bar</td>
                                            <td className="p-4 text-[#D0CCC4]">99.5% (0.995)</td>
                                            <td className="p-4 text-[#D0CCC4]">Switzerland</td>
                                        </tr>
                                        <tr>
                                            <td className="p-4 font-semibold text-[#F6F4EF]">PAMP Suisse Gold Bar</td>
                                            <td className="p-4 text-[#D0CCC4]">Bar</td>
                                            <td className="p-4 text-[#D0CCC4]">99.99% (24k)</td>
                                            <td className="p-4 text-[#D0CCC4]">Switzerland</td>
                                        </tr>
                        ...
                        <section id="gold-coins" className="scroll-mt-32">
                            <div className="flex items-center gap-4 mb-4 not-prose">
                                ...
                                <h2 className="text-2xl md:text-3xl font-serif font-bold text-[#F6F4EF] m-0">IRA-Approved Gold Coins</h2>
                            </div>
                            <p>
                                ...
                                <table className="w-full text-left border-collapse bg-[#0C0D18] rounded-xl shadow-sm border border-[#2A2D42]">
                                    ...
                                    <tbody className="divide-y divide-[#2A2D42] text-sm">
                                        <tr>
                                            <td className="p-4 font-semibold text-[#F6F4EF]">American Gold Eagle</td>
                                            <td className="p-4 text-[#D0CCC4]">91.67% (22k)*</td>
                                            <td className="p-4 text-[#D0CCC4]">1 oz, 1/2 oz, 1/4 oz, 1/10 oz</td>
                                            <td className="p-4 text-[#D0CCC4]">4-8%</td>
                                        </tr>
                                        <tr className="bg-[#121423]/50">
                                            <td className="p-4 font-semibold text-[#F6F4EF]">American Gold Buffalo</td>
                                            <td className="p-4 text-[#D0CCC4]">99.99% (24k)</td>
                                        ...
                                        <tr className="bg-[#121423]/50">
                                            <td className="p-4 font-semibold text-[#F6F4EF]">British Gold Britannia</td>
                                            <td className="p-4 text-[#D0CCC4]">99.99% (24k)</td>
                                            <td className="p-4 text-[#D0CCC4]">1 oz</td>
                                            <td className="p-4 text-[#D0CCC4]">3-6%</td>
                                        </tr>
                            ...
                            <p className="text-sm text-[#D0CCC4]">*American Gold Eagle is specifically approved by Congress despite lower purity.</p>
                        ...
                        <section id="gold-bars" className="scroll-mt-32">
                            <div className="flex items-center gap-4 mb-4 not-prose">
                                ...
                                <h2 className="text-2xl md:text-3xl font-serif font-bold text-[#F6F4EF] m-0">IRA-Approved Gold Bars</h2>
                            </div>
                            <p>
                        ...
                        <section id="silver" className="scroll-mt-32">
                            <div className="flex items-center gap-4 mb-4 not-prose">
                                ...
                                <h2 className="text-2xl md:text-3xl font-serif font-bold text-[#F6F4EF] m-0">IRA-Approved Silver</h2>
                            </div>
                            <p>
                                ...
                                <table className="w-full text-left border-collapse bg-[#0C0D18] rounded-xl shadow-sm border border-[#2A2D42]">
                                    ...
                                    <tbody className="divide-y divide-[#2A2D42] text-sm">
                                        <tr>
                                            ...
                                            <td className="p-4 text-[#D0CCC4]">99.9%</td>
                                            <td className="p-4 text-[#D0CCC4]">10-20%</td>
                                        </tr>
                                        <tr className="bg-[#121423]/50">
                                            <td className="p-4 font-semibold text-[#F6F4EF]">Canadian Silver Maple Leaf</td>
                                            <td className="p-4 text-[#D0CCC4]">99.99%</td>
                                            <td className="p-4 text-[#D0CCC4]">8-15%</td>
                                        </tr>
                                        <tr>
                                            <td className="p-4 font-semibold text-[#F6F4EF]">Austrian Silver Philharmonic</td>
                                            <td className="p-4 text-[#D0CCC4]">99.9%</td>
                                            <td className="p-4 text-[#D0CCC4]">8-12%</td>
                                        </tr>
                                        <tr className="bg-[#121423]/50">
                                            <td className="p-4 font-semibold text-[#F6F4EF]">British Silver Britannia</td>
                                            <td className="p-4 text-[#D0CCC4]">99.9%</td>
                                            <td className="p-4 text-[#D0CCC4]">8-12%</td>
                                        </tr>
                                    </tbody>
                        ...
                        <section id="platinum-palladium" className="scroll-mt-32">
                            <div className="flex items-center gap-4 mb-4 not-prose">
                                ...
                                <h2 className="text-2xl md:text-3xl font-serif font-bold text-[#F6F4EF] m-0">Platinum & Palladium</h2>
                            </div>
                            <p>
                        ...
                        <section id="how-to-choose" className="scroll-mt-32">
                            ...
                            <div className="not-prose my-8 space-y-4">
                                <div className="flex gap-4 p-5 rounded-xl bg-[#0C0D18] border border-[#2A2D42] shadow-sm">
                                    <CheckCircle2 className="w-6 h-6 text-green-600 shrink-0 mt-1" />
                                    <div>
                                        <h4 className="font-bold text-[#F6F4EF]">Consider Premiums</h4>
                                        <p className="text-sm text-[#D0CCC4] mt-1">Bars have lower premiums than coins. If you&apos;re maximizing gold per dollar, consider bars from reputable refiners.</p>
                                    </div>
                                </div>
                                <div className="flex gap-4 p-5 rounded-xl bg-[#0C0D18] border border-[#2A2D42] shadow-sm">
                                    <CheckCircle2 className="w-6 h-6 text-green-600 shrink-0 mt-1" />
                                    <div>
                                        <h4 className="font-bold text-[#F6F4EF]">Consider Liquidity</h4>
                                        <p className="text-sm text-[#D0CCC4] mt-1">American Gold Eagles are the most recognized and liquid. They may sell faster and at better prices when you need to liquidate.</p>
                                    </div>
                                </div>
                                <div className="flex gap-4 p-5 rounded-xl bg-[#0C0D18] border border-[#2A2D42] shadow-sm">
                                    <CheckCircle2 className="w-6 h-6 text-green-600 shrink-0 mt-1" />
                                    <div>
                                        <h4 className="font-bold text-[#F6F4EF]">Consider Storage</h4>
                                        <p className="text-sm text-[#D0CCC4] mt-1">Smaller denominations (1/4 oz, 1/10 oz) offer flexibility for partial distributions but carry higher per-ounce premiums.</p>
                                    </div>
                                </div>
                                <div className="flex gap-4 p-5 rounded-xl bg-[#0C0D18] border border-[#2A2D42] shadow-sm">
                                    <CheckCircle2 className="w-6 h-6 text-green-600 shrink-0 mt-1" />
                                    <div>
                                        <h4 className="font-bold text-[#F6F4EF]">Consider Diversification</h4>
                                        <p className="text-sm text-[#D0CCC4] mt-1">Many investors hold a mix: gold for stability, silver for growth potential. Common allocations range from 60/40 to 80/20 gold/silver.</p>
                                    </div>
                                </div>
                            </div>
