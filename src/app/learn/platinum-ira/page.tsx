                    ...
                    <article className="flex-1 prose prose-lg prose-headings:font-serif prose-headings:text-[#F6F4EF] prose-p:text-[#D0CCC4] prose-strong:text-[#F6F4EF] prose-li:text-[#D0CCC4] max-w-none">
                        ...
                        <section id="what-is-platinum" className="scroll-mt-32">
                            <div className="flex items-center gap-4 mb-4 not-prose">
                                ...
                                <h2 className="text-2xl md:text-3xl font-serif font-bold text-[#F6F4EF] m-0">Why Platinum?</h2>
                            </div>
                            <p>
                        ...
                        <section id="investment-case" className="scroll-mt-32">
                            <div className="flex items-center gap-4 mb-4 not-prose">
                                ...
                                <h2 className="text-2xl md:text-3xl font-serif font-bold text-[#F6F4EF] m-0">The Bull Case for Platinum</h2>
                            </div>
                            <p>
                                ...
                                <table className="w-full text-left border-collapse bg-[#0C0D18] rounded-xl shadow-sm border border-[#2A2D42]">
                                    <thead className="bg-[#121423]">
                                        <tr>
                                            ...
                                            <th className="p-4 border-b border-[#2A2D42] font-bold text-[#F6F4EF]">Platinum</th>
                                        </tr>
                                    </thead>
                                    <tbody className="divide-y divide-[#2A2D42] text-sm">
                                        <tr>
                                            <td className="p-4 font-semibold text-[#F6F4EF]">Primary Use</td>
                                            <td className="p-4 text-[#D0CCC4]">Monetary / Investment</td>
                                            <td className="p-4 text-[#D0CCC4]">Industrial / Auto</td>
                                        </tr>
                                        <tr>
                                            <td className="p-4 font-semibold text-[#F6F4EF]">Economic Sensitivity</td>
                                            <td className="p-4 text-[#D0CCC4]">Counter-cyclical (Safe Haven)</td>
                                            <td className="p-4 text-[#D0CCC4]">Pro-cyclical (Grows with Economy)</td>
                                        </tr>
                                        <tr>
                                            <td className="p-4 font-semibold text-[#F6F4EF]">Volatility</td>
                                            <td className="p-4 text-[#D0CCC4]">Low/Moderate</td>
                        ...
                        <section id="risks" className="scroll-mt-32">
                            <div className="flex items-center gap-4 mb-4 not-prose">
                                ...
                                <h2 className="text-2xl md:text-3xl font-serif font-bold text-[#F6F4EF] m-0">The Risks</h2>
                            </div>
                            <p>
                        ...
                        <section id="faq" className="scroll-mt-32">
                            ...
                            <div className="space-y-4 not-prose">
                                {(schema["@graph"][1] as { mainEntity: Array<{ name: string; acceptedAnswer: { text: string } }> }).mainEntity.map((faq, index) => (
                                    <details key={index} className="group bg-[#0C0D18] rounded-xl border border-[#2A2D42] p-6 [&_summary::-webkit-details-marker]:hidden">
