        ...
        <section className="bg-gradient-to-b from-slate-50 to-white border-b border-slate-100 pt-28 pb-12 md:pt-32 md:pb-16">
          <Container>
            <nav className="flex items-center gap-2 text-sm text-slate-500 mb-6" aria-label="Breadcrumb">
              ...
              <span>/</span>
              <span className="text-[#000080] font-medium">Gold as Inflation Hedge</span>
            </nav>
          ...
          <article className="max-w-3xl mx-auto">
            ...
            <section id="gold-2020s" className="mb-12 scroll-mt-24">
              ...
              <ul className="space-y-2 text-slate-600 mb-4 ml-4">
                <li className="flex items-start gap-2"><CheckCircle2 className="h-5 w-5 text-slate-400 mt-0.5 shrink-0" /> Inflation expectations</li>
                <li className="flex items-start gap-2"><CheckCircle2 className="h-5 w-5 text-slate-400 mt-0.5 shrink-0" /> Federal Reserve policy</li>
                <li className="flex items-start gap-2"><CheckCircle2 className="h-5 w-5 text-slate-400 mt-0.5 shrink-0" /> Real interest rates</li>
                <li className="flex items-start gap-2"><CheckCircle2 className="h-5 w-5 text-slate-400 mt-0.5 shrink-0" /> Recession fears</li>
                <li className="flex items-start gap-2"><CheckCircle2 className="h-5 w-5 text-slate-400 mt-0.5 shrink-0" /> Geopolitical stress</li>
                <li className="flex items-start gap-2"><CheckCircle2 className="h-5 w-5 text-slate-400 mt-0.5 shrink-0" /> Investor demand</li>
              </ul>
              <p className="text-slate-600">
                That is why retirees should think of gold as one tool in an inflation plan, not the whole plan. Our <Link href="/retirement-risk-score" className="text-[#B22234] font-medium hover:underline">Retirement Risk Score quiz</Link> can help assess your overall exposure.
              </p>
            </section>
            ...
            <section id="recessions" className="mb-12 scroll-mt-24">
              ...
              <p className="text-slate-600">
                Gold may provide value in a retirement portfolio not just because of inflation, but because it can diversify when traditional assets struggle. Still, diversification is not the same as guarantee. Use our <Link href="/tools/retirement-calculator" className="text-[#B22234] font-medium hover:underline">retirement calculator</Link> to see how different allocations affect your outlook.
              </p>
            </section>
            ...
            <section id="who-is-this-for" className="mb-12 scroll-mt-24">
              ...
              <p className="text-slate-600 mt-4">
                If gold does not seem right for your situation, explore <Link href="/when-not-to-open-gold-ira" className="text-[#B22234] font-medium hover:underline">when not to open a gold IRA</Link> for alternatives.
              </p>
            </section>
