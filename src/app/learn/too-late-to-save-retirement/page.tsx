                    ...
                    <article className="flex-1 prose prose-lg prose-headings:font-serif prose-headings:text-[#F6F4EF] prose-p:text-[#D0CCC4] prose-strong:text-[#F6F4EF] prose-li:text-[#D0CCC4] max-w-none">
                            ...
                            <div className="overflow-x-auto not-prose my-8">
                                <table className="w-full text-left border-collapse bg-[#0C0D18] rounded-xl shadow-sm border border-[#2A2D42]">
                                    <thead className="bg-[#121423]">
                                        <tr>
                                            <th className="p-4 border-b border-[#2A2D42] font-bold text-[#F6F4EF]">Account Type</th>
                                            <th className="p-4 border-b border-[#2A2D42] font-bold text-[#F6F4EF]">Standard Limit (2026)</th>
                                            <th className="p-4 border-b border-[#2A2D42] font-bold text-[#F6F4EF]">Catch-Up (50+)</th>
                                            <th className="p-4 border-b border-[#2A2D42] font-bold text-[#F6F4EF]">Total Possible</th>
                                        </tr>
                                    </thead>
                                    <tbody className="divide-y divide-white/10 text-sm">
                                        <tr>
                                            <td className="p-4 text-[#F6F4EF]">401(k) / 403(b)</td>
                                            <td className="p-4 text-[#A8A39A]">$23,000</td>
                                            <td className="p-4 text-green-700 font-semibold">+$7,500</td>
                                            <td className="p-4 text-[#D4A94E] font-bold">$30,500</td>
                                        </tr>
                                        <tr>
                                            <td className="p-4 text-[#F6F4EF]">Traditional/Roth IRA</td>
                                            <td className="p-4 text-[#A8A39A]">$7,000</td>
                                            <td className="p-4 text-green-700 font-semibold">+$1,000</td>
                                            <td className="p-4 text-[#D4A94E] font-bold">$8,000</td>
                                        </tr>
                                        <tr>
                                            <td className="p-4 text-[#F6F4EF]">SIMPLE IRA</td>
                                            <td className="p-4 text-[#A8A39A]">$16,000</td>
                                            <td className="p-4 text-green-700 font-semibold">+$3,500</td>
                                            <td className="p-4 text-[#D4A94E] font-bold">$19,500</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                            ...
                            <div className="bg-[#0C0D18] rounded-2xl p-6 border border-[#2A2D42] not-prose my-8">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="flex justify-between items-center p-3 bg-[#161828]0/10 rounded-lg border border-amber-500/20">
                                        ...
                                        <div className="text-right">
                                            <div className="text-[#D4A94E] font-bold">$2,000/month</div>
                                ...
                                <p className="text-sm text-[#A8A39A] mt-4 text-center">
                        ...
                        <section id="lifestyle" className="scroll-mt-32">
                            <div className="flex items-center gap-4 mb-4 not-prose">
                                ...
                                <h2 className="text-2xl md:text-3xl font-serif font-bold text-[#F6F4EF] m-0">Strategy #3: Lifestyle Adjustments & Downsizing</h2>
                            </div>
                        ...
                        <section id="work-retirement" className="scroll-mt-32">
                            <div className="flex items-center gap-4 mb-4 not-prose">
                                ...
                                <h2 className="text-2xl md:text-3xl font-serif font-bold text-[#F6F4EF] m-0">Strategy #4: Working Part-Time in Retirement</h2>
                            </div>
                            ...
                            <div className="bg-[#0C0D18] rounded-2xl p-6 border border-[#2A2D42] not-prose my-8">
                                <h4 className="font-bold text-[#F6F4EF] text-lg mb-4">The Math of Part-Time Work</h4>
                                <div className="space-y-4">
                                    <div className="flex justify-between items-center p-4 bg-teal-500/10 rounded-lg border border-teal-500/20">
                                        <span className="text-[#D0CCC4]">Working 20 hours/week at $15/hour</span>
                        ...
                        <section id="age-50" className="scroll-mt-32">
                            ...
                            <div className="bg-[#0C0D18] rounded-2xl p-6 border border-blue-500/20 not-prose my-6">
                                ...
                                <ul className="space-y-3">
                                    <li className="flex items-start gap-3 text-[#D0CCC4]">
                                        ...
                                        <span>Max out 401(k) with catch-up: <strong className="text-[#F6F4EF]">$30,500/year</strong></span>
                                    </li>
                                    <li className="flex items-start gap-3 text-[#D0CCC4]">
                                        <CheckCircle2 className="h-5 w-5 text-blue-700 flex-shrink-0 mt-0.5" />
                                        <span>Max out IRA with catch-up: <strong className="text-[#F6F4EF]">$8,000/year</strong></span>
                                    </li>
                                    <li className="flex items-start gap-3 text-[#D0CCC4]">
                                        <CheckCircle2 className="h-5 w-5 text-blue-700 flex-shrink-0 mt-0.5" />
                        ...
                        <section id="age-55" className="scroll-mt-32">
                            <div className="flex items-center gap-4 mb-4 not-prose">
                                ...
                                <h2 className="text-2xl md:text-3xl font-serif font-bold text-[#F6F4EF] m-0">Starting at 55: Your 10-Year Power Play</h2>
                            </div>
                            ...
                            <div className="bg-[#0C0D18] rounded-2xl p-6 border border-purple-500/20 not-prose my-6">
                                ...
                                <ul className="space-y-3">
                                    <li className="flex items-start gap-3 text-[#D0CCC4]">
                                        ...
                                        <span>Max contributions: <strong className="text-[#F6F4EF]">$38,500/year possible</strong></span>
                                    </li>
                                    <li className="flex items-start gap-3 text-[#D0CCC4]">
                                        <CheckCircle2 className="h-5 w-5 text-purple-700 flex-shrink-0 mt-0.5" />
                        ...
                        <section id="age-60" className="scroll-mt-32">
                            ...
                            <div className="bg-[#0C0D18] rounded-2xl p-6 border border-amber-500/20 not-prose my-6">
                                <h4 className="font-bold text-[#D4A94E] mb-4">The 60-Year-Old Action Plan</h4>
                                <ul className="space-y-3">
                                    <li className="flex items-start gap-3 text-[#D0CCC4]">
                                        <CheckCircle2 className="h-5 w-5 text-[#D4A94E] flex-shrink-0 mt-0.5" />
                                        <span>Max all retirement contributions: <strong className="text-[#F6F4EF]">$38,500/year</strong></span>
                                    </li>
                                    <li className="flex items-start gap-3 text-[#D0CCC4]">
                                        <CheckCircle2 className="h-5 w-5 text-[#D4A94E] flex-shrink-0 mt-0.5" />
                        ...
                        <section id="gold-protection" className="scroll-mt-32">
                            ...
                            <div className="overflow-x-auto not-prose my-8">
                                <table className="w-full text-left border-collapse bg-[#0C0D18] rounded-xl shadow-sm border border-[#2A2D42]">
                                    <thead className="bg-[#121423]">
                                        <tr>
                                            <th className="p-4 border-b border-[#2A2D42] font-bold text-[#F6F4EF]">Crisis Event</th>
                        ...
                        <div className="my-12 bg-[rgba(197,149,46,0.1)] rounded-2xl p-8 text-[#F6F4EF] relative overflow-hidden not-prose">
                            ...
                            <div className="relative z-10 text-center">
                                <h3 className="text-3xl font-serif font-bold mb-4 text-[#F6F4EF]">Ready to Take the First Step?</h3>
