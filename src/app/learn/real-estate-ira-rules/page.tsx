                    ...
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8">
                            <p className="text-slate-300 text-lg mb-6">
                                <strong className="text-white">UBIT</strong> is a tax that applies when your IRA earns income from
                            ...
                            <div className="space-y-6">
                                ...
                                <p className="text-slate-400 text-sm">
                                    <strong className="text-white">UBIT Rate:</strong> Trust tax rates apply, which can be quite high (up to 37% for income over ~$14,000).
