          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="bg-[#0C0D18] border border-[#2A2D42] rounded-xl p-6 text-center">
                ...
                <h3 className="font-bold text-[#F6F4EF] mb-2">Government Minted</h3>
              ...
              <div className="bg-[#0C0D18] border border-[#2A2D42] rounded-xl p-6 text-center">
                ...
                <h3 className="font-bold text-[#F6F4EF] mb-2">.999+ Purity</h3>
                <p className="text-sm text-[#D0CCC4]">
              ...
              <div className="bg-[#0C0D18] border border-[#2A2D42] rounded-xl p-6 text-center">
                ...
                <h3 className="font-bold text-[#F6F4EF] mb-2">Legal Tender</h3>
                <p className="text-sm text-[#D0CCC4]">
              ...
              >
                <div className="flex items-start justify-between mb-3">
                  <div>
                    ...
                    <p className="text-sm text-[#D0CCC4]">{coin.country} - {coin.mint}</p>
                  </div>
                ...
                <p className="text-sm text-[#D0CCC4] mb-4">{coin.notes}</p>

                <div className="grid grid-cols-3 gap-4 text-xs">
                  <div>
                    <span className="text-[#D0CCC4] block">Purity</span>
                    <span className="text-[#F6F4EF] font-semibold">{coin.purity}</span>
                  </div>
                  <div>
                    <span className="text-[#D0CCC4] block">Weight</span>
                    <span className="text-[#F6F4EF] font-semibold">{coin.weight}</span>
                  </div>
                  <div>
                    <span className="text-[#D0CCC4] block">Premium</span>
                    <span className="text-[#F6F4EF] font-semibold">{coin.premium}</span>
                  </div>
                </div>
              </div>
            ))}
          ...
          <div className="max-w-3xl mx-auto">
              ...
              <div className="space-y-4">
                {notApprovedCoins.map((item, index) => (
                  <div key={index} className="flex items-start gap-3">
                    ...
                    <div>
                      <span className="text-[#F6F4EF] font-semibold">{item.name}</span>
            ...
            <div className="mt-8 bg-[rgba(220,38,38,0.1)] border border-[#B22234]/30 rounded-xl p-6">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h4 className="font-bold text-[#F6F4EF] mb-2">
              ...
              <table className="w-full text-left border-collapse bg-[#0C0D18] backdrop-blur-sm rounded-xl border border-[#2A2D42]">
                <thead className="bg-[#0C0D18]">
                  <tr>
                    ...
                    <th className="p-4 border-b border-[#2A2D42] font-bold text-[#F6F4EF]">American Eagle</th>
                    <th className="p-4 border-b border-[#2A2D42] font-bold text-[#F6F4EF]">Maple Leaf</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-[#2A2D42] text-sm">
                  <tr>
                    <td className="p-4 font-semibold text-[#F6F4EF]">Purity</td>
                    <td className="p-4 text-[#D0CCC4]">.999 fine (99.9%)</td>
                  ...
                  <tr className="bg-[#121423]">
                    ...
                    <td className="p-4 text-[#D0CCC4]">Higher (~$3-5 over spot)</td>
                    <td className="p-4 text-green-400 font-semibold">Lower (~$2-4 over spot)</td>
                  </tr>
                  <tr>
                    <td className="p-4 font-semibold text-[#F6F4EF]">Liquidity</td>
                    <td className="p-4 text-green-400 font-semibold">Highest - Most recognized</td>
                    <td className="p-4 text-[#D0CCC4]">Very High</td>
                  </tr>
                  <tr className="bg-[#121423]">
                    <td className="p-4 font-semibold text-[#F6F4EF]">Security Features</td>
                    <td className="p-4 text-[#D0CCC4]">Limited</td>
                  ...
                  <tr>
                    ...
                    <td className="p-4 text-[#D0CCC4]">$1 USD</td>
                    <td className="p-4 text-[#D0CCC4]">$5 CAD</td>
                  </tr>
                  <tr className="bg-[#121423]">
                    <td className="p-4 font-semibold text-[#F6F4EF]">Best For</td>
                    <td className="p-4 text-[#D0CCC4]">Maximum liquidity, patriotic appeal</td>
                    <td className="p-4 text-[#D0CCC4]">Best value, highest purity</td>
                  </tr>
                </tbody>
              </table>
            </div>
            <p className="text-sm text-[#D0CCC4] text-center mt-4">
        ...
        <Container>
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-4xl mx-auto">
            ...
            >
              ...
              <p className="text-sm text-[#D0CCC4]">PAMP, RCM & more</p>
            </Link>
            <Link
            ...
            >
              ...
              <p className="text-sm text-[#D0CCC4]">Portfolio allocation</p>
            </Link>
          </div>
        </Container>
      </section>
