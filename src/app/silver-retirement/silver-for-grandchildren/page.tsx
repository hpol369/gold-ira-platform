  ...
  return (
    <main className="min-h-screen bg-slate-900">
      ...
      <section className="relative pt-24 pb-16 overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-b from-pink-900/20 via-slate-900 to-slate-900" />
        ...
        <Container className="relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <Button variant="gold" size="lg" asChild>
              <a
                href={getTrackedLink(AFFILIATE_LINKS.augustaSilver, "silver-grandchildren-hero", "augusta")}
                target="_blank"
        ...
        <Container>
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            {educationalValue.map((item, index) => (
              ...
              >
                <h3 className="font-bold text-white mb-2">{item.lesson}</h3>
      ...
      <section className="py-12 bg-gradient-to-r from-slate-900 via-amber-900/20 to-slate-900">
        <Container>
          <div className="max-w-3xl mx-auto text-center">
            ...
            <Button variant="gold" size="lg" asChild>
              <a
                href={getTrackedLink(AFFILIATE_LINKS.augustaSilver, "silver-grandchildren-mid", "augusta")}
                target="_blank"
                rel="noopener noreferrer"
              >
        ...
        <Container>
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {taxConsiderations.map((item, index) => (
              ...
              >
                <h3 className="font-bold text-white mb-2">{item.topic}</h3>
                <p className="text-sm text-slate-400">{item.details}</p>
              </div>
            ))}
          </div>
          <div className="max-w-3xl mx-auto mt-6 bg-amber-500/10 border border-amber-500/30 rounded-xl p-4">
            <div className="flex items-start gap-3">
              <AlertTriangle className="h-5 w-5 text-amber-400 mt-0.5 flex-shrink-0" />
              <p className="text-sm text-slate-400">
                <strong className="text-white">Note:</strong> Tax rules are complex
        ...
        <Container>
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            <div className="bg-white/5 border border-white/10 rounded-xl p-6 text-center">
              ...
              <h3 className="font-bold text-white mb-2">Birthdays</h3>
              <p className="text-sm text-slate-400">
            ...
            <div className="bg-white/5 border border-white/10 rounded-xl p-6 text-center">
              <div className="text-3xl mb-3">🎄</div>
              <h3 className="font-bold text-white mb-2">Christmas</h3>
              <p className="text-sm text-slate-400">
            ...
            <div className="bg-white/5 border border-white/10 rounded-xl p-6 text-center">
              <div className="text-3xl mb-3">🎓</div>
              <h3 className="font-bold text-white mb-2">Graduation</h3>
              <p className="text-sm text-slate-400">
      ...
      <section className="py-12">
        <Container>
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-4xl mx-auto">
            ...
            >
              <h3 className="font-semibold text-white mb-1">Silver Inheritance Planning</h3>
            ...
            >
              ...
              <p className="text-sm text-slate-400">Best coins for IRAs</p>
            </Link>
            <Link
              href="/grandchildren"
              className="bg-white/5 hover:bg-white/10 border border-white/10 rounded-lg p-4 transition-colors"
            >
              <h3 className="font-semibold text-white mb-1">Grandchildren Legacy Hub</h3>
              <p className="text-sm text-slate-400">More ways to gift wealth</p>
            </Link>
          </div>
        </Container>
      </section>
