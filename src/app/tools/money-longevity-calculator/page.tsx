                    ...
                    >
                      ...
                      <div className="space-y-8">
                        ...
                        <div className="space-y-4">
                          <h3 className="text-lg font-semibold text-[#F6F4EF] text-center">Total Retirement Savings</h3>
                        ...
                        {/* Age */}
                        <div className="space-y-4">
                          <h3 className="text-lg font-semibold text-[#F6F4EF] text-center">Current Age</h3>
                          <div className="text-center">
                      ...
                      <div className="mt-8 flex justify-end">
                        <button
                          onClick={() => setStep(2)}
                          className="px-8 py-3 bg-purple-500 text-[#F6F4EF] font-semibold rounded-lg hover:bg-purple-400 transition-colors"
                        >
                          Next Step
                        </button>
                      </div>
                  ...
                  {step === 2 && (
                    ...
                    >
                      ...
                      <div className="space-y-8">
                        {/* Monthly Expenses */}
                        <div className="space-y-4">
                          <h3 className="text-lg font-semibold text-[#F6F4EF] text-center">Monthly Expenses</h3>
                          <div className="text-center">
                            <span className="text-4xl font-bold text-red-600">
                              {formatCurrency(monthlyExpenses)}
                            </span>
                            <span className="text-xl text-[#A8A39A]">/month</span>
                          </div>
                          <input
                            type="range"
                            min="2000"
                        ...
                        {/* Social Security */}
                        <div className="space-y-4">
                          <h3 className="text-lg font-semibold text-[#F6F4EF] text-center">Monthly Social Security</h3>
                          <div className="text-center">
                        ...
                        {/* Pension */}
                        <div className="space-y-4">
                          <h3 className="text-lg font-semibold text-[#F6F4EF] text-center">Monthly Pension (if any)</h3>
                          <div className="text-center">
                        ...
                        <div className="bg-[#0C0D18] rounded-lg p-4">
                          <div className="flex justify-between mb-2">
                            <span className="text-[#A8A39A]">Monthly Income</span>
                            <span className="text-green-600 font-semibold">{formatCurrency(socialSecurity + pension)}</span>
                          </div>
                          <div className="flex justify-between mb-2">
                            <span className="text-[#A8A39A]">Monthly Expenses</span>
                            <span className="text-red-600 font-semibold">{formatCurrency(monthlyExpenses)}</span>
                          </div>
                          <div className="flex justify-between border-t border-slate-700 pt-2">
                            <span className="text-[#D0CCC4]">Monthly Gap (from savings)</span>
                            <span className={`font-semibold ${monthlyExpenses - socialSecurity - pension > 0 ? 'text-[#D4A94E]' : 'text-green-600'}`}>
                  ...
                  {step === 3 && (
                    ...
                    >
                      ...
                      <div className="space-y-8">
                        {/* Expected Return */}
                        <div className="space-y-4">
                          <h3 className="text-lg font-semibold text-[#F6F4EF] text-center">Expected Annual Return</h3>
                          <div className="text-center">
                        ...
                        {/* Inflation Rate */}
                        <div className="space-y-4">
                          <h3 className="text-lg font-semibold text-[#F6F4EF] text-center">Expected Inflation Rate</h3>
                          <div className="text-center">
                            <span className="text-4xl font-bold text-[#D4A94E]">{inflationRate}%</span>
                          </div>
                          <input
                            type="range"
                            min="1"
                ...
                >
                  ...
                  <div className={`border-2 rounded-2xl p-8 text-center ${
                    ...
                    {calculations.yearsLasting === Infinity ? (
                      ...
                      <>
                        ...
                        <div className="text-6xl font-bold text-[#F6F4EF] mb-2">
                          {calculations.yearsLasting} <span className="text-3xl text-[#A8A39A]">years</span>
                        </div>
                        <p className="text-xl text-[#D0CCC4] mb-4">
                    ...
                    <div className="bg-[#161828] border border-[#2A2D42] shadow-sm rounded-2xl p-8">
                      ...
                      <div className="grid md:grid-cols-2 gap-6 mb-8">
                        <div className="bg-[#0C0D18] rounded-xl p-6">
                          <h3 className="text-lg font-semibold text-[#F6F4EF] mb-4">Annual Cash Flow</h3>
                          <div className="space-y-3">
                            <div className="flex justify-between">
                              <span className="text-[#A8A39A]">Total Expenses</span>
                              <span className="text-red-600 font-semibold">{formatCurrency(calculations.annualExpenses)}</span>
                            </div>
                            <div className="flex justify-between">
                              <span className="text-[#A8A39A]">Guaranteed Income</span>
                              <span className="text-green-600 font-semibold">{formatCurrency(calculations.annualIncome)}</span>
                            </div>
                            <div className="flex justify-between border-t border-slate-700 pt-3">
                              <span className="text-[#F6F4EF]">Annual Withdrawal</span>
                              <span className="text-[#D4A94E] font-semibold">{formatCurrency(calculations.annualGap)}</span>
                            </div>
                          </div>
                        </div>

                        <div className="bg-[#0C0D18] rounded-xl p-6">
                          <h3 className="text-lg font-semibold text-[#F6F4EF] mb-4">Withdrawal Analysis</h3>
                          <div className="space-y-3">
                            <div className="flex justify-between">
                              <span className="text-[#A8A39A]">Your Withdrawal Rate</span>
                              <span className="text-[#F6F4EF] font-semibold">
                                {((calculations.annualGap / currentSavings) * 100).toFixed(1)}%
                              </span>
                            </div>
                            <div className="flex justify-between">
                              <span className="text-[#A8A39A]">Safe Rate (4% Rule)</span>
                              <span className="text-green-600 font-semibold">4.0%</span>
                            </div>
                            <div className="flex justify-between">
                              <span className="text-[#A8A39A]">Sustainable Monthly</span>
                      ...
                      {calculations.yearByYear.length > 0 && (
                        <div className="bg-[#0C0D18] rounded-xl p-6">
                          <h3 className="text-lg font-semibold text-[#F6F4EF] mb-4">Balance Over Time</h3>
                            ...
                            {calculations.yearByYear.filter((_, i) => i % 5 === 0 || i === calculations.yearByYear.length - 1).map((year) => {
                              ...
                              return (
                                <div key={year.year} className="flex items-center gap-4">
                                  <span className="text-[#A8A39A] w-20">Age {year.age}</span>
                                  ...
                                  <span className="text-[#F6F4EF] font-semibold w-28 text-right">
                    ...
                    <div className="bg-[rgba(220,38,38,0.1)] border border-[rgba(197,149,46,0.32)] rounded-xl p-6">
                      ...
                      <ul className="space-y-2 text-[#D0CCC4]">
                        <li className="flex items-start gap-2">
                          <span className="text-[#D4A94E] mt-1">1.</span>
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 justify-center">
                    ...
                    <Link
                      ...
                      className="px-8 py-3 bg-purple-500 text-[#F6F4EF] font-semibold rounded-lg hover:bg-purple-400 transition-colors text-center"
                    >
