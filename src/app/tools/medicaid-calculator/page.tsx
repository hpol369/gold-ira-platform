              ...
              {!showResults ? (
                      ...
                      <div key={s} className="flex items-center">
                        <div
                          className={`w-10 h-10 rounded-full flex items-center justify-center font-semibold transition-colors ${
                            step >= s ? 'bg-teal-500 text-[#F6F4EF]' : 'bg-slate-700 text-[#A8A39A]'
                          }`}
                        >
                          {s}
                        </div>
                    ...
                    >
                      ...
                      <div className="space-y-8">
                        ...
                        <div className="space-y-4">
                          <h3 className="text-lg font-semibold text-[#F6F4EF] text-center">Marital Status</h3>
                          <div className="grid grid-cols-2 gap-4">
                            ...
                            >
                              <p className="text-[#F6F4EF] font-semibold">Single/Widowed</p>
                              <p className="text-[#D0CCC4] text-sm">Applying alone</p>
                            </button>
                            <button
                            ...
                            >
                              <p className="text-[#F6F4EF] font-semibold">Married</p>
                              <p className="text-[#D0CCC4] text-sm">Spouse at home</p>
                            </button>
                          </div>
                        </div>
                        ...
                        {/* State */}
                        <div className="space-y-4">
                          <h3 className="text-lg font-semibold text-[#F6F4EF] text-center">State Category</h3>
                          <div className="grid grid-cols-3 gap-4">
                            ...
                            >
                              <p className="text-[#F6F4EF] font-semibold">Standard</p>
                              <p className="text-[#A8A39A] text-xs">Most states</p>
                            </button>
                            <button
                              onClick={() => setState('ny')}
                              className={`p-4 rounded-xl border-2 text-center transition-colors ${
                            ...
                            >
                              <p className="text-[#F6F4EF] font-semibold">New York</p>
                              <p className="text-[#A8A39A] text-xs">Higher limits</p>
                            </button>
                            <button
                            ...
                            >
                              <p className="text-[#F6F4EF] font-semibold">Other</p>
                              <p className="text-[#A8A39A] text-xs">CT, some others</p>
                            </button>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="mt-8 flex justify-end">
                        <button
                          onClick={() => setStep(2)}
                          className="px-8 py-3 bg-teal-500 text-[#F6F4EF] font-semibold rounded-lg hover:bg-teal-400 transition-colors"
                        >
                          Next Step
                        </button>
                      </div>
                  ...
                  {step === 2 && (
                    ...
                    >
                      ...
                      <div className="space-y-8">
                        {/* Countable Assets */}
                        <div className="space-y-4">
                          <h3 className="text-lg font-semibold text-[#F6F4EF] text-center">Countable Assets</h3>
                          <p className="text-[#D0CCC4] text-sm text-center">Bank accounts, investments, IRAs, second properties</p>
                        ...
                        {/* Home Equity */}
                        <div className="space-y-4">
                          <h3 className="text-lg font-semibold text-[#F6F4EF] text-center">Home Equity</h3>
                          <p className="text-[#D0CCC4] text-sm text-center">Market value minus mortgage balance</p>
                          <div className="text-center">
                            <span className="text-4xl font-bold text-teal-400">
                  ...
                  {step === 3 && (
                    ...
                    >
                      ...
                      <div className="space-y-8">
                        {/* Monthly Income */}
                        <div className="space-y-4">
                          <h3 className="text-lg font-semibold text-[#F6F4EF] text-center">Your Monthly Income</h3>
                          <div className="text-center">
                            <span className="text-4xl font-bold text-teal-400">
                        ...
                        {maritalStatus === 'married' && (
                          <div className="space-y-4">
                            <h3 className="text-lg font-semibold text-[#F6F4EF] text-center">Spouse's Monthly Income</h3>
                            <div className="text-center">
                        ...
                        {/* Nursing Home Cost */}
                        <div className="space-y-4">
                          <h3 className="text-lg font-semibold text-[#F6F4EF] text-center">Monthly Nursing Home Cost</h3>
                          <div className="text-center">
                ...
                >
                    ...
                    {calculations.isEligible ? (
                      ...
                      <>
                        ...
                        <p className="text-[#D0CCC4]">
                          Estimated spend-down period: <strong className="text-[#D4A94E]">{calculations.spendDownMonths} months</strong>
                        </p>
                      </>
                    )}
                  </div>
                  ...
                  <div className="bg-[#161828] border border-[#2A2D42] shadow-sm rounded-2xl p-8">
                    <h2 className="text-2xl font-bold text-[#F6F4EF] mb-6">Asset Analysis</h2>

                    <div className="grid md:grid-cols-2 gap-6 mb-6">
                      <div className="bg-[#0C0D18] rounded-xl p-6">
                        <h3 className="text-lg font-semibold text-[#F6F4EF] mb-4">Countable Assets</h3>
                        <div className="space-y-3">
                          <div className="flex justify-between">
                            <span className="text-[#A8A39A]">Your Assets</span>
                            <span className="text-[#F6F4EF] font-semibold">{formatCurrency(countableAssets)}</span>
                          </div>
                          <div className="flex justify-between">
                            <span className="text-[#A8A39A]">Asset Limit</span>
                            <span className="text-teal-400 font-semibold">{formatCurrency(calculations.assetLimit)}</span>
                          </div>
                          <div className="flex justify-between border-t border-slate-700 pt-3">
                            <span className="text-[#F6F4EF]">Excess</span>
                      ...
                      <div className="bg-[#0C0D18] rounded-xl p-6">
                        <h3 className="text-lg font-semibold text-[#F6F4EF] mb-4">Home Equity</h3>
                        <div className="space-y-3">
                          <div className="flex justify-between">
                            <span className="text-[#A8A39A]">Your Equity</span>
                            <span className="text-[#F6F4EF] font-semibold">{formatCurrency(homeEquity)}</span>
                          </div>
                          <div className="flex justify-between">
                            <span className="text-[#A8A39A]">Equity Limit</span>
                            <span className="text-teal-400 font-semibold">{formatCurrency(calculations.homeEquityLimit)}</span>
                          </div>
                          <div className="flex justify-between border-t border-slate-700 pt-3">
                            <span className="text-[#F6F4EF]">Status</span>
                    ...
                    {/* Income Breakdown */}
                    <div className="bg-[#0C0D18] rounded-xl p-6">
                      <h3 className="text-lg font-semibold text-[#F6F4EF] mb-4">Monthly Cost Breakdown</h3>
                      <div className="space-y-3">
                        <div className="flex justify-between">
                          <span className="text-[#A8A39A]">Nursing Home Cost</span>
                          <span className="text-red-600 font-semibold">{formatCurrency(nursingHomeCost)}</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-[#A8A39A]">Your Patient Liability</span>
                          <span className="text-[#F6F4EF] font-semibold">{formatCurrency(calculations.patientLiability)}</span>
                        </div>
                        {maritalStatus === 'married' && (
                          <div className="flex justify-between">
                            <span className="text-[#A8A39A]">Spouse Allowance</span>
                            <span className="text-blue-600 font-semibold">{formatCurrency(calculations.spouseAllowance)}</span>
                          </div>
                        )}
                        <div className="flex justify-between border-t border-slate-700 pt-3">
                          <span className="text-[#F6F4EF]">Medicaid Pays</span>
                  ...
                  {calculations.strategies.length > 0 && (
                    <div className="bg-[#161828] border border-[#2A2D42] shadow-sm rounded-2xl p-8">
                      <h2 className="text-2xl font-bold text-[#F6F4EF] mb-6">Legitimate Spend-Down Strategies</h2>
                      <div className="grid md:grid-cols-2 gap-4">
                        {calculations.strategies.map((strategy, index) => (
                          <div key={index} className="bg-[#0C0D18] rounded-xl p-4">
                            <h3 className="text-lg font-semibold text-teal-400 mb-2">{strategy.name}</h3>
                            <p className="text-[#D0CCC4] text-sm mb-2">{strategy.description}</p>
                            <p className="text-[#F6F4EF] font-semibold">Potential: up to {formatCurrency(strategy.savings)}</p>
                          </div>
                        ))}
                      </div>
                    </div>
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 justify-center">
                    ...
                    <Link
                      ...
                      className="px-8 py-3 bg-teal-500 text-[#F6F4EF] font-semibold rounded-lg hover:bg-teal-400 transition-colors text-center"
                    >
