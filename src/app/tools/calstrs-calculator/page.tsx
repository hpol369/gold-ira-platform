          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-4">
              {calstrsTimeline.map((item, index) => (
                <div
                  key={index}
                  className="bg-[#161828] border border-[#2A2D42] shadow-sm rounded-xl p-5 flex flex-col md:flex-row md:items-center gap-4"
                >
                  <div className="md:w-32 flex-shrink-0">
                    <span className="text-blue-600 font-bold">{item.year}</span>
                  </div>
                  <div className="flex-1">
                    <h4 className="text-[#F6F4EF] font-semibold mb-1">{item.change}</h4>
                    <p className="text-[#D0CCC4] text-sm">{item.impact}</p>
                  </div>
                </div>
              ))}
            </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-[rgba(220,38,38,0.1)] border border-[rgba(197,149,46,0.32)] rounded-2xl p-8">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-xl font-bold text-[#D4A94E] mb-3">
                  ...
                  <div className="grid md:grid-cols-2 gap-4 mt-6">
                    <div className="bg-[#0C0D18] rounded-lg p-4">
                      <h4 className="text-[#F6F4EF] font-semibold mb-2">Windfall Elimination Provision</h4>
                      <p className="text-[#D0CCC4] text-sm">
                    ...
                    <div className="bg-[#0C0D18] rounded-lg p-4">
                      <h4 className="text-[#F6F4EF] font-semibold mb-2">Government Pension Offset</h4>
                      <p className="text-[#D0CCC4] text-sm">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-[#161828] border border-[#2A2D42] shadow-sm rounded-xl p-6">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-[#F6F4EF] font-semibold">403(b) Plans</h3>
                </div>
              ...
              <div className="bg-[#161828] border border-[#2A2D42] shadow-sm rounded-xl p-6">
                <div className="flex items-center gap-3 mb-4">
                  <CheckCircle2 className="h-6 w-6 text-green-600" />
                  <h3 className="text-[#F6F4EF] font-semibold">457(b) Deferred Compensation</h3>
                </div>
                <p className="text-[#D0CCC4] text-sm mb-3">
              ...
              <div className="bg-[#161828] border border-[#2A2D42] shadow-sm rounded-xl p-6">
                <div className="flex items-center gap-3 mb-4">
                  <CheckCircle2 className="h-6 w-6 text-green-600" />
                  <h3 className="text-[#F6F4EF] font-semibold">Roth IRA</h3>
                </div>
                <p className="text-[#D0CCC4] text-sm mb-3">
