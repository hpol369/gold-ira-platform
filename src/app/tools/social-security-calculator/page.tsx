      ...
      <main className="min-h-screen bg-slate-900">
        ...
        <section className="relative pt-24 pb-16 overflow-hidden">
          ...
          <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            >
              <span className="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-green-500/10 text-green-400 border border-green-500/20 mb-4">
                ...
                >
                    ...
                    >
                      ...
                      <div className="space-y-6">
                        <div className="text-center">
                          <span className="text-5xl font-bold text-green-400">{birthYear}</span>
                        </div>
                  ...
                  {step === 3 && (
                    ...
                    >
                      ...
                      <div className="space-y-6">
                        <div className="text-center">
                          <span className="text-5xl font-bold text-green-400">{lifeExpectancy}</span>
                ...
                >
                  ...
                  <div className="bg-gradient-to-b from-green-500/10 to-transparent border-2 border-green-500/30 rounded-2xl p-8 text-center">
                    ...
                    <div className="flex justify-center gap-8">
                      <div>
                        <p className="text-slate-400 text-sm">Monthly Benefit</p>
                        <p className="text-2xl font-bold text-white">{formatCurrency(calculations.optimalAge.monthly)}</p>
                      </div>
                      <div>
                        <p className="text-slate-400 text-sm">Lifetime Total</p>
                        <p className="text-2xl font-bold text-white">{formatCurrency(calculations.optimalAge.lifetime)}</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8">
                    ...
                    <div className="grid md:grid-cols-3 gap-6 mb-8">
                      ...
                      <div className="bg-slate-800/50 border border-slate-700 rounded-xl p-6">
                        <div className="flex items-center gap-2 mb-4">
                          ...
                          <h3 className="text-lg font-semibold text-white">Age 62 (Early)</h3>
                        </div>
                        <div className="space-y-3">
                          ...
                          <div>
                            <p className="text-slate-400 text-sm">Reduction from FRA</p>
                      ...
                      <div className="bg-slate-800/50 border border-slate-700 rounded-xl p-6">
                        <div className="flex items-center gap-2 mb-4">
                          ...
                          <h3 className="text-lg font-semibold text-white">Age {calculations.fraYears} (FRA)</h3>
                        </div>
                        <div className="space-y-3">
                          <div>
                            <p className="text-slate-400 text-sm">Monthly Benefit</p>
                          ...
                          <div>
                            <p className="text-slate-400 text-sm">Full Retirement Age</p>
                      ...
                      <div className="bg-slate-800/50 border border-slate-700 rounded-xl p-6">
                        <div className="flex items-center gap-2 mb-4">
                          ...
                          <h3 className="text-lg font-semibold text-white">Age 70 (Maximum)</h3>
                        </div>
                        <div className="space-y-3">
                          <div>
                            <p className="text-slate-400 text-sm">Monthly Benefit</p>
                          ...
                          <div>
                            <p className="text-slate-400 text-sm">Increase from FRA</p>
                    ...
                    <div className="bg-slate-800/50 rounded-xl p-6">
                      <h3 className="text-lg font-semibold text-white mb-4">Lifetime Benefits by Claiming Age</h3>
                      <div className="space-y-3">
                        {calculations.lifetimeBenefits.map((benefit) => {
                          ...
                          return (
                            <div key={benefit.age} className="flex items-center gap-4">
                              <span className="text-slate-400 w-16">Age {benefit.age}</span>
                  ...
                  {calculations.breakeven62vs70 && (
                    <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6">
                      ...
                      <p className="text-slate-300">
                        ...
                        <strong className="text-amber-400">{Math.round(calculations.breakeven62vs70)}</strong>.
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6">
                <h3 className="text-lg font-semibold text-green-400 mb-3">Early Claiming (62-FRA)</h3>
                <p className="text-slate-300">
              ...
              <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6">
                <h3 className="text-lg font-semibold text-green-400 mb-3">Delayed Claiming (FRA-70)</h3>
                <p className="text-slate-300">
              ...
              <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6">
                <h3 className="text-lg font-semibold text-green-400 mb-3">Full Retirement Age (FRA)</h3>
                <p className="text-slate-300">
              ...
              <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6">
                <h3 className="text-lg font-semibold text-green-400 mb-3">When to Claim Early</h3>
                <p className="text-slate-300">
