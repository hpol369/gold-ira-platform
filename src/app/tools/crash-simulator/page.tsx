          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {historicalCrashes.map((crash) => (
                <div
                  key={crash.year}
                  className="bg-[#161828] border border-[#2A2D42] rounded-xl p-6 shadow-sm"
                >
                  <div className="flex items-start justify-between mb-4">
                    <div>
                      <div className="text-[#D4A94E] font-bold text-lg">
                        {crash.year}
                      </div>
                  ...
                  <p className="text-[#D0CCC4] text-sm">{crash.description}</p>
                </div>
              ))}
            </div>
          </div>
