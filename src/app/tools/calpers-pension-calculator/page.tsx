                ...
                <table className="w-full">
                  <thead>
                    <tr className="bg-[#0C0D18] border-b border-[#2A2D42]">
                      <th className="px-6 py-4 text-left text-sm font-semibold text-[#D0CCC4]">Employer Type</th>
                      <th className="px-6 py-4 text-left text-sm font-semibold text-[#D0CCC4]">Classic Formula</th>
                      <th className="px-6 py-4 text-left text-sm font-semibold text-[#D0CCC4]">PEPRA Formula</th>
                      <th className="px-6 py-4 text-left text-sm font-semibold text-[#D0CCC4]">Health Vesting</th>
                      <th className="px-6 py-4 text-left text-sm font-semibold text-[#D0CCC4]">Notes</th>
                    </tr>
                  </thead>
                  <tbody>
                    {employerComparison.map((row, index) => (
                      <tr key={row.employer} className={`border-b border-[#2A2D42] ${index % 2 === 0 ? 'bg-[#0C0D18]' : ''}`}>
                        <td className="px-6 py-4 text-[#F6F4EF] font-medium">{row.employer}</td>
                        <td className="px-6 py-4 text-green-600">{row.classic}</td>
                        <td className="px-6 py-4 text-[#D4A94E]">{row.pepra}</td>
                        <td className="px-6 py-4 text-[#A8A39A]">{row.healthVesting}</td>
                        <td className="px-6 py-4 text-[#A8A39A] text-sm">{row.notes}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
          ...
          <div className="max-w-5xl mx-auto">
            <div className="flex items-center gap-3 mb-8">
              ...
              <div>
                ...
                <p className="text-[#A8A39A]">Combine service from multiple California public retirement systems</p>
              </div>
            </div>

            <div className="grid md:grid-cols-2 gap-6 mb-8">
              {reciprocitySystems.map((system) => (
                <div key={system.system} className="bg-[#161828] border border-[#2A2D42] shadow-sm rounded-xl p-5">
                  <h3 className="text-[#F6F4EF] font-semibold text-lg mb-1">{system.system}</h3>
                  <p className="text-blue-600 text-sm mb-2">{system.description}</p>
                  <p className="text-[#D0CCC4] text-sm">{system.note}</p>
                </div>
              ))}
            </div>

            <div className="bg-blue-50 border border-blue-200 rounded-xl p-6">
              <h3 className="text-lg font-semibold text-blue-600 mb-3">How Reciprocity Benefits You</h3>
              <div className="grid md:grid-cols-2 gap-4">
                <div className="flex items-start gap-3">
                  <CheckCircle2 className="h-5 w-5 text-green-600 flex-shrink-0 mt-0.5" />
                  <div>
                    <p className="text-[#F6F4EF] font-medium">Combined Service Credit</p>
                    <p className="text-[#D0CCC4] text-sm">All service years count toward vesting and benefit calculation</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle2 className="h-5 w-5 text-green-600 flex-shrink-0 mt-0.5" />
                  <div>
                    <p className="text-[#F6F4EF] font-medium">Highest Salary Used</p>
                    <p className="text-[#D0CCC4] text-sm">Your highest final compensation from any system applies to all</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle2 className="h-5 w-5 text-green-600 flex-shrink-0 mt-0.5" />
                  <div>
                    <p className="text-[#F6F4EF] font-medium">Concurrent Retirement</p>
                    <p className="text-[#D0CCC4] text-sm">Retire from all systems on the same date for maximum benefits</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle2 className="h-5 w-5 text-green-600 flex-shrink-0 mt-0.5" />
                  <div>
                    <p className="text-[#F6F4EF] font-medium">No Gap in Employment</p>
                    <p className="text-[#D0CCC4] text-sm">Must maintain reciprocity by not breaking service more than 6 months</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6">
              <div className="bg-[#161828] border border-[#2A2D42] shadow-sm rounded-xl p-6">
                <h3 className="text-[#F6F4EF] font-semibold text-lg mb-4">Understanding Health Vesting</h3>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="bg-green-50 border border-green-200 rounded-xl p-5">
                  <h4 className="text-green-600 font-semibold mb-2">State Employees</h4>
              ...
              <div className="bg-[#161828] border border-[#2A2D42] shadow-sm rounded-xl p-5">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-[#F6F4EF] font-medium mb-1">Medicare Coordination</p>
                    <p className="text-[#D0CCC4] text-sm">
      ...
      <section className="py-16 bg-[#0C0D18]">
        <Container>
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-[#161828] border border-[#2A2D42] shadow-sm rounded-xl p-6 mb-6">
              <h3 className="text-[#F6F4EF] font-semibold text-lg mb-4">Factors to Consider</h3>
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  <h4 className="text-[#D4A94E] font-medium mb-2">Reasons to Wait Longer</h4>
                ...
                <div>
                  <h4 className="text-blue-600 font-medium mb-2">Reasons to Retire Earlier</h4>
                  <ul className="space-y-2 text-[#D0CCC4] text-sm">
                    <li className="flex items-start gap-2">
            ...
            <div className="bg-[rgba(220,38,38,0.1)] border border-[#B22234]/30 rounded-xl p-6">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-[#D4A94E] font-semibold mb-2">Pro Tip: The Break-Even Point</p>
                  <p className="text-[#D0CCC4] text-sm">
        ...
        <Container>
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              >
                <Shield className="h-8 w-8 text-[#D4A94E] mb-3" />
                <h3 className="text-[#F6F4EF] font-semibold group-hover:text-[#D4A94E] transition-colors">
                  CalPERS Retirement Calculator
                </h3>
              ...
              >
                ...
                <h3 className="text-[#F6F4EF] font-semibold group-hover:text-blue-600 transition-colors">
                  CalSTRS Calculator
                </h3>
                <p className="text-[#D0CCC4] text-sm mt-2">
              ...
              >
                ...
                <h3 className="text-[#F6F4EF] font-semibold group-hover:text-green-600 transition-colors">
