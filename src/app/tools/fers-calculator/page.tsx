                    ...
                    >
                      ...
                      <div className="grid md:grid-cols-2 gap-8">
                        ...
                        <div className="space-y-4">
                          <h3 className="text-lg font-semibold text-[#F6F4EF] text-center">Years of Service</h3>
                          <div className="text-center">
                        ...
                        {/* Retirement Age */}
                        <div className="space-y-4">
                          <h3 className="text-lg font-semibold text-[#F6F4EF] text-center">Retirement Age</h3>
                          <div className="text-center">
                  ...
                  {step === 4 && (
                    ...
                    >
                      ...
                      <div className="space-y-4">
                        ...
                        >
                          <h3 className="text-lg font-semibold text-[#F6F4EF]">No Survivor Benefit</h3>
                        ...
                        >
                          <h3 className="text-lg font-semibold text-[#F6F4EF]">Partial Survivor (25%)</h3>
                          <p className="text-[#D0CCC4] text-sm mt-1">
                            Spouse receives 25% of your pension after your death.
                          </p>
                          <p className="text-[#D4A94E] font-semibold mt-2">5% reduction in your pension</p>
                        </button>
                        ...
                        >
                          <h3 className="text-lg font-semibold text-[#F6F4EF]">Full Survivor (50%)</h3>
                          <p className="text-[#D0CCC4] text-sm mt-1">
                ...
                >
                  ...
                  <div className="bg-[#161828] border border-[#2A2D42] shadow-sm rounded-2xl p-8">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
                      <div className="bg-[#0C0D18] rounded-lg p-4 text-center">
                        <p className="text-[#D0CCC4] text-sm">High-3 Salary</p>
                        <p className="text-xl font-bold text-[#F6F4EF]">{formatCurrency(highThreeSalary)}</p>
                      </div>
                      <div className="bg-[#0C0D18] rounded-lg p-4 text-center">
                        <p className="text-[#D0CCC4] text-sm">Years of Service</p>
                        <p className="text-xl font-bold text-[#F6F4EF]">{yearsOfService}</p>
                      </div>
                      <div className="bg-[#0C0D18] rounded-lg p-4 text-center">
                        <p className="text-[#D0CCC4] text-sm">Retirement Age</p>
                        <p className="text-xl font-bold text-[#F6F4EF]">{retirementAge}</p>
                      </div>
                      <div className="bg-[#0C0D18] rounded-lg p-4 text-center">
                        <p className="text-[#D0CCC4] text-sm">Multiplier</p>
                        <p className="text-xl font-bold text-[#F6F4EF]">{(calculations.multiplier * 100).toFixed(1)}%</p>
                      </div>
                    </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-6 mb-8">
                      ...
                      <div className="bg-gradient-to-b from-blue-500/10 to-transparent border-2 border-blue-500/30 rounded-xl p-6">
                        <h3 className="text-lg font-semibold text-[#F6F4EF] mb-4">Monthly Income</h3>
                        <div className="space-y-3">
                          <div className="flex justify-between">
                            <span className="text-[#A8A39A]">FERS Basic Benefit</span>
                            <span className="text-[#F6F4EF] font-semibold">{formatCurrency(calculations.netMonthlyBenefit)}</span>
                          </div>
                          {calculations.fersSupplementMonthly > 0 && (
                            <div className="flex justify-between">
                              <span className="text-[#A8A39A]">FERS Supplement</span>
                              <span className="text-[#F6F4EF] font-semibold">{formatCurrency(calculations.fersSupplementMonthly)}</span>
                            </div>
                          )}
                          <div className="flex justify-between">
                            <span className="text-[#A8A39A]">TSP (4% rate)</span>
                            <span className="text-[#F6F4EF] font-semibold">{formatCurrency(calculations.tspMonthlyWithdrawal)}</span>
                          </div>
                          <div className="border-t border-slate-700 pt-3">
                            <div className="flex justify-between">
                              <span className="text-[#F6F4EF] font-semibold">Total Monthly</span>
                      ...
                      <div className="bg-[#0C0D18] border border-slate-700 rounded-xl p-6">
                        <h3 className="text-lg font-semibold text-[#F6F4EF] mb-4">Annual Income</h3>
                        <div className="space-y-3">
                          <div className="flex justify-between">
                            <span className="text-[#A8A39A]">FERS Basic Benefit</span>
                            <span className="text-[#F6F4EF] font-semibold">{formatCurrency(calculations.netAnnualBenefit)}</span>
                          </div>
                          {calculations.fersSupplementAnnual > 0 && (
                            <div className="flex justify-between">
                              <span className="text-[#A8A39A]">FERS Supplement</span>
                              <span className="text-[#F6F4EF] font-semibold">{formatCurrency(calculations.fersSupplementAnnual)}</span>
                            </div>
                          )}
                          <div className="flex justify-between">
                            <span className="text-[#A8A39A]">TSP (4% rate)</span>
                            <span className="text-[#F6F4EF] font-semibold">{formatCurrency(calculations.tspAnnualWithdrawal)}</span>
                          </div>
                          <div className="border-t border-slate-700 pt-3">
                            <div className="flex justify-between">
                              <span className="text-[#F6F4EF] font-semibold">Total Annual</span>
                              <span className="text-2xl font-bold text-[#F6F4EF]">{formatCurrency(calculations.totalAnnual)}</span>
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div className="bg-[#0C0D18] rounded-lg p-6">
                      <div className="flex items-center justify-between mb-4">
                        <span className="text-[#D0CCC4]">Income Replacement Ratio</span>
                        <span className={`text-2xl font-bold ${
                          calculations.replacementRatio >= 80 ? 'text-green-600' :
                          calculations.replacementRatio >= 60 ? 'text-[#D4A94E]' : 'text-red-600'
                        }`}>
                  ...
                  {survivorBenefit !== 'none' && (
                    <div className="bg-[#161828] border border-[#2A2D42] shadow-sm rounded-2xl p-6">
                      <h3 className="text-lg font-semibold text-[#F6F4EF] mb-4">Survivor Benefit Impact</h3>
                      <div className="grid md:grid-cols-3 gap-4">
                        <div className="bg-[#0C0D18] rounded-lg p-4">
                          <p className="text-[#D0CCC4] text-sm">Gross Annual Benefit</p>
                          <p className="text-lg font-semibold text-[#F6F4EF]">{formatCurrency(calculations.annualBasicBenefit)}</p>
                        </div>
                        <div className="bg-[#0C0D18] rounded-lg p-4">
                          <p className="text-[#D0CCC4] text-sm">Survivor Reduction</p>
                          <p className="text-lg font-semibold text-red-600">-{formatCurrency(calculations.survivorReduction)}</p>
                        </div>
                        <div className="bg-[#0C0D18] rounded-lg p-4">
                          <p className="text-[#D0CCC4] text-sm">Net Annual Benefit</p>
