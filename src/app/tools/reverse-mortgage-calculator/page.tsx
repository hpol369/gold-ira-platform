        ...
        <Container>
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-[#161828] border border-[#2A2D42] shadow-sm rounded-xl p-6 mb-8">
              <h3 className="text-lg font-semibold text-[#F6F4EF] mb-4">The Reverse Mortgage Formula</h3>
              ...
              <div className="space-y-3 text-[#A8A39A]">
                <p><strong className="text-[#F6F4EF]">PLF (Principal Limit Factor):</strong> A percentage based on your age and expected interest rate. Older borrowers get higher PLFs.</p>
              ...
              <table className="w-full">
                <thead>
                  <tr className="bg-[#0C0D18] border-b border-[#2A2D42]">
                    <th className="px-6 py-4 text-left text-sm font-semibold text-[#D0CCC4]">Option</th>
                    <th className="px-6 py-4 text-left text-sm font-semibold text-[#D0CCC4]">Best For</th>
                    <th className="px-6 py-4 text-left text-sm font-semibold text-[#D0CCC4]">Pros</th>
                    <th className="px-6 py-4 text-left text-sm font-semibold text-[#D0CCC4]">Cons</th>
                  </tr>
                </thead>
                <tbody>
                  <tr className="border-b border-[#2A2D42]">
                    <td className="px-6 py-4 text-[#F6F4EF] font-medium">Lump Sum</td>
                    <td className="px-6 py-4 text-[#A8A39A]">Large immediate expense</td>
                  ...
                  <tr className="border-b border-[#2A2D42] bg-[#0C0D18]">
                    <td className="px-6 py-4 text-[#F6F4EF] font-medium">Line of Credit</td>
                    <td className="px-6 py-4 text-[#A8A39A]">Emergency fund, flexibility</td>
                  ...
                  <tr className="border-b border-[#2A2D42]">
                    <td className="px-6 py-4 text-[#F6F4EF] font-medium">Tenure (Lifetime)</td>
                    <td className="px-6 py-4 text-[#A8A39A]">Long-term income supplement</td>
                  ...
                  <tr className="border-b border-[#2A2D42] bg-[#0C0D18]">
                    <td className="px-6 py-4 text-[#F6F4EF] font-medium">Term</td>
                    <td className="px-6 py-4 text-[#A8A39A]">Bridge to other income</td>
