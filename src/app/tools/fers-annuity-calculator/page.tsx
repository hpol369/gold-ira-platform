                  ...
                  >
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <div className="bg-[#121423] rounded-lg px-3 py-2 mb-2">
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-[#2A2D42]">
                    <th className="py-3 px-4 text-left text-[#A8A39A] font-semibold">Retirement Type</th>
                    <th className="py-3 px-4 text-left text-[#A8A39A] font-semibold">Age</th>
                    <th className="py-3 px-4 text-left text-[#A8A39A] font-semibold">Years of Service</th>
                    <th className="py-3 px-4 text-left text-[#A8A39A] font-semibold">Benefit Reduction</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-white/5">
                  ...
                  <tr className="bg-[#161828]0/5">
                    ...
                    <td className="py-3 px-4 text-[#D4A94E]">5% per year before 62</td>
                  </tr>
                  <tr>
                    <td className="py-3 px-4 text-[#F6F4EF] font-medium">Deferred</td>
                    <td className="py-3 px-4 text-[#D0CCC4]">62</td>
                    <td className="py-3 px-4 text-[#D0CCC4]">5+ years</td>
                    <td className="py-3 px-4 text-[#A8A39A]">None (no FEHB eligibility)</td>
                  </tr>
                </tbody>
              </table>
            </div>
        ...
        <Container>
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-[#161828] border border-[#2A2D42] shadow-sm rounded-xl p-6">
              <h3 className="text-lg font-semibold text-[#F6F4EF] mb-4">How FERS COLA Works</h3>
              <div className="space-y-4">
                <div className="bg-[#0C0D18] rounded-lg p-4">
                  <p className="text-[#D0CCC4] mb-2">
                  ...
                  <ul className="space-y-2 text-[#D0CCC4] text-sm">
                    <li className="flex items-start gap-2">
                      ...
                      <span>If CPI increase is <strong className="text-[#F6F4EF]">2% or less</strong>: You get the full COLA</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <CheckCircle2 className="h-4 w-4 text-[#D4A94E] mt-0.5 flex-shrink-0" />
                      <span>If CPI increase is <strong className="text-[#F6F4EF]">2-3%</strong>: You get 2%</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <CheckCircle2 className="h-4 w-4 text-blue-600 mt-0.5 flex-shrink-0" />
                      <span>If CPI increase is <strong className="text-[#F6F4EF]">over 3%</strong>: You get CPI minus 1%</span>
                    </li>
                  </ul>
                </div>

                <div className="bg-[rgba(220,38,38,0.1)] border border-[#B22234]/30 rounded-lg p-4">
                  <p className="text-[#D4A94E] font-semibold mb-2">Important: COLA Timing</p>
                  <p className="text-[#D0CCC4] text-sm">
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-[rgba(220,38,38,0.06)] border border-[#B22234]/30 rounded-2xl p-8">
              ...
              <div className="grid md:grid-cols-3 gap-4 mb-6">
                <div className="bg-[#0C0D18] rounded-lg p-4">
                  <p className="text-[#D4A94E] font-semibold mb-1">COLA Gap</p>
                  <p className="text-[#D0CCC4] text-sm">FERS COLAs are capped below true inflation in high-inflation years</p>
                </div>
                <div className="bg-[#0C0D18] rounded-lg p-4">
                  <p className="text-[#D4A94E] font-semibold mb-1">Gold Hedge</p>
                  <p className="text-[#D0CCC4] text-sm">Gold historically rises during high inflation periods</p>
                </div>
                <div className="bg-[#0C0D18] rounded-lg p-4">
                  <p className="text-[#D4A94E] font-semibold mb-1">TSP Rollover</p>
                  <p className="text-[#D0CCC4] text-sm">Roll TSP to a Gold IRA after separation or at 59 1/2</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <Container>
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid sm:grid-cols-3 gap-4">
              ...
              >
                <h3 className="text-lg font-semibold text-[#F6F4EF] group-hover:text-blue-600 transition-colors">
