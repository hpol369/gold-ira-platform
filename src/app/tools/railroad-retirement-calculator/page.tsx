      ...
      <section className="relative pt-24 pb-16 overflow-hidden">
        ...
        <Container>
          <div className="relative max-w-4xl mx-auto text-center">
            <span className="inline-flex items-center gap-2 px-3 py-1 rounded-full text-sm font-medium bg-[rgba(220,38,38,0.1)] text-[#D4A94E] border border-[rgba(197,149,46,0.32)] mb-4">
                  ...
                  >
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-[#D0CCC4] text-sm">{fact.description}</p>
                      </div>
                    </div>
                  </div>
                );
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-[#161828] border border-[#2A2D42] shadow-sm rounded-xl p-6">
              ...
              <div className="bg-[#121423] rounded-lg p-4 mb-4">
                <p className="text-[#D4A94E] font-mono text-sm">
                  30 years service | $7,000/month average earnings | Age 62
                </p>
              </div>
              <div className="grid md:grid-cols-3 gap-4 text-center">
                <div className="bg-[#0C0D18] rounded-lg p-4">
                  <p className="text-[#D0CCC4] text-sm">Tier I (approx)</p>
                  <p className="text-2xl font-bold text-blue-600">$2,800</p>
                </div>
                <div className="bg-[#0C0D18] rounded-lg p-4">
                  <p className="text-[#D0CCC4] text-sm">Tier II (approx)</p>
                  <p className="text-2xl font-bold text-[#D4A94E]">$1,470</p>
                </div>
                <div className="bg-[rgba(220,38,38,0.1)] rounded-lg p-4">
                  <p className="text-[#D0CCC4] text-sm">Total Monthly</p>
                  <p className="text-2xl font-bold text-[#F6F4EF]">$4,270</p>
                </div>
              </div>
              ...
              <table className="w-full">
                <thead>
                  <tr className="bg-[#0C0D18] border-b border-[#2A2D42]">
                    <th className="px-6 py-4 text-left text-sm font-semibold text-[#D0CCC4]">
                      Years of Service
                    </th>
                    <th className="px-6 py-4 text-left text-sm font-semibold text-[#D0CCC4]">
                ...
                <tbody>
                  <tr className="border-b border-[#2A2D42]">
                    <td className="px-6 py-4 text-[#F6F4EF] font-medium">30+ years</td>
                    <td className="px-6 py-4 text-[#D4A94E] font-semibold">Age 60</td>
                    <td className="px-6 py-4 text-[#D0CCC4] text-sm">
                      Full Tier I and Tier II - no reductions
                    </td>
                  </tr>
                  <tr className="border-b border-[#2A2D42] bg-[#0C0D18]">
                    <td className="px-6 py-4 text-[#F6F4EF] font-medium">10-29 years</td>
                    <td className="px-6 py-4 text-[#D0CCC4]">Age 62 (reduced) / 67 (full)</td>
                    <td className="px-6 py-4 text-[#D0CCC4] text-sm">
                      Tier I follows SS rules, Tier II has own schedule
                    </td>
                  </tr>
                  <tr className="border-b border-[#2A2D42]">
                    <td className="px-6 py-4 text-[#F6F4EF] font-medium">5-9 years</td>
                    <td className="px-6 py-4 text-[#D0CCC4]">Age 62 (reduced)</td>
                    <td className="px-6 py-4 text-[#D0CCC4] text-sm">
                      May receive Tier I only; credits transfer to SS
                    </td>
                  </tr>
                  <tr className="border-b border-[#2A2D42] bg-[#0C0D18]">
                    <td className="px-6 py-4 text-[#F6F4EF] font-medium">&lt;5 years</td>
                    <td className="px-6 py-4 text-[#D0CCC4]">N/A</td>
                    <td className="px-6 py-4 text-[#D0CCC4] text-sm">
