  ...
  return (
    <main className="min-h-screen bg-white">
              ...
              <table className="w-full">
                <thead>
                  <tr className="bg-[#0C0D18] border-b border-[#2A2D42]">
                    <th className="px-6 py-4 text-left text-sm font-semibold text-[#D0CCC4]">Asset Type</th>
                    <th className="px-6 py-4 text-left text-sm font-semibold text-[#D0CCC4]">Federal Income Tax</th>
                    <th className="px-6 py-4 text-left text-sm font-semibold text-[#D0CCC4]">Special Rules</th>
                  </tr>
                </thead>
                <tbody>
                  <tr className="border-b border-[#2A2D42]">
                    <td className="px-6 py-4 text-[#F6F4EF] font-medium">Cash</td>
                    <td className="px-6 py-4 text-green-600">None</td>
                    <td className="px-6 py-4 text-[#D0CCC4] text-sm">Interest earned after inheritance is taxable</td>
                  </tr>
                  <tr className="border-b border-[#2A2D42] bg-[#0C0D18]">
                    <td className="px-6 py-4 text-[#F6F4EF] font-medium">Traditional IRA/401(k)</td>
                    <td className="px-6 py-4 text-red-600">Ordinary income on withdrawals</td>
                    <td className="px-6 py-4 text-[#D0CCC4] text-sm">10-year rule for non-spouse; spouse can rollover</td>
                  </tr>
                  <tr className="border-b border-[#2A2D42]">
                    <td className="px-6 py-4 text-[#F6F4EF] font-medium">Roth IRA</td>
                    <td className="px-6 py-4 text-green-600">None (if qualified)</td>
                    <td className="px-6 py-4 text-[#D0CCC4] text-sm">10-year rule still applies; tax-free growth</td>
                  </tr>
                  <tr className="border-b border-[#2A2D42] bg-[#0C0D18]">
                    <td className="px-6 py-4 text-[#F6F4EF] font-medium">Stocks/Investments</td>
                    <td className="px-6 py-4 text-green-600">None (step-up in basis)</td>
                    <td className="px-6 py-4 text-[#D0CCC4] text-sm">Only pay tax on gains after inheritance</td>
                  </tr>
                  <tr className="border-b border-[#2A2D42]">
                    <td className="px-6 py-4 text-[#F6F4EF] font-medium">Real Estate</td>
                    <td className="px-6 py-4 text-green-600">None (step-up in basis)</td>
                    <td className="px-6 py-4 text-[#D0CCC4] text-sm">Property taxes continue; rental income taxable</td>
                  </tr>
                  <tr className="border-b border-[#2A2D42] bg-[#0C0D18]">
                    <td className="px-6 py-4 text-[#F6F4EF] font-medium">Life Insurance</td>
                    <td className="px-6 py-4 text-green-600">None</td>
                    <td className="px-6 py-4 text-[#D0CCC4] text-sm">Proceeds tax-free to named beneficiaries</td>
                  </tr>
                </tbody>
              </table>
            </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6">
              <div className="bg-[#161828] border border-[#2A2D42] shadow-sm rounded-xl p-6">
                <h3 className="text-lg font-semibold text-[#F6F4EF] mb-3">Strategy 1: Equal Annual Distributions</h3>
                ...
                <div className="p-3 bg-[#0C0D18] rounded-lg">
                  <p className="text-sm text-[#A8A39A]">
                    <strong className="text-[#F6F4EF]">Example:</strong> $500,000 inherited IRA = $50,000/year for 10 years
              ...
              <div className="bg-[#161828] border border-[#2A2D42] shadow-sm rounded-xl p-6">
                <h3 className="text-lg font-semibold text-[#F6F4EF] mb-3">Strategy 2: Tax Bracket Management</h3>
                <p className="text-[#D0CCC4] text-sm mb-3">
              ...
              <div className="bg-[#161828] border border-[#2A2D42] shadow-sm rounded-xl p-6">
                <h3 className="text-lg font-semibold text-[#F6F4EF] mb-3">Strategy 3: Charitable Giving</h3>
                <p className="text-[#D0CCC4] text-sm mb-3">
              ...
              <div className="bg-[#161828] border border-[#2A2D42] shadow-sm rounded-xl p-6">
                <h3 className="text-lg font-semibold text-[#F6F4EF] mb-3">Strategy 4: Roth Conversion Bridge</h3>
                <p className="text-[#D0CCC4] text-sm mb-3">
      ...
      <section className="py-16 bg-[#0C0D18]">
        <Container>
          <div className="max-w-4xl mx-auto">
            <h2 className="text-2xl md:text-3xl font-bold text-[#F6F4EF] text-center mb-8">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
              {[
                ...
                <div key={item.state} className="bg-[#161828] border border-[#2A2D42] shadow-sm rounded-lg p-4">
                  <div className="text-[#F6F4EF] font-semibold">{item.state}</div>
                  <div className="text-[#D4A94E] text-lg font-bold">{item.rate}</div>
                  <div className="text-[#A8A39A] text-xs">{item.note}</div>
                </div>
              ))}
            </div>

            <p className="text-center text-[#D0CCC4] text-sm mt-6">
