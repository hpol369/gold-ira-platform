        ...
        <Container>
          <div className="max-w-6xl mx-auto">
            <div className="grid lg:grid-cols-2 gap-8">
              ...
              <div className="space-y-6">
                ...
                <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6">
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <h2 className="text-lg font-semibold text-white">Your Age</h2>
                  </div>
                  ...
                  <div className="space-y-5">
                    ...
                    <div>
                      <div className="flex items-center justify-between mb-3">
                        ...
                        <span className="text-amber-400 font-bold">{currentAge}</span>
                      </div>
                      <input
                        type="range"
                        min={18}
                    ...
                    <div className="bg-slate-800/50 rounded-lg p-3 border border-slate-700">
                      <div className="flex justify-between items-center">
                        ...
                        <span className="font-bold text-green-400">{calculations.yearsToRetirement} years</span>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6">
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <h2 className="text-lg font-semibold text-white">Your 401(k)</h2>
                  </div>
                  ...
                  <div className="space-y-5">
                    ...
                    <div>
                      <div className="flex items-center justify-between mb-3">
                        ...
                        <span className="text-amber-400 font-bold">{formatFullCurrency(currentBalance)}</span>
                      </div>
                      <input
                        type="range"
                        min={0}
                    ...
                    <div>
                      <div className="flex items-center justify-between mb-3">
                        ...
                        <span className="text-amber-400 font-bold">{formatFullCurrency(annualSalary)}</span>
                      </div>
                      <input
                        type="range"
                        min={30000}
                    ...
                    <div>
                      <div className="flex items-center justify-between mb-3">
                        ...
                        <span className="text-amber-400 font-bold">{formatFullCurrency(annualContribution)}</span>
                      </div>
                      <input
                        type="range"
                        min={0}
                ...
                <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6">
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <h2 className="text-lg font-semibold text-white">Employer Match</h2>
                  </div>
                  ...
                  <div className="space-y-5">
                    ...
                    <div>
                      <div className="flex items-center justify-between mb-3">
                        ...
                        <span className="text-amber-400 font-bold">{employerMatchPercent}%</span>
                      </div>
                      <input
                        type="range"
                        min={0}
                    ...
                    <div>
                      <div className="flex items-center justify-between mb-3">
                        ...
                        <span className="text-amber-400 font-bold">{employerMatchLimit}%</span>
                      </div>
                      <input
                        type="range"
                        min={0}
                    ...
                    <div className="bg-gradient-to-r from-purple-500/10 to-blue-500/10 border border-purple-500/30 rounded-lg p-4">
                      <div className="flex items-center justify-between">
                        <div>
                          <div className="text-slate-300 text-sm">Annual Employer Match</div>
                          <div className="text-xs text-slate-400">Free money from your employer!</div>
                        </div>
                ...
                <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6">
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <h2 className="text-lg font-semibold text-white">Investment Assumptions</h2>
                  </div>
                  ...
                  <div className="space-y-5">
                    ...
                    <div>
                      <div className="flex items-center justify-between mb-3">
                        ...
                        <span className="text-amber-400 font-bold">{expectedReturn}%</span>
                      </div>
                      <input
                        type="range"
                        min={3}
                    ...
                    <div>
                      <div className="flex items-center justify-between mb-3">
                        ...
                        <span className="text-amber-400 font-bold">{inflationRate}%</span>
                      </div>
                      <input
                        type="range"
                        min={1}
                    ...
                    <div className="bg-slate-800/50 rounded-lg p-3 border border-slate-700">
                      <div className="flex justify-between items-center">
                        <span className="text-sm text-slate-400">Real Return (after inflation)</span>
                        <span className="font-bold text-blue-400">{(expectedReturn - inflationRate).toFixed(1)}%</span>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="space-y-6">
                {/* Main Result Card */}
                <div className="bg-gradient-to-br from-amber-500/20 to-amber-600/20 backdrop-blur-sm rounded-2xl p-8 border border-amber-500/30">
                  <div className="flex items-center gap-3 mb-4">
                    <Target className="h-10 w-10 text-amber-400" />
                    <div>
                      <h3 className="text-sm text-slate-400">Projected 401(k) at Retirement</h3>
                  ...
                  <div className="grid grid-cols-2 gap-4 mt-6 pt-6 border-t border-amber-500/30">
                    <div>
                      <div className="text-sm text-slate-400 mb-1">Real Value (Today's Dollars)</div>
                      <div className="text-xl font-bold text-white">
                        {formatCurrency(calculations.finalRealBalance)}
                      </div>
                    </div>
                    <div>
                      <div className="text-sm text-slate-400 mb-1">Retirement Age</div>
                      <div className="text-xl font-bold text-white">
                ...
                <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <h3 className="text-lg font-semibold text-white">Monthly Retirement Income (4% Rule)</h3>
                  </div>

                  <div className="grid grid-cols-2 gap-4">
                    <div className="bg-slate-800/50 rounded-xl p-4">
                      <div className="text-slate-400 text-sm mb-1">Nominal</div>
                      <div className="text-2xl font-bold text-green-400">
                    ...
                    <div className="bg-slate-800/50 rounded-xl p-4">
                      <div className="text-slate-400 text-sm mb-1">Real (Today's $)</div>
                ...
                <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6">
                  ...
                  <div className="space-y-4">
                    <div className="flex justify-between items-center p-3 bg-slate-800/50 rounded-lg">
                      ...
                      <span className="font-semibold text-white">{formatFullCurrency(currentBalance)}</span>
                    </div>

                    <div className="flex justify-between items-center p-3 bg-slate-800/50 rounded-lg">
                      <div className="flex items-center gap-3">
                        <div className="w-3 h-3 rounded-full bg-green-500"></div>
                        <span className="text-slate-300">Your Total Contributions</span>
                      </div>
                      <span className="font-semibold text-green-400">+{formatFullCurrency(calculations.totalYourContributions)}</span>
                    </div>

                    <div className="flex justify-between items-center p-3 bg-slate-800/50 rounded-lg">
                      <div className="flex items-center gap-3">
                        <div className="w-3 h-3 rounded-full bg-blue-500"></div>
                        <span className="text-slate-300">Total Employer Match</span>
                      </div>
                      <span className="font-semibold text-blue-400">+{formatFullCurrency(calculations.totalEmployerMatch)}</span>
                    </div>
                    ...
                    <div className="flex justify-between items-center p-3 bg-slate-800/50 rounded-lg">
                      ...
                      <span className="font-semibold text-amber-400">+{formatFullCurrency(calculations.totalInvestmentGrowth)}</span>
                    </div>

                    <div className="flex justify-between items-center p-4 bg-gradient-to-r from-amber-500/10 to-amber-600/10 border border-amber-500/30 rounded-lg">
                      <span className="text-white font-semibold">Total at Retirement</span>
                      <span className="text-2xl font-bold text-amber-400">{formatFullCurrency(calculations.finalBalance)}</span>
                    </div>
                  </div>
                </div>
                ...
                {/* Growth Chart */}
                <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6">
                  <h3 className="text-lg font-semibold text-white mb-4">401(k) Growth Over Time</h3>
                  ...
                  <div className="flex justify-center gap-6 mt-4">
                    <div className="flex items-center gap-2">
                      <div className="w-3 h-3 rounded-full bg-amber-500"></div>
                      <span className="text-sm text-slate-400">Nominal Balance</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <div className="w-3 h-3 rounded-full bg-blue-500"></div>
                      <span className="text-sm text-slate-400">Real Balance (Today's $)</span>
                    </div>
                  </div>
                </div>
                ...
                {/* Pie Chart */}
                <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6">
                  <h3 className="text-lg font-semibold text-white mb-4">Where Your Money Comes From</h3>
                      ...
                      <table className="w-full text-sm">
                        <thead>
                          <tr className="border-b border-slate-700">
                            ...
                            <th className="text-right py-2 px-2 text-slate-400">Contribution</th>
                            <th className="text-right py-2 px-2 text-slate-400">Match</th>
                            <th className="text-right py-2 px-2 text-slate-400">Growth</th>
                          ...
                          {calculations.projections.map((proj, index) => (
                            <tr
                              ...
                              className={`border-b border-slate-800 ${
                                proj.age === retirementAge ? 'bg-amber-500/10' : ''
                              }`}
                            >
                              <td className="py-2 px-2 text-slate-300">{proj.year}</td>
                              <td className="py-2 px-2 text-slate-300">{proj.age}</td>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6">
                <div className="flex items-center gap-3 mb-4">
                  <div className="w-8 h-8 bg-amber-500 rounded-full flex items-center justify-center text-slate-900 font-bold">1</div>
                  <h3 className="text-lg font-semibold text-white">Enter Your Age</h3>
                </div>
              ...
              <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6">
                <div className="flex items-center gap-3 mb-4">
                  <div className="w-8 h-8 bg-amber-500 rounded-full flex items-center justify-center text-slate-900 font-bold">2</div>
                  <h3 className="text-lg font-semibold text-white">Add Your Balance</h3>
                </div>
                <p className="text-slate-400">
              ...
              <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6">
                <div className="flex items-center gap-3 mb-4">
                  <div className="w-8 h-8 bg-amber-500 rounded-full flex items-center justify-center text-slate-900 font-bold">3</div>
                  <h3 className="text-lg font-semibold text-white">Set Employer Match</h3>
                </div>
                <p className="text-slate-400">
              ...
              <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6">
                <div className="flex items-center gap-3 mb-4">
                  <div className="w-8 h-8 bg-amber-500 rounded-full flex items-center justify-center text-slate-900 font-bold">4</div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-invert max-w-none">
              <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6 mb-6">
                <h3 className="text-xl font-semibold text-white mb-4">The Power of Compound Interest</h3>
                <p className="text-slate-400">
                ...
                <div className="bg-slate-800/50 rounded-lg p-4 mt-4">
                  <p className="text-amber-400 font-semibold mb-2">Example:</p>
              ...
              <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6 mb-6">
                <h3 className="text-xl font-semibold text-white mb-4">The Three Sources of Growth</h3>
                <div className="space-y-4">
                  <div className="flex gap-4">
                    <div className="w-3 h-3 rounded-full bg-green-500 mt-2 shrink-0"></div>
                    <div>
                      <h4 className="text-white font-semibold">Your Contributions</h4>
                  ...
                  <div className="flex gap-4">
                    ...
                    <div>
                      <h4 className="text-white font-semibold">Employer Match</h4>
                      <p className="text-slate-400 text-sm">
                  ...
                  <div className="flex gap-4">
                    ...
                    <div>
                      <h4 className="text-white font-semibold">Investment Growth</h4>
                      <p className="text-slate-400 text-sm">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-gradient-to-br from-blue-500/10 to-blue-600/10 border border-blue-500/30 rounded-xl p-6">
                <h3 className="text-xl font-bold text-blue-400 mb-4">Under Age 50</h3>
                <div className="text-4xl font-bold text-white mb-2">$23,500</div>
                <p className="text-slate-400">
              ...
              <div className="bg-gradient-to-br from-purple-500/10 to-purple-600/10 border border-purple-500/30 rounded-xl p-6">
                <h3 className="text-xl font-bold text-purple-400 mb-4">Age 50 and Over</h3>
                <div className="text-4xl font-bold text-white mb-2">$31,000</div>
                <p className="text-slate-400">
            ...
            <div className="mt-6 bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6">
              ...
              <div className="flex flex-wrap gap-4">
                <div className="bg-slate-800/50 rounded-lg px-4 py-2">
                  <span className="text-slate-400 text-sm">Under 50:</span>
                  <span className="text-white font-bold ml-2">$70,000</span>
                </div>
                <div className="bg-slate-800/50 rounded-lg px-4 py-2">
                  <span className="text-slate-400 text-sm">Age 50+:</span>
                  <span className="text-white font-bold ml-2">$77,500</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 bg-slate-900">
        <Container>
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6 mb-6">
              <h3 className="text-xl font-semibold text-white mb-4">Common Matching Formulas</h3>

              <div className="space-y-4">
                <div className="bg-slate-800/50 rounded-lg p-4">
                  <div className="flex justify-between items-start mb-2">
                    <h4 className="text-amber-400 font-semibold">50% match up to 6%</h4>
                    <span className="text-xs bg-green-500/20 text-green-400 px-2 py-1 rounded">Most Common</span>
                  </div>
                ...
                <div className="bg-slate-800/50 rounded-lg p-4">
                  <h4 className="text-amber-400 font-semibold mb-2">100% match up to 3%</h4>
                  <p className="text-slate-400 text-sm mb-2">
                ...
                <div className="bg-slate-800/50 rounded-lg p-4">
                  <h4 className="text-amber-400 font-semibold mb-2">100% match up to 4%, plus 50% of next 2%</h4>
                  <p className="text-slate-400 text-sm mb-2">
            ...
            <div className="bg-gradient-to-r from-green-500/10 to-green-600/10 border border-green-500/30 rounded-xl p-6">
              <div className="flex items-start gap-4">
                <CheckCircle2 className="h-6 w-6 text-green-400 shrink-0 mt-1" />
                <div>
                  <h3 className="text-lg font-bold text-white mb-2">Always Get the Full Match!</h3>
