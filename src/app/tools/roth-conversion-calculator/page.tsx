                  ...
                  <div>
                    <div className="flex items-center justify-between mb-3">
                      <label className="text-sm text-[#D0CCC4] font-medium flex items-center gap-2">
                        <PiggyBank className="h-4 w-4 text-[#D4A94E]" />
                        Traditional IRA Balance
                      </label>
                      ...
                      {results.bracketAdvice && (
                        <div className="bg-[#121423] border border-blue-200 rounded-xl p-5">
                          <div className="flex items-start gap-3">
                            ...
                            <div>
                              <h4 className="text-[#F6F4EF] font-semibold mb-1">
                                Optimization Tip
                              </h4>
        ...
        <Container>
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              <div className="bg-[#161828] border border-[#2A2D42] shadow-sm rounded-xl p-6">
                <div className="w-12 h-12 bg-[rgba(220,38,38,0.1)] rounded-xl flex items-center justify-center mb-4">
