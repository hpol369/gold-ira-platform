            ...
            <div className="bg-[#161828] border border-[#2A2D42] shadow-sm rounded-xl p-6 mb-8">
              <div className="grid md:grid-cols-2 gap-6 mb-6">
                <div className="bg-[#0C0D18] rounded-lg p-4">
                  <h4 className="text-[#D4A94E] font-semibold mb-2">Upfront MIP</h4>
                  <div className="text-3xl font-bold text-[#F6F4EF] mb-2">2%</div>
                  <p className="text-[#D0CCC4] text-sm">
                    of appraised home value (or HECM limit, whichever is less). Typically financed into the loan.
                  </p>
                </div>
                <div className="bg-[#0C0D18] rounded-lg p-4">
                  <h4 className="text-[#D4A94E] font-semibold mb-2">Annual MIP</h4>
                  <div className="text-3xl font-bold text-[#F6F4EF] mb-2">0.5%</div>
                  <p className="text-[#D0CCC4] text-sm">
