        ...
        <Container>
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-[#161828] border border-[#2A2D42] shadow-sm rounded-xl p-6">
                <div className="flex items-start gap-4">
                  <div className="w-8 h-8 bg-[#DC2626] rounded-full flex items-center justify-center flex-shrink-0 text-white font-bold">
                    3
                  </div>
                  <div>
                    <h3 className="text-lg font-semibold text-[#F6F4EF] mb-2">
            ...
            <div className="mt-8 bg-green-50 border border-green-200 rounded-xl p-6">
              ...
              <div className="bg-[#121423] rounded-lg p-4 mb-4">
                <p className="text-[#D0CCC4] font-mono text-sm">
