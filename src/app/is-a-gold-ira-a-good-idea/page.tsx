            ...
            <div className="max-w-3xl mx-auto">
              ...
              <div className="space-y-4">
                {[
                  ...
                  >
                    <h3 className="font-bold text-[#B22234] mb-2 flex items-center gap-2">
                      <AlertTriangle className="w-4 h-4 flex-shrink-0" />
                      {item.title}
                    </h3>
                    <p className="text-slate-600 leading-relaxed text-sm pl-6">
                      {item.body}
                    </p>
                  </div>
                ))}
              ...
              <div className="mt-6 bg-amber-50 border border-amber-200 rounded-xl p-5">
                <p className="text-slate-700 leading-relaxed text-sm">
                  <strong className="text-[#000080]">Bottom line:</strong> A
            ...
            <div className="max-w-3xl mx-auto">
              ...
              <div className="mt-6 bg-amber-50 border border-amber-200 rounded-xl p-5">
                <p className="text-slate-700 leading-relaxed">
                  <strong className="text-[#000080]">What this means for you:</strong>{" "}
          ...
          <Container>
            <div className="max-w-3xl mx-auto">
              ...
              <div className="mt-6 bg-white border border-slate-200 rounded-xl p-5">
                <h3 className="font-bold text-[#000080] mb-3">
        ...
        <section className="py-12 md:py-16 bg-slate-50">
          <Container>
            <div className="max-w-3xl mx-auto">
              ...
              <div className="mt-6 bg-[#000080] text-white rounded-xl p-6">
              ...
              <div className="grid sm:grid-cols-3 gap-4">
                {[
                  ...
                  <Link
                    key={link.href}
                    href={link.href}
                    className="block bg-slate-50 border border-slate-200 rounded-xl p-5 hover:border-[#000080] hover:shadow-md transition-all group"
                  >
                    <h3 className="font-bold text-[#000080] group-hover:text-[#B22234] transition-colors mb-1 text-sm">
                      {link.title}
                    </h3>
                    <p className="text-xs text-slate-500">{link.desc}</p>
                    <span className="inline-flex items-center gap-1 text-xs font-semibold text-[#B22234] mt-2">
