      ...
      <section className="py-8 bg-slate-100 border-b border-slate-200">
        <Container>
          <div className="flex flex-wrap gap-4 text-sm">
            ...
            <a href="#contribution-limits" className="text-[#B22234] hover:text-[#8B1A28]">Contribution Limits</a>
            <a href="#eligible-metals" className="text-[#B22234] hover:text-[#8B1A28]">Eligible Metals</a>
        ...
        <Container>
          <div className="grid lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2 space-y-12">
              ...
              <div id="contribution-limits">
                <h2 className="text-2xl font-bold text-[#000080] mb-6 flex items-center gap-3">
                  <DollarSign className="h-7 w-7 text-[#B22234]" />
                  Contribution Limits
                </h2>
                ...
                <div className="grid sm:grid-cols-2 gap-4 mb-6">
                  <div className="bg-slate-50 rounded-xl p-6 border border-slate-200 text-center">
                    <div className="text-3xl font-bold text-[#B22234] mb-2">$7,000</div>
                    <div className="text-sm text-slate-500">Under Age 50</div>
                  </div>
                  <div className="bg-slate-50 rounded-xl p-6 border border-slate-200 text-center">
                    <div className="text-3xl font-bold text-[#B22234] mb-2">$8,000</div>
                    <div className="text-sm text-slate-500">Age 50+ (Catch-Up)</div>
                  </div>
                </div>
              ...
              <div className="bg-slate-50 rounded-xl border border-slate-200 p-6">
                <h3 className="font-bold text-[#000080] mb-4">Rollovers vs. Transfers: No Contribution Limits</h3>
                ...
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <span className="font-medium text-[#000080]">Direct Rollover:</span>
                      <span className="text-slate-500"> Funds move directly between custodians. No limit, no taxes.</span>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <CheckCircle2 className="h-5 w-5 text-green-500 flex-shrink-0 mt-0.5" />
                    <div>
                      <span className="font-medium text-[#000080]">Trustee-to-Trustee Transfer:</span>
                      <span className="text-slate-500"> Same as direct rollover. No limit, no taxes.</span>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <AlertTriangle className="h-5 w-5 text-amber-500 flex-shrink-0 mt-0.5" />
                    <div>
                      <span className="font-medium text-[#000080]">Indirect Rollover:</span>
                      <span className="text-slate-500"> You receive funds and have 60 days to deposit. 20% withholding applies. One per year.</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div id="eligible-metals">
                <h2 className="text-2xl font-bold text-[#000080] mb-6 flex items-center gap-3">
                  <Scale className="h-7 w-7 text-[#B22234]" />
                  ...
                  <table className="w-full bg-slate-50 rounded-xl border border-slate-200">
                    <thead>
                      <tr className="bg-slate-100">
                        <th className="p-4 text-left font-semibold text-slate-600">Metal</th>
                        <th className="p-4 text-center font-semibold text-slate-600">Minimum Purity</th>
                        <th className="p-4 text-left font-semibold text-slate-600">Examples</th>
                      </tr>
                    </thead>
                    <tbody>
                      <tr className="border-t border-slate-200">
                        <td className="p-4 font-medium text-[#000080]">Gold</td>
                        <td className="p-4 text-center text-slate-500">99.5% (0.995)</td>
                        <td className="p-4 text-slate-500">American Gold Eagle, Canadian Gold Maple Leaf, Gold bars</td>
                      </tr>
                      <tr className="border-t border-slate-200 bg-slate-100/50">
                        <td className="p-4 font-medium text-[#000080]">Silver</td>
                        <td className="p-4 text-center text-slate-500">99.9% (0.999)</td>
                        <td className="p-4 text-slate-500">American Silver Eagle, Canadian Silver Maple Leaf, Silver bars</td>
                      </tr>
                      <tr className="border-t border-slate-200">
                        <td className="p-4 font-medium text-[#000080]">Platinum</td>
                        <td className="p-4 text-center text-slate-500">99.95% (0.9995)</td>
                        <td className="p-4 text-slate-500">American Platinum Eagle, Canadian Platinum Maple Leaf</td>
                      </tr>
                      <tr className="border-t border-slate-200 bg-slate-100/50">
                        <td className="p-4 font-medium text-[#000080]">Palladium</td>
                        <td className="p-4 text-center text-slate-500">99.95% (0.9995)</td>
                        <td className="p-4 text-slate-500">Canadian Palladium Maple Leaf</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
              ...
              <div id="storage-rules">
                <h2 className="text-2xl font-bold text-[#000080] mb-6 flex items-center gap-3">
                  <Landmark className="h-7 w-7 text-[#B22234]" />
                ...
                <div className="space-y-4 mb-6">
                  <div className="bg-slate-50 rounded-xl p-6 border border-slate-200">
                    <h4 className="font-bold text-[#000080] mb-2">Approved Depositories</h4>
                  ...
                  <div className="bg-slate-50 rounded-xl p-6 border border-slate-200">
                    <h4 className="font-bold text-[#000080] mb-2">Segregated vs. Commingled Storage</h4>
                    <div className="space-y-3 text-sm">
                      <div className="flex items-start gap-3">
                        <CheckCircle2 className="h-5 w-5 text-green-500 flex-shrink-0 mt-0.5" />
                        <div>
                          <span className="font-medium text-[#000080]">Segregated:</span>
                          <span className="text-slate-500"> Your metals stored separately with your name. Higher fees but you get your exact coins back.</span>
                        </div>
                      </div>
                      <div className="flex items-start gap-3">
                        <CheckCircle2 className="h-5 w-5 text-blue-500 flex-shrink-0 mt-0.5" />
                        <div>
                          <span className="font-medium text-[#000080]">Commingled:</span>
                          <span className="text-slate-500"> Your metals stored with other investors&apos; metals. Lower fees but you get equivalent metals back.</span>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div id="distribution-rules">
                <h2 className="text-2xl font-bold text-[#000080] mb-6 flex items-center gap-3">
                  <Calendar className="h-7 w-7 text-[#B22234]" />
                  Distribution Rules
                </h2>
                <p className="text-slate-500 mb-6">
                ...
                <div className="space-y-4">
                  <div className="bg-slate-50 rounded-xl p-6 border border-slate-200">
                    <h4 className="font-bold text-[#000080] mb-3">Early Withdrawal (Before 59 1/2)</h4>
                  ...
                  <div className="bg-slate-50 rounded-xl p-6 border border-slate-200">
                    <h4 className="font-bold text-[#000080] mb-3">Qualified Distributions (After 59 1/2)</h4>
                    <ul className="space-y-2 text-sm text-slate-500">
                      <li className="flex items-start gap-2">
                        <CheckCircle2 className="h-4 w-4 text-green-500 flex-shrink-0 mt-0.5" />
              ...
              <div id="prohibited-transactions">
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-4 bg-slate-50 rounded-xl p-5 border border-slate-200">
                    ...
                    <div>
                      <h4 className="font-bold text-[#000080]">Selling Personal Gold to Your IRA</h4>
                  ...
                  <div className="flex items-start gap-4 bg-slate-50 rounded-xl p-5 border border-slate-200">
                    <XCircle className="h-6 w-6 text-red-500 flex-shrink-0 mt-0.5" />
                    <div>
                      <h4 className="font-bold text-[#000080]">Using IRA Gold as Collateral</h4>
                      <p className="text-sm text-slate-500">
                  ...
                  <div className="flex items-start gap-4 bg-slate-50 rounded-xl p-5 border border-slate-200">
                    <XCircle className="h-6 w-6 text-red-500 flex-shrink-0 mt-0.5" />
                    <div>
                      <h4 className="font-bold text-[#000080]">Personal Use or Possession</h4>
                      <p className="text-sm text-slate-500">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-slate-50 rounded-xl p-6 border border-slate-200 sticky top-4">
                ...
                <ul className="space-y-4">
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      <div className="font-medium text-[#000080]">Contribution Limit</div>
                  ...
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      <div className="font-medium text-[#000080]">Gold Purity</div>
                      <div className="text-sm text-slate-500">99.5% minimum</div>
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <Calendar className="h-5 w-5 text-[#B22234] flex-shrink-0" />
                    <div>
                      <div className="font-medium text-[#000080]">Early Withdrawal Age</div>
                      <div className="text-sm text-slate-500">59 1/2</div>
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
              ...
              {/* CTA */}
              <div className="bg-[#B22234]/10 rounded-xl p-6 border border-[#B22234]/20">
                ...
                <Link
                  ...
                  className="block text-center px-4 py-2.5 bg-[#B22234] text-white font-bold rounded-lg hover:bg-[#8B1A28] transition-all shadow text-sm"
                >
