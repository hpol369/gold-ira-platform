      ...
      <section className="py-8 bg-[rgba(220,38,38,0.1)] border-y border-[#B22234]/30">
        <Container>
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-[#D4A94E] mt-2 font-semibold">- Robert Kiyosaki, Rich Dad Poor Dad</p>
          </div>
        </Container>
      </section>
              ...
              {guides.filter(g => g.featured).map((guide) => {
                ...
                return (
                  <Link
                    ...
                    className="group bg-[#0C0D18] backdrop-blur-sm border border-[#3F4460] rounded-xl p-6 hover:bg-[#1E2134] hover:border-[#3F4460]/50 transition-all"
                  >
                  ...
                  >
                    <div className="flex items-start gap-4">
                      <div className={`w-10 h-10 rounded-lg flex items-center justify-center flex-shrink-0 ${
                        guide.featured ? "bg-[rgba(220,38,38,0.1)]" : "bg-[#121423]"
                      }`}>
                        <Icon className={`h-5 w-5 ${
                          guide.featured ? "text-[#D0CCC4]" : "text-[#D0CCC4]"
                        }`} />
                      </div>
                      <div className="flex-1">
                        <h3 className="text-base font-bold text-[#F6F4EF] group-hover:text-[#D4A94E] transition-colors mb-1">
                          {guide.title}
                        </h3>
                        <p className="text-[#D0CCC4] text-sm mb-2 line-clamp-2">
                          {guide.description}
                        </p>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="bg-[rgba(220,38,38,0.1)] border border-[#B22234]/30 rounded-xl p-6">
                ...
                <ul className="space-y-3 text-[#D0CCC4]">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="text-[#D4A94E] mt-1">5.</span>
        ...
        <Container>
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <Link
                href="/silver-ira"
                className="inline-flex items-center gap-2 px-6 py-3 bg-[#121423] hover:bg-[#1E2134] text-[#F6F4EF] rounded-xl font-semibold transition-colors"
              >
              ...
              <Link
                ...
                className="inline-flex items-center gap-2 px-6 py-3 bg-[#121423] hover:bg-[#1E2134]/20 text-[#F6F4EF] rounded-xl font-semibold transition-colors"
              >
                Silver IRA Rules
                <ArrowRight className="h-4 w-4" />
              </Link>
