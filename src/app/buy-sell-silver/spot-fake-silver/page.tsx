        ...
        <Container>
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-slate-600">
              <strong className="text-slate-900">Buy from reputable dealers only.</strong>
                ...
                return (
                  <div key={index} className="bg-slate-50 backdrop-blur-sm border border-slate-200 rounded-xl p-6">
                    <div className="flex items-center gap-3 mb-4">
                      ...
                      <h3 className="text-lg font-bold text-slate-900">{item.check}</h3>
                    </div>
                    <p className="text-slate-600 text-sm mb-4">{item.description}</p>
                    <div className="space-y-3">
                      <div>
                        <span className="text-green-400 font-semibold text-sm">What to Look For: </span>
                        <span className="text-slate-600 text-sm">{item.whatToLook}</span>
                      </div>
                      <div className="bg-red-500/10 border border-red-500/30 rounded-lg p-3">
                        <span className="text-red-400 font-semibold text-sm">Red Flag: </span>
                        <span className="text-slate-600 text-sm">{item.redFlag}</span>
                      </div>
                    </div>
                  </div>
                );
        ...
        <Container>
          <div className="max-w-5xl mx-auto">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="grid md:grid-cols-2 gap-4 mb-4">
                          ...
                          <div className="bg-[#B22234]/10 border border-[#B22234]/30 rounded-lg p-4">
                            <h4 className="text-sm font-semibold text-[#B22234] mb-2 flex items-center gap-1">
                              <AlertTriangle className="h-3 w-3" />
                              Caution
                            </h4>
                            <p className="text-slate-600 text-sm">{test.caution}</p>
                          </div>
                        </div>
                      </div>
                    </div>
            ...
            <p className="text-center text-slate-600 text-sm mt-8">
              For the most comprehensive testing, see our <Link href="/buy-sell-silver/silver-testing" className="text-[#B22234] hover:underline">Complete Silver Testing Guide</Link>.
            </p>
          </div>
        </Container>
      </section>
                  ...
                  <div className="flex flex-col md:flex-row md:items-start gap-4">
                    <div className="flex-1">
                      <div className="flex items-center gap-3 mb-2">
                        <h3 className="text-lg font-bold text-slate-900">{fake.type}</h3>
                        <span className={`text-xs px-2 py-1 rounded ${
                          fake.prevalence === "Very Common" ? "bg-red-500/20 text-red-400" :
                          fake.prevalence === "Common" || fake.prevalence === "Common Online" ? "bg-[#B22234]/20 text-[#B22234]" :
                          "bg-blue-500/20 text-blue-400"
                        }`}>
                          {fake.prevalence}
                        </span>
                      </div>
                      <p className="text-slate-600 text-sm mb-3">{fake.description}</p>
                      <div>
                        <span className="text-green-400 font-semibold text-sm">How to Spot: </span>
                        <span className="text-slate-600 text-sm">{fake.howToSpot}</span>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <Container>
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            <Link href="/buy-sell-silver/silver-testing" className="group bg-slate-50 backdrop-blur-sm border border-slate-200 rounded-xl p-6 hover:bg-slate-100 transition-colors">
              ...
              <p className="text-sm text-slate-600">Complete testing guide with all methods</p>
            </Link>
            <Link href="/buy-sell-silver/best-coins-to-buy" className="group bg-slate-50 backdrop-blur-sm border border-slate-200 rounded-xl p-6 hover:bg-slate-100 transition-colors">
              ...
              <p className="text-sm text-slate-600">Stick to reputable coins from trusted sources</p>
            </Link>
            <Link href="/buy-sell-silver/best-place-to-sell" className="group bg-slate-50 backdrop-blur-sm border border-slate-200 rounded-xl p-6 hover:bg-slate-100 transition-colors">
              ...
              <p className="text-sm text-slate-600">Reputable dealers test for you</p>
            </Link>
          </div>
        </Container>
      </section>
