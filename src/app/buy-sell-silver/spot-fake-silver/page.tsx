        ...
        <Container>
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-[#D0CCC4]">
              <strong className="text-[#F6F4EF]">Buy from reputable dealers only.</strong>
              ...
              {visualChecks.map((item, index) => {
                ...
                return (
                  <div key={index} className="bg-[#0C0D18] backdrop-blur-sm border border-[#2A2D42] rounded-xl p-6">
                    ...
                    <p className="text-[#D0CCC4] text-sm mb-4">{item.description}</p>
      ...
      <section className="py-16 bg-[#0C0D18]">
        <Container>
          <div className="max-w-5xl mx-auto">
                  ...
                  <div key={index} className="bg-[#0C0D18] backdrop-blur-sm border border-[#2A2D42] rounded-xl p-6 md:p-8">
                    <div className="flex flex-col md:flex-row md:items-start gap-6">
                      <div className="flex items-center gap-4 md:w-48 flex-shrink-0">
                        ...
                        <div>
                          <h3 className="text-lg font-bold text-[#F6F4EF]">{test.name}</h3>
                      ...
                      <div className="flex-1">
                        <p className="text-[#D0CCC4] mb-4">{test.description}</p>
                        <div className="grid md:grid-cols-2 gap-4 mb-4">
                          ...
                          <div className="bg-[rgba(220,38,38,0.1)] border border-[#B22234]/30 rounded-lg p-4">
                            ...
                            <p className="text-[#D0CCC4] text-sm">{test.caution}</p>
                          </div>
                        </div>
                      </div>
                    </div>
            ...
            <p className="text-center text-[#D0CCC4] text-sm mt-8">
              For the most comprehensive testing, see our <Link href="/buy-sell-silver/silver-testing" className="text-[#D4A94E] hover:underline">Complete Silver Testing Guide</Link>.
            </p>
          </div>
        </Container>
      </section>
                ...
                <div key={index} className="bg-[#0C0D18] backdrop-blur-sm border border-[#2A2D42] rounded-xl p-6">
                  <div className="flex flex-col md:flex-row md:items-start gap-4">
                    <div className="flex-1">
                      ...
                      <p className="text-[#D0CCC4] text-sm mb-3">{fake.description}</p>
                      <div>
                        <span className="text-green-400 font-semibold text-sm">How to Spot: </span>
                        <span className="text-[#D0CCC4] text-sm">{fake.howToSpot}</span>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <Container>
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            <Link href="/buy-sell-silver/silver-testing" className="group bg-[#0C0D18] backdrop-blur-sm border border-[#2A2D42] rounded-xl p-6 hover:bg-[#1E2134] transition-colors">
              ...
              <p className="text-sm text-[#D0CCC4]">Complete testing guide with all methods</p>
            </Link>
            <Link href="/buy-sell-silver/best-coins-to-buy" className="group bg-[#0C0D18] backdrop-blur-sm border border-[#2A2D42] rounded-xl p-6 hover:bg-[#1E2134] transition-colors">
              ...
              <p className="text-sm text-[#D0CCC4]">Stick to reputable coins from trusted sources</p>
            </Link>
            <Link href="/buy-sell-silver/best-place-to-sell" className="group bg-[#0C0D18] backdrop-blur-sm border border-[#2A2D42] rounded-xl p-6 hover:bg-[#1E2134] transition-colors">
              ...
              <p className="text-sm text-[#D0CCC4]">Reputable dealers test for you</p>
            </Link>
          </div>
        </Container>
      </section>
