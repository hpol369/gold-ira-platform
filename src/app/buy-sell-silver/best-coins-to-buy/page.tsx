        ...
        <Container>
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-[#D0CCC4]">
              <strong className="text-[#F6F4EF]">Canadian Silver Maple Leaf</strong> -
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {topCoins.map((coin, index) => (
                ...
                >
                  ...
                  <h3 className="text-lg font-bold text-[#F6F4EF] mb-1">{coin.name}</h3>
                  <p className="text-sm text-[#D0CCC4] mb-4">{coin.country}</p>

                  <div className="grid grid-cols-2 gap-3 mb-4 text-sm">
                    <div className="bg-[#0C0D18] rounded-lg p-2">
                      <span className="text-[#D0CCC4] block text-xs">Purity</span>
                      <span className="text-[#F6F4EF] font-semibold">{coin.purity}</span>
                    </div>
                    <div className="bg-[#0C0D18] rounded-lg p-2">
                      <span className="text-[#D0CCC4] block text-xs">Premium</span>
                      <span className="text-[#D4A94E] font-semibold">{coin.premium}</span>
                    </div>
                    <div className="bg-[#0C0D18] rounded-lg p-2">
                      <span className="text-[#D0CCC4] block text-xs">Liquidity</span>
                      <div className="flex gap-0.5">
                        {[1, 2, 3, 4, 5].map((star) => (
                          <Star
                            key={star}
                            className={`h-3 w-3 ${
                              star <= coin.liquidity ? "text-green-400 fill-current" : "text-[#D0CCC4]"
                            }`}
                          />
                        ))}
                      </div>
                    ...
                    <div className="bg-[#0C0D18] rounded-lg p-2">
                      <span className="text-[#D0CCC4] block text-xs">Recognition</span>
                      <div className="flex gap-0.5">
                        {[1, 2, 3, 4, 5].map((star) => (
                          <Star
                            key={star}
                            className={`h-3 w-3 ${
                              star <= coin.recognition ? "text-blue-400 fill-current" : "text-[#D0CCC4]"
                            }`}
                          />
                        ))}
                      </div>
                  ...
                  <div className="mb-4">
                    <p className="text-xs text-[#D0CCC4] mb-1 font-semibold">Pros:</p>
                    <ul className="space-y-1">
                      {coin.pros.slice(0, 2).map((pro, i) => (
                        <li key={i} className="text-xs text-[#D0CCC4] flex items-start gap-1">
                  ...
                  <div className="pt-4 border-t border-[#2A2D42]">
                    <p className="text-xs">
                      <span className="text-[#D4A94E] font-semibold">Best For: </span>
                      <span className="text-[#D0CCC4]">{coin.bestFor}</span>
                    </p>
                  </div>
            ...
            <div className="bg-[#0C0D18] backdrop-blur-sm border border-[#2A2D42] rounded-xl p-8">
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-lg font-bold text-[#F6F4EF] mb-2">Start with 10-20 oz of Sovereign Coins</h3>
                    <p className="text-[#D0CCC4]">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-lg font-bold text-[#F6F4EF] mb-2">Add Lower-Premium Coins (20-50 oz)</h3>
                    <p className="text-[#D0CCC4]">
                ...
                <div className="flex items-start gap-4">
                  <div className="w-10 h-10 bg-[rgba(220,38,38,0.18)] rounded-full flex items-center justify-center flex-shrink-0">
                    <span className="text-[#D4A94E] font-bold">3</span>
                  </div>
                  <div>
                    <h3 className="text-lg font-bold text-[#F6F4EF] mb-2">Consider Bars (50+ oz)</h3>
                    <p className="text-[#D0CCC4]">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {budgetOptions.map((option, index) => (
                <div key={index} className="bg-[#0C0D18] backdrop-blur-sm border border-[#2A2D42] rounded-xl p-6">
                  <h3 className="text-lg font-bold text-[#F6F4EF] mb-1">{option.name}</h3>
                  <p className="text-green-400 font-semibold text-sm mb-3">{option.premium} premium</p>
                  <p className="text-[#D0CCC4] text-sm mb-4">{option.description}</p>
        ...
        <Container>
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            <Link href="/buy-sell-silver/coins-vs-bars" className="group bg-[#0C0D18] backdrop-blur-sm border border-[#2A2D42] rounded-xl p-6 hover:bg-[#1E2134] transition-colors">
              <h3 className="font-bold text-[#F6F4EF] mb-2 group-hover:text-[#D4A94E]">Silver Coins vs Bars</h3>
              <p className="text-sm text-[#D0CCC4]">Detailed comparison of pros/cons</p>
            </Link>
            <Link href="/buy-sell-silver/stacking-beginners" className="group bg-[#0C0D18] backdrop-blur-sm border border-[#2A2D42] rounded-xl p-6 hover:bg-[#1E2134] transition-colors">
              ...
              <p className="text-sm text-[#D0CCC4]">How to build your silver position</p>
            </Link>
            <Link href="/buy-sell-silver/spot-fake-silver" className="group bg-[#0C0D18] backdrop-blur-sm border border-[#2A2D42] rounded-xl p-6 hover:bg-[#1E2134] transition-colors">
              ...
              <p className="text-sm text-[#D0CCC4]">Protect yourself from counterfeits</p>
            </Link>
          </div>
        </Container>
      </section>
