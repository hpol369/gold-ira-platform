        ...
        <main className="min-h-screen flex flex-col bg-white">
            ...
            <div className="flex-grow flex items-center justify-center py-16 md:py-32">
                <Container className="text-center max-w-2xl">
                    <div className="inline-flex items-center justify-center p-6 rounded-full bg-[#121423] mb-8">
                    ...
                    <div className="grid sm:grid-cols-2 gap-4 max-w-lg mx-auto mb-10 text-left">
                        <Link href="/guide/gold-ira-guide" className="group flex items-center gap-4 p-4 rounded-xl border border-slate-200 hover:border-[rgba(197,149,46,0.45)] hover:bg-[rgba(197,149,46,0.08)] transition-all bg-[#161828]">
                        ...
                        <Link href="/quiz" className="group flex items-center gap-4 p-4 rounded-xl border border-slate-200 hover:border-[rgba(197,149,46,0.45)] hover:bg-[rgba(197,149,46,0.08)] transition-all bg-[#161828]">
                            <div className="p-3 bg-[#B22234]/10 rounded-lg group-hover:bg-[#B22234] transition-colors">
