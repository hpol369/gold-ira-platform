...
function SourceNote({ text }: { text: string }) {
  return (
    <p className="text-xs text-[#A8A39A] mt-3 italic">
      Source: {text}
    </p>
  );
}
  ...
  return (
    <>
      ...
      <main className="bg-white min-h-screen">
        ...
        {/* TABLE OF CONTENTS */}
        {/* ================================================================= */}
        <section className="py-8 border-b border-[#2A2D42]">
          <Container>
            <div className="max-w-3xl mx-auto">
              <h2 className="text-sm font-bold uppercase tracking-wider text-[#A8A39A] mb-4">
                In This Report
              </h2>
              <nav>
            ...
            <div className="max-w-3xl mx-auto">
              ...
              <div className="space-y-4">
                {originalInsights.map((item, i) => (
                  <div
                    key={i}
                    className="bg-[#0C0D18] border border-[#2A2D42] rounded-xl p-5"
                  >
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <p className="font-semibold text-[#F6F4EF]">
                          {item.insight}
                        </p>
                        <p className="text-sm text-[#D0CCC4] mt-1">
                          {item.dataPoints}
                        </p>
                        <p className="text-xs text-[#A8A39A] mt-1 italic">
        ...
        {/* ================================================================= */}
        <section className="py-12 md:py-16 bg-[#0C0D18]" id="recession-performance">
          <Container>
            <div className="max-w-4xl mx-auto">
                  ...
                  <table className="w-full text-sm">
                    <thead>
                      <tr className="bg-[#121423] text-left">
                        <th className="px-4 py-3 font-semibold text-[#D0CCC4]">Recession</th>
                        <th className="px-4 py-3 font-semibold text-[#D0CCC4]">Period</th>
                        <th className="px-4 py-3 font-semibold text-[#D0CCC4] text-right">Gold Start</th>
                        <th className="px-4 py-3 font-semibold text-[#D0CCC4] text-right">Gold End</th>
                    ...
                    <tbody>
                      {recessionGoldData.map((row, i) => {
                        ...
                        return (
                          <tr
                            key={row.recession}
                            className={i % 2 === 0 ? "bg-white" : "bg-[#0C0D18]/50"}
                          >
                            <td className="px-4 py-3 font-medium text-[#F6F4EF]">
                              {row.recession}
                            </td>
                            <td className="px-4 py-3 text-[#D0CCC4] whitespace-nowrap">
                              {row.startDate} &ndash; {row.endDate}
                            </td>
                            <td className="px-4 py-3 text-right text-[#D0CCC4]">
              ...
              <h3 className="text-lg font-bold text-[#F6F4EF] mt-10 mb-4">
                ...
                <div className="overflow-x-auto">
                  <table className="w-full text-sm">
                    <thead>
                      <tr className="bg-[#121423] text-left">
                        <th className="px-4 py-3 font-semibold text-[#D0CCC4]">Recession</th>
                        <th className="px-4 py-3 font-semibold text-[#D0CCC4] text-right">Gold at Start</th>
                        <th className="px-4 py-3 font-semibold text-[#D0CCC4] text-right">Gold 2 Yrs After End</th>
              ...
              <div className="bg-[#161828] border border-[#2A2D42] rounded-xl overflow-hidden">
                <div className="overflow-x-auto">
                  <table className="w-full text-sm md:text-base">
                    <thead>
                      <tr className="bg-[#121423] text-left">
                        <th className="px-4 py-3 font-semibold text-[#D0CCC4]">Decade</th>
                        ...
                        <th className="px-4 py-3 font-semibold text-[#D0CCC4] text-center">Winner</th>
                      </tr>
                    </thead>
                    <tbody>
                      {decadeComparisons.map((row, i) => (
                        ...
                        >
                          <td className="px-4 py-3">
                            <span className="font-medium text-[#F6F4EF]">{row.decade}</span>
                            <br />
                            <span className="text-xs text-[#A8A39A]">{row.context}</span>
                          </td>
        ...
        {/* ================================================================= */}
        <section className="py-12 md:py-16 bg-[#0C0D18]" id="worst-crashes">
          <Container>
            <div className="max-w-3xl mx-auto">
              <SectionHeader
                icon={AlertTriangle}
              ...
              <div className="bg-[#161828] border border-[#2A2D42] rounded-xl overflow-hidden">
                <div className="overflow-x-auto">
                  <table className="w-full text-sm">
                    <thead>
                      <tr className="bg-[#121423] text-left">
                        <th className="px-4 py-3 font-semibold text-[#D0CCC4]">Event</th>
                        <th className="px-4 py-3 font-semibold text-[#D0CCC4]">Dates</th>
                        <th className="px-4 py-3 font-semibold text-red-700 text-right">S&P 500</th>
                        <th className="px-4 py-3 font-semibold text-amber-700 text-right">Gold</th>
                        <th className="px-4 py-3 font-semibold text-[#D0CCC4] text-center">Hedge?</th>
                      </tr>
                    </thead>
                    <tbody>
                      {worstCrashes.map((row, i) => (
                        ...
                        >
                          <td className="px-4 py-3">
                            <span className="font-medium text-[#F6F4EF]">{row.event}</span>
                            <br />
                            <span className="text-xs text-[#A8A39A] leading-tight">{row.notes}</span>
                          </td>
                          <td className="px-4 py-3 text-[#D0CCC4] whitespace-nowrap text-xs">
                            {row.dates}
                          </td>
                          <td className="px-4 py-3 text-right font-bold text-red-600">
                            {row.sp500Drop}
        ...
        <section className="py-12 md:py-16" id="ira-market">
          <Container>
            <div className="max-w-3xl mx-auto">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-10">
                {iraIndustryStats.map((stat) => (
                  <div
                    ...
                    className="bg-[#0C0D18] border border-[#2A2D42] rounded-xl p-5"
                  >
                    <p className="text-sm text-[#A8A39A]">{stat.metric}</p>
                    <p className="text-2xl font-bold text-[#F6F4EF] mt-1">
                      {stat.value}
                    </p>
              ...
              <div className="bg-[#161828] border border-[#2A2D42] rounded-xl overflow-hidden mb-10">
                <div className="overflow-x-auto">
                  <table className="w-full text-sm md:text-base">
                    <thead>
                      <tr className="bg-[#121423] text-left">
                        <th className="px-4 py-3 font-semibold text-[#D0CCC4]">Generation</th>
                        <th className="px-4 py-3 font-semibold text-[#D0CCC4]">Ages</th>
                    ...
                    <tbody>
                      {iraBalancesByAge.map((row, i) => (
                        ...
                        >
                          ...
                          <td className="px-4 py-3 text-[#D0CCC4]">{row.ageGroup}</td>
                          <td className="px-4 py-3 text-right font-bold text-[#F6F4EF]">
              ...
              <div className="bg-[#161828] border border-[#2A2D42] rounded-xl overflow-hidden mb-4">
                <div className="overflow-x-auto">
                  <table className="w-full text-sm md:text-base">
                    <thead>
                      <tr className="bg-[#121423] text-left">
                        <th className="px-4 py-3 font-semibold text-[#D0CCC4]">Age Group</th>
                        <th className="px-4 py-3 font-semibold text-[#D0CCC4] text-right">Average</th>
                  ...
                  <table className="w-full text-sm md:text-base">
                    <thead>
                      <tr className="bg-[#121423] text-left">
                        ...
                        <th className="px-4 py-3 font-semibold text-[#D0CCC4] text-right">Under 50</th>
                        <th className="px-4 py-3 font-semibold text-amber-700 text-right">50 &amp; Over</th>
                        <th className="px-4 py-3 font-semibold text-[#D0CCC4] text-right">Catch-Up</th>
                      </tr>
                    </thead>
                    <tbody>
        ...
        {/* ================================================================= */}
        <section className="py-12 md:py-16 bg-[#0C0D18]" id="fee-analysis">
          <Container>
            <div className="max-w-4xl mx-auto">
              <SectionHeader
                icon={DollarSign}
                  ...
                  <table className="w-full text-sm">
                    <thead>
                      <tr className="bg-[#121423] text-left">
                        ...
                        <th className="px-4 py-3 font-semibold text-[#D0CCC4]">Notes</th>
                      </tr>
                    </thead>
                    <tbody>
                      {goldIRAFees.map((row, i) => {
                        ...
                        return (
                          ...
                          >
                            <td className="px-4 py-3 text-[#F6F4EF]">
                              {row.feeType}
                            </td>
              ...
              <div className="bg-[#161828] border border-[#2A2D42] rounded-xl overflow-hidden mb-10">
                <div className="overflow-x-auto">
                  <table className="w-full text-sm">
                    <thead>
                      <tr className="bg-[#121423] text-left">
                        <th className="px-4 py-3 font-semibold text-[#D0CCC4]">Category</th>
                        <th className="px-4 py-3 font-semibold text-[#D0CCC4] text-center">Frequency</th>
                        <th className="px-4 py-3 font-semibold text-[#D0CCC4]">Description</th>
                      </tr>
                    </thead>
                    <tbody>
                      {commonComplaintCategories.map((cat, i) => (
                        ...
                        >
                          ...
                          <td className="px-4 py-3 text-[#D0CCC4] text-xs">
                            {cat.description}
                          </td>
                        </tr>
                      ))}
              ...
              <div className="bg-[#161828] border border-[#2A2D42] rounded-xl overflow-hidden">
                <div className="overflow-x-auto">
                  <table className="w-full text-sm md:text-base">
                    <thead>
                      <tr className="bg-[#121423] text-left">
                        <th className="px-4 py-3 font-semibold text-[#D0CCC4]">Company</th>
                        <th className="px-4 py-3 font-semibold text-[#D0CCC4] text-center">BBB Rating</th>
                        <th className="px-4 py-3 font-semibold text-[#D0CCC4] text-center">3-Year Complaints</th>
                        <th className="px-4 py-3 font-semibold text-[#D0CCC4]">Notes</th>
                      </tr>
                    </thead>
                    <tbody>
                      {companyComplaintData.map((row, i) => (
                        ...
                        >
                          ...
                          <td className="px-4 py-3 text-center text-[#D0CCC4] font-medium">
        ...
        {/* ================================================================= */}
        <section className="py-12 md:py-16 bg-[#0C0D18]" id="supply-demand">
          <Container>
            <div className="max-w-3xl mx-auto">
              <SectionHeader
                icon={Globe2}
                    ...
                    <tbody>
                      {aboveGroundData.map((row, i) => {
                        ...
                        return (
                          ...
                          >
                            <td className="px-4 py-3 text-[#F6F4EF]">{row.metric}</td>
                            <td className="px-4 py-3 text-right text-[#F6F4EF] font-bold">
                              {row.value} {row.unit}
                            </td>
                          </tr>
                        );
                      ...
                      {goldSupplyDemand
                        ...
                        .map((row) => (
                          <tr key={row.metric} className="bg-[#0C0D18]/50">
                            <td className="px-4 py-3 text-[#F6F4EF]">{row.metric}</td>
                            <td className="px-4 py-3 text-right text-[#F6F4EF] font-bold">
                              {row.value} {row.unit}
                            </td>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-10">
                {demandData2025.map((stat) => (
                  ...
                  >
                    <p className="text-sm text-[#A8A39A]">{stat.metric}</p>
                    <p className="text-2xl font-bold text-[#F6F4EF] mt-1">
                      {stat.value} <span className="text-sm font-normal text-[#A8A39A]">{stat.unit}</span>
                    </p>
                  </div>
                ))}
              </div>
                    ...
                    <tbody>
                      {centralBankHistory.map((row, i) => (
                        ...
                        >
                          ...
                          <td className="px-4 py-3 text-[#D0CCC4]">{row.metric}</td>
                          <td className="px-4 py-3 text-right font-bold text-[#F6F4EF]">
                            {row.value}
                          </td>
                        </tr>
        ...
        {/* 9. SOURCES */}
        {/* ================================================================= */}
        <section className="py-12 md:py-16 bg-[#0C0D18]" id="sources">
          <Container>
            <div className="max-w-3xl mx-auto">
              ...
              <p className="text-xs text-[#A8A39A] mt-6">
