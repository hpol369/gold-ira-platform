                ...
                <Container className="relative z-10">
                    <div className="max-w-4xl mx-auto">
                        <nav className="flex items-center gap-2 text-sm text-slate-500 mb-6">
                            ...
                            <span>/</span>
                            <span className="text-slate-900">Tax Rules</span>
                        </nav>
                ...
                <Container>
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="bg-blue-50 border border-blue-200 rounded-xl p-6 mt-6">
                            <h3 className="font-bold text-[#000080] mb-3">Key IRS Rules for Crypto in IRAs</h3>
                            ...
                            <table className="w-full border-collapse bg-white rounded-xl overflow-hidden">
                                <thead>
                                    <tr className="bg-slate-100">
                                        <th className="text-left px-5 py-3 text-slate-900 font-semibold">Tax Feature</th>
                                        <th className="text-left px-5 py-3 text-slate-900 font-semibold">Traditional Crypto IRA</th>
                                        <th className="text-left px-5 py-3 text-slate-900 font-semibold">Roth Crypto IRA</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr className="border-t border-slate-100">
                                        <td className="px-5 py-3 font-medium text-slate-700">Contributions</td>
                                        <td className="px-5 py-3 text-slate-600">Tax-deductible (reduces current taxes)</td>
                                        <td className="px-5 py-3 text-slate-600">After-tax (no deduction)</td>
                                    </tr>
                                    <tr className="border-t border-slate-100 bg-slate-50/50">
                                        <td className="px-5 py-3 font-medium text-slate-700">Growth</td>
                                        <td className="px-5 py-3 text-slate-600">Tax-deferred</td>
                                        <td className="px-5 py-3 text-slate-600">Tax-free</td>
                                    </tr>
                                    <tr className="border-t border-slate-100">
                                        <td className="px-5 py-3 font-medium text-slate-700">Withdrawals</td>
                                        <td className="px-5 py-3 text-slate-600">Taxed as ordinary income</td>
                                        <td className="px-5 py-3 text-slate-600">Tax-free (if qualified)</td>
                                    </tr>
                                    <tr className="border-t border-slate-100 bg-slate-50/50">
                                        <td className="px-5 py-3 font-medium text-slate-700">RMDs at 73</td>
                                        <td className="px-5 py-3 text-slate-600">Required</td>
                                        <td className="px-5 py-3 text-slate-600">Not required for original owner</td>
                                    </tr>
                                    <tr className="border-t border-slate-100">
                                        <td className="px-5 py-3 font-medium text-slate-700">Early Withdrawal Penalty</td>
                                        <td className="px-5 py-3 text-slate-600">10% + income tax before 59 1/2</td>
                                        <td className="px-5 py-3 text-slate-600">10% on earnings before 59 1/2</td>
                                    </tr>
                                    <tr className="border-t border-slate-100 bg-slate-50/50">
                                        <td className="px-5 py-3 font-medium text-slate-700">Best For</td>
                                        <td className="px-5 py-3 text-slate-600 font-medium">Higher income now, lower in retirement</td>
                                        <td className="px-5 py-3 text-slate-600 font-medium">Expect crypto to grow significantly</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
