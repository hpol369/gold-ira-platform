                ...
                <Container className="relative z-10">
                    <div className="max-w-4xl mx-auto">
                        <nav className="flex items-center gap-2 text-sm text-slate-500 mb-6">
                            ...
                            <span>/</span>
                            <span className="text-slate-900">Bitcoin vs Gold IRA</span>
                        </nav>
                            ...
                            <table className="w-full border-collapse">
                                <thead>
                                    <tr className="bg-slate-50">
                                        <th className="text-left px-4 py-3 text-slate-900 font-semibold border-b border-slate-200">Metric</th>
                                        ...
                                        <th className="text-left px-4 py-3 text-slate-900 font-semibold border-b border-slate-200">Notes</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    {comparisonData.map((row, idx) => (
                                        <tr key={row.metric} className={idx % 2 === 1 ? "bg-slate-50/50" : ""}>
                                            <td className="px-4 py-3 border-b border-slate-100 font-medium text-slate-700 text-sm">{row.metric}</td>
                                            <td className="px-4 py-3 border-b border-slate-100 text-slate-600 text-sm">{row.bitcoin}</td>
                                            <td className="px-4 py-3 border-b border-slate-100 text-slate-600 text-sm">{row.gold}</td>
                                            <td className="px-4 py-3 border-b border-slate-100 text-slate-500 text-xs italic">{row.notes}</td>
                                        </tr>
                                    ))}
                                </tbody>
                            </table>
                        ...
                        <div className="grid md:grid-cols-2 gap-8">
                            ...
                            <div className="bg-white rounded-xl border border-blue-200 p-6">
                                <div className="flex items-center gap-3 mb-4">
                                    ...
                                    <h3 className="text-xl font-bold text-slate-900">The Case for Bitcoin</h3>
                                </div>
                            ...
                            <div className="bg-white rounded-xl border border-amber-200 p-6">
                                <div className="flex items-center gap-3 mb-4">
                                    ...
                                    <h3 className="text-xl font-bold text-slate-900">The Case for Gold</h3>
                                </div>
                                <ul className="space-y-3">
                                    <li className="flex items-start gap-2 text-slate-600 text-sm">
                                        <CheckCircle2 className="w-4 h-4 text-green-500 mt-0.5 flex-shrink-0" />
                ...
                <Container>
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="bg-slate-50 border border-slate-200 rounded-xl p-6 mt-8">
                            <h3 className="font-bold text-[#000080] mb-4">Suggested Allocation by Risk Tolerance</h3>
                            <div className="space-y-4">
                                <div className="flex items-center gap-4">
                                    <span className="w-32 text-sm font-medium text-slate-700">Conservative</span>
                                ...
                                <div className="flex items-center gap-4">
                                    <span className="w-32 text-sm font-medium text-slate-700">Moderate</span>
                                    <div className="flex-1 flex gap-1 h-6">
                                ...
                                <div className="flex items-center gap-4">
                                    <span className="w-32 text-sm font-medium text-slate-700">Aggressive</span>
                                    <div className="flex-1 flex gap-1 h-6">
