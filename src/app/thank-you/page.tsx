        ...
        <Container className="relative z-10">
          <div className="max-w-2xl mx-auto text-center">
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div key={i} className="flex gap-4">
                    ...
                    <div>
                      <h3 className="font-semibold text-[#F6F4EF]">{item.title}</h3>
                      <p className="text-[#A8A39A] text-sm">{item.desc}</p>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <div className="bg-gradient-to-r from-amber-50 via-amber-100/50 to-amber-50 border border-amber-200 rounded-2xl p-8 mb-8">
              <div className="flex items-center justify-center gap-2 text-[#D4A94E] mb-4">
                <Clock className="h-5 w-5" />
                <span className="font-semibold">While You Wait...</span>
              </div>
              <h3 className="text-2xl font-serif font-bold text-[#F6F4EF] mb-4">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <Link
                ...
                className="bg-[#0C0D18] hover:bg-[#1E2134] border border-[#2A2D42] rounded-xl p-6 text-left transition-all"
              >
                <h3 className="font-semibold text-[#F6F4EF] mb-2">Rollover Guide</h3>
                <p className="text-[#A8A39A] text-sm">Learn how to roll over your 401k or IRA.</p>
              </Link>
            </div>
          </div>
        </Container>
