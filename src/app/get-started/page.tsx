              ...
              >
                ...
                <div className="bg-white/5 backdrop-blur border border-white/10 rounded-2xl p-6 md:p-8 mb-6">
                  ...
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-2 px-8 py-4 bg-[#DC2626] hover:bg-[#9a1d2d] text-white font-bold text-lg rounded-xl transition-all duration-200 shadow-lg active:scale-[0.98]"
                  >
                    Get My Free Kit
