            ...
            <header className="bg-white/5 backdrop-blur-sm py-16 border-b border-white/10">
                <Container>
                    <div className="max-w-4xl mx-auto">
                        ...
                        <span className="text-slate-500 text-sm block mb-4">80 monthly searches</span>
                        <h1 className="text-4xl md:text-5xl font-serif font-bold text-white mb-6">
                            When Will Silver Hit $100? The Road to Triple Digits
                        </h1>
                        <p className="text-xl text-slate-300 leading-relaxed">
                            $100 silver sounds extreme—until you realize it would still be below the <strong className="text-white">inflation-adjusted 1980 high</strong>. Here&apos;s what it would take, when it could happen, and why some experts think it&apos;s inevitable.
                        </p>
                    </div>
                </Container>
            </header>
                    ...
                    <article className="prose prose-lg prose-invert prose-headings:font-serif prose-headings:text-white prose-p:text-slate-300 prose-strong:text-white prose-li:text-slate-300 max-w-none">
                        ...
                        <section className="scroll-mt-32">
                            <div className="flex items-center gap-4 mb-4 not-prose">
                                ...
                                <h2 className="text-2xl md:text-3xl font-serif font-bold text-white m-0">The Math Behind $100 Silver</h2>
                            </div>

                            <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-6 border border-white/10 not-prose my-8">
                                <h4 className="font-bold text-white text-lg mb-4">Multiple Paths to $100 Silver</h4>
                                <div className="space-y-4">
                                    <div className="p-4 bg-slate-800/50 rounded-lg">
                                        <div className="flex justify-between items-center mb-2">
                                            <span className="text-slate-400 font-medium">Path 1: Inflation Adjustment</span>
                                            <span className="text-green-400 font-bold">$180+</span>
                                        </div>
                                        <p className="text-xs text-slate-500">1980 high of $49.45 adjusted for CPI inflation = $180+. $100 is 55% of that.</p>
                                    </div>
                                    <div className="p-4 bg-slate-800/50 rounded-lg">
                                        <div className="flex justify-between items-center mb-2">
                                            <span className="text-slate-400 font-medium">Path 2: Gold/Silver Ratio to 25:1</span>
                                            <span className="text-green-400 font-bold">$104</span>
                                        </div>
                                        <p className="text-xs text-slate-500">With gold at $2,600, ratio falling from 80:1 to 25:1 = $104 silver.</p>
                                    </div>
                                    <div className="p-4 bg-slate-800/50 rounded-lg">
                                        <div className="flex justify-between items-center mb-2">
                                            <span className="text-slate-400 font-medium">Path 3: Gold at $4,000, Ratio 40:1</span>
                                            <span className="text-green-400 font-bold">$100</span>
                                        </div>
                                        <p className="text-xs text-slate-500">Gold rises to $4,000 (up 50%), ratio compresses to 40:1 = $100 silver.</p>
                                    </div>
                                    <div className="p-4 bg-slate-800/50 rounded-lg">
                                        <div className="flex justify-between items-center mb-2">
                                            <span className="text-slate-400 font-medium">Path 4: M2 Money Supply Adjustment</span>
                                            <span className="text-green-400 font-bold">$400+</span>
                                        </div>
                                        <p className="text-xs text-slate-500">1980 high adjusted for money supply growth = $400+. $100 is only 25% of that.</p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <section className="scroll-mt-32">
                            <div className="flex items-center gap-4 mb-4 not-prose">
                                ...
                                <h2 className="text-2xl md:text-3xl font-serif font-bold text-white m-0">Scenarios for $100 Silver</h2>
                            </div>
                            <p>
                                ...
                                {scenariosFor100.map((scenario, idx) => (
                                    <div key={idx} className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10">
                                        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-4">
                                            ...
                                            <div className="flex items-center gap-4">
                                                <div className="text-center">
                                                    ...
                                                    <div className="font-bold text-amber-400">{scenario.probability}</div>
                                                </div>
                                                <div className="text-center">
                                        ...
                                        <div className="bg-slate-800/50 rounded-lg p-3">
                                            <span className="text-xs text-slate-500">Price Path: </span>
                                            <span className="text-sm text-white font-mono">{scenario.silverPath}</span>
                                        </div>
                                    </div>
                                ))}
                            </div>
                        ...
                        <section className="scroll-mt-32">
                            <div className="flex items-center gap-4 mb-4 not-prose">
                                ...
                                <h2 className="text-2xl md:text-3xl font-serif font-bold text-white m-0">Experts Who Predict $100+ Silver</h2>
                            </div>
                            <p>
                                ...
                                {expertPredictions100.map((expert, idx) => (
                                    <div key={idx} className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10">
                                        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-3">
                                            <div>
                                                <h4 className="font-bold text-white text-lg">{expert.expert}</h4>
                                            ...
                                            <div className="flex items-center gap-4">
                                                <div className="text-center px-4 py-2 bg-green-500/20 rounded-lg">
                                                    ...
                                                    <div className="text-xs text-slate-500">{expert.timeline}</div>
                                                </div>
                                            </div>
                                        </div>
                                        <blockquote className="border-l-4 border-gray-500 pl-4 italic text-slate-400 text-sm">
                                            &quot;{expert.rationale}&quot;
                                        </blockquote>
                                    </div>
                                ))}
                        ...
                        <section className="scroll-mt-32">
                            <div className="flex items-center gap-4 mb-4 not-prose">
                                ...
                                <h2 className="text-2xl md:text-3xl font-serif font-bold text-white m-0">Timeline: When Could Silver Hit $100?</h2>
                            </div>

                            <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-6 border border-white/10 not-prose my-8">
                                <h4 className="font-bold text-white text-lg mb-6">Silver to $100: Timeline Scenarios</h4>
                                <div className="space-y-6">
                                    <div>
                                        <div className="flex items-center justify-between mb-2">
                                            <span className="font-bold text-green-400">Aggressive: 2026-2027</span>
                                            <span className="text-sm text-slate-500">Requires crisis catalyst</span>
                                        </div>
                                        <div className="w-full bg-slate-700 rounded-full h-3">
                                            <div className="bg-green-500 h-3 rounded-full" style={{ width: '30%' }}></div>
                                        </div>
                                        <p className="text-xs text-slate-500 mt-2">Probability: 15-20%. Requires monetary crisis, bank failures, or supply emergency.</p>
                                    </div>
                                    <div>
                                        <div className="flex items-center justify-between mb-2">
                                            <span className="font-bold text-amber-400">Base Case: 2028-2030</span>
                                            <span className="text-sm text-slate-500">Steady grind higher</span>
                                        </div>
                                        <div className="w-full bg-slate-700 rounded-full h-3">
                                            <div className="bg-amber-500 h-3 rounded-full" style={{ width: '50%' }}></div>
                                        </div>
                                        <p className="text-xs text-slate-500 mt-2">Probability: 40-50%. Supply deficits worsen, industrial demand grows, gold rallies.</p>
                                    </div>
                                    <div>
                                        <div className="flex items-center justify-between mb-2">
                                            <span className="font-bold text-slate-400">Conservative: 2030+</span>
                                            <span className="text-sm text-slate-500">Manipulation persists</span>
                                        </div>
                                        <div className="w-full bg-slate-700 rounded-full h-3">
                                            <div className="bg-slate-500 h-3 rounded-full" style={{ width: '70%' }}></div>
                                        </div>
                                        <p className="text-xs text-slate-500 mt-2">Probability: 30-35%. Paper market suppression continues, gradual inflation-driven rise.</p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <section className="scroll-mt-32">
                            ...
                            <div className="not-prose my-8 grid md:grid-cols-2 gap-4">
                                <div className="bg-green-500/10 rounded-xl p-5 border border-green-500/20">
                                    ...
                                    <p className="text-sm text-slate-300">Silver follows gold. If gold rises 50% to $4,000, silver at even 40:1 ratio would be $100.</p>
                                </div>
                                <div className="bg-green-500/10 rounded-xl p-5 border border-green-500/20">
                                    <div className="flex items-center gap-3 mb-3">
                                        <Zap className="w-5 h-5 text-green-400" />
                                    ...
                                    <p className="text-sm text-slate-300">If solar/EV makers can&apos;t get silver, they&apos;ll pay any price. Physical scarcity trumps paper shorts.</p>
                                </div>
                                <div className="bg-green-500/10 rounded-xl p-5 border border-green-500/20">
                                    <div className="flex items-center gap-3 mb-3">
                                        <Zap className="w-5 h-5 text-green-400" />
                                    ...
                                    <p className="text-sm text-slate-300">A loss of confidence in the dollar would drive panic buying of hard assets. Silver is the &quot;poor man&apos;s gold.&quot;</p>
                                </div>
                                <div className="bg-green-500/10 rounded-xl p-5 border border-green-500/20">
                                    <div className="flex items-center gap-3 mb-3">
                                        <Zap className="w-5 h-5 text-green-400" />
                                    ...
                                    <p className="text-sm text-slate-300">If COMEX can&apos;t deliver physical metal, the paper price becomes irrelevant. Physical sets the price.</p>
                                </div>
                            </div>
                        </section>
                        ...
                        <section className="scroll-mt-32">
                            <div className="flex items-center gap-4 mb-4 not-prose">
                                ...
                                <h2 className="text-2xl md:text-3xl font-serif font-bold text-white m-0">Why $100 Silver Might NOT Happen</h2>
                            </div>
                            <p>
                        ...
                        <div className="my-12 bg-primary rounded-2xl p-8 text-white text-center relative overflow-hidden not-prose">
                            ...
                            <div className="relative z-10">
                                <h3 className="text-2xl font-serif font-bold mb-4 text-white">Position Yourself for the Potential</h3>
                        ...
                        <div className="my-12 bg-gradient-to-br from-primary to-primary-dark rounded-2xl p-8 text-white relative overflow-hidden not-prose">
                            ...
                            <div className="relative z-10 text-center">
                                <h3 className="text-3xl font-serif font-bold mb-4 text-white">The Asymmetric Opportunity</h3>
