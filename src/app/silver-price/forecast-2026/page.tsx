        ...
        <main className="min-h-screen bg-white pb-24">
            ...
            <Container className="py-12">
                <div className="flex flex-col lg:flex-row gap-12 max-w-6xl mx-auto">
                    ...
                    {/* Content */}
                    <article className="flex-1 prose prose-lg prose-invert prose-headings:font-serif prose-headings:text-[#F6F4EF] prose-p:text-[#D0CCC4] prose-strong:text-[#F6F4EF] prose-li:text-[#D0CCC4] max-w-none">
                        ...
                        <section id="supply-analysis" className="scroll-mt-32">
                            <div className="flex items-center gap-4 mb-4 not-prose">
                                ...
                                <h2 className="text-2xl md:text-3xl font-serif font-bold text-[#F6F4EF] m-0">Supply Analysis: The Production Problem</h2>
                            </div>
                            <p>
                            ...
                            <div className="overflow-x-auto not-prose my-8">
                                <table className="w-full text-left border-collapse bg-[#0C0D18] backdrop-blur-sm rounded-xl shadow-sm border border-[#2A2D42]">
                                    <thead className="bg-[#0C0D18]">
                                        <tr>
                                            <th className="p-4 font-bold text-[#F6F4EF] border-b border-[#2A2D42]">Supply Source</th>
                                            <th className="p-4 font-bold text-[#F6F4EF] border-b border-[#2A2D42]">2026 Estimate</th>
                                            <th className="p-4 font-bold text-[#F6F4EF] border-b border-[#2A2D42]">YoY Change</th>
                                            <th className="p-4 font-bold text-[#F6F4EF] border-b border-[#2A2D42]">Notes</th>
                                        </tr>
                                    </thead>
                                    <tbody className="divide-y divide-[#2A2D42] text-sm">
                                        <tr>
                                            <td className="p-4 text-[#F6F4EF] font-medium">Mine Production</td>
                                            <td className="p-4 text-[#D0CCC4]">{supplyData.mineProduction.amount}</td>
                                            <td className="p-4 text-red-700">{supplyData.mineProduction.change}</td>
                                            <td className="p-4 text-[#D0CCC4]">{supplyData.mineProduction.notes}</td>
                                        </tr>
                                        <tr className="bg-[#121423]">
                                            <td className="p-4 text-[#F6F4EF] font-medium">Recycling</td>
                                            <td className="p-4 text-[#D0CCC4]">{supplyData.recycling.amount}</td>
                                            <td className="p-4 text-green-700">{supplyData.recycling.change}</td>
                                            <td className="p-4 text-[#D0CCC4]">{supplyData.recycling.notes}</td>
                                        </tr>
                                        <tr className="bg-[rgba(220,38,38,0.1)]">
                                            <td className="p-4 text-[#F6F4EF] font-bold">Total Supply</td>
                                            <td className="p-4 text-[#F6F4EF] font-bold">{supplyData.totalSupply.amount}</td>
                                            <td className="p-4 text-[#D4A94E]">{supplyData.totalSupply.change}</td>
                                            <td className="p-4 text-[#D4A94E]">{supplyData.totalSupply.notes}</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                        ...
                        <section id="demand-analysis" className="scroll-mt-32">
                            ...
                            <div className="not-prose my-8 grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                                {demandData.map((item, idx) => (
                                    <div key={idx} className="bg-[#0C0D18] backdrop-blur-sm rounded-xl p-5 border border-[#2A2D42]">
                                        <div className="flex items-center gap-3 mb-3">
                                            <div className="p-2 bg-gray-500/20 rounded-lg text-[#A8A39A]">
                                                <item.icon className="w-5 h-5" />
                                            </div>
                                            <div>
                                                <h4 className="font-bold text-[#F6F4EF]">{item.sector}</h4>
                                                <p className="text-xs text-[#D0CCC4]">{item.share} of demand</p>
                                            </div>
                                        </div>
                                        <div className="flex items-end justify-between">
                                            <div>
                                                <div className="text-2xl font-bold text-[#A8A39A]">{item.amount}</div>
                        ...
                        <section id="supply-demand-balance" className="scroll-mt-32">
                            ...
                            <div className="bg-[#0C0D18] backdrop-blur-sm rounded-2xl p-6 border border-[#2A2D42] not-prose my-8">
                                <h4 className="font-bold text-[#F6F4EF] text-lg mb-4">Silver Supply/Demand Balance (Million Ounces)</h4>
                                <div className="space-y-4">
                                    <div>
                                        <div className="flex justify-between text-sm mb-1">
                                            <span className="text-[#D0CCC4]">Total Supply</span>
                                            <span className="text-[#F6F4EF] font-bold">1,000M oz</span>
                                        </div>
                                        <div className="w-full bg-[#121423] rounded-full h-4">
                                            <div className="bg-[#DC2626] h-4 rounded-full" style={{ width: '83%' }}></div>
                                        </div>
                                    </div>
                                    <div>
                                        <div className="flex justify-between text-sm mb-1">
                                            <span className="text-[#D0CCC4]">Total Demand</span>
                                    ...
                                    <div className="pt-4 border-t border-[#2A2D42]">
                                        ...
                                        <p className="text-xs text-[#D0CCC4] mt-2">The deficit is being filled by above-ground stockpiles, which are at multi-decade lows.</p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <section id="technical-analysis" className="scroll-mt-32">
                            ...
                            <div className="bg-[#0C0D18] backdrop-blur-sm rounded-2xl p-6 border border-[#2A2D42] not-prose my-8">
                                <h4 className="font-bold text-[#F6F4EF] text-lg mb-4">Multi-Year Cup and Handle Pattern</h4>
                                <div className="relative h-48 bg-[#0C0D18] rounded-lg p-4 mb-4">
                                    <div className="absolute left-0 top-0 bottom-0 w-12 flex flex-col justify-between text-xs text-[#D0CCC4]">
                                        <span>$50</span>
                                        <span>$40</span>
                                        <span>$30</span>
                                        <span>$20</span>
                                    ...
                                    <div className="ml-12 h-full relative">
                                        ...
                                        <div className="absolute top-2 left-2 text-xs text-[#D0CCC4]">2011 High</div>
                                        <div className="absolute bottom-8 left-1/2 -translate-x-1/2 text-xs text-[#D0CCC4]">2015 Low</div>
                                        <div className="absolute top-2 right-2 text-xs text-green-700">Handle forming</div>
                                    </div>
                                    <div className="absolute bottom-0 left-12 right-0 flex justify-between text-xs text-[#D0CCC4] pt-2">
                                        <span>2011</span>
                                        <span>2015</span>
                                        <span>2020</span>
                                        <span>2026</span>
                                ...
                                <p className="text-sm text-[#D0CCC4]">The cup formed from 2011-2020. The handle is forming now. Measured move target: $50-55.</p>
                            </div>
                            ...
                            <div className="grid md:grid-cols-2 gap-6 not-prose my-8">
                                <div className="bg-green-500/10 rounded-xl p-5 border border-green-500/20">
                                    ...
                                    <ul className="space-y-2 text-sm text-[#D0CCC4]">
                                        ...
                                        <li className="flex justify-between"><span>$40.00</span><span className="text-[#D0CCC4]">Round number</span></li>
                                        <li className="flex justify-between"><span>$48.70</span><span className="text-[#D0CCC4]">2011 high</span></li>
                                        <li className="flex justify-between"><span>$49.45</span><span className="text-[#D0CCC4]">All-time high</span></li>
                                ...
                                <div className="bg-red-500/10 rounded-xl p-5 border border-red-500/20">
                                    ...
                                    <ul className="space-y-2 text-sm text-[#D0CCC4]">
                                        ...
                                        <li className="flex justify-between"><span>$28.00</span><span className="text-[#D0CCC4]">200-day MA</span></li>
                                        <li className="flex justify-between"><span>$26.00</span><span className="text-[#D0CCC4]">2023 support</span></li>
                                        <li className="flex justify-between"><span>$22.00</span><span className="text-[#D0CCC4]">Major support</span></li>
                                        <li className="flex justify-between"><span>$18.00</span><span className="text-[#D0CCC4]">Breakdown level</span></li>
                                    </ul>
                                </div>
                            </div>
                        </section>
                        ...
                        <section id="macro-factors" className="scroll-mt-32">
                            <div className="flex items-center gap-4 mb-4 not-prose">
                                ...
                                <h2 className="text-2xl md:text-3xl font-serif font-bold text-[#F6F4EF] m-0">Macro Factors</h2>
                            </div>
                            <p>
                            ...
                            <div className="not-prose my-8 space-y-4">
                                <div className="bg-[#0C0D18] backdrop-blur-sm rounded-xl p-5 border border-[#2A2D42]">
                                    <h4 className="font-bold text-[#F6F4EF] mb-2">US Dollar Index (DXY)</h4>
                                    <p className="text-sm text-[#D0CCC4] mb-2">Silver is priced in dollars, so a weaker dollar typically means higher silver prices. Watch for DXY moves below 100.</p>
                                    <div className="flex items-center gap-4">
                                        <span className="text-xs text-[#D0CCC4]">Impact:</span>
                                        <div className="flex gap-1">
                                            {[1,2,3,4,5].map(i => (
                                                <div key={i} className={`w-6 h-2 rounded ${i <= 4 ? 'bg-[#DC2626]' : 'bg-[#121423]'}`}></div>
                                            ))}
                                        </div>
                                        <span className="text-[#D4A94E] text-sm font-semibold">High</span>
                                    </div>
                                </div>
                                <div className="bg-[#0C0D18] backdrop-blur-sm rounded-xl p-5 border border-[#2A2D42]">
                                    <h4 className="font-bold text-[#F6F4EF] mb-2">Real Interest Rates</h4>
                                    <p className="text-sm text-[#D0CCC4] mb-2">Negative real rates (inflation &gt; nominal rates) are bullish for non-yielding assets like silver. Currently real rates are near zero.</p>
                                    <div className="flex items-center gap-4">
                                        <span className="text-xs text-[#D0CCC4]">Impact:</span>
                                        <div className="flex gap-1">
                                            {[1,2,3,4,5].map(i => (
                                                <div key={i} className={`w-6 h-2 rounded ${i <= 5 ? 'bg-[#DC2626]' : 'bg-[#121423]'}`}></div>
                                            ))}
                                        </div>
                                        <span className="text-[#D4A94E] text-sm font-semibold">Very High</span>
                                    </div>
                                </div>
                                <div className="bg-[#0C0D18] backdrop-blur-sm rounded-xl p-5 border border-[#2A2D42]">
                                    <h4 className="font-bold text-[#F6F4EF] mb-2">Gold Price</h4>
                                    <p className="text-sm text-[#D0CCC4] mb-2">Silver follows gold but with more volatility. If gold breaks $3,000, silver could surge toward $50.</p>
                                    <div className="flex items-center gap-4">
                                        <span className="text-xs text-[#D0CCC4]">Impact:</span>
                                        <div className="flex gap-1">
                                            {[1,2,3,4,5].map(i => (
                                ...
                                <div className="bg-[#0C0D18] backdrop-blur-sm rounded-xl p-5 border border-[#2A2D42]">
                                    <h4 className="font-bold text-[#F6F4EF] mb-2">China Economic Data</h4>
                                    <p className="text-sm text-[#D0CCC4] mb-2">China is the world&apos;s largest silver consumer. Strong Chinese manufacturing = strong silver demand.</p>
                                    <div className="flex items-center gap-4">
                                        <span className="text-xs text-[#D0CCC4]">Impact:</span>
                                        <div className="flex gap-1">
                                            {[1,2,3,4,5].map(i => (
                                                <div key={i} className={`w-6 h-2 rounded ${i <= 3 ? 'bg-[#DC2626]' : 'bg-[#121423]'}`}></div>
                                            ))}
                                        </div>
                                        <span className="text-[#D4A94E] text-sm font-semibold">Medium</span>
                                    </div>
                                </div>
                            </div>
                        </section>
                        ...
                        <section id="fed-policy" className="scroll-mt-32">
                            ...
                            <div className="overflow-x-auto not-prose my-8">
                                <table className="w-full text-left border-collapse bg-[#0C0D18] backdrop-blur-sm rounded-xl shadow-sm border border-[#2A2D42]">
                                    <thead className="bg-[#0C0D18]">
                                        <tr>
                                            <th className="p-4 font-bold text-[#F6F4EF] border-b border-[#2A2D42]">Rate Cycle</th>
                                            <th className="p-4 font-bold text-[#F6F4EF] border-b border-[#2A2D42]">Fed Action</th>
                                            <th className="p-4 font-bold text-[#F6F4EF] border-b border-[#2A2D42]">Silver Performance</th>
                                        </tr>
                                    </thead>
                                    <tbody className="divide-y divide-[#2A2D42] text-sm">
                                        <tr>
                                            <td className="p-4 text-[#F6F4EF]">2001-2003</td>
                                            <td className="p-4 text-[#D0CCC4]">Cutting cycle (6.5% to 1%)</td>
                                            <td className="p-4 text-green-700 font-bold">+75% ($4 to $7)</td>
                                        </tr>
                                        <tr className="bg-[#121423]">
                                            <td className="p-4 text-[#F6F4EF]">2007-2008</td>
                                            <td className="p-4 text-[#D0CCC4]">Emergency cuts</td>
                                            <td className="p-4 text-green-700 font-bold">+80% ($12 to $21)</td>
                                        </tr>
                                        <tr>
                                            <td className="p-4 text-[#F6F4EF]">2019-2020</td>
                                            <td className="p-4 text-[#D0CCC4]">Cuts + QE</td>
                                            <td className="p-4 text-green-700 font-bold">+140% ($12 to $29)</td>
                                        </tr>
                                        <tr className="bg-[rgba(220,38,38,0.1)]">
                                            <td className="p-4 text-[#F6F4EF] font-bold">2025-2026?</td>
                                            <td className="p-4 text-[#D4A94E]">Expected cuts</td>
                                            <td className="p-4 text-[#D4A94E] font-bold">+30-50%? (to $40-50)</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                        ...
                        <section id="quarterly-forecast" className="scroll-mt-32">
                            ...
                            <div className="overflow-x-auto not-prose my-8">
                                <table className="w-full text-left border-collapse bg-[#0C0D18] backdrop-blur-sm rounded-xl shadow-sm border border-[#2A2D42]">
                                    <thead className="bg-[#0C0D18]">
                                        <tr>
                                            <th className="p-4 font-bold text-[#F6F4EF] border-b border-[#2A2D42]">Quarter</th>
                                            ...
                                            <th className="p-4 font-bold text-[#F6F4EF] border-b border-[#2A2D42]">Key Events</th>
                                        </tr>
                                    </thead>
                                    <tbody className="divide-y divide-[#2A2D42] text-sm">
                                        {quarterlyForecast.map((q, idx) => (
                                            <tr key={idx} className={idx % 2 === 1 ? 'bg-[#121423]' : ''}>
                                                <td className="p-4 text-[#F6F4EF] font-bold">{q.quarter}</td>
                                                <td className="p-4 text-red-700">{q.low}</td>
                                                <td className="p-4 text-[#D4A94E] font-bold">{q.base}</td>
                                                <td className="p-4 text-green-700">{q.high}</td>
                                                <td className="p-4 text-[#D0CCC4]">{q.notes}</td>
                                            </tr>
                                        ))}
                                    </tbody>
                                </table>
                        ...
                        <div className="my-12 bg-primary rounded-2xl p-8 text-[#F6F4EF] text-center relative overflow-hidden not-prose">
                            ...
                            <div className="relative z-10">
                                <h3 className="text-2xl font-serif font-bold mb-4 text-[#F6F4EF]">Position Yourself for 2026</h3>
                        ...
                        <div className="my-12 bg-gradient-to-br from-primary to-primary-dark rounded-2xl p-8 text-[#F6F4EF] relative overflow-hidden not-prose">
                            ...
                            <div className="relative z-10 text-center">
                                <h3 className="text-3xl font-serif font-bold mb-4 text-[#F6F4EF]">The Data Is Clear. What&apos;s Your Move?</h3>
