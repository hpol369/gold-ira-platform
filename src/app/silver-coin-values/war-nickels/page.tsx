        ...
        <Container>
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-xl text-slate-600 max-w-2xl mb-8">
              ...
              <span className="text-[#B22234] font-semibold"> Put silver in the five-cent piece.</span>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-slate-50 backdrop-blur-sm border border-[#B22234]/30 rounded-xl p-6">
                <h3 className="text-lg font-bold text-[#B22234] mb-4">Look for the Large Mint Mark</h3>
                <p className="text-slate-600 mb-4">
                  Silver war nickels have a <span className="text-slate-900 font-semibold">large mint mark
              ...
              <div className="bg-slate-50 backdrop-blur-sm border border-slate-200 rounded-xl p-6">
                <h3 className="text-lg font-bold text-slate-900 mb-4">Other Identification Methods</h3>
                <ul className="space-y-3">
                  <li className="flex items-start gap-3 text-slate-600">
                    <CheckCircle className="h-5 w-5 text-green-400 flex-shrink-0 mt-0.5" />
                    <div>
                      <span className="font-semibold text-slate-900">Color:</span> Slightly grayish vs. the yellowish tint of regular nickels
                    </div>
                  </li>
                  <li className="flex items-start gap-3 text-slate-600">
                    <CheckCircle className="h-5 w-5 text-green-400 flex-shrink-0 mt-0.5" />
                    <div>
                      <span className="font-semibold text-slate-900">Date Range:</span> Only mid-1942 through 1945
                    </div>
                  </li>
                  <li className="flex items-start gap-3 text-slate-600">
                    <CheckCircle className="h-5 w-5 text-green-400 flex-shrink-0 mt-0.5" />
                    <div>
                      <span className="font-semibold text-slate-900">Toning:</span> Silver tones differently than nickel over time
                    </div>
                  </li>
                </ul>
              </div>
            ...
            <div className="mt-6 bg-gradient-to-r from-[#B22234]/10 via-amber-500/5 to-transparent border-l-4 border-amber-500 rounded-r-xl p-4">
              <div className="flex items-start gap-3">
                ...
                <p className="text-slate-600 text-sm">
                  <span className="font-semibold text-slate-900">Important:</span> Not all 1942 nickels are silver.
                  The changeover happened mid-year. 1942 nickels with <span className="text-slate-900">no mint mark</span> or
                  a <span className="text-slate-900">small D mint mark to the right of Monticello</span> are regular
              ...
              <table className="w-full min-w-[900px] text-sm">
                ...
                <tbody className="divide-y divide-slate-200">
                  {warNickelValues.map((row, index) => (
                    <tr key={index} className={row.notes.includes("Overdate") ? "bg-[#B22234]/10" : ""}>
        ...
        <Container>
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-slate-50 backdrop-blur-sm border border-[#B22234]/30 rounded-xl p-6">
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  <h3 className="text-lg font-bold text-[#B22234] mb-4">What Is It?</h3>
                  <p className="text-slate-600 mb-4">
                ...
                <div>
                  <h3 className="text-lg font-bold text-slate-900 mb-4">How to Identify</h3>
              ...
              <div className="mt-6 pt-6 border-t border-slate-200">
                <h4 className="font-bold text-slate-900 mb-2">1943/2-P Values</h4>
                <div className="grid grid-cols-4 md:grid-cols-8 gap-2 text-center text-sm">
                  <div className="bg-slate-50 rounded p-2">
                    <div className="text-slate-600">G-4</div>
                    <div className="text-slate-900 font-semibold">$100</div>
                  </div>
                  <div className="bg-slate-50 rounded p-2">
                    <div className="text-slate-600">VG-8</div>
                    <div className="text-slate-900 font-semibold">$150</div>
                  </div>
                  <div className="bg-slate-50 rounded p-2">
                    <div className="text-slate-600">F-12</div>
                    <div className="text-slate-900 font-semibold">$200</div>
                  </div>
                  <div className="bg-slate-50 rounded p-2">
                    <div className="text-slate-600">VF-20</div>
                    <div className="text-slate-900 font-semibold">$300</div>
                  </div>
                  <div className="bg-slate-50 rounded p-2">
                    <div className="text-slate-600">XF-40</div>
                    <div className="text-slate-900 font-semibold">$500</div>
                  </div>
                  <div className="bg-slate-50 rounded p-2">
                    <div className="text-slate-600">AU-50</div>
                    <div className="text-slate-900 font-semibold">$800</div>
                  </div>
                  <div className="bg-slate-50 rounded p-2">
                    <div className="text-slate-600">MS-60</div>
                    <div className="text-green-400 font-semibold">$1,200</div>
                  </div>
                  <div className="bg-slate-50 rounded p-2">
                    <div className="text-slate-600">MS-65</div>
                    <div className="text-[#B22234] font-semibold">$4,000</div>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="bg-slate-50 backdrop-blur-sm border border-slate-200 rounded-xl p-6">
                ...
                <ul className="space-y-3">
                  <li className="flex items-start gap-3 text-slate-600">
                    <CheckCircle className="h-5 w-5 text-green-400 flex-shrink-0 mt-0.5" />
                    <div>
                      <span className="font-semibold text-slate-900">Silver:</span> 35% (0.0563 oz pure)
                    </div>
                  </li>
                  <li className="flex items-start gap-3 text-slate-600">
                    <CheckCircle className="h-5 w-5 text-green-400 flex-shrink-0 mt-0.5" />
                    <div>
                      <span className="font-semibold text-slate-900">Copper:</span> 56%
                    </div>
                  </li>
                  <li className="flex items-start gap-3 text-slate-600">
                    <CheckCircle className="h-5 w-5 text-green-400 flex-shrink-0 mt-0.5" />
                    <div>
                      <span className="font-semibold text-slate-900">Manganese:</span> 9%
                    </div>
                  </li>
                  <li className="flex items-start gap-3 text-slate-600">
                    <CheckCircle className="h-5 w-5 text-green-400 flex-shrink-0 mt-0.5" />
                    <div>
                      <span className="font-semibold text-slate-900">Total Weight:</span> 5 grams
                    </div>
                  </li>
                </ul>
              </div>
