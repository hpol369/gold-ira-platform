        ...
        <Container>
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-xl text-[#D0CCC4] max-w-2xl mb-8">
              ...
              <span className="text-[#D4A94E] font-semibold"> Put silver in the five-cent piece.</span>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="bg-[#0C0D18] backdrop-blur-sm border border-[#2A2D42] rounded-xl p-6">
                <h3 className="text-lg font-bold text-[#F6F4EF] mb-4">Other Identification Methods</h3>
                <ul className="space-y-3">
                  <li className="flex items-start gap-3 text-[#D0CCC4]">
                    <CheckCircle className="h-5 w-5 text-green-400 flex-shrink-0 mt-0.5" />
                    <div>
                      <span className="font-semibold text-[#F6F4EF]">Color:</span> Slightly grayish vs. the yellowish tint of regular nickels
                    </div>
                  </li>
                  <li className="flex items-start gap-3 text-[#D0CCC4]">
                    <CheckCircle className="h-5 w-5 text-green-400 flex-shrink-0 mt-0.5" />
                    <div>
                      <span className="font-semibold text-[#F6F4EF]">Date Range:</span> Only mid-1942 through 1945
                    </div>
                  </li>
                  <li className="flex items-start gap-3 text-[#D0CCC4]">
                    <CheckCircle className="h-5 w-5 text-green-400 flex-shrink-0 mt-0.5" />
                    <div>
                      <span className="font-semibold text-[#F6F4EF]">Toning:</span> Silver tones differently than nickel over time
                    </div>
                  </li>
                </ul>
              </div>
            ...
            <div className="mt-6 bg-gradient-to-r from-[#C5952E]/10 via-amber-500/5 to-transparent border-l-4 border-amber-500 rounded-r-xl p-4">
              <div className="flex items-start gap-3">
                ...
                <p className="text-[#D0CCC4] text-sm">
                  <span className="font-semibold text-[#F6F4EF]">Important:</span> Not all 1942 nickels are silver.
                  The changeover happened mid-year. 1942 nickels with <span className="text-[#F6F4EF]">no mint mark</span> or
                  a <span className="text-[#F6F4EF]">small D mint mark to the right of Monticello</span> are regular
              ...
              <table className="w-full min-w-[900px] text-sm">
                ...
                <tbody className="divide-y divide-[#2A2D42]">
                  {warNickelValues.map((row, index) => (
                    <tr key={index} className={row.notes.includes("Overdate") ? "bg-[rgba(220,38,38,0.1)]" : ""}>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-[#0C0D18] backdrop-blur-sm border border-[rgba(197,149,46,0.32)] rounded-xl p-6">
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div>
                  <h3 className="text-lg font-bold text-[#F6F4EF] mb-4">How to Identify</h3>
              ...
              <div className="mt-6 pt-6 border-t border-[#2A2D42]">
                <h4 className="font-bold text-[#F6F4EF] mb-2">1943/2-P Values</h4>
                <div className="grid grid-cols-4 md:grid-cols-8 gap-2 text-center text-sm">
                  <div className="bg-[#0C0D18] rounded p-2">
                    <div className="text-[#D0CCC4]">G-4</div>
                    <div className="text-[#F6F4EF] font-semibold">$100</div>
                  </div>
                  <div className="bg-[#0C0D18] rounded p-2">
                    <div className="text-[#D0CCC4]">VG-8</div>
                    <div className="text-[#F6F4EF] font-semibold">$150</div>
                  </div>
                  <div className="bg-[#0C0D18] rounded p-2">
                    <div className="text-[#D0CCC4]">F-12</div>
                    <div className="text-[#F6F4EF] font-semibold">$200</div>
                  </div>
                  <div className="bg-[#0C0D18] rounded p-2">
                    <div className="text-[#D0CCC4]">VF-20</div>
                    <div className="text-[#F6F4EF] font-semibold">$300</div>
                  </div>
                  <div className="bg-[#0C0D18] rounded p-2">
                    <div className="text-[#D0CCC4]">XF-40</div>
                    <div className="text-[#F6F4EF] font-semibold">$500</div>
                  </div>
                  <div className="bg-[#0C0D18] rounded p-2">
                    <div className="text-[#D0CCC4]">AU-50</div>
                    <div className="text-[#F6F4EF] font-semibold">$800</div>
                  </div>
                  <div className="bg-[#0C0D18] rounded p-2">
                    <div className="text-[#D0CCC4]">MS-60</div>
                    <div className="text-green-400 font-semibold">$1,200</div>
                  </div>
                  <div className="bg-[#0C0D18] rounded p-2">
                    <div className="text-[#D0CCC4]">MS-65</div>
                    <div className="text-[#D4A94E] font-semibold">$4,000</div>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="py-16 bg-[#0C0D18]">
        <Container>
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-[#0C0D18] backdrop-blur-sm border border-[#2A2D42] rounded-xl p-6">
                <h3 className="text-lg font-bold text-[#F6F4EF] mb-4">Composition</h3>
                <ul className="space-y-3">
                  <li className="flex items-start gap-3 text-[#D0CCC4]">
                    <CheckCircle className="h-5 w-5 text-green-400 flex-shrink-0 mt-0.5" />
                    <div>
                      <span className="font-semibold text-[#F6F4EF]">Silver:</span> 35% (0.0563 oz pure)
                    </div>
                  </li>
                  <li className="flex items-start gap-3 text-[#D0CCC4]">
                    <CheckCircle className="h-5 w-5 text-green-400 flex-shrink-0 mt-0.5" />
                    <div>
                      <span className="font-semibold text-[#F6F4EF]">Copper:</span> 56%
                    </div>
                  </li>
                  <li className="flex items-start gap-3 text-[#D0CCC4]">
                    <CheckCircle className="h-5 w-5 text-green-400 flex-shrink-0 mt-0.5" />
                    <div>
                      <span className="font-semibold text-[#F6F4EF]">Manganese:</span> 9%
                    </div>
                  </li>
                  <li className="flex items-start gap-3 text-[#D0CCC4]">
                    <CheckCircle className="h-5 w-5 text-green-400 flex-shrink-0 mt-0.5" />
                    <div>
                      <span className="font-semibold text-[#F6F4EF]">Total Weight:</span> 5 grams
                    </div>
                  </li>
                </ul>
              </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid sm:grid-cols-3 gap-4">
              ...
              >
                ...
                <p className="text-sm text-[#D0CCC4]">Constitutional silver explained</p>
              </Link>
              <Link
                href="/silver-coin-values/melt-value-calculator"
                className="bg-[#0C0D18] backdrop-blur-sm border border-[#2A2D42] rounded-xl p-4 hover:bg-[#1E2134] transition-colors group"
              ...
              <Link
                ...
                className="bg-[#0C0D18] backdrop-blur-sm border border-[#2A2D42] rounded-xl p-4 hover:bg-[#1E2134] transition-colors group"
              >
                <h3 className="font-bold text-[#F6F4EF] group-hover:text-[#D4A94E] transition-colors">Silver Dimes</h3>
                <p className="text-sm text-[#D0CCC4]">Mercury, Roosevelt, Barber</p>
              </Link>
            </div>
          </div>
        </Container>
