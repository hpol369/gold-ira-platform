        ...
        <Container>
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-xl text-slate-300 max-w-2xl mb-8">
              ...
              <span className="text-amber-400 font-semibold"> That&apos;s what real money looks like.</span>
            </p>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6">
                <h3 className="text-lg font-bold text-amber-400 mb-2">Barber Quarter</h3>
              ...
              <div className="bg-white/5 backdrop-blur-sm border border-amber-500/30 rounded-xl p-6">
                <h3 className="text-lg font-bold text-amber-400 mb-2">Standing Liberty</h3>
                <p className="text-slate-400 text-sm mb-3">1916-1930</p>
                <p className="text-slate-300 text-sm">
              ...
              <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6">
                <h3 className="text-lg font-bold text-amber-400 mb-2">Washington Quarter</h3>
                <p className="text-slate-400 text-sm mb-3">1932-1964 (silver)</p>
                <p className="text-slate-300 text-sm">
              ...
              <table className="w-full min-w-[800px] text-sm">
                ...
                <tbody className="divide-y divide-white/10">
                  {washingtonValues.map((row, index) => (
                    <tr key={index} className={row.notes.includes("Key") ? "bg-amber-500/10" : ""}>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="mt-4 bg-amber-500/10 border border-amber-500/30 rounded-xl p-4">
              <div className="flex items-start gap-3">
                ...
                <p className="text-slate-300 text-sm">
                  <span className="font-semibold text-white">Date Visibility:</span> Standing Liberty quarters
              ...
              <table className="w-full min-w-[800px] text-sm">
                ...
                <tbody className="divide-y divide-white/10">
                  {barberValues.map((row, index) => (
                    <tr key={index} className={row.notes.includes("Key") || row.notes.includes("Major") ? "bg-amber-500/10" : ""}>
                      <td className="p-3 text-white font-medium">{row.year}</td>
                      <td className="p-3 text-center text-slate-400">{row.mint}</td>
                      <td className="p-3 text-center text-slate-300">${row.g.toLocaleString()}</td>
                      <td className="p-3 text-center text-slate-300">${row.vg.toLocaleString()}</td>
              ...
              <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6">
                ...
                <ul className="space-y-3">
                  <li className="flex items-start gap-3 text-slate-300">
                    ...
                    <div>
                      <span className="font-semibold text-white">Weight:</span> 6.25 grams total
                    </div>
                  </li>
                  <li className="flex items-start gap-3 text-slate-300">
                    <CheckCircle className="h-5 w-5 text-green-400 flex-shrink-0 mt-0.5" />
                  ...
                  <li className="flex items-start gap-3 text-slate-300">
                    <CheckCircle className="h-5 w-5 text-green-400 flex-shrink-0 mt-0.5" />
                    <div>
                      <span className="font-semibold text-white">Pure Silver:</span> 0.1808 troy ounces
                    </div>
                  </li>
                  <li className="flex items-start gap-3 text-slate-300">
                    <CheckCircle className="h-5 w-5 text-green-400 flex-shrink-0 mt-0.5" />
                    <div>
                      <span className="font-semibold text-white">Per $1 Face:</span> 0.7234 oz silver
                    </div>
                  </li>
                </ul>
              </div>
