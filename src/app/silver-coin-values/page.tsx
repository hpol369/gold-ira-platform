        ...
        <Container>
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-[#D0CCC4] max-w-2xl mx-auto mb-8">
              ...
              <span className="text-[#D4A94E] font-semibold"> Real money vs paper promises.</span>
            </p>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-gradient-to-r from-[#B22234]/10 via-amber-500/5 to-transparent border-l-4 border-amber-500 rounded-r-xl p-6">
              ...
              <p className="text-[#D0CCC4]">
                ...
                its silver content is worth over <span className="text-[#D4A94E] font-semibold">$4.50</span>.
              ...
              {silverCoinPages.map((page) => {
                ...
                return (
                  ...
                  >
                    <div className="flex items-start gap-4">
                      <div className={`w-12 h-12 rounded-xl flex items-center justify-center flex-shrink-0 ${
                        ...
                        <Icon className={`h-6 w-6 ${
                          page.highlight ? "text-[#D4A94E]" : "text-[#D0CCC4]"
                        }`} />
                      </div>
                      <div className="flex-1">
                        ...
                        <div className="flex items-center gap-3 text-xs">
                          ...
                          {page.highlight && (
                            <span className="bg-[rgba(220,38,38,0.18)] text-[#D4A94E] px-2 py-0.5 rounded">
                              Popular
                            </span>
                          )}
                        </div>
                    ...
                    <div className="flex items-center gap-1 mt-4 text-[#D0CCC4] group-hover:text-[#D4A94E] transition-colors text-sm">
                      View Price Guide
              ...
              <table className="w-full min-w-[600px]">
                <thead className="bg-[#0C0D18]">
                  <tr>
                    ...
                    <th className="text-center p-4 text-[#F6F4EF] font-bold">Years</th>
                    <th className="text-center p-4 text-[#F6F4EF] font-bold">Silver Content</th>
                    <th className="text-center p-4 text-[#F6F4EF] font-bold">Melt Value*</th>
                    <th className="text-center p-4 text-[#F6F4EF] font-bold">Typical Premium</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-[#2A2D42]">
                  <tr>
                    <td className="p-4 text-[#D0CCC4] font-medium">Morgan Dollar</td>
                    <td className="p-4 text-center text-[#D0CCC4]">1878-1921</td>
                    <td className="p-4 text-center text-[#D0CCC4]">0.7734 oz</td>
                    <td className="p-4 text-center text-green-400">$19.34</td>
                    <td className="p-4 text-center text-[#D4A94E]">50-200%+</td>
                  </tr>
                  <tr>
                    <td className="p-4 text-[#D0CCC4] font-medium">Peace Dollar</td>
                    <td className="p-4 text-center text-[#D0CCC4]">1921-1935</td>
                    <td className="p-4 text-center text-[#D0CCC4]">0.7734 oz</td>
                    <td className="p-4 text-center text-green-400">$19.34</td>
                    <td className="p-4 text-center text-[#D4A94E]">30-100%+</td>
                  </tr>
                  <tr>
                    <td className="p-4 text-[#D0CCC4] font-medium">Walking Liberty Half</td>
                    <td className="p-4 text-center text-[#D0CCC4]">1916-1947</td>
                    <td className="p-4 text-center text-[#D0CCC4]">0.3617 oz</td>
                    <td className="p-4 text-center text-green-400">$9.04</td>
                    <td className="p-4 text-center text-[#D4A94E]">10-50%</td>
                  </tr>
                  <tr>
                    <td className="p-4 text-[#D0CCC4] font-medium">Silver Quarter</td>
                    <td className="p-4 text-center text-[#D0CCC4]">1932-1964</td>
                    <td className="p-4 text-center text-[#D0CCC4]">0.1808 oz</td>
                    <td className="p-4 text-center text-green-400">$4.52</td>
                    <td className="p-4 text-center text-[#D4A94E]">5-15%</td>
                  </tr>
                  <tr>
                    <td className="p-4 text-[#D0CCC4] font-medium">Silver Dime</td>
                    <td className="p-4 text-center text-[#D0CCC4]">1946-1964</td>
                    <td className="p-4 text-center text-[#D0CCC4]">0.0723 oz</td>
                    <td className="p-4 text-center text-green-400">$1.81</td>
                    <td className="p-4 text-center text-[#D4A94E]">5-15%</td>
                  </tr>
                  <tr>
                    <td className="p-4 text-[#D0CCC4] font-medium">War Nickel</td>
                    <td className="p-4 text-center text-[#D0CCC4]">1942-1945</td>
                    <td className="p-4 text-center text-[#D0CCC4]">0.0563 oz</td>
                    <td className="p-4 text-center text-green-400">$1.41</td>
                    <td className="p-4 text-center text-[#D4A94E]">5-20%</td>
                  </tr>
                </tbody>
              </table>
            </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
              {[
                ...
                <div
                  key={item.grade}
                  className="bg-[#0C0D18] backdrop-blur-sm border border-[#2A2D42] rounded-xl p-4"
                >
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-[#F6F4EF] font-bold">{item.grade}</span>
                    <span className="text-[#D4A94E] text-sm">{item.value}</span>
                  </div>
                  <p className="text-[#D0CCC4] text-sm">{item.desc}</p>
                </div>
              ))}
            </div>
