                ...
                <div className="max-w-3xl mx-auto">
                    <article className="prose prose-lg prose-headings:font-serif prose-headings:text-[#F6F4EF] prose-p:text-[#D0CCC4] prose-a:text-[#D4A94E] max-w-none">
                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-lg text-green-800">
                                        The key is using a <strong className="text-[#F6F4EF]">&quot;direct rollover&quot;</strong> (also called a trustee-to-trustee transfer). When done correctly, your retirement funds transfer directly from your 401(k) to a Gold IRA without you ever touching the money. No taxes. No penalties. No withholding.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <section className="scroll-mt-32">
                            <h2 className="text-[#F6F4EF]">How to Avoid Penalties: The Direct Rollover Method</h2>
                            <p>
                                The IRS allows you to transfer retirement funds between qualified accounts without paying taxes or penalties. The secret? <strong className="text-[#F6F4EF]">Your money must go directly from one custodian to another</strong>. You never receive a check. You never touch the funds. They move electronically between accounts.
                            </p>
                            <p>
                                This is called a <strong className="text-[#F6F4EF]">direct rollover</strong> or <strong className="text-[#F6F4EF]">trustee-to-trustee transfer</strong>, and it&apos;s 100% tax-free and penalty-free, regardless of:
                            </p>
                        ...
                        <section className="scroll-mt-32">
                            <h2 className="text-[#F6F4EF]">The 60-Day Rule Trap: Why Indirect Rollovers Are Risky</h2>
                            <p>
                                There&apos;s another way to roll over your 401(k) called an <strong className="text-[#F6F4EF]">indirect rollover</strong>. With this method, your old plan sends you a check, and you have 60 days to deposit it into your new IRA.
                            </p>
                            <p>
                        ...
                        {/* Comparison Box */}
                        <section className="scroll-mt-32">
                            <h2 className="text-[#F6F4EF]">Direct vs. Indirect Rollover: Side-by-Side</h2>
                                ...
                                <div className="bg-green-500/10 border-2 border-green-500/30 rounded-xl p-6">
                                    ...
                                    <ul className="space-y-3">
                                        <li className="flex items-start gap-3 text-[#D0CCC4]">
                                            ...
                                            <span><strong className="text-[#F6F4EF]">No taxes</strong> - funds transfer tax-free</span>
                                        </li>
                                        <li className="flex items-start gap-3 text-[#D0CCC4]">
                                            <CheckCircle2 className="w-5 h-5 text-green-700 mt-0.5 shrink-0" />
                                            <span><strong className="text-[#F6F4EF]">No penalties</strong> - no early withdrawal penalty</span>
                                        </li>
                                        <li className="flex items-start gap-3 text-[#D0CCC4]">
                                            <CheckCircle2 className="w-5 h-5 text-green-700 mt-0.5 shrink-0" />
                                            <span><strong className="text-[#F6F4EF]">No withholding</strong> - 100% of your money transfers</span>
                                        </li>
                                        <li className="flex items-start gap-3 text-[#D0CCC4]">
                                            <CheckCircle2 className="w-5 h-5 text-green-700 mt-0.5 shrink-0" />
                                            <span><strong className="text-[#F6F4EF]">No deadline</strong> - no 60-day rule to worry about</span>
                                        </li>
                                        <li className="flex items-start gap-3 text-[#D0CCC4]">
                                            <CheckCircle2 className="w-5 h-5 text-green-700 mt-0.5 shrink-0" />
                                            <span><strong className="text-[#F6F4EF]">You never touch the money</strong> - lowest risk</span>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div className="bg-red-500/10 border-2 border-red-500/30 rounded-xl p-6">
                                    ...
                                    <ul className="space-y-3">
                                        <li className="flex items-start gap-3 text-[#D0CCC4]">
                                            ...
                                            <span><strong className="text-[#F6F4EF]">20% withholding</strong> - taken from your check</span>
                                        </li>
                                        <li className="flex items-start gap-3 text-[#D0CCC4]">
                                            <XCircle className="w-5 h-5 text-red-700 mt-0.5 shrink-0" />
                                            <span><strong className="text-[#F6F4EF]">60-day deadline</strong> - miss it and face taxes</span>
                                        </li>
                                        <li className="flex items-start gap-3 text-[#D0CCC4]">
                                            <XCircle className="w-5 h-5 text-red-700 mt-0.5 shrink-0" />
                                            <span><strong className="text-[#F6F4EF]">10% penalty risk</strong> - if under 59 1/2</span>
                                        </li>
                                        <li className="flex items-start gap-3 text-[#D0CCC4]">
                                            <XCircle className="w-5 h-5 text-red-700 mt-0.5 shrink-0" />
                                            <span><strong className="text-[#F6F4EF]">Must replace withheld funds</strong> - from pocket</span>
                                        </li>
                                        <li className="flex items-start gap-3 text-[#D0CCC4]">
                                            <XCircle className="w-5 h-5 text-red-700 mt-0.5 shrink-0" />
                                            <span><strong className="text-[#F6F4EF]">Only one per year</strong> - IRS limitation</span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <section className="scroll-mt-32">
                            <h2 className="text-[#F6F4EF]">Step-by-Step: The Tax-Free Rollover Process</h2>
                            <p>
                                Here&apos;s exactly how to move your 401(k) to gold without paying a penny in taxes or penalties:
                            </p>

                            <div className="not-prose my-8 space-y-4">
                                <div className="flex gap-4 items-start bg-[#0C0D18] rounded-xl p-5 border border-[#2A2D42]">
                                ...
                                <div className="flex gap-4 items-start bg-[#0C0D18] rounded-xl p-5 border border-[#2A2D42]">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-[#D0CCC4] mt-1">Your Gold IRA company helps you open an account with an IRS-approved custodian. This typically takes 24-48 hours and involves completing an application and providing identification.</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex gap-4 items-start bg-[#0C0D18] rounded-xl p-5 border border-[#2A2D42]">
                                    ...
                                    <div>
                                        <h4 className="font-bold text-[#F6F4EF] text-lg">Funds Transfer Directly (You Never Touch the Money)</h4>
                                        <p className="text-[#D0CCC4] mt-1">The transfer typically takes 1-3 weeks. Your 401(k) administrator sends funds electronically to your new Gold IRA custodian. Since you never have possession, it&apos;s completely tax-free and penalty-free.</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex gap-4 items-start bg-[#0C0D18] rounded-xl p-5 border border-[#2A2D42]">
                                    ...
                                    <div>
                                        <h4 className="font-bold text-[#F6F4EF] text-lg">Buy IRS-Approved Gold</h4>
                                        <p className="text-[#D0CCC4] mt-1">Once funds arrive in your Gold IRA, work with your dealer to purchase IRS-approved gold, silver, platinum, or palladium. Metals are shipped to an IRS-approved depository and stored in your name. See our <Link href="/gold-ira-rules" className="text-[#D4A94E] hover:underline">Gold IRA rules guide</Link> for approved products.</p>
                                    </div>
                                </div>
                            </div>
                        </section>
                        ...
                        {/* Related Links */}
                        <section className="scroll-mt-32">
                            <h2 className="text-[#F6F4EF]">Learn More</h2>
                            <p>
                        ...
                        {/* FAQ Section */}
                        <section className="scroll-mt-32">
                            <h2 className="text-[#F6F4EF]">Frequently Asked Questions About Tax-Free 401k Rollovers</h2>
                            ...
                            <div className="space-y-4 not-prose">
                                ...
                                <details className="group bg-[#0C0D18] backdrop-blur-sm rounded-xl border border-[#2A2D42] p-6 [&_summary::-webkit-details-marker]:hidden">
                                    ...
                                    <p className="mt-4 leading-relaxed text-[#D0CCC4]">
                                        A direct rollover typically takes <strong className="text-[#F6F4EF]">2-3 weeks</strong> from start to finish. The longest part is usually waiting for your old 401(k) administrator to process the transfer request (1-2 weeks). Your Gold IRA company handles most of the paperwork and will follow up with your old plan administrator to keep things moving.
                                    </p>
                                </details>
                            </div>
                        </section>
                        ...
                        <div className="my-12 bg-[rgba(197,149,46,0.1)] rounded-2xl p-8 text-white relative overflow-hidden not-prose">
                            ...
                            <div className="relative z-10 text-center">
                                ...
                                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                                    <Button variant="gold" size="xl" asChild className="bg-[#DC2626] hover:bg-[#8B0000]">
