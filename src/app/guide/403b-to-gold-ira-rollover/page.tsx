                ...
                <div className="flex flex-col lg:flex-row gap-12">
                    ...
                    <article className="flex-1 prose prose-lg prose-headings:font-serif prose-headings:text-[#F6F4EF] prose-p:text-[#D0CCC4] prose-a:text-[#D4A94E] max-w-none">
                        ...
                        <p className="lead text-xl text-[#D0CCC4]">
                            If you&apos;re a teacher, nurse, or non-profit worker, you&apos;ve probably noticed something about your 403(b): <strong className="text-[#F6F4EF]">the options are terrible</strong>.
                        </p>
                            ...
                            <div className="not-prose my-8 space-y-4">
                                <div className="flex gap-4 p-5 rounded-xl bg-[#0C0D18] backdrop-blur-sm border border-[#2A2D42]">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-[#D0CCC4] mt-1">Choose a Gold IRA company. They&apos;ll help you open an account with a custodian who can hold physical metals.</p>
                                    </div>
                                </div>
                                <div className="flex gap-4 p-5 rounded-xl bg-[#0C0D18] backdrop-blur-sm border border-[#2A2D42]">
                                    <div className="w-10 h-10 rounded-full bg-[#DC2626] text-[#F6F4EF] flex items-center justify-center font-bold shrink-0">2</div>
                                    <div>
                                        <h4 className="font-bold text-[#F6F4EF]">Identify Your 403(b) Vendor</h4>
                                        <p className="text-sm text-[#D0CCC4] mt-1">This is usually an insurance company (not your school district). Check your statements for names like VALIC, TIAA, AXA, or Lincoln Financial.</p>
                                    </div>
                                </div>
                                <div className="flex gap-4 p-5 rounded-xl bg-[#0C0D18] backdrop-blur-sm border border-[#2A2D42]">
                                    <div className="w-10 h-10 rounded-full bg-[#DC2626] text-[#F6F4EF] flex items-center justify-center font-bold shrink-0">3</div>
                                    <div>
                                        <h4 className="font-bold text-[#F6F4EF]">Request a Direct Rollover Form</h4>
                                        <p className="text-sm text-[#D0CCC4] mt-1">Call your vendor and ask for their &quot;rollover request form.&quot; Specify you want a <strong className="text-[#F6F4EF]">direct transfer</strong> to avoid withholding.</p>
                                    </div>
                                </div>
                                <div className="flex gap-4 p-5 rounded-xl bg-[#0C0D18] backdrop-blur-sm border border-[#2A2D42]">
                                    <div className="w-10 h-10 rounded-full bg-[#DC2626] text-[#F6F4EF] flex items-center justify-center font-bold shrink-0">4</div>
                                    <div>
                                        <h4 className="font-bold text-[#F6F4EF]">Complete the Paperwork</h4>
                                        <p className="text-sm text-[#D0CCC4] mt-1">Fill out the form with your new Gold IRA custodian&apos;s information. Your Gold IRA company can help you with this.</p>
                                    </div>
                                </div>
                                <div className="flex gap-4 p-5 rounded-xl bg-[#0C0D18] backdrop-blur-sm border border-[#2A2D42]">
                                    <div className="w-10 h-10 rounded-full bg-[#DC2626] text-[#F6F4EF] flex items-center justify-center font-bold shrink-0">5</div>
                                    <div>
                                        <h4 className="font-bold text-[#F6F4EF]">Wait for Transfer & Purchase Gold</h4>
                                        <p className="text-sm text-[#D0CCC4] mt-1">Funds typically arrive in 2-4 weeks (insurance companies are slower than 401k administrators). Then select your gold.</p>
                                    </div>
                                </div>
                            </div>
                        </section>
                        ...
                        <section id="tax-benefits" className="scroll-mt-32">
                            <h2>Tax Benefits</h2>
                            <p>
                                A direct rollover from a 403(b) to a Traditional Gold IRA is <strong className="text-[#F6F4EF]">completely tax-free</strong>. No taxes owed. No penalties. The money simply moves from one tax-advantaged account to another.
                            </p>
                            <p>
                        ...
                        <div className="my-12 bg-gradient-to-br from-primary to-primary-dark rounded-2xl p-8 text-[#F6F4EF] relative overflow-hidden not-prose">
                            ...
                            <div className="relative z-10 text-center">
                                <h3 className="text-3xl font-serif font-bold mb-4 text-[#F6F4EF]">Take Control of Your 403(b)</h3>
