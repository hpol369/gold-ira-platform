                ...
                <div className="flex flex-col lg:flex-row gap-12">
                    ...
                    <article className="flex-1 prose prose-lg prose-headings:font-serif prose-headings:text-primary prose-p:text-text prose-a:text-secondary max-w-none">
                        ...
                        <section id="what-is-rollover" className="scroll-mt-32">
                            <h2>What is a 401(k) to Gold IRA Rollover?</h2>
                            <p>
                            ...
                            <div className="bg-background-subtle rounded-2xl p-6 border border-primary/5 not-prose my-8">
                                <h4 className="font-bold text-primary text-lg mb-4">Accounts You Can Roll Over:</h4>
                                <ul className="space-y-3">
                                    <li className="flex items-start gap-3">
                                        <CheckCircle2 className="w-5 h-5 text-secondary mt-0.5 flex-shrink-0" />
                                        <span><strong>401(k)</strong> — Traditional and Roth employer plans</span>
                                    </li>
                                    <li className="flex items-start gap-3">
                                        <CheckCircle2 className="w-5 h-5 text-secondary mt-0.5 flex-shrink-0" />
                                        <span><strong>403(b)</strong> — Non-profit and education sector plans</span>
                                    </li>
                                    <li className="flex items-start gap-3">
                                        <CheckCircle2 className="w-5 h-5 text-secondary mt-0.5 flex-shrink-0" />
                                        <span><strong>457(b)</strong> — Government employee plans</span>
                                    </li>
                                    <li className="flex items-start gap-3">
                                        <CheckCircle2 className="w-5 h-5 text-secondary mt-0.5 flex-shrink-0" />
                                        <span><strong>TSP</strong> — Thrift Savings Plan (federal employees)</span>
                                    </li>
                                    <li className="flex items-start gap-3">
                                        <CheckCircle2 className="w-5 h-5 text-secondary mt-0.5 flex-shrink-0" />
                                        <span><strong>Traditional IRA</strong> — Personal retirement accounts</span>
                                    </li>
                                    <li className="flex items-start gap-3">
                                        <CheckCircle2 className="w-5 h-5 text-secondary mt-0.5 flex-shrink-0" />
                                        <span><strong>SEP IRA</strong> — Self-employed retirement plans</span>
                                    </li>
                                    <li className="flex items-start gap-3">
                                        <CheckCircle2 className="w-5 h-5 text-secondary mt-0.5 flex-shrink-0" />
                                        <span><strong>SIMPLE IRA</strong> — Small business plans (after 2 years)</span>
                                    </li>
                                </ul>
                            </div>
                        </section>
                        ...
                        <section id="rollover-types" className="scroll-mt-32">
                            <h2>Direct vs. Indirect Rollover: Which to Choose</h2>
                            <p>
                                ...
                                <table className="w-full text-left border-collapse bg-white rounded-xl shadow-sm border border-gray-200">
                                    <thead className="bg-gray-50">
                                        <tr>
                                            ...
                                            <th className="p-4 border-b font-bold text-primary">Direct Rollover</th>
                                            <th className="p-4 border-b font-bold text-primary">Indirect Rollover</th>
                                        </tr>
                                    </thead>
                                    <tbody className="divide-y divide-gray-100 text-sm">
                                        <tr>
                                            <td className="p-4 font-semibold">How It Works</td>
                                        ...
                                        <tr className="bg-background-subtle">
                                            <td className="p-4 font-semibold">Tax Withholding</td>
                                            <td className="p-4">None</td>
                                            <td className="p-4">20% mandatory withholding</td>
                                        </tr>
                                        <tr>
                                            <td className="p-4 font-semibold">Time Limit</td>
                                            <td className="p-4">None</td>
                                            <td className="p-4">60 days to complete</td>
                                        </tr>
                                        <tr className="bg-background-subtle">
                                            <td className="p-4 font-semibold">Risk Level</td>
                                            <td className="p-4 text-green-600 font-medium">Low</td>
                                            <td className="p-4 text-red-600 font-medium">High</td>
                                        </tr>
                                        <tr className="bg-secondary/5">
                                            <td className="p-4 font-bold text-primary">Recommendation</td>
                                            <td className="p-4 font-bold text-green-600">✓ Always choose this</td>
                                            <td className="p-4 font-bold text-red-600">✗ Avoid if possible</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>

                            <h3>Why Direct Rollover is Better</h3>
                            <p>
                            ...
                            <div className="not-prose my-8">
                                <div className="space-y-4">
                                    <div className="flex gap-4 p-6 rounded-xl bg-white border border-gray-100 shadow-sm">
                                        ...
                                        <div>
                                            <strong className="block text-primary text-lg">Left Your Employer</strong>
                                            <p className="text-text-muted mt-1">If you&apos;ve quit, retired, or been laid off, you have full control over your 401(k) and can roll it over to a gold IRA at any time. This is the most common scenario.</p>
                                        </div>
                                    </div>
                                    <div className="flex gap-4 p-6 rounded-xl bg-white border border-gray-100 shadow-sm">
                                        <div className="w-12 h-12 rounded-full bg-green-100 text-green-600 flex items-center justify-center font-bold shrink-0">
                                        ...
                                        <div>
                                            <strong className="block text-primary text-lg">Age 59½ or Older (Still Employed)</strong>
                                            <p className="text-text-muted mt-1">Most 401(k) plans allow &quot;in-service distributions&quot; once you reach 59½, even if you&apos;re still working. Check with your HR department or plan administrator.</p>
                                        </div>
                                    </div>
                                    <div className="flex gap-4 p-6 rounded-xl bg-white border border-gray-100 shadow-sm">
                                        ...
                                        <div>
                                            <strong className="block text-primary text-lg">Under 59½ and Still Employed</strong>
                                            <p className="text-text-muted mt-1">This is the trickiest scenario. Some plans allow in-service withdrawals; many don&apos;t. You&apos;ll need to check your specific plan rules. Even if rollovers aren&apos;t allowed, you can still roll over when you eventually leave.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>

                            <h3>What About Old 401(k)s From Previous Jobs?</h3>
                            <p>
                        ...
                        <section id="step-by-step" className="scroll-mt-32">
                            <h2>Step-by-Step: How to Roll Over Your 401(k) to Gold</h2>
                            <p>
                                ...
                                <div className="space-y-6">
                                    <div className="flex gap-4 items-start">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-text-muted mt-1">Select a reputable precious metals dealer to guide you through the process. They&apos;ll handle most of the paperwork. Top choices include <Link href="/reviews/augusta-precious-metals" className="text-secondary hover:underline">Augusta Precious Metals</Link> (best for $50k+) and <Link href="/reviews/noble-gold" className="text-secondary hover:underline">Noble Gold</Link> (best for smaller rollovers).</p>
                                        </div>
                                    </div>
                                    <div className="flex gap-4 items-start">
                                        <div className="w-10 h-10 rounded-full bg-secondary text-white flex items-center justify-center font-bold shrink-0">2</div>
                                        <div>
                                            <h4 className="font-bold text-primary text-lg">Open a Self-Directed IRA</h4>
                                            <p className="text-text-muted mt-1">Your gold IRA company will help you open an account with an IRS-approved custodian. This typically involves completing an application and providing identification. Most companies handle this within 24-48 hours.</p>
                                        </div>
                                    </div>
                                    <div className="flex gap-4 items-start">
                                        <div className="w-10 h-10 rounded-full bg-secondary text-white flex items-center justify-center font-bold shrink-0">3</div>
                                        <div>
                                            <h4 className="font-bold text-primary text-lg">Request the Rollover</h4>
                                            <p className="text-text-muted mt-1">Your new custodian sends a rollover request to your 401(k) administrator. For a direct rollover, specify that funds should be sent to your new IRA custodian—not to you personally. Your gold IRA company typically handles this paperwork.</p>
                                        </div>
                                    </div>
                                    <div className="flex gap-4 items-start">
                                        <div className="w-10 h-10 rounded-full bg-secondary text-white flex items-center justify-center font-bold shrink-0">4</div>
                                        <div>
                                            <h4 className="font-bold text-primary text-lg">Wait for Fund Transfer</h4>
                                            <p className="text-text-muted mt-1">The transfer typically takes 1-3 weeks depending on your old plan administrator. Some plans process quickly; others take the full time. Your gold IRA company will track the progress and notify you when funds arrive.</p>
                                        </div>
                                    </div>
                                    <div className="flex gap-4 items-start">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-text-muted mt-1">Once funds are in your new IRA, work with your dealer to choose IRS-approved gold, silver, platinum, or palladium products. They&apos;ll explain options, premiums, and help you build a diversified metals portfolio.</p>
                                        </div>
                                    </div>
                                    <div className="flex gap-4 items-start">
                                        <div className="w-10 h-10 rounded-full bg-secondary text-white flex items-center justify-center font-bold shrink-0">6</div>
                                        <div>
                                            <h4 className="font-bold text-primary text-lg">Purchase & Storage</h4>
                                            <p className="text-text-muted mt-1">Your dealer purchases the metals and ships them directly to an IRS-approved depository. You&apos;ll receive confirmation of your purchase and can view your holdings at any time. The metals are stored, insured, and held in your name.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <section id="tax-rules" className="scroll-mt-32">
                            ...
                            <h3>Traditional to Roth Conversion</h3>
                            <p>
                        ...
                        <section id="timeline" className="scroll-mt-32">
                            <h2>Timeline: How Long Does a Rollover Take?</h2>
                            <p>
                        ...
                        <section id="mistakes" className="scroll-mt-32">
                            <h2>Common Rollover Mistakes to Avoid</h2>
                            <p>
                            ...
                            <div className="not-prose my-8 space-y-4">
                                <div className="flex gap-4 p-5 rounded-xl bg-red-50 border border-red-100">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-red-600 mt-1">Unless you have a specific reason, always choose direct rollover. The 60-day deadline and 20% withholding create unnecessary risk and complications.</p>
                                    </div>
                                </div>
                                <div className="flex gap-4 p-5 rounded-xl bg-red-50 border border-red-100">
                                    <AlertTriangle className="w-6 h-6 text-red-500 shrink-0 mt-1" />
                                    <div>
                                        ...
                                        <p className="text-sm text-red-600 mt-1">Some companies promote &quot;home storage gold IRAs.&quot; This is extremely risky and can trigger a full taxable distribution. Always use IRS-approved depositories.</p>
                                    </div>
                                </div>
                                <div className="flex gap-4 p-5 rounded-xl bg-amber-50 border border-amber-100">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-amber-600 mt-1">Fees and service vary dramatically between gold IRA companies. A few hours of research (or taking our quiz) can save you thousands over the life of your account.</p>
                                    </div>
                                </div>
                                <div className="flex gap-4 p-5 rounded-xl bg-amber-50 border border-amber-100">
                                    <AlertTriangle className="w-6 h-6 text-amber-500 shrink-0 mt-1" />
                                    <div>
                                        ...
                                        <p className="text-sm text-amber-600 mt-1">Most advisors recommend keeping 10-20% of your portfolio in precious metals, not 100%. Consider rolling over a portion while maintaining diversification.</p>
                                    </div>
                                </div>
                                <div className="flex gap-4 p-5 rounded-xl bg-amber-50 border border-amber-100">
                                    <AlertTriangle className="w-6 h-6 text-amber-500 shrink-0 mt-1" />
                                    <div>
                                        ...
                                        <p className="text-sm text-amber-600 mt-1">Gold IRAs have fees that standard IRAs don&apos;t (storage, custodian). Make sure you understand all fees before proceeding. See our <Link href="/guide/gold-ira-fees" className="text-secondary hover:underline">fee guide</Link> for details.</p>
                                    </div>
                                </div>
                            </div>
                        </section>
                        ...
                        <section id="faq" className="scroll-mt-32">
                            <h2>401(k) to Gold Rollover FAQs</h2>
