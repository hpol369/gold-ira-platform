                ...
                <div className="flex flex-col lg:flex-row gap-12">
                    ...
                    <article className="flex-1 prose prose-lg prose-headings:font-serif prose-headings:text-[#F6F4EF] prose-p:text-[#D0CCC4] prose-a:text-[#D4A94E] max-w-none">
                        ...
                        <section id="what-is-rollover" className="scroll-mt-32">
                            <h2 className="text-[#F6F4EF]">What is a 401(k) to Gold IRA Rollover?</h2>
                            <p>
                            ...
                            <div className="bg-[#121423] rounded-2xl p-6 border border-[#2A2D42] not-prose my-8">
                                <h4 className="font-bold text-[#F6F4EF] text-lg mb-4">Accounts You Can Roll Over:</h4>
                                <ul className="space-y-3">
                                    <li className="flex items-start gap-3">
                                        <CheckCircle2 className="w-5 h-5 text-[#D4A94E] mt-0.5 flex-shrink-0" />
                                        <span className="text-[#D0CCC4]"><strong>401(k)</strong> — Traditional and Roth employer plans</span>
                                    </li>
                                    <li className="flex items-start gap-3">
                                        <CheckCircle2 className="w-5 h-5 text-[#D4A94E] mt-0.5 flex-shrink-0" />
                                        <span className="text-[#D0CCC4]"><strong>403(b)</strong> — Non-profit and education sector plans</span>
                                    </li>
                                    <li className="flex items-start gap-3">
                                        <CheckCircle2 className="w-5 h-5 text-[#D4A94E] mt-0.5 flex-shrink-0" />
                                        <span className="text-[#D0CCC4]"><strong>457(b)</strong> — Government employee plans</span>
                                    </li>
                                    <li className="flex items-start gap-3">
                                        <CheckCircle2 className="w-5 h-5 text-[#D4A94E] mt-0.5 flex-shrink-0" />
                                        <span className="text-[#D0CCC4]"><strong>TSP</strong> — Thrift Savings Plan (federal employees)</span>
                                    </li>
                                    <li className="flex items-start gap-3">
                                        <CheckCircle2 className="w-5 h-5 text-[#D4A94E] mt-0.5 flex-shrink-0" />
                                        <span className="text-[#D0CCC4]"><strong>Traditional IRA</strong> — Personal retirement accounts</span>
                                    </li>
                                    <li className="flex items-start gap-3">
                                        <CheckCircle2 className="w-5 h-5 text-[#D4A94E] mt-0.5 flex-shrink-0" />
                                        <span className="text-[#D0CCC4]"><strong>SEP IRA</strong> — Self-employed retirement plans</span>
                                    </li>
                                    <li className="flex items-start gap-3">
                                        <CheckCircle2 className="w-5 h-5 text-[#D4A94E] mt-0.5 flex-shrink-0" />
                                        <span className="text-[#D0CCC4]"><strong>SIMPLE IRA</strong> — Small business plans (after 2 years)</span>
                                    </li>
                                </ul>
                            </div>
                        </section>
                        ...
                        <section id="rollover-types" className="scroll-mt-32">
                            <h2 className="text-[#F6F4EF]">Direct vs. Indirect Rollover: Which to Choose</h2>
                            <p>
                                ...
                                <table className="w-full text-left border-collapse bg-[#0C0D18] backdrop-blur-sm rounded-xl shadow-sm border border-[#2A2D42]">
                                    <thead className="bg-[#121423]">
                                        <tr>
                                            ...
                                            <th className="p-4 border-b border-[#2A2D42] font-bold text-[#F6F4EF]">Direct Rollover</th>
                                            <th className="p-4 border-b border-[#2A2D42] font-bold text-[#F6F4EF]">Indirect Rollover</th>
                                        </tr>
                                    </thead>
                                    <tbody className="divide-y divide-white/10 text-sm text-[#D0CCC4]">
                                        <tr>
                                            <td className="p-4 font-semibold text-[#F6F4EF]">How It Works</td>
                                        ...
                                        <tr className="bg-slate-800/30">
                                            <td className="p-4 font-semibold text-[#F6F4EF]">Tax Withholding</td>
                                            <td className="p-4">None</td>
                                            <td className="p-4">20% mandatory withholding</td>
                                        </tr>
                                        <tr>
                                            <td className="p-4 font-semibold text-[#F6F4EF]">Time Limit</td>
                                            <td className="p-4">None</td>
                                            <td className="p-4">60 days to complete</td>
                                        </tr>
                                        <tr className="bg-slate-800/30">
                                            <td className="p-4 font-semibold text-[#F6F4EF]">Risk Level</td>
                                        ...
                                        <tr className="bg-[rgba(220,38,38,0.1)]">
                                            <td className="p-4 font-bold text-[#F6F4EF]">Recommendation</td>
                            ...
                            <h3 className="text-[#F6F4EF]">Why Direct Rollover is Better</h3>
                            <p>
                        ...
                        <section id="eligibility" className="scroll-mt-32">
                            <h2 className="text-[#F6F4EF]">Eligibility Requirements</h2>
                            <p>
                            ...
                            <div className="not-prose my-8">
                                <div className="space-y-4">
                                    <div className="flex gap-4 p-6 rounded-xl bg-[#0C0D18] backdrop-blur-sm border border-[#2A2D42]">
                                        ...
                                        <div>
                                            <strong className="block text-[#F6F4EF] text-lg">Left Your Employer</strong>
                                            <p className="text-[#D0CCC4] mt-1">If you&apos;ve quit, retired, or been laid off, you have full control over your 401(k) and can roll it over to a gold IRA at any time. This is the most common scenario.</p>
                                        </div>
                                    </div>
                                    <div className="flex gap-4 p-6 rounded-xl bg-[#0C0D18] backdrop-blur-sm border border-[#2A2D42]">
                                        <div className="w-12 h-12 rounded-full bg-green-500/20 text-green-700 flex items-center justify-center font-bold shrink-0">
                                        ...
                                        <div>
                                            <strong className="block text-[#F6F4EF] text-lg">Age 59½ or Older (Still Employed)</strong>
                                            <p className="text-[#D0CCC4] mt-1">Most 401(k) plans allow &quot;in-service distributions&quot; once you reach 59½, even if you&apos;re still working. Check with your HR department or plan administrator.</p>
                                        </div>
                                    </div>
                                    <div className="flex gap-4 p-6 rounded-xl bg-[#0C0D18] backdrop-blur-sm border border-[#2A2D42]">
                                        ...
                                        <div>
                                            <strong className="block text-[#F6F4EF] text-lg">Under 59½ and Still Employed</strong>
                                            <p className="text-[#D0CCC4] mt-1">This is the trickiest scenario. Some plans allow in-service withdrawals; many don&apos;t. You&apos;ll need to check your specific plan rules. Even if rollovers aren&apos;t allowed, you can still roll over when you eventually leave.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>

                            <h3 className="text-[#F6F4EF]">What About Old 401(k)s From Previous Jobs?</h3>
                            <p>
                        ...
                        <div className="my-12 bg-primary rounded-2xl p-8 text-[#F6F4EF] text-center relative overflow-hidden not-prose">
                            ...
                            <div className="relative z-10">
                                <h3 className="text-2xl font-serif font-bold mb-4 text-[#F6F4EF]">Ready to Roll Over Your 401(k)?</h3>
                        ...
                        <section id="step-by-step" className="scroll-mt-32">
                            <h2 className="text-[#F6F4EF]">Step-by-Step: How to Roll Over Your 401(k) to Gold</h2>
                            <p>
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div className="flex gap-4 items-start">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-[#D0CCC4] mt-1">Your gold IRA company will help you open an account with an IRS-approved custodian. This typically involves completing an application and providing identification. Most companies handle this within 24-48 hours.</p>
                                        </div>
                                    </div>
                                    <div className="flex gap-4 items-start">
                                        <div className="w-10 h-10 rounded-full bg-[#DC2626] text-[#F6F4EF] flex items-center justify-center font-bold shrink-0">3</div>
                                        <div>
                                            <h4 className="font-bold text-[#F6F4EF] text-lg">Request the Rollover</h4>
                                            <p className="text-[#D0CCC4] mt-1">Your new custodian sends a rollover request to your 401(k) administrator. For a direct rollover, specify that funds should be sent to your new IRA custodian—not to you personally. Your gold IRA company typically handles this paperwork.</p>
                                        </div>
                                    </div>
                                    <div className="flex gap-4 items-start">
                                        <div className="w-10 h-10 rounded-full bg-[#DC2626] text-[#F6F4EF] flex items-center justify-center font-bold shrink-0">4</div>
                                        <div>
                                            <h4 className="font-bold text-[#F6F4EF] text-lg">Wait for Fund Transfer</h4>
                                            <p className="text-[#D0CCC4] mt-1">The transfer typically takes 1-3 weeks depending on your old plan administrator. Some plans process quickly; others take the full time. Your gold IRA company will track the progress and notify you when funds arrive.</p>
                                        </div>
                                    </div>
                                    <div className="flex gap-4 items-start">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-[#D0CCC4] mt-1">Once funds are in your new IRA, work with your dealer to choose IRS-approved gold, silver, platinum, or palladium products. They&apos;ll explain options, premiums, and help you build a diversified metals portfolio.</p>
                                        </div>
                                    </div>
                                    <div className="flex gap-4 items-start">
                                        <div className="w-10 h-10 rounded-full bg-[#DC2626] text-[#F6F4EF] flex items-center justify-center font-bold shrink-0">6</div>
                                        <div>
                                            <h4 className="font-bold text-[#F6F4EF] text-lg">Purchase & Storage</h4>
                                            <p className="text-[#D0CCC4] mt-1">Your dealer purchases the metals and ships them directly to an IRS-approved depository. You&apos;ll receive confirmation of your purchase and can view your holdings at any time. The metals are stored, insured, and held in your name.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <section id="tax-rules" className="scroll-mt-32">
                            ...
                            <h3 className="text-[#F6F4EF]">Traditional to Roth Conversion</h3>
                            <p>
                        ...
                        <section id="timeline" className="scroll-mt-32">
                            <h2 className="text-[#F6F4EF]">Timeline: How Long Does a Rollover Take?</h2>
                            <p>
                            ...
                            <div className="overflow-x-auto not-prose my-8">
                                <table className="w-full text-left border-collapse bg-[#0C0D18] backdrop-blur-sm rounded-xl shadow-sm border border-[#2A2D42]">
                                    <thead className="bg-[#121423]">
                                        <tr>
                                            <th className="p-4 border-b border-[#2A2D42] font-bold text-[#F6F4EF]">Step</th>
                                            <th className="p-4 border-b border-[#2A2D42] font-bold text-[#F6F4EF]">Typical Time</th>
                                            <th className="p-4 border-b border-[#2A2D42] font-bold text-[#F6F4EF]">Notes</th>
                                        </tr>
                                    </thead>
                                    <tbody className="divide-y divide-white/10 text-sm text-[#D0CCC4]">
                                        <tr>
                                            <td className="p-4 font-semibold text-[#F6F4EF]">Choose company & open IRA</td>
                                            <td className="p-4">1-3 days</td>
                                            <td className="p-4">Quick once you&apos;ve decided</td>
                                        </tr>
                                        <tr className="bg-slate-800/30">
                                            <td className="p-4 font-semibold text-[#F6F4EF]">Rollover paperwork</td>
                                            <td className="p-4">1-2 days</td>
                                            <td className="p-4">Dealer handles most of it</td>
                                        </tr>
                                        <tr>
                                            <td className="p-4 font-semibold text-[#F6F4EF]">Fund transfer</td>
                                            <td className="p-4">5-15 business days</td>
                                            <td className="p-4">Depends on old plan administrator</td>
                                        </tr>
                                        <tr className="bg-slate-800/30">
                                            <td className="p-4 font-semibold text-[#F6F4EF]">Metal selection & purchase</td>
                                            <td className="p-4">1-2 days</td>
                                            <td className="p-4">Once funds arrive</td>
                                        </tr>
                                        <tr>
                                            <td className="p-4 font-semibold text-[#F6F4EF]">Shipping to depository</td>
                                            <td className="p-4">3-7 days</td>
                                            <td className="p-4">Fully insured shipping</td>
                                        </tr>
                                        <tr className="bg-[rgba(220,38,38,0.1)]">
                                            <td className="p-4 font-bold text-[#F6F4EF]">Total</td>
                                            <td className="p-4 font-bold text-[#F6F4EF]">2-4 weeks</td>
                        ...
                        <section id="mistakes" className="scroll-mt-32">
                            <h2 className="text-[#F6F4EF]">Common Rollover Mistakes to Avoid</h2>
                            <p>
                            ...
                            <div className="not-prose my-8 space-y-4">
                                ...
                                <div className="flex gap-4 p-5 rounded-xl bg-amber-500/10 border border-amber-500/20">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-amber-800 mt-1">Gold IRAs have fees that standard IRAs don&apos;t (storage, custodian). Make sure you understand all fees before proceeding. See our <Link href="/guide/gold-ira-fees" className="text-[#D4A94E] hover:underline">fee guide</Link> for details.</p>
                                    </div>
                                </div>
                            </div>
                        </section>
                        ...
                        <section id="other-accounts" className="scroll-mt-32">
                            <h2 className="text-[#F6F4EF]">403(b) and TSP Rollovers to Gold</h2>
                            <p>
                            ...
                            <h3 className="text-[#F6F4EF]">403(b) to Gold IRA Rollover</h3>
                            <p>
                            ...
                            <h3 className="text-[#F6F4EF]">TSP to Gold IRA Rollover (Federal Employees)</h3>
                            <p>
                        ...
                        <section id="faq" className="scroll-mt-32">
                            <h2 className="text-[#F6F4EF]">401(k) to Gold Rollover FAQs</h2>
                            ...
                            <div className="space-y-4 not-prose">
                                ...
                                <details className="group bg-[#0C0D18] backdrop-blur-sm rounded-xl border border-[#2A2D42] p-6 [&_summary::-webkit-details-marker]:hidden">
                                    ...
                                    <p className="mt-4 leading-relaxed text-[#D0CCC4]">
                                        There&apos;s no IRS minimum, but gold IRA companies have their own minimums. <Link href="/reviews/noble-gold" className="text-[#D4A94E] hover:underline">Noble Gold</Link> accepts as little as $2,000. <Link href="/reviews/goldco" className="text-[#D4A94E] hover:underline">Goldco</Link> starts at $25,000. <Link href="/reviews/augusta-precious-metals" className="text-[#D4A94E] hover:underline">Augusta Precious Metals</Link> requires $50,000+. Choose a company based on your investment amount.
                                    </p>
                                </details>
                            </div>
                        </section>
                        ...
                        <div className="my-12 bg-gradient-to-br from-primary to-primary-dark rounded-2xl p-8 text-[#F6F4EF] relative overflow-hidden not-prose">
                            ...
                            <div className="relative z-10 text-center">
                                <h3 className="text-3xl font-serif font-bold mb-4 text-[#F6F4EF]">Ready to Roll Over Your 401(k)?</h3>
