    ...
    return (
      <div className="min-h-screen bg-gradient-to-b from-[#000040] via-[#000060] to-[#000080] flex items-center justify-center px-4">
        <motion.div
          ...
          className="bg-[#161828] rounded-2xl p-8 md:p-12 max-w-lg w-full text-center shadow-2xl"
        >
          <div className="w-16 h-16 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-6">
            <CheckCircle className="w-8 h-8 text-green-600" />
          </div>
          <h2 className="text-2xl font-bold text-[#F6F4EF] mb-3">You&apos;re Almost There!</h2>
          ...
          <a
            ...
            className="inline-flex items-center gap-2 bg-[#DC2626] text-white px-8 py-4 rounded-xl font-bold text-lg hover:bg-[#9a1e2d] transition-colors"
          >
            Get My Personalized Kit
            <ArrowRight className="w-5 h-5" />
          </a>
          <p className="text-xs text-[#A8A39A] mt-3">Takes 60 seconds. No phone call required.</p>
          <div className="mt-8 pt-6 border-t border-[#2A2D42]">
            ...
            <p className="text-xs text-[#A8A39A] mt-2">Our #1 rated company — A+ BBB, zero complaints</p>
          </div>
          <p className="text-sm text-[#A8A39A] mt-6">
      ...
      <div className="max-w-6xl mx-auto px-4 py-16 md:py-24">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <div className="flex items-center gap-4 text-[#A8A39A] text-sm">
          ...
          >
            ...
            >
              ...
              <p className="text-[#3F4460] text-center mb-6">
                Instant download. No phone call. No spam.
              </p>

              <div className="space-y-4">
                <div>
                  <label htmlFor="firstName" className="block text-sm font-medium text-[#3F4460] mb-1">
                    First Name
                  </label>
                  <input
                    id="firstName"
                ...
                <div>
                  <label htmlFor="email" className="block text-sm font-medium text-[#3F4460] mb-1">
                    Email Address
                  </label>
                  <input
                    id="email"
              ...
              <p className="text-xs text-[#A8A39A] text-center mt-4 flex items-center justify-center gap-1">
