                ...
                <div className="flex flex-col lg:flex-row gap-12 max-w-6xl mx-auto">
                    ...
                    <article className="flex-1 prose prose-lg prose-headings:font-serif prose-headings:text-primary max-w-none">
                        ...
                        <section id="overview" className="scroll-mt-32">
                            ...
                            <p>
                                The threats to wealth are numerous: market crashes, inflation, taxes, lawsuits, poor estate planning, and simple overspending. <strong>Wealth preservation is about building defenses against all of these threats simultaneously.</strong>
                            </p>
                            <p>
                        ...
                        <section id="diversification" className="scroll-mt-32">
                            <div className="flex items-center gap-4 mb-4 not-prose">
                                ...
                                <h2 className="text-2xl md:text-3xl font-serif font-bold text-primary m-0">1. True Diversification</h2>
                            </div>
                            <p>
                            ...
                            <ul>
                                <li><strong>Asset classes:</strong> Stocks, bonds, real estate, precious metals, private equity</li>
                                <li><strong>Geographies:</strong> Domestic and international exposure</li>
                                <li><strong>Currencies:</strong> Not just USD—exposure to other stable currencies</li>
                                <li><strong>Time horizons:</strong> Short, medium, and long-term holdings</li>
                                <li><strong>Counterparties:</strong> Different custodians, banks, and brokerages</li>
                            </ul>

                            <div className="bg-background-subtle rounded-2xl p-6 border border-primary/5 not-prose my-8">
                                <h4 className="font-bold text-primary text-lg mb-4">Wealth Preservation Allocation</h4>
                                <div className="space-y-3">
                                    <div className="flex justify-between items-center p-3 bg-white rounded-lg">
                                        <span className="text-gray-700">Stocks (Domestic & International)</span>
                                        <span className="font-semibold text-blue-600">30-40%</span>
                                    </div>
                                    <div className="flex justify-between items-center p-3 bg-white rounded-lg">
                                        <span className="text-gray-700">Bonds & Fixed Income</span>
                                    ...
                                    <div className="flex justify-between items-center p-3 bg-white rounded-lg">
                                        ...
                                        <span className="font-semibold text-amber-600">10-20%</span>
                                    </div>
                                    <div className="flex justify-between items-center p-3 bg-white rounded-lg">
                                        <span className="text-gray-700">Cash & Alternatives</span>
                        ...
                        <section id="gold" className="scroll-mt-32">
                            <div className="flex items-center gap-4 mb-4 not-prose">
                                ...
                                <h2 className="text-2xl md:text-3xl font-serif font-bold text-primary m-0">2. Precious Metals Allocation</h2>
                            </div>
                            <p>
                            ...
                            <h3>Why Gold for Wealth Preservation?</h3>
                            <ul>
                                <li><strong>No counterparty risk:</strong> Physical gold doesn&apos;t depend on any company or government</li>
                                <li><strong>Crisis performance:</strong> Rose 25% in 2008 while stocks fell 37%</li>
                                <li><strong>Purchasing power:</strong> Maintains value across centuries</li>
                                <li><strong>Privacy:</strong> Can be held privately outside the banking system</li>
                                <li><strong>Universal value:</strong> Accepted and valued everywhere on Earth</li>
                            </ul>
                        ...
                        <section id="real-assets" className="scroll-mt-32">
                            <div className="flex items-center gap-4 mb-4 not-prose">
                                ...
                                <h2 className="text-2xl md:text-3xl font-serif font-bold text-primary m-0">3. Real Asset Ownership</h2>
                            </div>
                            <p>
                            ...
                            <h3>Key Real Assets</h3>
                            <ul>
                                <li><strong>Real estate:</strong> Income, appreciation, tax benefits, inflation hedge</li>
                                <li><strong>Farmland:</strong> Food production, uncorrelated returns, limited supply</li>
                                <li><strong>Physical gold/silver:</strong> Crisis hedge, portable wealth, privacy</li>
                                <li><strong>Timber:</strong> Growing asset, inflation protection, tax benefits</li>
                                <li><strong>Collectibles:</strong> Art, rare items (for sophisticated investors)</li>
                            </ul>

                            <p>
                                The key principle: <strong>own things, not just paper claims on things</strong>. Physical ownership removes counterparty risk.
                            </p>
                        </section>
                        ...
                        <section id="tax-planning" className="scroll-mt-32">
                            <div className="flex items-center gap-4 mb-4 not-prose">
                                ...
                                <h2 className="text-2xl md:text-3xl font-serif font-bold text-primary m-0">4. Tax-Efficient Planning</h2>
                            </div>
                            <p>
                            ...
                            <ul>
                                <li><strong>Tax-advantaged accounts:</strong> Max out 401(k), IRA, Gold IRA, HSA contributions</li>
                                <li><strong>Roth conversions:</strong> Pay taxes now at lower rates, withdraw tax-free later</li>
                                <li><strong>Tax-loss harvesting:</strong> Offset gains with losses</li>
                                <li><strong>Asset location:</strong> Hold tax-inefficient assets in tax-advantaged accounts</li>
                                <li><strong>Long-term gains:</strong> Hold investments over a year for lower rates</li>
                                <li><strong>Charitable giving:</strong> Donate appreciated assets, not cash</li>
                            </ul>
                        </section>
                        ...
                        <section id="asset-protection" className="scroll-mt-32">
                            <div className="flex items-center gap-4 mb-4 not-prose">
                                ...
                                <h2 className="text-2xl md:text-3xl font-serif font-bold text-primary m-0">5. Asset Protection</h2>
                            </div>
                            <p>
                            ...
                            <ul>
                                <li><strong>LLCs:</strong> Hold real estate and businesses in separate LLCs</li>
                                <li><strong>Trusts:</strong> Irrevocable trusts can protect assets from creditors</li>
                                <li><strong>Umbrella insurance:</strong> Additional liability coverage beyond standard policies</li>
                                <li><strong>Retirement accounts:</strong> 401(k)s and IRAs have strong creditor protection</li>
                                <li><strong>Homestead exemption:</strong> Protect primary residence (varies by state)</li>
                            </ul>
                        ...
                        <section id="inflation" className="scroll-mt-32">
                            <div className="flex items-center gap-4 mb-4 not-prose">
                                ...
                                <h2 className="text-2xl md:text-3xl font-serif font-bold text-primary m-0">6. Inflation Defense</h2>
                            </div>
                            <p>
                            ...
                            <h3>Inflation Hedges</h3>
                            <ul>
                                <li><strong>Gold:</strong> The ultimate inflation hedge—maintained purchasing power for millennia</li>
                                <li><strong>Real estate:</strong> Rents and values rise with inflation</li>
                                <li><strong>TIPS:</strong> Treasury bonds that adjust for inflation</li>
                                <li><strong>Commodities:</strong> Physical goods that rise with prices</li>
                                <li><strong>Stocks:</strong> Companies can raise prices (partial hedge)</li>
                            </ul>
                        </section>
                        ...
                        <section id="estate" className="scroll-mt-32">
                            <div className="flex items-center gap-4 mb-4 not-prose">
                                ...
                                <h2 className="text-2xl md:text-3xl font-serif font-bold text-primary m-0">7. Estate Planning</h2>
                            </div>
                            <p>
                            ...
                            <ul>
                                <li><strong>Will:</strong> Basic distribution instructions</li>
                                <li><strong>Revocable living trust:</strong> Avoid probate, maintain control</li>
                                <li><strong>Power of attorney:</strong> Financial decision-making if incapacitated</li>
                                <li><strong>Healthcare directive:</strong> Medical decision-making</li>
                                <li><strong>Beneficiary designations:</strong> Keep these current on all accounts</li>
                            </ul>

                            <h3>Wealth Transfer Strategies</h3>
                            <ul>
                                <li><strong>Annual gifting:</strong> $18,000 per person per year (2024) tax-free</li>
                                <li><strong>529 plans:</strong> Education funding for heirs</li>
                                <li><strong>Irrevocable life insurance trusts:</strong> Tax-free inheritance</li>
                                <li><strong>Family limited partnerships:</strong> Business succession + valuation discounts</li>
                            </ul>
                        </section>
                        ...
                        <section id="insurance" className="scroll-mt-32">
                            <div className="flex items-center gap-4 mb-4 not-prose">
                                ...
                                <h2 className="text-2xl md:text-3xl font-serif font-bold text-primary m-0">8. Risk Insurance</h2>
                            </div>
                            <p>
                            ...
                            <ul>
                                <li><strong>Umbrella liability:</strong> $2-5 million for high-net-worth individuals</li>
                                <li><strong>Long-term care:</strong> Protect assets from nursing home costs</li>
                                <li><strong>Disability:</strong> Protect income-earning ability</li>
                                <li><strong>Life insurance:</strong> Estate liquidity and wealth transfer</li>
                                <li><strong>Property insurance:</strong> Full replacement value on real estate</li>
                            </ul>
                        </section>
                        ...
                        <section id="framework" className="scroll-mt-32">
                            <div className="flex items-center gap-4 mb-4 not-prose">
                                ...
                                <h2 className="text-2xl md:text-3xl font-serif font-bold text-primary m-0">Building Your Wealth Preservation Framework</h2>
                            </div>

                            <div className="bg-background-subtle rounded-2xl p-6 border border-primary/5 not-prose my-8">
                                <h4 className="font-bold text-primary text-lg mb-4">Wealth Preservation Checklist</h4>
                                <div className="space-y-3">
                                    <div className="flex items-center gap-3 p-3 bg-white rounded-lg">
                                        <input type="checkbox" className="w-5 h-5 text-secondary" />
                                        <span className="text-gray-700">Diversified across 5+ asset classes</span>
                                    </div>
                                    <div className="flex items-center gap-3 p-3 bg-white rounded-lg">
                                        <input type="checkbox" className="w-5 h-5 text-secondary" />
                                        <span className="text-gray-700">10-20% in physical gold/precious metals</span>
                                    </div>
                                    <div className="flex items-center gap-3 p-3 bg-white rounded-lg">
                                        <input type="checkbox" className="w-5 h-5 text-secondary" />
                                        <span className="text-gray-700">Real estate and/or farmland ownership</span>
                                    </div>
                                    <div className="flex items-center gap-3 p-3 bg-white rounded-lg">
                                        <input type="checkbox" className="w-5 h-5 text-secondary" />
                                        <span className="text-gray-700">Tax-advantaged accounts maximized</span>
                                    </div>
                                    <div className="flex items-center gap-3 p-3 bg-white rounded-lg">
                                        <input type="checkbox" className="w-5 h-5 text-secondary" />
                                        <span className="text-gray-700">Asset protection structures in place</span>
                                    </div>
                                    <div className="flex items-center gap-3 p-3 bg-white rounded-lg">
                                        <input type="checkbox" className="w-5 h-5 text-secondary" />
                                        <span className="text-gray-700">Estate planning documents current</span>
                                    </div>
                                    <div className="flex items-center gap-3 p-3 bg-white rounded-lg">
                                        <input type="checkbox" className="w-5 h-5 text-secondary" />
                                        <span className="text-gray-700">Umbrella liability insurance ($2M+)</span>
                                    </div>
                                </div>
                            </div>
                        </section>
