...
export default function IraApprovedSilverPage() {
    return (
        <main className="min-h-screen bg-white">
            ...
            {/* Header */}
            <header className="bg-white text-[#F6F4EF] py-20 relative overflow-hidden">
                <div className="absolute inset-0 bg-[radial-gradient(circle_at_30%_20%,rgba(203,213,225,0.1),transparent_50%)]" />
                <Container className="relative z-10">
                    <div className="max-w-3xl">
                        <div className="inline-flex items-center gap-2 rounded-full bg-[#121423] px-4 py-1.5 text-sm font-semibold text-[#D4A94E] mb-6 border border-[#2A2D42]">
                ...
                <div className="flex flex-col lg:flex-row gap-12">
                    ...
                    <article className="flex-1 prose prose-lg prose-headings:font-serif prose-headings:text-[#F6F4EF] prose-p:text-[#D0CCC4] prose-a:text-[#D4A94E] max-w-none">
                        ...
                        <section id="requirements" className="scroll-mt-32">
                            <h2 className="text-[#F6F4EF]">IRS Silver Purity Requirements</h2>
                            <p>
                        ...
                        <section id="coins" className="scroll-mt-32">
                            <h2 className="text-[#F6F4EF]">IRA Approved Silver Coins</h2>
                            <p>
                            ...
                            <div className="overflow-x-auto not-prose my-8">
                                <table className="w-full text-left border-collapse bg-[#0C0D18] backdrop-blur-sm rounded-xl shadow-sm border border-[#2A2D42]">
                                    <thead className="bg-[#0C0D18]">
                                        <tr>
                                            <th className="p-4 border-b border-[#2A2D42] font-bold text-[#F6F4EF]">Coin</th>
                                            ...
                                            <th className="p-4 border-b border-[#2A2D42] font-bold text-[#F6F4EF] hidden md:table-cell">Notes</th>
                                        </tr>
                                    </thead>
                                    <tbody className="divide-y divide-[#2A2D42] text-sm text-[#D0CCC4]">
                                        {approvedCoins.map((coin, index) => (
                                            <tr key={coin.name} className={index % 2 === 1 ? "bg-[#121423]" : ""}>
                                                <td className="p-4">
                                                    <div className="flex items-center gap-2">
                                                        {coin.recommended && <span className="text-[#D4A94E]">★</span>}
                                                        <div>
                                                            <span className="font-semibold text-[#F6F4EF]">{coin.name}</span>
                                                            <div className="text-xs text-[#D0CCC4]">{coin.country}</div>
                                                        </div>
                                                    </div>
                                                </td>
                            ...
                            <p className="text-sm text-[#D0CCC4]">★ = Recommended picks for best value and liquidity</p>
                            ...
                            <div className="grid md:grid-cols-3 gap-4 not-prose my-6">
                                ...
                                <div className="bg-[#0C0D18] border border-[#2A2D42] rounded-xl p-5">
                                    ...
                                    <h4 className="font-bold text-[#F6F4EF]">Canadian Maple Leaf</h4>
                                    <p className="text-[#D0CCC4] text-sm mt-2">Highest purity (99.99%), lower premiums than Eagles, excellent security features. Best bang for your buck.</p>
                                </div>
                                <div className="bg-[#0C0D18] border border-[#2A2D42] rounded-xl p-5">
                                    <div className="text-blue-700 font-bold text-sm mb-2">#3 Budget Pick</div>
                                    <h4 className="font-bold text-[#F6F4EF]">Austrian Philharmonic</h4>
                                    <p className="text-[#D0CCC4] text-sm mt-2">Lowest premiums among major government coins. Beautiful design. EU legal tender status.</p>
                                </div>
                            </div>
                        </section>
                        ...
                        <section id="bars" className="scroll-mt-32">
                            <h2 className="text-[#F6F4EF]">IRA Approved Silver Bars</h2>
                            <p>
                            ...
                            <div className="overflow-x-auto not-prose my-8">
                                <table className="w-full text-left border-collapse bg-[#0C0D18] backdrop-blur-sm rounded-xl shadow-sm border border-[#2A2D42]">
                                    <thead className="bg-[#0C0D18]">
                                        <tr>
                                            <th className="p-4 border-b border-[#2A2D42] font-bold text-[#F6F4EF]">Refiner/Mint</th>
                                    ...
                                    <tbody className="divide-y divide-[#2A2D42] text-sm text-[#D0CCC4]">
                                        {approvedBars.map((bar, index) => (
                                            <tr key={bar.refiner} className={index % 2 === 1 ? "bg-[#121423]" : ""}>
                                                <td className="p-4 font-semibold text-[#F6F4EF]">{bar.refiner}</td>
                        ...
                        <div className="my-12 bg-[#161828] rounded-2xl p-8 text-[#F6F4EF] text-center relative overflow-hidden not-prose border border-[#2A2D42]">
                            <div className="relative z-10">
                                <h3 className="text-2xl font-serif font-bold mb-4 text-[#F6F4EF]">Ready to Add Silver to Your IRA?</h3>
                                <p className="mb-6 text-[#D0CCC4]">Compare the best silver IRA companies and find the lowest premiums on approved products.</p>
                        ...
                        <section id="premiums" className="scroll-mt-32">
                            <h2 className="text-[#F6F4EF]">Silver IRA Premium Comparison</h2>
                            <p>
                                The &quot;premium&quot; is how much you pay above the spot price of silver. Lower premiums mean more silver for your money:
                            </p>

                            <div className="bg-[#0C0D18] border border-[#2A2D42] rounded-xl p-6 not-prose my-8">
                                <h4 className="font-bold text-[#F6F4EF] mb-4">Typical Premiums by Product Type</h4>
                                <div className="space-y-4">
                                    ...
                                    <div>
                                        <div className="flex justify-between text-sm mb-1">
                                            ...
                                            <span className="text-[#D4A94E] font-semibold">8-15%</span>
                                        </div>
                                        <div className="h-2 bg-[#121423] rounded-full">
                                            <div className="h-2 bg-[#DC2626] rounded-full" style={{ width: '45%' }}></div>
                                        </div>
                                    </div>
                                    <div>
                                        <div className="flex justify-between text-sm mb-1">
                                ...
                                <p className="text-xs text-[#D0CCC4] mt-4">* Premiums vary by market conditions and dealer. Data as of January 2026.</p>
                            </div>
                        </section>

                        {/* Section 5: Not Allowed */}
                        <section id="not-allowed" className="scroll-mt-32">
                            <h2 className="text-[#F6F4EF]">Silver NOT Allowed in IRAs</h2>
                            <p>
                        ...
                        <section id="best-value" className="scroll-mt-32">
                            <h2 className="text-[#F6F4EF]">Best Value IRA Silver: Our Recommendations</h2>
                            <p>
                            ...
                            <div className="bg-[#0C0D18] border border-[#B22234]/30 rounded-xl p-6 not-prose my-8">
                                ...
                                <div className="space-y-4">
                                    <div className="flex items-center justify-between p-3 bg-[#0C0D18] rounded-lg">
                                        <div>
                                            <span className="font-semibold text-[#F6F4EF]">10 oz Silver Bars</span>
                                            <span className="text-[#D0CCC4] text-sm ml-2">(Sunshine, RCM)</span>
                                        </div>
                                        <span className="text-[#D4A94E] font-bold">40-50%</span>
                                    </div>
                                    <div className="flex items-center justify-between p-3 bg-[#0C0D18] rounded-lg">
                                        <div>
                                            <span className="font-semibold text-[#F6F4EF]">Canadian Silver Maple Leafs</span>
                                        </div>
                                        <span className="text-[#D4A94E] font-bold">30-40%</span>
                                    </div>
                                    <div className="flex items-center justify-between p-3 bg-[#0C0D18] rounded-lg">
                                        <div>
                                            <span className="font-semibold text-[#F6F4EF]">American Silver Eagles</span>
                                        </div>
                                        <span className="text-[#D4A94E] font-bold">10-20%</span>
                                    </div>
                                </div>
                                <p className="text-sm text-[#D0CCC4] mt-4">This mix provides: lowest average premiums (bars), best value coins (Maples), and ultimate liquidity (Eagles).</p>
                            </div>
                        </section>
                        ...
                        {/* Related Content */}
                        <div className="bg-[#0C0D18] border border-[#2A2D42] rounded-xl p-6 not-prose my-12">
                            <h3 className="font-bold text-[#F6F4EF] mb-4">Related Silver IRA Guides</h3>
                            <div className="grid md:grid-cols-2 gap-4">
                                <Link href="/guide/silver-ira-guide" className="flex items-center gap-3 p-3 bg-[#0C0D18] rounded-lg hover:bg-[#1E2134] transition-colors">
                                    <Coins className="w-5 h-5 text-[#D4A94E]" />
                                    <span className="text-[#D0CCC4] hover:text-[#F6F4EF]">Complete Silver IRA Guide</span>
                                </Link>
                                <Link href="/silver-ira/rollover" className="flex items-center gap-3 p-3 bg-[#0C0D18] rounded-lg hover:bg-[#1E2134] transition-colors">
                                    <ArrowRight className="w-5 h-5 text-[#D4A94E]" />
                                    <span className="text-[#D0CCC4] hover:text-[#F6F4EF]">Silver IRA Rollover Guide</span>
                                </Link>
                                <Link href="/compare/gold-vs-silver-ira" className="flex items-center gap-3 p-3 bg-[#0C0D18] rounded-lg hover:bg-[#1E2134] transition-colors">
                                    <Scale className="w-5 h-5 text-[#D4A94E]" />
                                    <span className="text-[#D0CCC4] hover:text-[#F6F4EF]">Silver IRA vs Gold IRA</span>
                                </Link>
                                <Link href="/best-silver-ira-companies" className="flex items-center gap-3 p-3 bg-[#0C0D18] rounded-lg hover:bg-[#1E2134] transition-colors">
                                    <Shield className="w-5 h-5 text-[#D4A94E]" />
                                    <span className="text-[#D0CCC4] hover:text-[#F6F4EF]">Best Silver IRA Companies</span>
                                </Link>
                            </div>
                        </div>
