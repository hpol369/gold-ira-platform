...
export default function IraApprovedSilverPage() {
    return (
        <main className="min-h-screen bg-slate-900">
            ...
            {/* Header */}
            <header className="bg-gradient-to-br from-slate-800 to-slate-900 text-white py-20 relative overflow-hidden">
                <div className="absolute inset-0 bg-[radial-gradient(circle_at_30%_20%,rgba(203,213,225,0.1),transparent_50%)]" />
                <Container className="relative z-10">
                    <div className="max-w-3xl">
                        <div className="inline-flex items-center gap-2 rounded-full bg-white/10 px-4 py-1.5 text-sm font-semibold text-amber-400 mb-6 border border-white/10">
            ...
            <Container className="py-12">
                <div className="flex flex-col lg:flex-row gap-12">
                    ...
                    <article className="flex-1 prose prose-lg prose-headings:font-serif prose-headings:text-white prose-p:text-slate-400 prose-a:text-amber-400 max-w-none">
                        ...
                        {/* Key Point Box */}
                        <div className="bg-amber-500/10 border border-amber-500/30 rounded-xl p-6 not-prose mb-8">
                            <h3 className="font-bold text-amber-400 text-lg mb-3">The 99.9% Rule</h3>
                        ...
                        <section id="requirements" className="scroll-mt-32">
                            <h2 className="text-white">IRS Silver Purity Requirements</h2>
                            <p>
                        ...
                        <section id="coins" className="scroll-mt-32">
                            <h2 className="text-white">IRA Approved Silver Coins</h2>
                            <p>
                                ...
                                <table className="w-full text-left border-collapse bg-white/5 backdrop-blur-sm rounded-xl shadow-sm border border-white/10">
                                    <thead className="bg-slate-800/50">
                                        <tr>
                                            ...
                                            <th className="p-4 border-b border-white/10 font-bold text-white hidden md:table-cell">Notes</th>
                                        </tr>
                                    </thead>
                                    <tbody className="divide-y divide-white/10 text-sm text-slate-300">
                                        {approvedCoins.map((coin, index) => (
                                            <tr key={coin.name} className={index % 2 === 1 ? "bg-slate-800/30" : ""}>
                                                <td className="p-4">
                                                    <div className="flex items-center gap-2">
                                                        {coin.recommended && <span className="text-amber-400">★</span>}
                                                        <div>
                                                            <span className="font-semibold text-white">{coin.name}</span>
                                                            <div className="text-xs text-slate-500">{coin.country}</div>
                                                        </div>
                                                    </div>
                                                </td>
                            ...
                            <p className="text-sm text-slate-500">★ = Recommended picks for best value and liquidity</p>

                            <h3 className="text-white">Top 3 Silver Coins for IRAs</h3>
                            <div className="grid md:grid-cols-3 gap-4 not-prose my-6">
                                <div className="bg-white/5 border border-amber-500/30 rounded-xl p-5">
                                    <div className="text-amber-400 font-bold text-sm mb-2">#1 Best Overall</div>
                                    <h4 className="font-bold text-white">American Silver Eagle</h4>
                                    <p className="text-slate-400 text-sm mt-2">Maximum liquidity and recognition. The &quot;gold standard&quot; of silver coins (ironic, we know). Higher premiums but easiest to sell.</p>
                                </div>
                                <div className="bg-white/5 border border-white/10 rounded-xl p-5">
                                    <div className="text-green-400 font-bold text-sm mb-2">#2 Best Value</div>
                                    <h4 className="font-bold text-white">Canadian Maple Leaf</h4>
                                    <p className="text-slate-400 text-sm mt-2">Highest purity (99.99%), lower premiums than Eagles, excellent security features. Best bang for your buck.</p>
                                </div>
                                <div className="bg-white/5 border border-white/10 rounded-xl p-5">
                                    <div className="text-blue-400 font-bold text-sm mb-2">#3 Budget Pick</div>
                                    <h4 className="font-bold text-white">Austrian Philharmonic</h4>
                                    <p className="text-slate-400 text-sm mt-2">Lowest premiums among major government coins. Beautiful design. EU legal tender status.</p>
                                </div>
                            </div>
                        </section>
                        ...
                        <section id="bars" className="scroll-mt-32">
                            <h2 className="text-white">IRA Approved Silver Bars</h2>
                            <p>
                            ...
                            <div className="overflow-x-auto not-prose my-8">
                                <table className="w-full text-left border-collapse bg-white/5 backdrop-blur-sm rounded-xl shadow-sm border border-white/10">
                                    <thead className="bg-slate-800/50">
                                        <tr>
                                            <th className="p-4 border-b border-white/10 font-bold text-white">Refiner/Mint</th>
                                    ...
                                    <tbody className="divide-y divide-white/10 text-sm text-slate-300">
                                        {approvedBars.map((bar, index) => (
                                            <tr key={bar.refiner} className={index % 2 === 1 ? "bg-slate-800/30" : ""}>
                                                <td className="p-4 font-semibold text-white">{bar.refiner}</td>
                        ...
                        <div className="my-12 bg-gradient-to-br from-slate-800 to-slate-900 rounded-2xl p-8 text-white text-center relative overflow-hidden not-prose border border-white/10">
                            <div className="relative z-10">
                                <h3 className="text-2xl font-serif font-bold mb-4 text-white">Ready to Add Silver to Your IRA?</h3>
                                <p className="mb-6 text-slate-300">Compare the best silver IRA companies and find the lowest premiums on approved products.</p>
                        ...
                        <section id="premiums" className="scroll-mt-32">
                            <h2 className="text-white">Silver IRA Premium Comparison</h2>
                            <p>
                            ...
                            <div className="bg-white/5 border border-white/10 rounded-xl p-6 not-prose my-8">
                                <h4 className="font-bold text-white mb-4">Typical Premiums by Product Type</h4>
                                <div className="space-y-4">
                                    <div>
                                        <div className="flex justify-between text-sm mb-1">
                                            <span className="text-slate-300">100 oz Silver Bars</span>
                                    ...
                                    <div>
                                        <div className="flex justify-between text-sm mb-1">
                                            <span className="text-slate-300">10 oz Silver Bars</span>
                                    ...
                                    <div>
                                        <div className="flex justify-between text-sm mb-1">
                                            <span className="text-slate-300">Canadian Maple Leafs</span>
                                            <span className="text-amber-400 font-semibold">8-15%</span>
                                        </div>
                                        <div className="h-2 bg-slate-700 rounded-full">
                                    ...
                                    <div>
                                        <div className="flex justify-between text-sm mb-1">
                                            <span className="text-slate-300">American Silver Eagles</span>
                                ...
                                <p className="text-xs text-slate-500 mt-4">* Premiums vary by market conditions and dealer. Data as of January 2026.</p>
                            </div>
                        </section>

                        {/* Section 5: Not Allowed */}
                        <section id="not-allowed" className="scroll-mt-32">
                            <h2 className="text-white">Silver NOT Allowed in IRAs</h2>
                            <p>
                        ...
                        <section id="best-value" className="scroll-mt-32">
                            <h2 className="text-white">Best Value IRA Silver: Our Recommendations</h2>
                            <p>
                                For most investors, we recommend a mix of coins and bars to balance liquidity with value:
                            </p>

                            <div className="bg-white/5 border border-amber-500/30 rounded-xl p-6 not-prose my-8">
                                <h4 className="font-bold text-amber-400 mb-4">Recommended Silver IRA Portfolio</h4>
                                <div className="space-y-4">
                                    <div className="flex items-center justify-between p-3 bg-slate-800/50 rounded-lg">
                                        <div>
                                            <span className="font-semibold text-white">10 oz Silver Bars</span>
                                            <span className="text-slate-400 text-sm ml-2">(Sunshine, RCM)</span>
                                        </div>
                                        <span className="text-amber-400 font-bold">40-50%</span>
                                    </div>
                                    <div className="flex items-center justify-between p-3 bg-slate-800/50 rounded-lg">
                                        <div>
                                            <span className="font-semibold text-white">Canadian Silver Maple Leafs</span>
                                        </div>
                                        <span className="text-amber-400 font-bold">30-40%</span>
                                    </div>
                                    <div className="flex items-center justify-between p-3 bg-slate-800/50 rounded-lg">
                                        <div>
                                            <span className="font-semibold text-white">American Silver Eagles</span>
                                        </div>
                                        <span className="text-amber-400 font-bold">10-20%</span>
                                    </div>
                                </div>
                                <p className="text-sm text-slate-400 mt-4">This mix provides: lowest average premiums (bars), best value coins (Maples), and ultimate liquidity (Eagles).</p>
                            </div>
                        </section>
                        ...
                        {/* Related Content */}
                        <div className="bg-white/5 border border-white/10 rounded-xl p-6 not-prose my-12">
                            <h3 className="font-bold text-white mb-4">Related Silver IRA Guides</h3>
                            <div className="grid md:grid-cols-2 gap-4">
                                <Link href="/guide/silver-ira-guide" className="flex items-center gap-3 p-3 bg-slate-800/50 rounded-lg hover:bg-slate-700/50 transition-colors">
                                    <Coins className="w-5 h-5 text-amber-400" />
                                    <span className="text-slate-300 hover:text-white">Complete Silver IRA Guide</span>
                                </Link>
                                <Link href="/guide/silver-ira-rollover" className="flex items-center gap-3 p-3 bg-slate-800/50 rounded-lg hover:bg-slate-700/50 transition-colors">
                                ...
                                <Link href="/best-silver-ira-companies" className="flex items-center gap-3 p-3 bg-slate-800/50 rounded-lg hover:bg-slate-700/50 transition-colors">
                                    <Shield className="w-5 h-5 text-amber-400" />
                                    <span className="text-slate-300 hover:text-white">Best Silver IRA Companies</span>
                                </Link>
                            </div>
                        </div>
