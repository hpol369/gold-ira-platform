                ...
                <div className="flex flex-col lg:flex-row gap-12 max-w-6xl mx-auto">
                    ...
                    <article className="flex-1 prose prose-lg prose-headings:font-serif prose-headings:text-[#F6F4EF] prose-p:text-[#D0CCC4] max-w-none">
                        ...
                        <section id="preservation" className="scroll-mt-32">
                            <h2 className="text-[#F6F4EF]">The Ultimate Insurance Policy</h2>
                            <p>
                        ...
                        <section id="risks-for-seniors" className="scroll-mt-32">
                            <h2 className="text-[#F6F4EF]">Risks Specific to Seniors</h2>
                            <p>
                        ...
                        <div className="my-12 bg-primary rounded-2xl p-8 text-[#F6F4EF] text-center relative overflow-hidden not-prose">
                            ...
                            <div className="relative z-10">
                                <h3 className="text-2xl font-serif font-bold mb-4 text-[#F6F4EF]">Find a Senior-Friendly Company</h3>
                        ...
                        <section id="faq" className="scroll-mt-32">
                            <h2 className="text-[#F6F4EF]">Senior Gold FAQ</h2>
