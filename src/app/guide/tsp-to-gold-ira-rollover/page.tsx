                ...
                <div className="flex flex-col lg:flex-row gap-12">
                    ...
                    <article className="flex-1 prose prose-lg prose-headings:font-serif prose-headings:text-[#F6F4EF] prose-p:text-[#D0CCC4] prose-a:text-[#D4A94E] max-w-none">
                        ...
                        <p className="lead text-xl text-[#D0CCC4]">
                            The Thrift Savings Plan is one of the best retirement plans in America. Low fees. Solid fund options. Government matching. But there&apos;s one thing it <strong className="text-[#F6F4EF]">cannot do</strong>: hold physical gold.
                        </p>
                        ...
                        <section id="tsp-vs-gold" className="scroll-mt-32">
                            ...
                            <ul className="text-[#D0CCC4]">
                                <li><strong className="text-[#F6F4EF]">G Fund:</strong> Government bonds. &quot;Safe,&quot; but barely beats inflation—often loses purchasing power over time.</li>
                                <li><strong className="text-[#F6F4EF]">F Fund:</strong> Corporate bonds. Slightly better returns, more risk.</li>
                                <li><strong className="text-[#F6F4EF]">C Fund:</strong> S&P 500 stocks. Great when markets are up, brutal when they crash.</li>
                                <li><strong className="text-[#F6F4EF]">S Fund:</strong> Small-cap stocks. More volatile than C Fund.</li>
                                <li><strong className="text-[#F6F4EF]">I Fund:</strong> International stocks. Tied to foreign economies and currencies.</li>
                            </ul>
                            <p>
                                Notice what&apos;s missing? Anything <strong className="text-[#F6F4EF]">real</strong>. Every fund is paper—stocks, bonds, government IOUs. When the financial system hiccups, they all tend to move together.
                            </p>
                            <p>
                        ...
                        <section id="step-by-step" className="scroll-mt-32">
                            ...
                            <div className="not-prose my-8 space-y-4">
                                <div className="flex gap-4 p-5 rounded-xl bg-[#0C0D18] backdrop-blur-sm border border-[#2A2D42]">
                                    ...
                                    <div>
                                        <h4 className="font-bold text-[#F6F4EF]">Open a Self-Directed Gold IRA</h4>
                                        <p className="text-sm text-[#D0CCC4] mt-1">Choose a Gold IRA company and open your account. They&apos;ll set you up with a custodian (like Equity Trust or New Direction IRA) who can hold physical metals.</p>
                                    </div>
                                </div>
                                <div className="flex gap-4 p-5 rounded-xl bg-[#0C0D18] backdrop-blur-sm border border-[#2A2D42]">
                                    <div className="w-10 h-10 rounded-full bg-[#DC2626] text-[#F6F4EF] flex items-center justify-center font-bold shrink-0">2</div>
                                    <div>
                                        <h4 className="font-bold text-[#F6F4EF]">Get Your New IRA Account Details</h4>
                                        <p className="text-sm text-[#D0CCC4] mt-1">Your Gold IRA company will provide the custodian name, address, and account number needed for the transfer.</p>
                                    </div>
                                </div>
                                <div className="flex gap-4 p-5 rounded-xl bg-[#0C0D18] backdrop-blur-sm border border-[#2A2D42]">
                                    <div className="w-10 h-10 rounded-full bg-[#DC2626] text-[#F6F4EF] flex items-center justify-center font-bold shrink-0">3</div>
                                    <div>
                                        <h4 className="font-bold text-[#F6F4EF]">Log Into TSP.gov</h4>
                                        <p className="text-sm text-[#D0CCC4] mt-1">Go to tsp.gov and use the &quot;Withdrawals&quot; section. The online wizard walks you through the options.</p>
                                    </div>
                                </div>
                                <div className="flex gap-4 p-5 rounded-xl bg-[#0C0D18] backdrop-blur-sm border border-[#2A2D42]">
                                    <div className="w-10 h-10 rounded-full bg-[#DC2626] text-[#F6F4EF] flex items-center justify-center font-bold shrink-0">4</div>
                                    <div>
                                        <h4 className="font-bold text-[#F6F4EF]">Select &quot;Transfer to IRA&quot; (Direct Rollover)</h4>
                                        <p className="text-sm text-[#D0CCC4] mt-1"><strong className="text-[#F6F4EF]">Critical:</strong> Choose the option to transfer directly to another retirement account. Do NOT have them send you a check—that triggers 20% withholding.</p>
                                    </div>
                                </div>
                                <div className="flex gap-4 p-5 rounded-xl bg-[#0C0D18] backdrop-blur-sm border border-[#2A2D42]">
                                    <div className="w-10 h-10 rounded-full bg-[#DC2626] text-[#F6F4EF] flex items-center justify-center font-bold shrink-0">5</div>
                                    <div>
                                        <h4 className="font-bold text-[#F6F4EF]">Purchase Gold</h4>
                                        <p className="text-sm text-[#D0CCC4] mt-1">Once funds arrive at your new IRA (usually 1-2 weeks), work with your Gold IRA company to select and purchase IRS-approved coins and bars.</p>
                                    </div>
                                </div>
                            </div>
                        </section>
                        ...
                        <section id="forms" className="scroll-mt-32">
                            ...
                            <ul className="text-[#D0CCC4]">
                                <li><strong className="text-[#F6F4EF]">Form TSP-70:</strong> Full withdrawal request (for separated employees)</li>
                                <li><strong className="text-[#F6F4EF]">Form TSP-75:</strong> Age-based in-service withdrawal (for active employees 59½+)</li>
                                <li><strong className="text-[#F6F4EF]">Form TSP-99:</strong> Used to designate beneficiaries (not for withdrawals)</li>
                            </ul>
                            <p>
                                The online system will generate the appropriate form based on your selections. Just make sure you choose <strong className="text-[#F6F4EF]">&quot;Transfer to IRA or eligible employer plan&quot;</strong>—not a cash distribution.
                            </p>
                        ...
                        <section id="tax-rules" className="scroll-mt-32">
                            ...
                            <p>
                                Here&apos;s the good news: a properly executed TSP to Gold IRA rollover is <strong className="text-[#F6F4EF]">100% tax-free</strong>. No taxes. No penalties. The money simply moves from one retirement account to another.
                            </p>
                            <p>
                            ...
                            <div className="not-prose my-8 overflow-x-auto">
                                <table className="w-full text-left border-collapse bg-[#0C0D18] backdrop-blur-sm rounded-xl shadow-sm border border-[#2A2D42]">
                                    <thead className="bg-[#121423]">
                                        <tr>
                                            <th className="p-4 border-b border-[#2A2D42] font-bold text-[#F6F4EF]">From TSP</th>
                                            <th className="p-4 border-b border-[#2A2D42] font-bold text-[#F6F4EF]">To IRA</th>
                            ...
                            <p>
                                <strong className="text-[#F6F4EF]">Early Withdrawal Penalty:</strong> If you take a distribution (not a rollover) before age 59½, you&apos;ll owe a 10% early withdrawal penalty plus income taxes. That&apos;s why rolling over to another IRA—not cashing out—is so important.
                            </p>
                        </section>
                        ...
                        <div className="my-12 bg-gradient-to-br from-primary to-primary-dark rounded-2xl p-8 text-[#F6F4EF] relative overflow-hidden not-prose">
                            ...
                            <div className="relative z-10 text-center">
                                <h3 className="text-3xl font-serif font-bold mb-4 text-[#F6F4EF]">Protect Your Federal Retirement</h3>
