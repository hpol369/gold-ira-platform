        ...
        <main className="min-h-screen bg-[#0C0D18] pb-24">
            ...
            <Container className="py-12">
                <div className="flex flex-col lg:flex-row gap-12 max-w-6xl mx-auto">
                    ...
                    {/* Content */}
                    <article className="flex-1 prose prose-lg prose-headings:font-serif prose-headings:text-[#F6F4EF] prose-p:text-[#D0CCC4] max-w-none">
                        ...
                        <section id="typical-minimums" className="scroll-mt-32">
                            ...
                            <div className="grid md:grid-cols-3 gap-6 not-prose my-8">
                                <div className="p-6 rounded-xl bg-[#0C0D18] backdrop-blur-sm border border-[#2A2D42]">
                                    <h4 className="font-bold text-[#F6F4EF] mb-2">Entry Level</h4>
                                    <div className="text-3xl font-bold text-primary mb-2">$10k - $25k</div>
                                    <p className="text-sm text-[#D0CCC4]">Best for first-time investors or partial rollovers.</p>
                                </div>
                                <div className="p-6 rounded-xl bg-[#0C0D18] backdrop-blur-sm border border-primary/30">
                                    <h4 className="font-bold text-primary mb-2">Standard</h4>
                                    <div className="text-3xl font-bold text-primary mb-2">$50,000</div>
                                    <div className="inline-block px-2 py-1 bg-[#DC2626] text-[#F6F4EF] text-xs font-bold rounded">Most Popular</div>
                                    <p className="text-sm text-[#D0CCC4] mt-2">Access to better pricing and promotions (like waived fees).</p>
                                </div>
                                <div className="p-6 rounded-xl bg-[#0C0D18] backdrop-blur-sm border border-[#2A2D42]">
                                    <h4 className="font-bold text-[#F6F4EF] mb-2">Premium</h4>
                                    <div className="text-3xl font-bold text-primary mb-2">$100,000+</div>
                                    <p className="text-sm text-[#D0CCC4]">VIP service, lowest premiums, and dedicated account managers.</p>
                                </div>
                            </div>
                        </section>
                        ...
                        <section id="why-minimums-exist" className="scroll-mt-32">
                            <h2 className="text-[#F6F4EF]">Why Do Minimums Exist?</h2>
                            <p>
                        ...
                        <section id="company-comparison" className="scroll-mt-32">
                            <h2 className="text-[#F6F4EF]">How to Qualify</h2>
                            <p>
                        ...
                        <section id="alternatives" className="scroll-mt-32">
                            <h2 className="text-[#F6F4EF]">Alternatives for Investors Under $10k</h2>
                            <p>
                        ...
                        <div className="my-12 bg-primary rounded-2xl p-8 text-[#F6F4EF] text-center relative overflow-hidden not-prose">
                            ...
                            <div className="relative z-10">
                                <h3 className="text-2xl font-serif font-bold mb-4 text-[#F6F4EF]">Check Your Eligibility</h3>
                        ...
                        <section id="faq" className="scroll-mt-32">
                            <h2 className="text-[#F6F4EF]">Minimum Investment FAQs</h2>
