                    ...
                    <article className="flex-1 prose prose-lg prose-headings:font-serif prose-headings:text-[#F6F4EF] prose-p:text-[#D0CCC4] prose-a:text-[#D4A94E] max-w-none">
                        ...
                        <section id="overview" className="scroll-mt-32">
                            <p className="lead text-xl text-[#D0CCC4]">
                                If you&apos;ve changed jobs, you probably have a <strong className="text-[#F6F4EF]">401(k) from your old employer</strong> sitting somewhere. You&apos;re not alone—Americans have left behind over $1.35 trillion in forgotten 401(k)s.
                            </p>
                            <p>
                            ...
                            <p>
                                Here are your <strong className="text-[#F6F4EF]">5 options</strong> for an old 401(k):
                            </p>

                            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 not-prose my-8">
                                <div className="p-4 bg-[#0C0D18] backdrop-blur-sm rounded-xl border border-[#2A2D42] text-center">
                                    <div className="text-2xl font-bold text-[#F6F4EF] mb-1">1</div>
                                    <div className="text-sm font-medium text-[#D0CCC4]">Leave It</div>
                                </div>
                                <div className="p-4 bg-[#0C0D18] backdrop-blur-sm rounded-xl border border-[#2A2D42] text-center">
                                    <div className="text-2xl font-bold text-[#F6F4EF] mb-1">2</div>
                                    <div className="text-sm font-medium text-[#D0CCC4]">New Employer 401(k)</div>
                                </div>
                                <div className="p-4 bg-[#0C0D18] backdrop-blur-sm rounded-xl border border-[#2A2D42] text-center">
                                    <div className="text-2xl font-bold text-[#F6F4EF] mb-1">3</div>
                                    <div className="text-sm font-medium text-[#D0CCC4]">Traditional IRA</div>
                                </div>
                                <div className="p-4 bg-[#0C0D18] backdrop-blur-sm rounded-xl border border-[#2A2D42] text-center">
                                    <div className="text-2xl font-bold text-[#F6F4EF] mb-1">4</div>
                                    <div className="text-sm font-medium text-[#D0CCC4]">Cash Out</div>
                                </div>
                                <div className="p-4 bg-[rgba(220,38,38,0.1)] rounded-xl border border-secondary/20 text-center">
                                    <div className="text-2xl font-bold text-[#D4A94E] mb-1">5</div>
                                    <div className="text-sm font-medium text-[#D4A94E]">Gold IRA</div>
                                </div>
                            </div>
                        </section>
                        ...
                        <section id="leave-it" className="scroll-mt-32">
                            <div className="flex items-center gap-4 mb-4 not-prose">
                                <div className="p-3 bg-slate-700/50 rounded-lg text-[#D0CCC4]">
                                    <Building2 className="w-6 h-6" />
                                </div>
                                <h2 className="text-2xl md:text-3xl font-serif font-bold text-[#F6F4EF] m-0">Option 1: Leave It Where It Is</h2>
                            </div>
                            <p>
                        ...
                        <section id="rollover-ira" className="scroll-mt-32">
                            <div className="flex items-center gap-4 mb-4 not-prose">
                                ...
                                <h2 className="text-2xl md:text-3xl font-serif font-bold text-[#F6F4EF] m-0">Option 3: Roll to a Traditional IRA</h2>
                            </div>
                            <p>
                        ...
                        <section id="cash-out" className="scroll-mt-32">
                            ...
                            <div className="bg-red-500/10 border-2 border-red-500/20 rounded-xl p-6 not-prose my-6">
                                ...
                                <div className="space-y-2 text-sm">
                                    <div className="flex justify-between p-2 bg-[#121423] rounded">
                                        <span className="text-[#D0CCC4]">Federal income tax (24% bracket)</span>
                                        <span className="text-red-700 font-bold">-$12,000</span>
                                    </div>
                                    <div className="flex justify-between p-2 bg-[#121423] rounded">
                                        <span className="text-[#D0CCC4]">Early withdrawal penalty (10%)</span>
                        ...
                        <div className="my-12 bg-primary rounded-2xl p-8 text-[#F6F4EF] text-center relative overflow-hidden not-prose">
                            ...
                            <div className="relative z-10">
                                <h3 className="text-2xl font-serif font-bold mb-4 text-[#F6F4EF]">Considering a Gold IRA Rollover?</h3>
                        ...
                        <section id="gold-ira" className="scroll-mt-32">
                            ...
                            <p>
                                Most people don&apos;t know this option exists: You can roll your old 401(k) into a <strong className="text-[#F6F4EF]">Gold IRA</strong>—a self-directed IRA that holds physical gold, silver, platinum, and palladium instead of paper assets.
                            </p>
                            ...
                            <div className="overflow-x-auto not-prose my-8">
                                <table className="w-full text-left border-collapse bg-[#0C0D18] backdrop-blur-sm rounded-xl shadow-sm border border-[#2A2D42]">
                                    <thead className="bg-[#121423]">
                                        <tr>
                                            <th className="p-4 border-b border-[#2A2D42] font-bold text-[#F6F4EF]">Option</th>
                                            <th className="p-4 border-b border-[#2A2D42] font-bold text-[#F6F4EF]">Tax Impact</th>
                                            <th className="p-4 border-b border-[#2A2D42] font-bold text-[#F6F4EF]">Investment Options</th>
                                    ...
                                    <tbody className="divide-y divide-white/10 text-sm text-[#D0CCC4]">
                                        <tr>
                                            <td className="p-4 font-medium text-[#F6F4EF]">Leave It</td>
                                        ...
                                        <tr>
                                            <td className="p-4 font-medium text-[#F6F4EF]">New Employer 401(k)</td>
                                            <td className="p-4 text-green-700">None (direct rollover)</td>
                                            <td className="p-4">Limited to plan options</td>
                                            <td className="p-4">Consolidation, simplicity</td>
                                        </tr>
                                        <tr>
                                            <td className="p-4 font-medium text-[#F6F4EF]">Traditional IRA</td>
                                            <td className="p-4 text-green-700">None (direct rollover)</td>
                        ...
                        <section id="how-to" className="scroll-mt-32">
                            ...
                            <div className="space-y-4 not-prose my-8">
                                <div className="flex gap-4 p-5 rounded-xl bg-[#0C0D18] backdrop-blur-sm border border-[#2A2D42]">
                                    <div className="w-10 h-10 rounded-full bg-[#DC2626] text-[#F6F4EF] flex items-center justify-center font-bold flex-shrink-0">1</div>
                                    <div>
                                        <h4 className="font-bold text-[#F6F4EF]">Choose Your Destination</h4>
                                        <p className="text-sm text-[#D0CCC4] mt-1">Decide whether you want a traditional IRA, new employer 401(k), or Gold IRA. For Gold IRAs, <Link href="/quiz" className="text-[#D4A94E] hover:underline">take our quiz</Link> to find the best company.</p>
                                    </div>
                                </div>
                                <div className="flex gap-4 p-5 rounded-xl bg-[#0C0D18] backdrop-blur-sm border border-[#2A2D42]">
                                    <div className="w-10 h-10 rounded-full bg-[#DC2626] text-[#F6F4EF] flex items-center justify-center font-bold flex-shrink-0">2</div>
                                    <div>
                                        <h4 className="font-bold text-[#F6F4EF]">Open Your New Account</h4>
                                        <p className="text-sm text-[#D0CCC4] mt-1">Set up your new IRA or 401(k). For Gold IRAs, your chosen company will guide you through this process.</p>
                                    </div>
                                </div>
                                <div className="flex gap-4 p-5 rounded-xl bg-[#0C0D18] backdrop-blur-sm border border-[#2A2D42]">
                                    <div className="w-10 h-10 rounded-full bg-[#DC2626] text-[#F6F4EF] flex items-center justify-center font-bold flex-shrink-0">3</div>
                                    <div>
                                        <h4 className="font-bold text-[#F6F4EF]">Request a Direct Rollover</h4>
                                        <p className="text-sm text-[#D0CCC4] mt-1"><strong className="text-[#F6F4EF]">Critical:</strong> Request a &quot;direct&quot; or &quot;trustee-to-trustee&quot; transfer. This sends funds directly to your new account without you touching the money—avoiding taxes.</p>
                                    </div>
                                </div>
                                <div className="flex gap-4 p-5 rounded-xl bg-[#0C0D18] backdrop-blur-sm border border-[#2A2D42]">
                                    <div className="w-10 h-10 rounded-full bg-[#DC2626] text-[#F6F4EF] flex items-center justify-center font-bold flex-shrink-0">4</div>
                                    <div>
                                        <h4 className="font-bold text-[#F6F4EF]">Complete the Transfer</h4>
                                        <p className="text-sm text-[#D0CCC4] mt-1">Your new custodian will coordinate with your old plan. The process typically takes 2-4 weeks. For Gold IRAs, you&apos;ll then select your precious metals.</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="space-y-4 not-prose">
                                <details className="group bg-[#0C0D18] backdrop-blur-sm rounded-xl border border-[#2A2D42] p-6 [&_summary::-webkit-details-marker]:hidden">
                                    ...
                                    <p className="mt-4 leading-relaxed text-[#D0CCC4]">
                                        You have 5 main options: 1) Leave it with your old employer, 2) Roll it over to your new employer&apos;s 401(k), 3) Roll it over to a traditional IRA, 4) Cash it out (not recommended), or 5) Roll it over to a <Link href="/what-is-a-gold-ira" className="text-[#D4A94E] hover:underline">Gold IRA</Link> for precious metals diversification.
                                    </p>
                                </details>
                        ...
                        <div className="my-12 bg-gradient-to-br from-primary to-primary-dark rounded-2xl p-8 text-[#F6F4EF] relative overflow-hidden not-prose">
                            ...
                            <div className="relative z-10 text-center">
                                <h3 className="text-3xl font-serif font-bold mb-4 text-[#F6F4EF]">Ready to Put Your Old 401(k) to Work?</h3>
