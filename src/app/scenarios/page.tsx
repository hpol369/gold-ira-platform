        ...
        <Container className="relative z-10">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-serif font-bold text-[#F6F4EF] mb-6">
              ...
              <span className="text-[#D4A94E]"> to Lose It Now</span>
            </h1>
        ...
        <Container>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            <div>
              ...
              <div className="text-sm text-[#A8A39A]">Hyperinflations since 1900</div>
            </div>
            <div>
              <div className="text-3xl font-bold text-orange-600">$34T</div>
              <div className="text-sm text-[#A8A39A]">US National Debt</div>
            </div>
            <div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {scenarios.map((scenario) => (
              <Link
                ...
                className={cn(
                  "group bg-[#0C0D18] rounded-2xl border border-[#2A2D42] overflow-hidden transition-all hover:bg-[#1E2134] hover:shadow-lg",
              ...
              >
                <div className="p-6">
                  ...
                  {/* Title & Description */}
                  <h3 className="text-xl font-bold text-[#F6F4EF] mb-2 group-hover:text-[#D4A94E] transition-colors">
                    {scenario.title}
                  </h3>
                  ...
                  {/* Stats Preview */}
                  <div className="mt-4 pt-4 border-t border-[#2A2D42] grid grid-cols-2 gap-2">
                    {scenario.stats.slice(0, 2).map((stat, i) => (
                      <div key={i} className="text-center">
                        <div className="text-lg font-bold text-[#D4A94E]">{stat.value}</div>
                ...
                {/* Footer */}
                <div className="px-6 py-3 bg-[#121423] border-t border-[#2A2D42] flex items-center justify-between">
                  <span className="text-sm text-[#A8A39A]">Read full guide</span>
      ...
      <section className="py-16 bg-gradient-to-r from-amber-50 via-amber-100/50 to-amber-50 border-y border-amber-200">
        <Container>
          <div className="max-w-3xl mx-auto text-center">
            <Shield className="h-12 w-12 text-[#D4A94E] mx-auto mb-6" />
            <h2 className="text-3xl font-serif font-bold text-[#F6F4EF] mb-4">
            ...
            <div className="flex flex-wrap gap-4 justify-center">
              ...
              <Button variant="outline" size="xl" asChild className="border-[#3F4460] text-[#D0CCC4] hover:bg-[#1E2134]">
      ...
      <section className="py-16 bg-white">
        <Container>
          <div className="max-w-3xl mx-auto text-center">
            ...
            <cite className="text-[#D4A94E] font-semibold">— Robert Kiyosaki, Rich Dad Poor Dad</cite>
          </div>
        </Container>
      </section>
