      ...
      <main className="min-h-screen bg-[#0C0D18] pb-24">
          ...
          <Container className="relative z-10">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-serif font-bold leading-tight mb-6 text-[#F6F4EF]">
                What&rsquo;s Your{" "}
                <span className="text-[#D4A94E]">Retirement Risk Score</span>?
              </h1>
              <p className="text-lg md:text-xl text-[#D0CCC4] leading-relaxed max-w-2xl mx-auto">
        ...
        <Container className="py-12">
          <div className="max-w-3xl mx-auto">
            ...
            {/* How the quiz works */}
            <article className="prose prose-lg prose-headings:font-serif prose-headings:text-[#F6F4EF] prose-p:text-[#D0CCC4] prose-a:text-[#D4A94E] max-w-none mt-16">
