        ...
        <section className="py-12 md:py-16">
          <Container>
            <div className="max-w-4xl mx-auto">
              <h2
                id="key-statistics"
                className="text-2xl md:text-3xl font-serif font-bold text-[#000080] mb-8 text-center"
              >
                Key Statistics at a Glance
              </h2>
          ...
          <Container>
            <div className="max-w-3xl mx-auto">
              ...
              <div className="bg-white border border-slate-200 rounded-xl overflow-hidden">
                  ...
                  <table className="w-full text-sm md:text-base">
                    <thead>
                      <tr className="bg-slate-100 text-left">
                        ...
                        <th className="px-4 py-3 font-semibold text-slate-700">Year-End Price</th>
                    ...
                    <tbody>
                      {annualReturns.map((row) => (
                        ...
                        >
                          ...
                          <td className="px-4 py-3 text-slate-700">{row.yearEndPrice}</td>
                ...
                <p className="px-4 py-3 text-xs text-slate-400 border-t border-slate-200 bg-slate-50">
              ...
              {/* Decade comparison */}
              <h3 className="text-xl font-serif font-bold text-[#000080] mt-10 mb-4">
                  ...
                  <table className="w-full text-sm md:text-base">
                    <thead>
                      <tr className="bg-slate-100 text-left">
                        ...
                        <th className="px-4 py-3 font-semibold text-slate-500">Bonds</th>
                      </tr>
                    </thead>
                    <tbody>
                      {decadeComparisons.map((row) => (
                        <tr
                          ...
                          className="border-t border-slate-200 even:bg-slate-50"
                        >
                          <td className="px-4 py-3 font-medium text-slate-800">{row.decade}</td>
                          <td className="px-4 py-3 font-semibold text-amber-700">{row.gold}</td>
                          <td className="px-4 py-3 text-blue-700">{row.sp500}</td>
                          <td className="px-4 py-3 text-slate-500">{row.bonds}</td>
                        </tr>
                      ))}
                    </tbody>
                  </table>
              ...
              <div className="bg-slate-50 border border-slate-200 rounded-xl overflow-hidden">
                <div className="overflow-x-auto">
                  <table className="w-full text-sm md:text-base">
                    <thead>
                      <tr className="bg-slate-100 text-left">
                        <th className="px-4 py-3 font-semibold text-slate-700">Country / Bank</th>
                        <th className="px-4 py-3 font-semibold text-slate-700">2023 (tonnes)</th>
                        <th className="px-4 py-3 font-semibold text-amber-700">2024 (tonnes)</th>
                        <th className="px-4 py-3 font-semibold text-slate-700">Total Reserves</th>
                      </tr>
                    </thead>
                    <tbody>
                      {centralBankBuyers.map((row) => (
                        ...
                        >
                          <td className="px-4 py-3 text-slate-800">{row.country}</td>
                          <td className="px-4 py-3 text-slate-700">{row.tonnes2023}</td>
                          <td className="px-4 py-3 text-amber-700 font-semibold">{row.tonnes2024}</td>
                          <td className="px-4 py-3 text-slate-600">{row.totalReserves} t</td>
                        </tr>
                      ))}
                    </tbody>
                  </table>
                    ...
                    <tbody>
                      {industryStats.map((row) => (
                        ...
                        >
                          ...
                          <td className="px-4 py-3 text-slate-500 text-sm">{row.source}</td>
                        </tr>
                      ))}
                    </tbody>
                  </table>
            ...
            <div className="max-w-3xl mx-auto">
              ...
              <div className="bg-slate-50 border border-slate-200 rounded-xl overflow-hidden">
                <div className="overflow-x-auto">
                  <table className="w-full text-sm md:text-base">
                    <thead>
                      <tr className="bg-slate-100 text-left">
                        <th className="px-4 py-3 font-semibold text-slate-700">Crisis</th>
                        <th className="px-4 py-3 font-semibold text-slate-700">Period</th>
                        <th className="px-4 py-3 font-semibold text-amber-700">Gold</th>
                        <th className="px-4 py-3 font-semibold text-blue-700">S&amp;P 500</th>
                      </tr>
                    ...
                    <tbody>
                      {crisisPerformance.map((row) => (
                        <tr
                          ...
                          className="border-t border-slate-200 even:bg-slate-50"
                        >
                          <td className="px-4 py-3 font-medium text-slate-800">{row.crisis}</td>
                          <td className="px-4 py-3 text-slate-600 text-sm">{row.period}</td>
              ...
              <div className="mt-6 bg-amber-50 border border-amber-200 rounded-xl p-5">
                <p className="text-slate-700 leading-relaxed">
                  <strong className="text-[#000080]">Key takeaway:</strong> Gold
                  ...
                  <table className="w-full text-sm md:text-base">
                    <thead>
                      <tr className="bg-slate-100 text-left">
                        ...
                        <th className="px-4 py-3 font-semibold text-slate-500">Range</th>
                    ...
                    <tbody>
                      {iraFees.map((row) => (
                        <tr
                          ...
                          className="border-t border-slate-200 even:bg-slate-50"
                        >
                          <td className="px-4 py-3 font-medium text-slate-800">{row.feeType}</td>
                          <td className="px-4 py-3 font-semibold text-amber-700">{row.typical}</td>
                          <td className="px-4 py-3 text-slate-600">{row.range}</td>
                          <td className="px-4 py-3 text-slate-500 text-sm">{row.notes}</td>
                        </tr>
                      ))}
                    </tbody>
                  </table>
