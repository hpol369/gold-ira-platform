                ...
                <div className="grid lg:grid-cols-3 gap-12">
                    ...
                    <div className="lg:col-span-2 space-y-12">
                        ...
                        <section className="bg-[#0C0D18] backdrop-blur-sm border border-[#2A2D42] rounded-xl p-8">
                            ...
                            <div className="prose prose-lg prose-invert max-w-none">
                                <p className="text-[#D0CCC4]">
                                    Rick Rule is one of the most respected names in natural resource investing. With over <strong className="text-[#F6F4EF]">50 years of experience</strong>, he has been instrumental in financing hundreds of mining companies and has generated returns that have made him a legend in the industry.
                                </p>
                                <p className="text-[#D0CCC4]">
                                ...
                                <div className="bg-[#0C0D18] rounded-lg p-6 my-6 not-prose">
                                    <h4 className="font-bold text-[#F6F4EF] mb-4">Rick Rule Quick Facts</h4>
                        ...
                        <section className="bg-[#0C0D18] backdrop-blur-sm border border-[#2A2D42] rounded-xl p-8">
                            ...
                            <div className="prose prose-lg prose-invert max-w-none">
                                <p className="text-[#D0CCC4]">
                                    Rule approaches silver differently than most precious metals investors. While he appreciates physical silver, his investment focus is on <strong className="text-[#F6F4EF]">silver mining stocks</strong> - where he believes the real leverage lies.
                                </p>

                                <h3 className="text-xl font-bold text-[#F6F4EF] mt-8 mb-4">Leverage Through Mining Stocks</h3>
                                <p className="text-[#D0CCC4]">
                                ...
                                <blockquote className="border-l-4 border-green-400 pl-4 my-6 text-[#D0CCC4] italic">
                                ...
                                <h3 className="text-xl font-bold text-[#F6F4EF] mt-8 mb-4">Supply Deficit Thesis</h3>
                                <p className="text-[#D0CCC4]">
                                    Rule points to the chronic underinvestment in silver mining during the 2013-2020 bear market. New deposits were not developed, existing mines were not expanded, and exploration was cut to the bone. This creates a <strong className="text-[#F6F4EF]">structural supply deficit</strong> that cannot be quickly fixed when demand rises.
                                </p>

                                <h3 className="text-xl font-bold text-[#F6F4EF] mt-8 mb-4">Industrial Demand Tailwind</h3>
                                <p className="text-[#D0CCC4]">
                        ...
                        <section className="bg-[#0C0D18] backdrop-blur-sm border border-[#2A2D42] rounded-xl p-8">
                            ...
                            <div className="prose prose-lg prose-invert max-w-none">
                                ...
                                <ul className="text-[#D0CCC4] space-y-3">
                                    <li><strong className="text-[#F6F4EF]">Start with Physical:</strong> Hold physical gold and silver as insurance. This is your foundation, not your speculation.</li>
                                    <li><strong className="text-[#F6F4EF]">Add Mining Stocks:</strong> For those willing to accept higher risk, quality mining stocks offer leverage to rising metal prices.</li>
                                    <li><strong className="text-[#F6F4EF]">Focus on Quality:</strong> Own the best companies, not the cheapest. Cheap stocks can get much cheaper.</li>
                                    <li><strong className="text-[#F6F4EF]">Be Patient:</strong> Resource cycles can last years. Position yourself and wait for the market to recognize value.</li>
                                    <li><strong className="text-[#F6F4EF]">Diversify Within the Sector:</strong> Spread risk across multiple companies and sub-sectors within precious metals.</li>
                                </ul>
                        ...
                        <section className="bg-[#0C0D18] backdrop-blur-sm border border-[#2A2D42] rounded-xl p-8">
                            ...
                            <div className="space-y-6">
                                <div className="border-b border-[#2A2D42] pb-6">
                                    ...
                                    <p className="text-[#D0CCC4]">Rick Rule is a legendary resource investor with over 50 years of experience. He was formerly the President of Sprott U.S. Holdings and has been instrumental in financing hundreds of mining companies throughout his career.</p>
                                </div>
                                <div className="border-b border-[#2A2D42] pb-6">
                                    <h3 className="text-lg font-bold text-green-700 mb-2">What is Rick Rule&apos;s silver thesis?</h3>
                                    <p className="text-[#D0CCC4]">Rule believes silver offers compelling value, particularly through mining stocks which provide leveraged exposure to rising metal prices. He sees silver&apos;s industrial demand as a key differentiator from gold.</p>
                                </div>
                                <div className="border-b border-[#2A2D42] pb-6">
                                    <h3 className="text-lg font-bold text-green-700 mb-2">How does Rick Rule invest in silver?</h3>
                                    <p className="text-[#D0CCC4]">Rule primarily invests in silver through mining stocks rather than physical metal, as he believes quality mining companies can generate 3-5x returns on metal price increases. He focuses on companies with strong balance sheets and quality management.</p>
                                </div>
                                <div>
                                    <h3 className="text-lg font-bold text-green-700 mb-2">What is Rick Rule&apos;s investment approach?</h3>
                                    <p className="text-[#D0CCC4]">Rule is a contrarian value investor who buys when sectors are out of favor and sells when they become popular. He emphasizes fundamental analysis, management quality, and buying at discounts to intrinsic value.</p>
                                </div>
                            </div>
                        </section>
                    </div>
