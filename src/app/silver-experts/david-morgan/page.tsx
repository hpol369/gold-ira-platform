                    ...
                    <div className="lg:col-span-2 space-y-12">
                        ...
                        <section className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-8">
                            ...
                            <div className="prose prose-lg prose-invert max-w-none">
                                ...
                                <p className="text-slate-300">
                                    Unlike some silver analysts who focus primarily on short-term price movements, Morgan emphasizes <strong className="text-white">fundamental analysis</strong> - studying supply and demand dynamics, monetary policy, and the role of silver in the global financial system.
                                </p>

                                <div className="bg-slate-800/50 rounded-lg p-6 my-6 not-prose">
                                    <h4 className="font-bold text-white mb-4">David Morgan Quick Facts</h4>
                        ...
                        <section className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-8">
                            <div className="flex items-center gap-3 mb-6">
                                ...
                                <h2 className="text-2xl font-bold font-serif text-white">David Morgan&apos;s Analysis Methodology</h2>
                            </div>
                            <div className="prose prose-lg prose-invert max-w-none">
                                <p className="text-slate-300">
                                ...
                                <h3 className="text-xl font-bold text-white mt-8 mb-4">Supply and Demand Analysis</h3>
                                <p className="text-slate-300">
                                    Morgan closely tracks silver supply from mining and recycling against demand from industrial uses, investment, and jewelry. He notes that silver is unique among precious metals because <strong className="text-white">roughly 50% of annual production is consumed by industry</strong>, unlike gold which is primarily hoarded.
                                </p>

                                <h3 className="text-xl font-bold text-white mt-8 mb-4">The Monetary Case</h3>
                                <p className="text-slate-300">
                                ...
                                <blockquote className="border-l-4 border-blue-400 pl-4 my-6 text-slate-400 italic">
                                ...
                                <h3 className="text-xl font-bold text-white mt-8 mb-4">Gold-to-Silver Ratio</h3>
                                <p className="text-slate-300">
                                ...
                                <h3 className="text-xl font-bold text-white mt-8 mb-4">Technical Analysis</h3>
                                <p className="text-slate-300">
                        ...
                        <section className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-8">
                            <div className="flex items-center gap-3 mb-6">
                                ...
                                <h2 className="text-2xl font-bold font-serif text-white">Books & Resources</h2>
                            </div>
                            <div className="space-y-6">
                                ...
                                <div className="bg-slate-800/50 rounded-lg p-6">
                                    <h3 className="text-xl font-bold text-white mb-2">The Morgan Report</h3>
                                    <p className="text-slate-300">Monthly newsletter providing silver market analysis, mining stock recommendations, and economic commentary. Subscribers receive detailed research reports and model portfolio updates.</p>
                                </div>
                            </div>
                        </section>
                            ...
                            <div className="prose prose-lg prose-invert max-w-none">
                                ...
                                <div className="grid md:grid-cols-2 gap-4 not-prose">
                                    <div className="bg-slate-800/50 rounded-lg p-4">
                                        <h4 className="font-bold text-white mb-2">USA Watchdog</h4>
                                        <p className="text-slate-400 text-sm">In-depth discussions on monetary policy and precious metals markets.</p>
                                    </div>
                                    <div className="bg-slate-800/50 rounded-lg p-4">
                                        <h4 className="font-bold text-white mb-2">Cambridge House</h4>
                                        <p className="text-slate-400 text-sm">Conference presentations on silver market fundamentals.</p>
                                    </div>
                                    <div className="bg-slate-800/50 rounded-lg p-4">
                                        <h4 className="font-bold text-white mb-2">Mining Stock Education</h4>
                                        <p className="text-slate-400 text-sm">Educational content on precious metals investing.</p>
                                    </div>
                                    <div className="bg-slate-800/50 rounded-lg p-4">
                                        <h4 className="font-bold text-white mb-2">Silver Doctors</h4>
                                        <p className="text-slate-400 text-sm">Market updates and silver analysis.</p>
                                    </div>
                                </div>
                            </div>
                        </section>
                        ...
                        <section className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-8">
                            <div className="flex items-center gap-3 mb-6">
                                ...
                                <h2 className="text-2xl font-bold font-serif text-white">David Morgan&apos;s Investment Philosophy</h2>
                            </div>
                            <div className="prose prose-lg prose-invert max-w-none">
                                <p className="text-slate-300">
                                ...
                                <ul className="text-slate-300 space-y-3">
                                    <li><strong className="text-white">Physical Metal First:</strong> Own physical silver as the foundation of your precious metals holdings. This is your insurance, not your speculation.</li>
                                    <li><strong className="text-white">Mining Stocks for Leverage:</strong> Carefully selected mining stocks can provide leverage to rising metal prices, but they also carry company-specific risks.</li>
                                    <li><strong className="text-white">Long-Term Perspective:</strong> Precious metals markets move in long cycles. Patience is essential for success.</li>
                                    <li><strong className="text-white">Education First:</strong> Understand what you own and why you own it. Emotional investing leads to poor decisions.</li>
                                    <li><strong className="text-white">Diversification Within Metals:</strong> Own both gold and silver, along with a mix of physical metal and mining equities.</li>
                                </ul>
                        ...
                        <section className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-8">
                            ...
                            <div className="space-y-6">
                                <div className="border-b border-white/10 pb-6">
                                    ...
                                    <p className="text-slate-300">David Morgan is a precious metals analyst known as &quot;The Silver Guru.&quot; He publishes The Morgan Report, a newsletter focused on precious metals and mining stocks, and authored &quot;The Silver Manifesto&quot; with Chris Marchese.</p>
                                </div>
                                <div className="border-b border-white/10 pb-6">
                                    <h3 className="text-lg font-bold text-blue-400 mb-2">What is The Morgan Report?</h3>
                                    <p className="text-slate-300">The Morgan Report is a subscription-based newsletter published by David Morgan that provides analysis on silver, gold, and mining stocks. It includes investment recommendations, market analysis, and economic commentary.</p>
                                </div>
                                <div className="border-b border-white/10 pb-6">
                                    <h3 className="text-lg font-bold text-blue-400 mb-2">What does David Morgan predict for silver prices?</h3>
                                    <p className="text-slate-300">David Morgan has consistently predicted that silver will significantly outperform gold during precious metals bull markets. He believes the gold-to-silver ratio will contract dramatically, potentially to 20:1 or lower.</p>
                                </div>
                                <div>
                                    <h3 className="text-lg font-bold text-blue-400 mb-2">What is David Morgan&apos;s investment philosophy?</h3>
                                    <p className="text-slate-300">Morgan advocates for owning physical silver as the foundation of a precious metals portfolio, supplemented by carefully selected mining stocks for leverage. He emphasizes patience and long-term thinking.</p>
                                </div>
                            </div>
                        </section>
                    </div>
                    ...
                    <aside className="lg:col-span-1 space-y-8">
                        ...
                        <div className="bg-white/5 backdrop-blur border border-white/10 rounded-xl p-6">
                            ...
                            <ul className="space-y-3 text-sm">
                                ...
                                <li>
                                    <Link href="/silver-squeeze/silver-to-gold-ratio-calculator" className="text-slate-400 hover:text-white">
                                        Gold-to-Silver Ratio Calculator
                                    </Link>
                                </li>
                                <li>
                                    <Link href="/silver-squeeze/silver-undervalued" className="text-slate-400 hover:text-white">
