            ...
            <header className="bg-[#0C0D18] text-[#F6F4EF] py-20 relative overflow-hidden border-b border-[#2A2D42]">
                ...
                <Container className="relative z-10">
                    <div className="max-w-4xl">
                        ...
                        <div className="inline-flex items-center gap-2 rounded-full bg-[#121423]0/20 px-4 py-1.5 text-sm font-semibold text-blue-700 mb-6 border border-blue-500/30 ml-4">
                    ...
                    <div className="lg:col-span-2 space-y-12">
                        ...
                        <section className="bg-[#0C0D18] backdrop-blur-sm border border-[#2A2D42] rounded-xl p-8">
                            ...
                            <div className="prose prose-lg prose-invert max-w-none">
                                ...
                                <p className="text-[#D0CCC4]">
                                    Unlike some silver analysts who focus primarily on short-term price movements, Morgan emphasizes <strong className="text-[#F6F4EF]">fundamental analysis</strong> - studying supply and demand dynamics, monetary policy, and the role of silver in the global financial system.
                                </p>

                                <div className="bg-[#0C0D18] rounded-lg p-6 my-6 not-prose">
                                    <h4 className="font-bold text-[#F6F4EF] mb-4">David Morgan Quick Facts</h4>
                        ...
                        <section className="bg-[#0C0D18] backdrop-blur-sm border border-[#2A2D42] rounded-xl p-8">
                            <div className="flex items-center gap-3 mb-6">
                                ...
                                <h2 className="text-2xl font-bold font-serif text-[#F6F4EF]">David Morgan&apos;s Analysis Methodology</h2>
                            </div>
                            <div className="prose prose-lg prose-invert max-w-none">
                                <p className="text-[#D0CCC4]">
                                ...
                                <h3 className="text-xl font-bold text-[#F6F4EF] mt-8 mb-4">Supply and Demand Analysis</h3>
                                <p className="text-[#D0CCC4]">
                                    Morgan closely tracks silver supply from mining and recycling against demand from industrial uses, investment, and jewelry. He notes that silver is unique among precious metals because <strong className="text-[#F6F4EF]">roughly 50% of annual production is consumed by industry</strong>, unlike gold which is primarily hoarded.
                                </p>

                                <h3 className="text-xl font-bold text-[#F6F4EF] mt-8 mb-4">The Monetary Case</h3>
                                <p className="text-[#D0CCC4]">
                                ...
                                <blockquote className="border-l-4 border-blue-400 pl-4 my-6 text-[#D0CCC4] italic">
                                ...
                                <h3 className="text-xl font-bold text-[#F6F4EF] mt-8 mb-4">Gold-to-Silver Ratio</h3>
                                <p className="text-[#D0CCC4]">
                                ...
                                <h3 className="text-xl font-bold text-[#F6F4EF] mt-8 mb-4">Technical Analysis</h3>
                                <p className="text-[#D0CCC4]">
                        ...
                        <section className="bg-[#0C0D18] backdrop-blur-sm border border-[#2A2D42] rounded-xl p-8">
                            <div className="flex items-center gap-3 mb-6">
                                ...
                                <h2 className="text-2xl font-bold font-serif text-[#F6F4EF]">Books & Resources</h2>
                            </div>
                            <div className="space-y-6">
                                {books.map((book, index) => (
                                    <div key={index} className="bg-[#0C0D18] rounded-lg p-6">
                                        <h3 className="text-xl font-bold text-[#F6F4EF] mb-2">{book.title}</h3>
                                        {book.coAuthor && (
                                            <p className="text-blue-700 text-sm mb-3">Co-authored with {book.coAuthor}</p>
                                        )}
                                        <p className="text-[#D0CCC4]">{book.description}</p>
                                    </div>
                                ))}
                                <div className="bg-[#0C0D18] rounded-lg p-6">
                                    <h3 className="text-xl font-bold text-[#F6F4EF] mb-2">The Morgan Report</h3>
                                    <p className="text-[#D0CCC4]">Monthly newsletter providing silver market analysis, mining stock recommendations, and economic commentary. Subscribers receive detailed research reports and model portfolio updates.</p>
                                </div>
                            </div>
                        </section>
                            ...
                            <div className="prose prose-lg prose-invert max-w-none">
                                ...
                                <div className="grid md:grid-cols-2 gap-4 not-prose">
                                    <div className="bg-[#0C0D18] rounded-lg p-4">
                                        <h4 className="font-bold text-[#F6F4EF] mb-2">USA Watchdog</h4>
                                        <p className="text-[#D0CCC4] text-sm">In-depth discussions on monetary policy and precious metals markets.</p>
                                    </div>
                                    <div className="bg-[#0C0D18] rounded-lg p-4">
                                        <h4 className="font-bold text-[#F6F4EF] mb-2">Cambridge House</h4>
                                        <p className="text-[#D0CCC4] text-sm">Conference presentations on silver market fundamentals.</p>
                                    </div>
                                    <div className="bg-[#0C0D18] rounded-lg p-4">
                                        <h4 className="font-bold text-[#F6F4EF] mb-2">Mining Stock Education</h4>
                                        <p className="text-[#D0CCC4] text-sm">Educational content on precious metals investing.</p>
                                    </div>
                                    <div className="bg-[#0C0D18] rounded-lg p-4">
                                        <h4 className="font-bold text-[#F6F4EF] mb-2">Silver Doctors</h4>
                                        <p className="text-[#D0CCC4] text-sm">Market updates and silver analysis.</p>
                                    </div>
                                </div>
                            </div>
                        </section>
                        ...
                        <section className="bg-[#0C0D18] backdrop-blur-sm border border-[#2A2D42] rounded-xl p-8">
                            <div className="flex items-center gap-3 mb-6">
                                ...
                                <h2 className="text-2xl font-bold font-serif text-[#F6F4EF]">David Morgan&apos;s Investment Philosophy</h2>
                            </div>
                            <div className="prose prose-lg prose-invert max-w-none">
                                <p className="text-[#D0CCC4]">
                                ...
                                <ul className="text-[#D0CCC4] space-y-3">
                                    <li><strong className="text-[#F6F4EF]">Physical Metal First:</strong> Own physical silver as the foundation of your precious metals holdings. This is your insurance, not your speculation.</li>
                                    <li><strong className="text-[#F6F4EF]">Mining Stocks for Leverage:</strong> Carefully selected mining stocks can provide leverage to rising metal prices, but they also carry company-specific risks.</li>
                                    <li><strong className="text-[#F6F4EF]">Long-Term Perspective:</strong> Precious metals markets move in long cycles. Patience is essential for success.</li>
                                    <li><strong className="text-[#F6F4EF]">Education First:</strong> Understand what you own and why you own it. Emotional investing leads to poor decisions.</li>
                                    <li><strong className="text-[#F6F4EF]">Diversification Within Metals:</strong> Own both gold and silver, along with a mix of physical metal and mining equities.</li>
                                </ul>
                        ...
                        <section className="bg-[#0C0D18] backdrop-blur-sm border border-[#2A2D42] rounded-xl p-8">
                            ...
                            <div className="space-y-6">
                                <div className="border-b border-[#2A2D42] pb-6">
                                    ...
                                    <p className="text-[#D0CCC4]">David Morgan is a precious metals analyst known as &quot;The Silver Guru.&quot; He publishes The Morgan Report, a newsletter focused on precious metals and mining stocks, and authored &quot;The Silver Manifesto&quot; with Chris Marchese.</p>
                                </div>
                                <div className="border-b border-[#2A2D42] pb-6">
                                    <h3 className="text-lg font-bold text-blue-700 mb-2">What is The Morgan Report?</h3>
                                    <p className="text-[#D0CCC4]">The Morgan Report is a subscription-based newsletter published by David Morgan that provides analysis on silver, gold, and mining stocks. It includes investment recommendations, market analysis, and economic commentary.</p>
                                </div>
                                <div className="border-b border-[#2A2D42] pb-6">
                                    <h3 className="text-lg font-bold text-blue-700 mb-2">What does David Morgan predict for silver prices?</h3>
                                    <p className="text-[#D0CCC4]">David Morgan has consistently predicted that silver will significantly outperform gold during precious metals bull markets. He believes the gold-to-silver ratio will contract dramatically, potentially to 20:1 or lower.</p>
                                </div>
                                <div>
                                    <h3 className="text-lg font-bold text-blue-700 mb-2">What is David Morgan&apos;s investment philosophy?</h3>
                                    <p className="text-[#D0CCC4]">Morgan advocates for owning physical silver as the foundation of a precious metals portfolio, supplemented by carefully selected mining stocks for leverage. He emphasizes patience and long-term thinking.</p>
                                </div>
                            </div>
                        </section>
                    </div>
                    ...
                    <aside className="lg:col-span-1 space-y-8">
                        ...
                        <div className="bg-[#0C0D18] backdrop-blur border border-[#2A2D42] rounded-xl p-6">
                            ...
                            <ul className="space-y-3 text-sm">
                                ...
                                <li>
                                    <Link href="/silver-squeeze/silver-to-gold-ratio-calculator" className="text-[#D0CCC4] hover:text-[#F6F4EF]">
                                        Gold-to-Silver Ratio Calculator
                                    </Link>
                                </li>
                                <li>
                                    <Link href="/silver-squeeze/silver-undervalued" className="text-[#D0CCC4] hover:text-[#F6F4EF]">
