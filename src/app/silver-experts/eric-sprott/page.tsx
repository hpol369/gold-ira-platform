            ...
            <header className="bg-[#0C0D18] text-[#F6F4EF] py-20 relative overflow-hidden border-b border-[#2A2D42]">
                ...
                <Container className="relative z-10">
                    <div className="max-w-4xl">
                        ...
                        <div className="inline-flex items-center gap-2 rounded-full bg-[rgba(220,38,38,0.1)] px-4 py-1.5 text-sm font-semibold text-[#D0CCC4] mb-6 border border-[#3F4460] ml-4">
                        ...
                        <p className="text-xl text-[#D0CCC4] font-semibold mb-4">
            ...
            <Container className="py-16">
                <div className="grid lg:grid-cols-3 gap-12">
                    ...
                    <div className="lg:col-span-2 space-y-12">
                        ...
                        <section className="bg-[#0C0D18] backdrop-blur-sm border border-[#2A2D42] rounded-xl p-8">
                            <div className="flex items-center gap-3 mb-6">
                                <div className="p-3 bg-[rgba(220,38,38,0.1)] rounded-lg">
                                    <Building2 className="w-6 h-6 text-[#D0CCC4]" />
                                </div>
                                <h2 className="text-2xl font-bold font-serif text-[#F6F4EF]">Who Is Eric Sprott?</h2>
                            </div>
                            <div className="prose prose-lg prose-invert max-w-none">
                                <p className="text-[#D0CCC4]">
                                    Eric Sprott is a Canadian <strong className="text-[#F6F4EF]">billionaire investor</strong> and the founder of <strong className="text-[#D0CCC4]">Sprott Inc.</strong>, one of the largest precious metals investment firms in the world. His personal fortune, estimated in the billions, is heavily concentrated in gold and silver investments.
                                </p>
                                <p className="text-[#D0CCC4]">
                                ...
                                <p className="text-[#D0CCC4]">
                                    What sets Sprott apart from many commentators is the scale of his personal investment. He has put <strong className="text-[#F6F4EF]">hundreds of millions of his own money</strong> into silver - through physical holdings, PSLV, and mining companies. When Eric Sprott talks about silver, he is talking about his largest personal bet.
                                </p>

                                <div className="bg-[#0C0D18] rounded-lg p-6 my-6 not-prose">
                                    <h4 className="font-bold text-[#F6F4EF] mb-4">Eric Sprott Quick Facts</h4>
                                    <ul className="space-y-2 text-[#D0CCC4]">
                                        <li className="flex items-start gap-2">
                                            <CheckCircle2 className="w-5 h-5 text-[#D0CCC4] shrink-0 mt-0.5" />
                        ...
                        <section className="bg-[#0C0D18] backdrop-blur-sm border border-[#2A2D42] rounded-xl p-8">
                            <div className="flex items-center gap-3 mb-6">
                                <div className="p-3 bg-[rgba(220,38,38,0.1)] rounded-lg">
                                    <Coins className="w-6 h-6 text-[#D0CCC4]" />
                                </div>
                                <h2 className="text-2xl font-bold font-serif text-[#F6F4EF]">The PSLV Creation Story</h2>
                            </div>
                            <div className="prose prose-lg prose-invert max-w-none">
                                <p className="text-[#D0CCC4]">
                                    PSLV - the <strong className="text-[#F6F4EF]">Sprott Physical Silver Trust</strong> - was born out of Sprott&apos;s concerns about existing silver investment vehicles. He did not trust that products like SLV (iShares Silver Trust) were fully backed by physical silver, and he wanted to create something better.
                                </p>

                                <h3 className="text-xl font-bold text-[#F6F4EF] mt-8 mb-4">The Problem with SLV</h3>
                                <p className="text-[#D0CCC4]">
                                ...
                                <blockquote className="border-l-4 border-[#3F4460] pl-4 my-6 text-[#D0CCC4] italic">
                                ...
                                <h3 className="text-xl font-bold text-[#F6F4EF] mt-8 mb-4">How PSLV Works</h3>
                                <ul className="text-[#D0CCC4] space-y-2">
                                    <li><strong className="text-[#F6F4EF]">Fully Allocated:</strong> Every ounce of silver is allocated to the trust and stored in the Royal Canadian Mint.</li>
                                    <li><strong className="text-[#F6F4EF]">Published Bar Lists:</strong> Complete lists of silver bars with serial numbers are publicly available.</li>
                                    <li><strong className="text-[#F6F4EF]">Independent Audits:</strong> Regular third-party audits verify that the silver exists as claimed.</li>
                                    <li><strong className="text-[#F6F4EF]">Physical Redemption:</strong> Large shareholders can redeem shares for actual physical silver delivery.</li>
                                </ul>

                                <h3 className="text-xl font-bold text-[#F6F4EF] mt-8 mb-4">PSLV and the Silver Squeeze</h3>
                                <p className="text-[#D0CCC4]">
                        ...
                        <section className="bg-[#0C0D18] backdrop-blur-sm border border-[#2A2D42] rounded-xl p-8">
                            <div className="flex items-center gap-3 mb-6">
                                <div className="p-3 bg-[rgba(220,38,38,0.1)] rounded-lg">
                                    <TrendingUp className="w-6 h-6 text-[#D0CCC4]" />
                                </div>
                                <h2 className="text-2xl font-bold font-serif text-[#F6F4EF]">Eric Sprott&apos;s Silver Investments</h2>
                            </div>
                            ...
                            <div className="space-y-4">
                                {sprottInvestments.map((item, index) => (
                                    <div key={index} className="bg-[#0C0D18] rounded-lg p-6">
                                        <h3 className="text-lg font-bold text-[#D0CCC4] mb-2">{item.category}</h3>
                                        <p className="text-[#D0CCC4]">{item.description}</p>
                                    </div>
                                ))}
                            </div>
                        </section>
                        ...
                        <section className="bg-[#0C0D18] backdrop-blur-sm border border-[#2A2D42] rounded-xl p-8">
                            <div className="flex items-center gap-3 mb-6">
                                <div className="p-3 bg-[rgba(220,38,38,0.1)] rounded-lg">
                                    <Quote className="w-6 h-6 text-[#D0CCC4]" />
                                </div>
                            ...
                            <div className="space-y-6">
                                {keyQuotes.map((item, index) => (
                                    <div key={index} className="bg-[#0C0D18] rounded-lg p-6">
                                        ...
                                        <p className="text-[#D0CCC4] text-sm font-semibold">{item.context}</p>
                                    </div>
                                ))}
                            </div>
                        </section>
                        ...
                        <section className="bg-[#0C0D18] backdrop-blur-sm border border-[#2A2D42] rounded-xl p-8">
                            <div className="flex items-center gap-3 mb-6">
                                <div className="p-3 bg-[rgba(220,38,38,0.1)] rounded-lg">
                                    <Star className="w-6 h-6 text-[#D0CCC4]" />
                                </div>
                                <h2 className="text-2xl font-bold font-serif text-[#F6F4EF]">Eric Sprott&apos;s Current Views</h2>
                            </div>
                            <div className="prose prose-lg prose-invert max-w-none">
                                <p className="text-[#D0CCC4]">
                                ...
                                <h3 className="text-xl font-bold text-[#F6F4EF] mt-8 mb-4">On Silver vs Gold</h3>
                                <p className="text-[#D0CCC4]">
                                ...
                                <h3 className="text-xl font-bold text-[#F6F4EF] mt-8 mb-4">On Market Manipulation</h3>
                                <p className="text-[#D0CCC4]">
                                ...
                                <h3 className="text-xl font-bold text-[#F6F4EF] mt-8 mb-4">On Monetary Policy</h3>
                                <p className="text-[#D0CCC4]">
                        ...
                        <section className="bg-[#0C0D18] backdrop-blur-sm border border-[#2A2D42] rounded-xl p-8">
                            ...
                            <div className="space-y-6">
                                <div className="border-b border-[#2A2D42] pb-6">
                                    <h3 className="text-lg font-bold text-[#D0CCC4] mb-2">Who is Eric Sprott?</h3>
                                    <p className="text-[#D0CCC4]">Eric Sprott is a Canadian billionaire investor and founder of Sprott Inc. He is one of the largest individual investors in precious metals and mining companies, having personally invested hundreds of millions of dollars in silver.</p>
                                </div>
                                <div className="border-b border-[#2A2D42] pb-6">
                                    <h3 className="text-lg font-bold text-[#D0CCC4] mb-2">What is PSLV?</h3>
                                    <p className="text-[#D0CCC4]">PSLV (Sprott Physical Silver Trust) is an exchange-traded trust that holds physical silver bullion. Unlike SLV, PSLV is fully allocated, regularly audited, and allows investors to redeem shares for physical silver delivery.</p>
                                </div>
                                <div className="border-b border-[#2A2D42] pb-6">
                                    <h3 className="text-lg font-bold text-[#D0CCC4] mb-2">Why did Eric Sprott create PSLV?</h3>
                                    <p className="text-[#D0CCC4]">Sprott created PSLV because he was concerned that existing silver ETFs like SLV were not fully backed by physical silver. PSLV was designed to give investors true physical silver exposure with the ability to take delivery.</p>
                                </div>
                                <div>
                                    <h3 className="text-lg font-bold text-[#D0CCC4] mb-2">What does Eric Sprott predict for silver?</h3>
                                    <p className="text-[#D0CCC4]">Sprott is extremely bullish on silver, believing it is significantly undervalued. He has predicted silver could dramatically outperform gold and has backed this view with hundreds of millions in personal investments.</p>
                                </div>
                            </div>
                        </section>
                    </div>
                    ...
                    <aside className="lg:col-span-1 space-y-8">
                        {/* CTA Box */}
                        <div className="bg-gradient-to-br from-slate-700/30 to-slate-800/50 border border-[#3F4460] rounded-xl p-6 sticky top-24">
                        ...
                        <div className="bg-[#0C0D18] backdrop-blur border border-[#2A2D42] rounded-xl p-6">
                            ...
                            <ul className="space-y-3">
                                <li>
                                    <Link href="/silver-experts/andy-schectman" className="text-[#D0CCC4] hover:text-[#F6F4EF] font-medium">
                                        Andy Schectman - Miles Franklin CEO
                                    </Link>
                                </li>
                                <li>
                                    <Link href="/silver-experts/david-morgan" className="text-[#D0CCC4] hover:text-[#F6F4EF] font-medium">
                                        David Morgan - The Silver Guru
                                    </Link>
                                </li>
                                <li>
                                    <Link href="/silver-experts/mike-maloney" className="text-[#D0CCC4] hover:text-[#F6F4EF] font-medium">
                                        Mike Maloney - GoldSilver.com
                                    </Link>
                                </li>
                                <li>
                                    <Link href="/silver-experts/ted-butler" className="text-[#D0CCC4] hover:text-[#F6F4EF] font-medium">
                                        Ted Butler - Manipulation Researcher
                                    </Link>
                                </li>
                                <li>
                                    <Link href="/silver-experts/rick-rule" className="text-[#D0CCC4] hover:text-[#F6F4EF] font-medium">
                        ...
                        <div className="bg-[#0C0D18] backdrop-blur border border-[#2A2D42] rounded-xl p-6">
                            ...
                            <ul className="space-y-3 text-sm">
                                <li>
                                    <Link href="/silver-squeeze/paper-silver-vs-physical" className="text-[#D0CCC4] hover:text-[#F6F4EF]">
                                ...
                                <li>
                                    <Link href="/best-silver-ira-companies" className="text-[#D0CCC4] hover:text-[#F6F4EF]">
