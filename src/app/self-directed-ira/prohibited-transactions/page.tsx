                ...
                <article className="max-w-4xl mx-auto prose prose-lg prose-headings:font-serif prose-headings:text-[#000080] prose-p:text-slate-600 prose-strong:text-slate-900 prose-li:text-slate-600">
                    ...
                    <div className="overflow-x-auto not-prose my-8">
                        <table className="w-full text-left border-collapse bg-white rounded-xl border border-slate-200 shadow-sm">
                            <thead className="bg-slate-50">
                                <tr>
                                    <th className="p-4 border-b border-slate-200 font-bold text-[#B22234]">Category</th>
                                    <th className="p-4 border-b border-slate-200 font-bold text-[#B22234]">Who&apos;s Included</th>
                                </tr>
                            </thead>
                            <tbody className="divide-y divide-slate-200 text-sm text-slate-600">
                                <tr><td className="p-4 font-semibold text-slate-900">You</td><td className="p-4">The IRA owner</td></tr>
                                <tr><td className="p-4 font-semibold text-slate-900">Spouse</td><td className="p-4">Your husband or wife</td></tr>
                                <tr><td className="p-4 font-semibold text-slate-900">Lineal Ascendants</td><td className="p-4">Your parents, grandparents</td></tr>
                                <tr><td className="p-4 font-semibold text-slate-900">Lineal Descendants</td><td className="p-4">Your children, grandchildren, and their spouses</td></tr>
                                <tr><td className="p-4 font-semibold text-slate-900">Fiduciaries</td><td className="p-4">IRA custodian, trustee, investment advisor</td></tr>
                                <tr><td className="p-4 font-semibold text-slate-900">Entities</td><td className="p-4">Any corporation, partnership, trust, or estate in which you or a disqualified person owns 50% or more</td></tr>
                                <tr><td className="p-4 font-semibold text-slate-900">Key Employees</td><td className="p-4">Officers, directors, 10%+ shareholders, or highly compensated employees of entities involved</td></tr>
                            </tbody>
                        </table>
                    </div>
                    ...
                    <div className="space-y-4 not-prose">
                        <details className="group bg-white rounded-xl border border-slate-200 shadow-sm p-6 [&_summary::-webkit-details-marker]:hidden">
                            ...
                            <p className="mt-4 leading-relaxed text-slate-600">The IRS imposes a 15% excise tax on the amount involved for each year it remains uncorrected. If you don&apos;t fix it within the taxable period, the penalty jumps to 100%. In the worst case, the entire IRA can be treated as a distribution, meaning you owe income tax on the full balance plus a 10% early withdrawal penalty if you&apos;re under 59&frac12;.</p>
                        </details>
                        ...
                        <details className="group bg-white rounded-xl border border-slate-200 shadow-sm p-6 [&_summary::-webkit-details-marker]:hidden">
                            ...
                            <p className="mt-4 leading-relaxed text-slate-600">No. Lending IRA funds to yourself, your business, or any disqualified person is a prohibited transaction under IRC Section 4975. This includes direct loans, lines of credit, and using IRA assets as collateral for a personal loan.</p>
                        </details>
                        ...
                        <details className="group bg-white rounded-xl border border-slate-200 shadow-sm p-6 [&_summary::-webkit-details-marker]:hidden">
                            ...
                            <p className="mt-4 leading-relaxed text-slate-600">Disqualified persons include: you (the IRA owner), your spouse, your parents, your children and their spouses, your grandchildren, any fiduciary of the IRA (custodian, trustee, investment advisor), and any entity you or a disqualified person owns 50% or more of (corporations, partnerships, trusts, estates).</p>
                        </details>
                        ...
                        <details className="group bg-white rounded-xl border border-slate-200 shadow-sm p-6 [&_summary::-webkit-details-marker]:hidden">
                            ...
                            <p className="mt-4 leading-relaxed text-slate-600">No. Your children are disqualified persons. Paying them to manage, maintain, or improve IRA-owned property is a prohibited transaction. You must hire unrelated third parties for all property management, repairs, and maintenance on IRA-owned real estate.</p>
                        </details>
                    </div>
