                ...
                <article className="max-w-4xl mx-auto prose prose-lg prose-headings:font-serif prose-headings:text-[#F6F4EF] prose-p:text-[#D0CCC4] prose-strong:text-[#F6F4EF] prose-li:text-[#D0CCC4]">
                        ...
                        <table className="w-full text-left border-collapse bg-[#161828] rounded-xl border border-[#2A2D42] shadow-sm text-sm">
                            <thead className="bg-[#0C0D18]">
                                <tr>
                                    ...
                                    <th className="p-4 border-b border-[#2A2D42] font-bold text-[#D4A94E]">Equity Trust</th>
                                    <th className="p-4 border-b border-[#2A2D42] font-bold text-[#D4A94E]">Millennium Trust</th>
                                    <th className="p-4 border-b border-[#2A2D42] font-bold text-[#D4A94E]">PENSCO</th>
                                    <th className="p-4 border-b border-[#2A2D42] font-bold text-[#D4A94E]">Entrust Group</th>
                                    <th className="p-4 border-b border-[#2A2D42] font-bold text-[#D4A94E]">Kingdom Trust</th>
                                </tr>
                            </thead>
                            <tbody className="divide-y divide-[#2A2D42] text-[#D0CCC4]">
                                ...
                                <tr>
                                    <td className="p-4 font-semibold text-[#F6F4EF]">Annual Fee</td>
                                ...
                                <tr>
                                    <td className="p-4 font-semibold text-[#F6F4EF]">Transaction Fee</td>
                                ...
                                <tr>
                                    <td className="p-4 font-semibold text-[#F6F4EF]">Account Minimum</td>
                                ...
                                <tr>
                                    <td className="p-4 font-semibold text-[#F6F4EF]">Checkbook IRA LLC</td>
                                    <td className="p-4 text-green-600 font-semibold">Yes</td>
                                    <td className="p-4 text-red-500">No</td>
                                    <td className="p-4 text-green-600 font-semibold">Yes</td>
                                    <td className="p-4 text-green-600 font-semibold">Yes</td>
                                ...
                                <tr>
                                    ...
                                    <td className="p-4 text-[#F6F4EF] font-medium">All-around versatility</td>
                                    <td className="p-4 text-[#F6F4EF] font-medium">Rollovers &amp; institutional</td>
                                    <td className="p-4 text-[#F6F4EF] font-medium">Real estate investors</td>
                                    <td className="p-4 text-[#F6F4EF] font-medium">Lowest fees for simple accounts</td>
                                    <td className="p-4 text-[#F6F4EF] font-medium">Cryptocurrency IRAs</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                    ...
                    <div className="space-y-4 not-prose">
                        <details className="group bg-[#161828] rounded-xl border border-[#2A2D42] shadow-sm p-6 [&_summary::-webkit-details-marker]:hidden">
                            ...
                            <p className="mt-4 leading-relaxed text-[#D0CCC4]">A self-directed IRA custodian is an IRS-approved financial institution that holds and administers your self-directed IRA. Unlike regular IRA custodians (like Fidelity or Schwab), self-directed custodians allow you to invest in alternative assets such as real estate, precious metals, private equity, cryptocurrency, and more. They handle paperwork, reporting, and compliance but do not provide investment advice.</p>
                        </details>
                        ...
                        <details className="group bg-[#161828] rounded-xl border border-[#2A2D42] shadow-sm p-6 [&_summary::-webkit-details-marker]:hidden">
                            ...
                            <p className="mt-4 leading-relaxed text-[#D0CCC4]">Self-directed IRA custodians typically charge: setup fees ($50-$300), annual maintenance fees ($75-$400), transaction fees ($25-$250 per transaction), and asset-specific fees (like precious metals storage at $100-$300/year). Total annual costs usually range from $200-$1,000 depending on account size, asset types, and transaction volume.</p>
                        </details>
                        ...
                        <details className="group bg-[#161828] rounded-xl border border-[#2A2D42] shadow-sm p-6 [&_summary::-webkit-details-marker]:hidden">
                            ...
                            <p className="mt-4 leading-relaxed text-[#D0CCC4]">A custodian holds and safeguards IRA assets and handles administrative duties, while a trustee has broader authority to manage trust assets. For most self-directed IRA investors, the terms are used interchangeably. The key distinction: a trustee may have discretionary authority over investments, while a custodian follows your directions exactly.</p>
                        </details>
                        ...
                        <details className="group bg-[#161828] rounded-xl border border-[#2A2D42] shadow-sm p-6 [&_summary::-webkit-details-marker]:hidden">
                            ...
                            <p className="mt-4 leading-relaxed text-[#D0CCC4]">Yes. You can transfer your self-directed IRA to a different custodian through a trustee-to-trustee transfer, which is tax-free and penalty-free. The process typically takes 2-4 weeks. Some custodians charge a transfer-out fee ($50-$150). Make sure the new custodian supports all the asset types you currently hold before initiating.</p>
                        </details>
