                ...
                <article className="max-w-4xl mx-auto prose prose-lg prose-headings:font-serif prose-headings:text-[#F6F4EF] prose-p:text-[#D0CCC4] prose-strong:text-[#F6F4EF] prose-li:text-[#D0CCC4]">
                    ...
                    <div className="bg-[#0C0D18] rounded-2xl p-6 border border-[#2A2D42] not-prose my-8">
                        <div className="space-y-6">
                            <div className="flex items-start gap-4">
                                <div className="w-10 h-10 rounded-full bg-[#DC2626] text-white flex items-center justify-center text-sm font-bold shrink-0">1</div>
                                <div>
                                    <h4 className="font-bold text-[#F6F4EF] text-lg">Your Self-Directed IRA (the owner)</h4>
                                    <p className="text-[#D0CCC4] mt-1">You open a self-directed IRA with a custodian that supports LLC structures. The IRA is the <strong>sole member</strong> (100% owner) of the LLC. The custodian&apos;s role is minimal &mdash; they hold the IRA and report to the IRS, but they don&apos;t approve each transaction.</p>
                                </div>
                            </div>
                            <div className="flex items-start gap-4">
                                <div className="w-10 h-10 rounded-full bg-[#DC2626] text-white flex items-center justify-center text-sm font-bold shrink-0">2</div>
                                <div>
                                    <h4 className="font-bold text-[#F6F4EF] text-lg">The LLC (the investment vehicle)</h4>
                                    <p className="text-[#D0CCC4] mt-1">An LLC is formed in your state (or a business-friendly state like Wyoming or New Mexico). The IRA funds the LLC by purchasing its membership interest. The LLC opens its own bank account &mdash; this is where the &quot;checkbook&quot; comes from.</p>
                                </div>
                            </div>
                            <div className="flex items-start gap-4">
                                <div className="w-10 h-10 rounded-full bg-[#DC2626] text-white flex items-center justify-center text-sm font-bold shrink-0">3</div>
                                <div>
                                    <h4 className="font-bold text-[#F6F4EF] text-lg">You (the manager)</h4>
                                    <p className="text-[#D0CCC4] mt-1">You are appointed as the <strong>manager</strong> of the LLC (not the owner &mdash; the IRA owns it). As manager, you have signing authority on the LLC bank account and can make investment decisions on the spot &mdash; buying property, writing checks, wiring funds &mdash; all without waiting for custodian approval.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="overflow-x-auto not-prose my-8">
                        <table className="w-full text-left border-collapse bg-[#161828] rounded-xl border border-[#2A2D42] shadow-sm">
                            <thead className="bg-[#0C0D18]">
                                <tr>
                                    <th className="p-4 border-b border-[#2A2D42] font-bold text-[#D4A94E]">Expense</th>
                                    <th className="p-4 border-b border-[#2A2D42] font-bold text-[#D4A94E]">One-Time Cost</th>
                                    <th className="p-4 border-b border-[#2A2D42] font-bold text-[#D4A94E]">Annual Cost</th>
                                </tr>
                            </thead>
                            <tbody className="divide-y divide-[#2A2D42] text-sm text-[#D0CCC4]">
                                <tr>
                                    <td className="p-4 font-semibold text-[#F6F4EF]">LLC formation (attorney)</td>
                                    <td className="p-4">$1,500-$3,000</td>
                                    <td className="p-4">&mdash;</td>
                                </tr>
                                <tr>
                                    <td className="p-4 font-semibold text-[#F6F4EF]">State filing fee</td>
                                    <td className="p-4">$50-$500</td>
                                    <td className="p-4">&mdash;</td>
                                </tr>
                                <tr>
                                    <td className="p-4 font-semibold text-[#F6F4EF]">EIN application</td>
                                    <td className="p-4">$0 (free from IRS)</td>
                                    <td className="p-4">&mdash;</td>
                                </tr>
                                <tr>
                                    <td className="p-4 font-semibold text-[#F6F4EF]">Custodian annual fee</td>
                                    <td className="p-4">&mdash;</td>
                                    <td className="p-4">$75-$400</td>
                                </tr>
                                <tr>
                                    <td className="p-4 font-semibold text-[#F6F4EF]">Registered agent</td>
                                    <td className="p-4">&mdash;</td>
                                    <td className="p-4">$100-$300</td>
                                </tr>
                                <tr>
                                    <td className="p-4 font-semibold text-[#F6F4EF]">State annual report</td>
                                    <td className="p-4">&mdash;</td>
                                    <td className="p-4">$50-$300</td>
                                </tr>
                                <tr className="bg-[#0C0D18]">
                                    <td className="p-4 font-bold text-[#F6F4EF]">Total Estimated</td>
                    ...
                    <div className="bg-[#0C0D18] rounded-2xl p-6 border border-[#2A2D42] not-prose my-8">
                        <div className="space-y-5">
                            <div className="flex items-start gap-3">
                                <div className="w-8 h-8 rounded-full bg-[rgba(197,149,46,0.1)] text-white flex items-center justify-center text-sm font-bold shrink-0">1</div>
                                <div>
                                    <strong className="text-[#F6F4EF]">Open a self-directed IRA with a custodian that supports LLCs</strong>
                                    <p className="text-sm text-[#D0CCC4]">Not all custodians allow IRA LLCs. Equity Trust, Entrust, and Kingdom Trust are popular options. Fund the IRA via contribution or rollover.</p>
                                </div>
                            </div>
                            <div className="flex items-start gap-3">
                                <div className="w-8 h-8 rounded-full bg-[rgba(197,149,46,0.1)] text-white flex items-center justify-center text-sm font-bold shrink-0">2</div>
                                <div>
                                    <strong className="text-[#F6F4EF]">Hire an attorney to form the LLC</strong>
                                    <p className="text-sm text-[#D0CCC4]">The operating agreement must specifically name the IRA as the sole member and you as the manager. Use an attorney experienced in IRA LLCs &mdash; generic LLC formation is not sufficient.</p>
                                </div>
                            </div>
                            <div className="flex items-start gap-3">
                                <div className="w-8 h-8 rounded-full bg-[rgba(197,149,46,0.1)] text-white flex items-center justify-center text-sm font-bold shrink-0">3</div>
                                <div>
                                    <strong className="text-[#F6F4EF]">Get an EIN for the LLC</strong>
                                    <p className="text-sm text-[#D0CCC4]">Apply for a free Employer Identification Number from the IRS. The LLC needs its own tax ID, separate from your personal SSN and the IRA.</p>
                                </div>
                            </div>
                            <div className="flex items-start gap-3">
                                <div className="w-8 h-8 rounded-full bg-[rgba(197,149,46,0.1)] text-white flex items-center justify-center text-sm font-bold shrink-0">4</div>
                                <div>
                                    <strong className="text-[#F6F4EF]">Open an LLC bank account</strong>
                                    <p className="text-sm text-[#D0CCC4]">Open a business checking account in the LLC&apos;s name. This is your &quot;checkbook.&quot; The account must be 100% separate from all personal accounts.</p>
                                </div>
                            </div>
                            <div className="flex items-start gap-3">
                                <div className="w-8 h-8 rounded-full bg-[rgba(197,149,46,0.1)] text-white flex items-center justify-center text-sm font-bold shrink-0">5</div>
                                <div>
                                    <strong className="text-[#F6F4EF]">Fund the LLC from the IRA</strong>
                                    <p className="text-sm text-[#D0CCC4]">Direct the custodian to purchase the LLC membership interest. IRA funds transfer to the LLC bank account. You now have checkbook control.</p>
                                </div>
                            </div>
                            <div className="flex items-start gap-3">
                                <div className="w-8 h-8 rounded-full bg-[rgba(197,149,46,0.1)] text-white flex items-center justify-center text-sm font-bold shrink-0">6</div>
                                <div>
                                    <strong className="text-[#F6F4EF]">Start investing &mdash; carefully</strong>
                                    <p className="text-sm text-[#D0CCC4]">Use the LLC checkbook to make investments. Keep meticulous records. Every transaction should benefit the IRA, never you personally. When in doubt, consult your attorney.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="space-y-4 not-prose">
                        <details className="group bg-[#161828] rounded-xl border border-[#2A2D42] shadow-sm p-6 [&_summary::-webkit-details-marker]:hidden">
                            ...
                            <p className="mt-4 leading-relaxed text-[#D0CCC4]">A self-directed IRA LLC is a structure where your IRA owns an LLC and you serve as manager. This gives you &quot;checkbook control&quot; &mdash; the ability to write checks and make investments directly without custodian approval on every transaction. The IRA remains the sole member, and all profits flow back tax-deferred.</p>
                        </details>
                        ...
                        <details className="group bg-[#161828] rounded-xl border border-[#2A2D42] shadow-sm p-6 [&_summary::-webkit-details-marker]:hidden">
                            ...
                            <p className="mt-4 leading-relaxed text-[#D0CCC4]">$1,500-$3,000 for initial setup (LLC formation, operating agreement, EIN, legal docs). Ongoing costs: custodian annual fee ($75-$400), registered agent ($100-$300), and state annual report ($50-$300). Total ongoing: roughly $300-$800/year after setup.</p>
                        </details>
                        ...
                        <details className="group bg-[#161828] rounded-xl border border-[#2A2D42] shadow-sm p-6 [&_summary::-webkit-details-marker]:hidden">
                            ...
                            <p className="mt-4 leading-relaxed text-[#D0CCC4]">Yes. The structure was validated by the Tax Court in Swanson v. Commissioner (2006). However, the IRS has increased scrutiny, and improper use triggers severe penalties. The legality is established, but you must follow all prohibited transaction rules.</p>
                        </details>
                        ...
                        <details className="group bg-[#161828] rounded-xl border border-[#2A2D42] shadow-sm p-6 [&_summary::-webkit-details-marker]:hidden">
                            ...
                            <p className="mt-4 leading-relaxed text-[#D0CCC4]">Absolutely not. Using IRA LLC funds for any personal purpose is a prohibited transaction that can result in the entire IRA being treated as a taxable distribution. You&apos;d owe income tax on the full balance plus a 10% penalty if under 59&frac12;. The LLC bank account is exclusively for IRA investments.</p>
                        </details>
