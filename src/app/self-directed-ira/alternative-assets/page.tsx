                ...
                <article className="max-w-4xl mx-auto prose prose-lg prose-headings:font-serif prose-headings:text-[#000080] prose-p:text-slate-600 prose-strong:text-slate-900 prose-li:text-slate-600">
                    ...
                    <div className="overflow-x-auto not-prose my-8">
                        <table className="w-full text-left border-collapse bg-white rounded-xl border border-slate-200 shadow-sm text-sm">
                            <thead className="bg-slate-50">
                                <tr>
                                    <th className="p-4 border-b border-slate-200 font-bold text-[#B22234]">Asset Type</th>
                                    <th className="p-4 border-b border-slate-200 font-bold text-[#B22234]">Min. Investment</th>
                                    <th className="p-4 border-b border-slate-200 font-bold text-[#B22234]">Income Potential</th>
                                    <th className="p-4 border-b border-slate-200 font-bold text-[#B22234]">Complexity</th>
                                    <th className="p-4 border-b border-slate-200 font-bold text-[#B22234]">Liquidity</th>
                                </tr>
                            </thead>
                            <tbody className="divide-y divide-slate-200 text-slate-600">
                                ...
                                <tr>
                                    <td className="p-4 font-semibold text-slate-900">Tax Liens</td>
                                ...
                                <tr>
                                    <td className="p-4 font-semibold text-slate-900">Promissory Notes</td>
                                    <td className="p-4">$5,000+</td>
                                ...
                                <tr>
                                    <td className="p-4 font-semibold text-slate-900">IRA LLC</td>
                    ...
                    <h2 id="real-estate">
                        <span className="not-prose inline-flex items-center gap-2">
                            <Building2 className="w-7 h-7 text-[#B22234]" />
                            Real Estate
                        </span>
                    </h2>
                    <p>
                    ...
                    <h2 id="precious-metals">
                        <span className="not-prose inline-flex items-center gap-2">
                            <Coins className="w-7 h-7 text-[#B22234]" />
                            Precious Metals
                        </span>
                    </h2>
                    <p>
                    ...
                    <h2 id="cryptocurrency">
                        <span className="not-prose inline-flex items-center gap-2">
                            <Bitcoin className="w-7 h-7 text-[#B22234]" />
                            Cryptocurrency
                        </span>
                    </h2>
                    <p>
                    ...
                    <h2 id="private-equity">
                        <span className="not-prose inline-flex items-center gap-2">
                            <Briefcase className="w-7 h-7 text-[#B22234]" />
                    ...
                    <h2 id="tax-liens">
                        <span className="not-prose inline-flex items-center gap-2">
                            <Landmark className="w-7 h-7 text-[#B22234]" />
                    ...
                    <h2 id="notes">
                        <span className="not-prose inline-flex items-center gap-2">
                            <FileText className="w-7 h-7 text-[#B22234]" />
                    ...
                    <div className="space-y-4 not-prose">
                        <details className="group bg-white rounded-xl border border-slate-200 shadow-sm p-6 [&_summary::-webkit-details-marker]:hidden">
                            ...
                            <p className="mt-4 leading-relaxed text-slate-600">Real estate, precious metals, cryptocurrency, private equity, promissory notes, tax lien certificates, LLCs, and many other non-traditional investments. The IRS only explicitly prohibits life insurance, collectibles (art, antiques, gems, stamps, rugs), and S-corporation stock.</p>
                        </details>
                        ...
                        <details className="group bg-white rounded-xl border border-slate-200 shadow-sm p-6 [&_summary::-webkit-details-marker]:hidden">
                            ...
                            <p className="mt-4 leading-relaxed text-slate-600">Life insurance policies, collectibles (artwork, antiques, rugs, gems, stamps, most coins, alcoholic beverages), and S-corporation stock. Certain bullion coins and bars meeting IRS fineness requirements ARE allowed despite the general collectibles ban.</p>
                        </details>
                        ...
                        <details className="group bg-white rounded-xl border border-slate-200 shadow-sm p-6 [&_summary::-webkit-details-marker]:hidden">
                            ...
                            <p className="mt-4 leading-relaxed text-slate-600">Yes. Your SDIRA can purchase residential rentals, commercial properties, raw land, farmland, and foreign real estate. All income goes into the IRA, all expenses are paid from IRA funds, and you cannot personally use the property. If using a mortgage, UDFI tax may apply to the leveraged portion.</p>
                        </details>
                        ...
                        <details className="group bg-white rounded-xl border border-slate-200 shadow-sm p-6 [&_summary::-webkit-details-marker]:hidden">
                            ...
                            <p className="mt-4 leading-relaxed text-slate-600">All gains grow tax-deferred (Traditional) or tax-free (Roth). You can sell a property that&apos;s doubled in value, reinvest the full amount, and owe zero capital gains tax. Rental income, interest, and dividends all accumulate without annual taxation.</p>
                        </details>
                    </div>
