...
**there's a difference between an inflation hedge and a speculation vehicle.** Yes, crypto was created as an alternative to the dollar – and I respect that mission. But somewhere along the way, it became a casino chip instead of real money. The rich already know this. They use crypto for trades, not for wealth preservation.
