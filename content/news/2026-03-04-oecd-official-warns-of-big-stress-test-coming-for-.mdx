...
- **the financial system is built on a foundation of fake money and endless debt**. The OECD's warning isn't news to anyone who understands how money really works. It's an admission that the chickens are coming home to roost.
...
The Fed has been playing a dangerous game for decades - printing trillions of dollars to keep the debt party going. They've created the biggest bubble in human history, and now inflation is the pin that's about to pop it. **, and you'll see that this "stress test" is really a wealth transfer from Main Street to Wall Street.**
...
This OECD warning is your canary in the coal mine. **The time to diversify into real assets is before the stress test begins, not after.**
