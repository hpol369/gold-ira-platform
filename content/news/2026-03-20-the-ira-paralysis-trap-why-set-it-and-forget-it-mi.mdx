...
**the rich don't get paralyzed by choice because they understand the fundamentals**. They know the difference between assets and liabilities. They know that in an environment where the Fed keeps printing money, you need assets that hold their value.
