...
Oil companies are rational actors. They're not going to spend billions drilling new wells when the profit margins don't justify it. But why are margins so tight? , and you'll see decades of artificial market manipulation by the Fed.
...
**when central planners try to control markets, they create chaos.** The rich already know this. That's why they don't put all their eggs in one basket, waiting for politicians to fix energy prices.
