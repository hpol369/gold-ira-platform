...
**** The Fed has painted themselves into a corner with decades of artificial money creation. Now they're trying to thread the needle between crashing the economy and crashing the currency. Guess what? They can't do both.
...
While retail investors panic over Bitcoin headlines, the wealthy are quietly moving into assets that have held value for thousands of years.
