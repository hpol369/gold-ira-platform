...
The financial media is spinning this as just another Fed appointment. **** This could be the most significant monetary policy shift in decades.

the Fed's money-printing spree can't last forever. Warsh understands this. During his previous Fed tenure, he was one of the few voices warning about the consequences of easy money policies. He's criticized the Fed for creating asset bubbles and widening wealth inequality.
...
**** Warsh has previously stated that gold serves as a useful barometer of monetary policy credibility. Unlike the current Fed leadership that treats gold as an "inflation hedge," Warsh understands gold's deeper role as real money in an unstable monetary system.
