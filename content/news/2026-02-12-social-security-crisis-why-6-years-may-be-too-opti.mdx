...
when governments print money to solve their problems, retirees get crushed. The Fed has created trillions of dollars out of thin air, and now we're seeing the inevitable result. Higher inflation means Social Security pays out more in cost-of-living adjustments while collecting taxes on a currency that's worth less every day.

**** The government created this mess through decades of fiscal irresponsibility, and now they want you to believe they can fix it. Meanwhile, the rich already know what's coming. They're not counting on Social Security – they're buying real assets that hold value when the dollar fail.
