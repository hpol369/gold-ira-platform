...
**the government's inflation numbers are designed to hide the truth, not reveal it**. The CPI calculation has been manipulated so many times since the 1980s that it barely resembles reality for most Americans.
