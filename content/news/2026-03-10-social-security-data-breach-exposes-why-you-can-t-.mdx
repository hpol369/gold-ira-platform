...
When the government can't even protect your personal data from rogue contractors, how can you trust them to protect your Social Security benefits? the system is broken from top to bottom.
...
While you're hoping Social Security will be there in 20 years, the wealthy are buying assets that can't be hacked, manipulated, or "accessed" by some random government contractor. **Physical gold doesn't have a database that can be breached.**
