...
– the Fed and the banking system work together to keep average Americans trapped in a depreciating currency. When someone pro-crypto takes the helm at the Fed, it legitimizes the very assets that threaten the dollar's dominance.
...
: Why would the establishment suddenly embrace crypto? Because they can't stop it, so they're trying to control it. But here's the kicker – **this legitimization of alternative currencies makes ALL alternative stores of value more attractive**, including the oldest one of all: gold.

The financial system is designed to keep you believing that dollars in your 401(k) are "safe." When the Fed itself starts acknowledging crypto, they're admitting the dollar isn't the only game in town anymore.
