...
**** The Federal Reserve isn't your friend. They've created a system that systematically transfers wealth from savers to speculators. While you're getting 0.5% on your savings account, the big banks are borrowing money from the Fed at near-zero rates and investing it in riskier assets.

Every time there's a banking scandal or enforcement action, ask yourself: Where were the regulators? The same Fed that's supposed to protect you is the same institution that created the incentives for this behavior in the first place.
