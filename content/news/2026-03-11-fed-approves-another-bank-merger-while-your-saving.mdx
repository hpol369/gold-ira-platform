...
- **the financial system is designed to consolidate wealth and power into fewer hands**. Every time the Fed approves these mergers, they're creating bigger "too big to fail" institutions that will demand taxpayer bailouts when things go south.
