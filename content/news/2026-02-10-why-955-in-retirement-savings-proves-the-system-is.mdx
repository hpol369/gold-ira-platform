...
The latest data just dropped, and it's worse than most realize.
...
**Savers are losers.** And this $955 figure proves it perfectly.
...
, and you'll see the wealthy have been moving into hard assets while telling everyone else to "stay the course" with their 401(k)s.
