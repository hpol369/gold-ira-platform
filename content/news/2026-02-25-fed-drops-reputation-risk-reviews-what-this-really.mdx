...
The Fed claims this will help banks focus on "core risks" instead of worrying about public relations nightmares. **But here's what you need to know:** This move makes it easier for banks to sweep problems under the rug while continuing to play fast and loose with the financial system.

## What's Really Going On

**** This isn't about "streamlining regulations" – it's about protecting the banking cartel that keeps this broken system running.

**the Fed and Wall Street work together, and it's not for your benefit.** When banks don't have to worry about their reputation with regulators, guess who pays the price? You do. Through higher fees, riskier lending practices, and the inevitable bailouts when things go sideways.
...
**** This move comes as banks are already sitting on massive unrealized losses from their bond portfolios – losses that could wipe out their capital if interest rates keep climbing. By removing reputation risk reviews, the Fed is essentially giving banks permission to hide their problems longer.
