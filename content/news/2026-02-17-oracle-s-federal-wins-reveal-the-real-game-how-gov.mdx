...
**** Oracle's "success" isn't happening in a vacuum. It's the direct result of massive government spending - spending that requires the Fed to keep the money printer running overtime.
