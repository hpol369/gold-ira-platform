...
**the Fed works for the banks, not for you.** Whether it's a Trump pick or anyone else, they'll keep the monetary policy running because stopping would collapse the entire debt-based system. The rich already know this, which is why they're buying real assets while everyone else chases stock gains.
...
The mainstream celebrates these earnings as economic strength. **This is wealth transfer in action** – from savers to asset holders, from Main Street to Wall Street.
