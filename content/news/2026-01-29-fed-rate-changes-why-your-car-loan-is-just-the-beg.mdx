...
**the Federal Reserve isn't federal, and it has no reserves.** It's a private banking cartel that creates money out of thin air, then charges you interest on it. , and you'll see this system is designed to keep average Americans on a hamster wheel of debt while the wealthy accumulate real assets.
...
The rich already know this secret: **when the dollar lose purchasing power, real assets become more valuable.** Gold and silver have been real money for 5,000 years, while every paper currency in history has eventually gone to zero.
